import {SafeContext, SerialNumberInfo, SERIAL_WORDS} from "../Safe/SafeTypes"
...
export class ColorOrderModule extends BaseScriptComponent {
  ...
  private animateGlow(
    ...
    animateGlowAmount(material, targetValue, duration, callback)
  }

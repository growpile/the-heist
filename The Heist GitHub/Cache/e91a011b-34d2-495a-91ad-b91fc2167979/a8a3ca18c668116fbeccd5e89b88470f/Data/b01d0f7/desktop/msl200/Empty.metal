...
Output_N13=smoothstep(Value2_N9,Output_N8,(*sc_set0.UserUniforms).Port_Input2_N013);
float4 Output_N11=float4(0.0);
Output_N11=mix(Output_N6,Output_N3,float4(Output_N13));

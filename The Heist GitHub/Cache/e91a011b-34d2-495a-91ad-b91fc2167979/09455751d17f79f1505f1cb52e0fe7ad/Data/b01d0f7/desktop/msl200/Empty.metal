...
float Value2_N9=0.0;
float2 param_2=UVCoord_N1;
float param_3=param_2.y;
Value2_N9=param_3;
float Output_N8=0.0;
float param_4=(*sc_set0.UserUniforms).progress;
Output_N8=param_4;
float Output_N10=0.0;
Output_N10=step(Value2_N9,Output_N8);
float4 Output_N11=float4(0.0);
Output_N11=mix((*sc_set0.UserUniforms).Port_Input0_N011,Output_N6,float4(Output_N10));
...
float4 l9_4=fast::max(param_6,float4(0.0));
float4 param_7=l9_4;
if (sc_ShaderCacheConstant_tmp!=0)
{

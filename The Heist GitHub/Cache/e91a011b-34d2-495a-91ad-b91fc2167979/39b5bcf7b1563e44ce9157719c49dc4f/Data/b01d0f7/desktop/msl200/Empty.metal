...
//float Port_Value1_N011 4504
//float2 Port_Import_N068 4520
//float Port_Input1_N083 4528
//float Port_Input2_N083 4532
//float depthRef 4536
//}
...
Output_N8=param_3;
float2 Value_N11=float2(0.0);
Value_N11.x=(*sc_set0.UserUniforms).Port_Value1_N011;
Value_N11.y=Output_N8;
...
float4 l9_4=fast::max(param_5,float4(0.0));
float4 param_6=l9_4;
if (sc_ShaderCacheConstant_tmp!=0)
{

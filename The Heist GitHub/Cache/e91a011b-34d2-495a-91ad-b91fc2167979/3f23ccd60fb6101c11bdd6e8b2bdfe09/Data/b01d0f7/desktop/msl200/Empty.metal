...
//float3x3 arrowOpacityMapTransform 4432
//float4 arrowOpacityMapUvMinMax 4480
//float4 arrowOpacityMapBorderColor 4496
//float progress 4512
//float3 Port_Value1_N005 4528
//float depthRef 4544
//}
...
int l9_6=l9_1;
int param_1=arrowOpacityMapLayout_tmp;
int param_2=l9_6;
float2 param_3=UVCoord_N1;
bool param_4=(int(SC_USE_UV_TRANSFORM_arrowOpacityMap_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).arrowOpacityMapTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_arrowOpacityMap_tmp,SC_SOFTWARE_WRAP_MODE_V_arrowOpacityMap_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_arrowOpacityMap_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).arrowOpacityMapUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_arrowOpacityMap_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).arrowOpacityMapBorderColor;
float param_11=0.0;
...
Color_N0=l9_75;
float Value2_N9=0.0;
float2 param_12=UVCoord_N1;
float param_13=param_12.y;
Value2_N9=param_13;
float Output_N8=0.0;
float param_14=(*sc_set0.UserUniforms).progress;
Output_N8=param_14;
float Output_N10=0.0;
Output_N10=step(Value2_N9,Output_N8);
float4 Output_N11=float4(0.0);
Output_N11=Color_N0*float4(Output_N10);
float4 Value_N5=float4(0.0);
Value_N5=float4((*sc_set0.UserUniforms).Port_Value1_N005.x,(*sc_set0.UserUniforms).Port_Value1_N005.y,(*sc_set0.UserUniforms).Port_Value1_N005.z,Value_N5.w);
Value_N5.w=Output_N11.x;
FinalColor=Value_N5;

...
function generateRules() {
    ...
    // UNIQUE (can't apply IFS or MODIFIERS here)
    ...
    // The next rule is a lie. This rule disregards order priority. (only once)
    // The previous rule is a lie. This rule disregards order priority. (only once)

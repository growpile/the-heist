...
function standardRules() {
    // Cut all COLOR wires
    function cutAllColorWires(color) {
    }

    // Cut all odd/even wires
    function cutAllParityWires(parity) {
    }

    // Do not cut any COLOR wires
    function doNotCutColorWires(color) {
    }

    // Do not cut the first/last wire.
    function doNotCutFirstLastWire(position) {
    }

    // Do not cut any odd/even wires.
    function doNotCutParityWires(parity) {
    }

    // Cut N COLOR wires
    function cutNColorWires(n, color) {
    }

    // Cut N odd/even wires.
    function cutNParityWires(n, parity) {
    }

    // Cut the Nth and Mth wires.
    function cutNthMthWires(n, m) {
    }

    // Cut any wire that is odd/even and COLOR.
    function cutParityColorWires(parity, color) {
    }
}

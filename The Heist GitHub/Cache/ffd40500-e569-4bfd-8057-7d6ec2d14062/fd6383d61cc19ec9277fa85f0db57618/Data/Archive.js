...
script.generatePuzzle = function() {
    createWires(print("Wires created."));
}
...
function ruleBuilder() {
    // populate the rule functions array with 4 random, unique rule functions.
    let ruleFunctions = [];
    ...
    function ifMoreColor1ThanColor2(modifier) {
    }

    // if there are more odd/even wires than even/odd wires.
    function ifMoreParity1ThanParity2(modifier) {
    }

    // if the first/last wire is COLOR.
    function ifFirstLastWireIsColor(modifier) {
    }

    // if the first wire is COLOR/parity and the last wire is COLOR/parity.
    function ifFirstLastWireIsColorParity(modifier) {
    }

    // if the number of wires is odd/even.
    function ifNumberOfWiresIsParity(modifier) {
    }

    // if the bomb's serial number contains a vowel/consonant/digit.
    function ifSerialContainsVowelConsonantDigit(modifier) {
    }

    // if the second-to-last wire is COLOR/parity.
    function ifSecondToLastWireIsColorParity(modifier) {
    }

    // if the Nth wire is COLOR/parity.
    function ifNthWireIsColorParity(modifier) {
    }

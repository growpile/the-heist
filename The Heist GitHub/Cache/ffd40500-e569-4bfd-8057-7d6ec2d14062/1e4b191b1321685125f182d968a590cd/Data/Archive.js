...
function createRules() {
    ...
    let bombContext = {
        ...
        wires: wires,
        timeToMidnightNoon: getTimeToMidnightNoon(),
    };

    // unique cases
    if(bombContext.serialNumber.containsWord) {
        // cutBasedOnSerialReversedWord();
    }

    if(timeToMidnightNoon.hoursToMidnight > 2 || timeToMidnightNoon.hoursToNoon > 2) {

...
//ubo int UserUniforms 0:37:7600 {
//float4 sc_Time 1376
...
//float2 Port_Input1_N062 7520
//float2 Port_Import_N063 7528
//float Port_Value_N046 7536
//float Port_Import_N048 7540
//float Port_Input1_N049 7544
//float3 Port_Value0_N094 7552
//float3 Port_Default_N094 7568
//float Port_Input1_N107 7584
//}
...
float2 Port_Input1_N062;
float2 Port_Import_N063;
float Port_Value_N046;
float Port_Import_N048;
float Port_Input1_N049;
float3 Port_Value0_N094;
float3 Port_Default_N094;
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/360]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(360*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/360]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/360];
...
float Value_N58=0.0;
Value_N58=gParticle.Size;
float3x3 ValueMatrix_N59=float3x3(float3(0.0),float3(0.0),float3(0.0));
ValueMatrix_N59=gParticle.Matrix;
float2 UVCoord_N60=float2(0.0);
UVCoord_N60=Globals.Surface_UVCoord0;
float2 Output_N62=float2(0.0);
Output_N62=UVCoord_N60-(*sc_set0.UserUniforms).Port_Input1_N062;
float2 Value_N63=float2(0.0);
Value_N63=fast::clamp((*sc_set0.UserUniforms).Port_Import_N063,float2(-0.5),float2(0.5));
float2 Output_N72=float2(0.0);
Output_N72=Output_N62+Value_N63;
float4 Output_N73=float4(0.0);
Output_N73=float4(Output_N72.x,Output_N72.y,0.0,1.0);
float3 Output_N74=float3(0.0);
Output_N74=ValueMatrix_N59*Output_N73.xyz;
float Value1_N22=0.0;
float Value2_N22=0.0;
float2 param_5=Output_N74.xy;
float param_6=param_5.x;
float param_7=param_5.y;
Value1_N22=param_6;
Value2_N22=param_7;
float3 Result_N78=float3(0.0);
float param_8=0.0;
...
l9_36=1.0;
param_8=l9_36;
param_8=floor(param_8);
float3 param_12;
if (param_8==0.0)
{
float3 l9_37=float3(0.0);
l9_37=(*sc_set0.UserUniforms).sc_Camera.position;
float3 l9_38=float3(0.0);
l9_38=gParticle.Position;
...
if (param_8==1.0)
{
float4x4 l9_40=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
int l9_41=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_41=0;
...
int l9_42=l9_41;
l9_40=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_42];
float4 l9_43=float4(0.0);
float4x4 l9_44=l9_40;
float4 l9_45=l9_44[2];
l9_43=l9_45;
param_10=l9_43.xyz;
param_12=param_10;
}
...
{
float4x4 l9_46=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
int l9_47=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_47=0;
...
int l9_48=l9_47;
l9_46=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_48];
float4 l9_49=float4(0.0);
float4x4 l9_50=l9_46;
float4 l9_51=l9_50[2];
l9_49=l9_51;
param_11=l9_49.xyz;
param_12=param_11;
}
...
Result_N78=param_12;
float3 Output_N369=float3(0.0);
float3 param_13=Result_N78;
float l9_52=dot(param_13,param_13);
float l9_53;
if (l9_52>0.0)
{
...
float l9_54=l9_53;
float3 param_14=param_13*l9_54;
Output_N369=param_14;
float3 Output_N97=float3(0.0);
float param_15=1.0;
float3 param_16=float3(0.0,1.0,0.0);
float3 param_17=float3(0.0);
float3 l9_55=float3(0.0);
l9_55=gParticle.Velocity;
float l9_56=0.0;
l9_56=length(l9_55);
float l9_57=0.0;
float l9_58=(*sc_set0.UserUniforms).Port_Value_N046;
float l9_59=l9_58+0.001;
l9_59-=0.001;
l9_57=l9_59;
float l9_60=0.0;
l9_60=float(l9_56<l9_57);
float l9_61=0.0;
l9_61=(*sc_set0.UserUniforms).Port_Import_N048;
float l9_62=0.0;
l9_62=float(l9_61<(*sc_set0.UserUniforms).Port_Input1_N049);
float l9_63=0.0;
float l9_64=l9_60;
bool l9_65=(l9_64*1.0)!=0.0;
bool l9_66;
if (!l9_65)
{
l9_66=(l9_62*1.0)!=0.0;
...
float l9_68=0.0;
float3 l9_69=(*sc_set0.UserUniforms).Port_Value0_N094;
float3 l9_70=float3(0.0);
float3 l9_71=(*sc_set0.UserUniforms).Port_Default_N094;
float l9_72=0.0;
l9_72=0.0;
l9_68=l9_72;
l9_68=floor(l9_68);
...
{
l9_75=gl_InstanceIndex%2;
}
int l9_76=l9_75;
l9_74=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_76][1].xyz);
l9_70=l9_74;
l9_73=l9_70;
}
else
...
float l9_82=l9_81;
float3 l9_83=l9_79*l9_82;
l9_78=l9_83;
param_17=l9_78;
param_18=param_17;
}
Output_N97=param_18;
float3 Result_N51=float3(0.0);
Result_N51=cross(Output_N369,Output_N97);
float3 Output_N100=float3(0.0);
float3 param_19=Result_N51;
float l9_84=dot(param_19,param_19);
float l9_85;
if (l9_84>0.0)
{
...
float l9_86=l9_85;
float3 param_20=param_19*l9_86;
Output_N100=param_20;
float3 Output_N102=float3(0.0);
Output_N102=-Output_N100;
float3 Output_N103=float3(0.0);
Output_N103=(float3(Value_N58)*float3(Value1_N22))*Output_N102;
float3 Value_N104=float3(0.0);
Value_N104=gParticle.Position;
float3 Value_N80=float3(0.0);
Value_N80=gParticle.Velocity;
float Output_N81=0.0;
Output_N81=length(Value_N80);
float Value_N48=0.0;
Value_N48=(*sc_set0.UserUniforms).Port_Import_N048;
float Output_N105=0.0;
Output_N105=Output_N81*Value_N48;
float Output_N107=0.0;
Output_N107=fast::max(Output_N105,(*sc_set0.UserUniforms).Port_Input1_N107);
float3 Result_N54=float3(0.0);
Result_N54=cross(Output_N100,Output_N369);
float3 Output_N55=float3(0.0);
float3 param_21=Result_N54;
float l9_87=dot(param_21,param_21);
float l9_88;
if (l9_87>0.0)
{
l9_88=1.0/sqrt(l9_87);
}
else
{
l9_88=0.0;
...
float l9_89=l9_88;
float3 param_22=param_21*l9_89;
Output_N55=param_22;
float3 Output_N57=float3(0.0);
Output_N57=((float3(Value_N58)*float3(Value2_N22))*float3(Output_N107))*Output_N55;
float3 Output_N122=float3(0.0);
Output_N122=(Output_N103+Value_N104)+Output_N57;
float3 param_23=Output_N122;
out.varPosAndMotion=float4(param_23.x,param_23.y,param_23.z,out.varPosAndMotion.w);
float3 param_24=Output_N55;
out.varTangent=float4(param_24.x,param_24.y,param_24.z,out.varTangent.w);
float3 param_25=Output_N369;
out.varNormalAndMotion=float4(param_25.x,param_25.y,param_25.z,out.varNormalAndMotion.w);
int l9_90=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_90=0;
...
int l9_91=l9_90;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_91]*float4(out.varPosAndMotion.xyz,1.0);
float4 param_26=clipPosition;
...
{
l9_92=gl_InstanceIndex%2;
}
int l9_93=l9_92;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_93][2].w!=0.0)
{
float l9_94=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_26.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_26.w))*l9_94)-1.0)*param_26.w;
}
}
float4 l9_95=param_26;
clipPosition=l9_95;
float4 param_27=clipPosition;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if (sc_StereoRenderingMode_tmp==1)
{
float l9_97=dot(l9_96,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_98=l9_97;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_98;
}
}
float4 l9_99=float4(param_27.x,-param_27.y,(param_27.z*0.5)+(param_27.w*0.5),param_27.w);
out.gl_Position=l9_99;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/360];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
param_1.Index1DPerCopy=param%360;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(360*((param/360)+1))-1;
...
param_1.SpawnOffset=param_1.Ratio1D*4.0;
...
float l9_45=param_9.x;
float l9_46=param_9.z;
bool l9_47=l9_43;
float l9_48=l9_31;
...
float l9_53=param_4.y;
float l9_54=param_9.y;
float l9_55=param_9.w;
bool l9_56=l9_52;
float l9_57=l9_31;
...
float2 l9_60=param_4;
bool l9_61=param_5;
float3x3 l9_62=param_6;
if (l9_61)
{
...
param_4.y=l9_75;
l9_31=l9_78;
float2 l9_86=param_4;
int l9_87=param_2;
int l9_88=param_3;
float l9_89=param_12;
float2 l9_90=l9_86;
int l9_91=l9_87;
int l9_92=l9_88;
...
float3 l9_94=l9_93;
float3 l9_95=l9_94;
float4 l9_96=sc_set0.mainTex.sample(sc_set0.mainTexSmpSC,l9_95.xy,bias(l9_89));
float4 l9_97=l9_96;
if (param_10)
{
l9_97=mix(param_11,l9_97,float4(l9_31));
}
float4 l9_98=l9_97;
Color_N18=l9_98;
float4 Output_N19=float4(0.0);
Output_N19=Value_N16*Color_N18;
float4 param_13=Output_N19;
Output_Color0=param_13;
float4 param_14=Output_Color0;
...
float4 l9_154=param_14;
Output_Color0=l9_154;

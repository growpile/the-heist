...
#if (1)
{
l9_442=floor((l9_442*255.0)+0.5)/255.0;
}
#endif
float l9_443=l9_442;
float l9_444=l9_443;
...
float l9_492=l9_491;
float l9_493=l9_492;
gParticle.Color.w=l9_493;
float4 param_69=gParticle.Quaternion;
param_69=normalize(param_69.yzwx);
float l9_494=param_69.x*param_69.x;
float l9_495=param_69.y*param_69.y;
float l9_496=param_69.z*param_69.z;
float l9_497=param_69.x*param_69.z;
float l9_498=param_69.x*param_69.y;
float l9_499=param_69.y*param_69.z;
float l9_500=param_69.w*param_69.x;
float l9_501=param_69.w*param_69.y;
float l9_502=param_69.w*param_69.z;
float3x3 l9_503=float3x3(float3(1.0-(2.0*(l9_495+l9_496)),2.0*(l9_498+l9_502),2.0*(l9_497-l9_501)),float3(2.0*(l9_498-l9_502),1.0-(2.0*(l9_494+l9_496)),2.0*(l9_499+l9_500)),float3(2.0*(l9_497+l9_501),2.0*(l9_499-l9_500),1.0-(2.0*(l9_494+l9_495))));
gParticle.Matrix=l9_503;
...
{
l9_40=gl_InstanceIndex%2;
}
int l9_41=l9_40;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_41]*float4(out.varPosAndMotion.xyz,1.0);
...
int l9_43=l9_42;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_43][2].w!=0.0)
{
float l9_44=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_6.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_6.w))*l9_44)-1.0)*param_6.w;
}
}
float4 l9_45=param_6;
clipPosition=l9_45;
...
float4 l9_46=param_7;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_47=dot(l9_46,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_48=l9_47;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_48;
}
}
float4 l9_49=float4(param_7.x,-param_7.y,(param_7.z*0.5)+(param_7.w*0.5),param_7.w);
out.gl_Position=l9_49;

...
//float3 prevPos 7408
//float3 Port_Input0_N009 7424
//float3 Port_Min_N019 7440
//float3 Port_Max_N019 7456
//float Port_Value_N018 7472
//float Port_Value_N011 7476
//}
...
float spawnAmount;
float3 prevPos;
float3 Port_Input0_N009;
float3 Port_Min_N019;
float3 Port_Max_N019;
float Port_Value_N018;
...
float3 l9_104=(*sc_set0.UserUniforms).prevPos;
l9_103=l9_104;
float3 l9_105=float3(0.0);
int l9_106=gl_InstanceIndex;
float4x4 l9_107=(*sc_set0.UserUniforms).vfxModelMatrix[l9_106/2001];
float3 l9_108=l9_107[3].xyz;
l9_105=l9_108;
float3 l9_109=float3(0.0);
l9_109=l9_103-l9_105;
float l9_110=0.0;
l9_110=gParticle.Index1DPerCopyF;
float l9_111=0.0;
float l9_112=(*sc_set0.UserUniforms).spawnAmount;
l9_111=l9_112;
float l9_113=0.0;
l9_113=mod(l9_110,l9_111);
float l9_114=0.0;
l9_114=l9_113/(l9_111+1.234e-06);
float3 l9_115=float3(0.0);
l9_115=mix((*sc_set0.UserUniforms).Port_Input0_N009,l9_109,float3(l9_114));
gParticle.Position=l9_115;
float3 l9_116=float3(0.0);
float3 l9_117=(*sc_set0.UserUniforms).Port_Min_N019;
float3 l9_118=(*sc_set0.UserUniforms).Port_Max_N019;
ssGlobals l9_119=param_2;
int l9_120=3;
bool l9_121=false;
bool l9_122=true;
bool l9_123=true;
...
l9_116=l9_195;
gParticle.Color=float4(l9_116,0.0);
float l9_196=(*sc_set0.UserUniforms).Port_Value_N018;
gParticle.Life=l9_196;
gParticle.Life=fast::clamp(gParticle.Life,0.1,3600.0);
gParticle.Size=(*sc_set0.UserUniforms).Port_Value_N011;
gParticle.Velocity+=((gParticle.Force/float3(gParticle.Mass))*0.033330001);
gParticle.Force=float3(0.0);
int l9_197=gl_InstanceIndex;
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_197/2001]*float4(gParticle.Position,1.0)).xyz;
int l9_198=gl_InstanceIndex;
int l9_199=l9_198/2001;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_199][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_199][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_199][2].xyz)*gParticle.Velocity;
int l9_200=gl_InstanceIndex;
int l9_201=l9_200/2001;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_201][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_201][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_201][2].xyz)*gParticle.Force;
int l9_202=gl_InstanceIndex;
int l9_203=gl_InstanceIndex;
int l9_204=gl_InstanceIndex;
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_202/2001][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_203/2001][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_204/2001][2].xyz)))*gParticle.Size;
int l9_205=gl_InstanceIndex;
int l9_206=l9_205/2001;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_206][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_206][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_206][2].xyz)*gParticle.Matrix;
...
float4 l9_207=param_3;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_208=dot(l9_207,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_209=l9_208;
...
{
out.varClipDistance=l9_209;
}
}
float4 l9_210=float4(param_3.x,-param_3.y,(param_3.z*0.5)+(param_3.w*0.5),param_3.w);
out.gl_Position=l9_210;
return out;
}
...
float4 l9_212=param_5;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_213=dot(l9_212,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_214=l9_213;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_214;
}
}
float4 l9_215=float4(param_5.x,-param_5.y,(param_5.z*0.5)+(param_5.w*0.5),param_5.w);
out.gl_Position=l9_215;
return out;
}
float l9_216;
...
{
l9_216=gParticle.Force.x;
}
gParticle.Force.x=l9_216;
float l9_217;
...
{
l9_217=gParticle.Force.y;
}
gParticle.Force.y=l9_217;
float l9_218;
...
{
l9_218=gParticle.Force.z;
}
gParticle.Force.z=l9_218;
...
{
l9_219=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_219;
float l9_220;
...
{
l9_220=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_220;
float l9_221;
...
{
l9_221=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_221;
...
float4 l9_224=param_6;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_225=dot(l9_224,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_226=l9_225;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_226;
}
}
float4 l9_227=float4(param_6.x,-param_6.y,(param_6.z*0.5)+(param_6.w*0.5),param_6.w);
out.gl_Position=l9_227;
...
float4 l9_228=param_7;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_229=dot(l9_228,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_230=l9_229;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_230;
}
}
float4 l9_231=float4(param_7.x,-param_7.y,(param_7.z*0.5)+(param_7.w*0.5),param_7.w);
out.gl_Position=l9_231;
return out;
}
return out;
}

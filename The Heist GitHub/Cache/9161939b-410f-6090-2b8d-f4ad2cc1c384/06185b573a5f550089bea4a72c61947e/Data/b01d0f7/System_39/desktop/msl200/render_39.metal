...
//sampler sampler colorrampTexSmpSC 0:23
//sampler sampler intensityTextureSmpSC 0:24
//sampler sampler mainTexSmpSC 0:25
...
//texture texture2D colorrampTex 0:0:0:23
//texture texture2D intensityTexture 0:1:0:24
//texture texture2D mainTex 0:2:0:25
...
//ubo int UserUniforms 0:39:7712 {
//float4 sc_Time 1376
...
//float3x3 colorrampTexTransform 7568
//float4 colorrampTexUvMinMax 7616
//float4 colorrampTexBorderColor 7632
//float Port_Input1_N072 7648
//float Port_Value_N076 7652
//float Port_Import_N078 7656
//float Port_Input1_N093 7660
//float Port_Input1_N096 7664
//float2 Port_SpriteCount_N021 7672
//float Port_MaxFrames_N021 7680
//float Port_Input1_N010 7684
//float Port_Multiplier_N033 7696
//float Port_Value2_N263 7704
//}
...
//spec_const bool sc_OutputBounds 52 0
//spec_const bool sc_RenderAlphaToColor 53 0
//spec_const bool sc_ScreenTextureHasSwappedViews 54 0
//spec_const bool sc_Voxelization 55 0
...
constant bool sc_OutputBounds [[function_constant(52)]];
constant bool sc_OutputBounds_tmp = is_function_constant_defined(sc_OutputBounds) ? sc_OutputBounds : false;
constant bool sc_RenderAlphaToColor [[function_constant(53)]];
constant bool sc_RenderAlphaToColor_tmp = is_function_constant_defined(sc_RenderAlphaToColor) ? sc_RenderAlphaToColor : false;
constant bool sc_ScreenTextureHasSwappedViews [[function_constant(54)]];
constant bool sc_ScreenTextureHasSwappedViews_tmp = is_function_constant_defined(sc_ScreenTextureHasSwappedViews) ? sc_ScreenTextureHasSwappedViews : false;
constant bool sc_Voxelization [[function_constant(55)]];
...
float Port_Value_N076;
float Port_Import_N078;
float Port_Input1_N093;
float Port_Input1_N096;
float Port_AlphaTestThreshold_N039;
float2 Port_SpriteCount_N021;
float Port_MaxFrames_N021;
float Port_Input1_N010;
float Port_Speed_N021;
float Port_SecondOffset_N021;
float Port_Multiplier_N033;
...
sampler colorrampTexSmpSC [[id(23)]];
sampler intensityTextureSmpSC [[id(24)]];
sampler mainTexSmpSC [[id(25)]];
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/500]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(500*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/500]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/500];
...
float3 Value_N69=float3(0.0);
Value_N69=gParticle.Position;
float Value_N70=0.0;
Value_N70=gParticle.Size;
float2 UVCoord_N71=float2(0.0);
UVCoord_N71=Globals.Surface_UVCoord0;
float2 Output_N72=float2(0.0);
Output_N72=UVCoord_N71-float2((*sc_set0.UserUniforms).Port_Input1_N072);
float Value1_N73=0.0;
float Value2_N73=0.0;
float2 param_5=Output_N72;
...
l9_37=length(l9_36);
float l9_38=0.0;
float l9_39=(*sc_set0.UserUniforms).Port_Value_N076;
...
float l9_42=0.0;
l9_42=(*sc_set0.UserUniforms).Port_Import_N078;
float l9_43=0.0;
...
int l9_50=l9_49;
l9_48=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_50][1].xyz);
param_9=l9_48;
param_11=param_9;
}
else
...
float l9_56=l9_55;
float3 l9_57=l9_53*l9_56;
l9_52=l9_57;
param_10=l9_52;
param_11=param_10;
}
Output_N87=param_11;
float3 Camera_Position_N366=float3(0.0);
Camera_Position_N366=(*sc_set0.UserUniforms).sc_Camera.position;
float3 Value_N367=float3(0.0);
Value_N367=gParticle.Position;
float3 Output_N368=float3(0.0);
Output_N368=Camera_Position_N366-Value_N367;
float3 Output_N369=float3(0.0);
float3 param_12=Output_N368;
float l9_58=dot(param_12,param_12);
float l9_59;
if (l9_58>0.0)
{
...
float l9_60=l9_59;
float3 param_13=param_12*l9_60;
Output_N369=param_13;
float3 Result_N89=float3(0.0);
Result_N89=cross(Output_N87,Output_N369);
float3 Output_N90=float3(0.0);
float3 param_14=Result_N89;
float l9_61=dot(param_14,param_14);
float l9_62;
if (l9_61>0.0)
{
...
float l9_63=l9_62;
float3 param_15=param_14*l9_63;
Output_N90=param_15;
float3 Output_N91=float3(0.0);
Output_N91=(float3(Value_N70)*float3(Value1_N73))*Output_N90;
float3 Value_N74=float3(0.0);
Value_N74=gParticle.Velocity;
float Output_N75=0.0;
Output_N75=length(Value_N74);
float Value_N78=0.0;
Value_N78=(*sc_set0.UserUniforms).Port_Import_N078;
float Output_N94=0.0;
Output_N94=Output_N75*Value_N78;
float Output_N96=0.0;
Output_N96=fast::max(Output_N94,(*sc_set0.UserUniforms).Port_Input1_N096);
float3 Output_N98=float3(0.0);
Output_N98=((float3(Value_N70)*float3(Value2_N73))*float3(Output_N96))*Output_N87;
float3 Output_N99=float3(0.0);
Output_N99=(Value_N69+Output_N91)+Output_N98;
...
float3 Result_N102=float3(0.0);
Result_N102=cross(Output_N87,Output_N90);
float3 Output_N103=float3(0.0);
float3 param_18=Result_N102;
float l9_64=dot(param_18,param_18);
float l9_65;
if (l9_64>0.0)
{
l9_65=1.0/sqrt(l9_64);
}
else
{
l9_65=0.0;
...
float l9_66=l9_65;
float3 param_19=param_18*l9_66;
Output_N103=param_19;
float3 param_20=Output_N103;
...
int l9_68=l9_67;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_68]*float4(out.varPosAndMotion.xyz,1.0);
...
int l9_70=l9_69;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_70][2].w!=0.0)
{
float l9_71=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_21.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_21.w))*l9_71)-1.0)*param_21.w;
}
}
float4 l9_72=param_21;
clipPosition=l9_72;
...
float4 l9_73=param_22;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_74=dot(l9_73,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_75=l9_74;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_75;
}
}
float4 l9_76=float4(param_22.x,-param_22.y,(param_22.z*0.5)+(param_22.w*0.5),param_22.w);
out.gl_Position=l9_76;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/500];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
param_1.Index1DPerCopy=param%500;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(500*((param/500)+1))-1;
...
float Value_N9=0.0;
Value_N9=gParticle.Seed;
float Output_N10=0.0;
Output_N10=Value_N9*(*sc_set0.UserUniforms).Port_Input1_N010;
float4 Color_N21=float4(0.0);
float2 param_2=(*sc_set0.UserUniforms).Port_SpriteCount_N021;
float param_3=(*sc_set0.UserUniforms).Port_MaxFrames_N021;
float param_4=Output_N10;
...
Color_N21=param_5;
float Value_N35=0.0;
Value_N35=gParticle.Ratio1DPerCopy;
float Time_N33=0.0;
Time_N33=Globals.gTimeElapsedShifted*(*sc_set0.UserUniforms).Port_Multiplier_N033;
float Output_N34=0.0;
Output_N34=Value_N35*Time_N33;
float Value_N262=0.0;
Value_N262=Output_N34;
...
float param_17=0.0;
bool l9_125=param_15&&(!param_13);
float l9_126=1.0;
float l9_127=param_9.x;
int l9_128=param_12.x;
if (l9_128==1)
{
l9_127=fract(l9_127);
}
...
param_9.x=l9_127;
float l9_132=param_9.y;
int l9_133=param_12.y;
if (l9_133==1)
{
l9_132=fract(l9_132);
}
...
float l9_139=param_9.x;
float l9_140=param_14.x;
float l9_141=param_14.z;
bool l9_142=l9_138;
float l9_143=l9_126;
...
float l9_148=param_9.y;
float l9_149=param_14.y;
float l9_150=param_14.w;
bool l9_151=l9_147;
float l9_152=l9_126;
...
float2 l9_155=param_9;
bool l9_156=param_10;
float3x3 l9_157=param_11;
if (l9_156)
{
...
param_9=l9_158;
float l9_159=param_9.x;
int l9_160=param_12.x;
bool l9_161=l9_125;
float l9_162=l9_126;
...
param_9.x=l9_159;
l9_126=l9_162;
float l9_170=param_9.y;
int l9_171=param_12.y;
bool l9_172=l9_125;
float l9_173=l9_126;
...
param_9.y=l9_170;
l9_126=l9_173;
float2 l9_181=param_9;
int l9_182=param_7;
int l9_183=param_8;
float l9_184=param_17;
...
float4 l9_191=sc_set0.colorrampTex.sample(sc_set0.colorrampTexSmpSC,l9_190.xy,bias(l9_184));
float4 l9_192=l9_191;
if (param_15)
{
l9_192=mix(param_16,l9_192,float4(l9_126));
}
...
Value_N7=gParticle.Color;
float4 Output_N32=float4(0.0);
Output_N32=(Color_N21*Export_N265)*Value_N7;

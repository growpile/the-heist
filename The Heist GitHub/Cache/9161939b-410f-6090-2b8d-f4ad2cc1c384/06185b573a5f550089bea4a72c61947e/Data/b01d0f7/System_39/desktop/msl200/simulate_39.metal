...
//float4 Tweak_N26 7392
//float4 Tweak_N27 7408
//float3 Port_Import_N084 7424
//float3 Port_Min_N213 7440
//float3 Port_Max_N213 7456
//float Port_Min_N254 7472
//float Port_Max_N254 7476
//float Port_Import_N214 7480
//float3 Port_Import_N212 7488
//float3 Port_Import_N014 7504
//float3 Port_Import_N016 7520
//float Port_Import_N132 7536
//float Port_Import_N133 7540
//float Port_Import_N036 7544
//float Port_Import_N267 7548
//float Port_Import_N268 7552
//float Port_Import_N269 7556
//float Port_Input4_N270 7560
//float Port_Multiplier_N272 7564
//float3 Port_Import_N053 7568
//float3 Port_Import_N055 7584
//float3 Port_Import_N318 7600
//float Port_Multiplier_N319 7616
//float3 Port_Import_N322 7632
//float2 Port_Input1_N326 7648
//float2 Port_Scale_N327 7656
//float2 Port_Input1_N329 7664
//float2 Port_Scale_N330 7672
//float2 Port_Input1_N332 7680
//float2 Port_Scale_N333 7688
//float3 Port_Input1_N335 7696
//float3 Port_Import_N046 7712
//float Port_Import_N057 7728
//}
...
param.CopyId=float(param_1/500);
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/500]!=0);
}
else
{
l9_46=l9_45;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/500];
...
l9_21=(*sc_set0.UserUniforms).Port_Import_N084;
...
l9_192=(*sc_set0.UserUniforms).Port_Import_N014;
float3 l9_193=float3(0.0);
l9_193=(*sc_set0.UserUniforms).Port_Import_N016;
...
float l9_274=0.0;
l9_274=(*sc_set0.UserUniforms).Port_Import_N132;
float l9_275=0.0;
l9_275=(*sc_set0.UserUniforms).Port_Import_N133;
float l9_276=0.0;
float l9_277=l9_274;
float l9_278=l9_275;
...
l9_358=l9_359;
float l9_360=0.0;
l9_360=(*sc_set0.UserUniforms).Port_Import_N036;
float l9_361=0.0;
l9_361=l9_358*l9_360;
gParticle.Size=l9_361;
float4 l9_362=float4(0.0);
float4 l9_363=(*sc_set0.UserUniforms).Tweak_N26;
l9_362=l9_363;
float4 l9_364=float4(0.0);
float4 l9_365=(*sc_set0.UserUniforms).Tweak_N27;
l9_364=l9_365;
float4 l9_366=float4(0.0);
float4 l9_367=l9_362;
float4 l9_368=l9_364;
ssGlobals l9_369=param_1;
int l9_370=4;
bool l9_371=true;
bool l9_372=true;
bool l9_373=true;
float l9_374=29.0;
ssParticle l9_375=gParticle;
float l9_376=0.0;
float l9_377=l9_369.gTimeElapsed;
float4 l9_378=float4(0.0);
float4 l9_379=float4(0.0);
if (l9_371)
{
l9_379.x=floor(fract(l9_377)*1000.0);
}
if (l9_373)
{
l9_379.y=float(l9_375.Index1D^((l9_375.Index1D*15299)+l9_375.Index1D));
}
if (l9_372)
{
l9_379.z=l9_374;
}
l9_379.w=l9_376*1000.0;
int l9_380=int(l9_379.x);
int l9_381=int(l9_379.y);
int l9_382=int(l9_379.z);
int l9_383=int(l9_379.w);
int l9_384=(((l9_380*15299)^(l9_381*30133))^(l9_382*17539))^(l9_383*12113);
int l9_385=l9_384;
if (l9_370==1)
{
int l9_386=l9_385;
...
float2 l9_403=float2(l9_400,l9_402);
l9_378=float4(l9_403.x,l9_403.y,l9_378.z,l9_378.w);
}
else
{
if (l9_370==3)
...
float3 l9_420=float3(l9_415,l9_417,l9_419);
l9_378=float4(l9_420.x,l9_420.y,l9_420.z,l9_378.w);
}
else
{
int l9_421=l9_385;
...
float4 l9_442=float4(l9_435,l9_437,l9_439,l9_441);
l9_378=l9_442;
}
}
}
float4 l9_443=l9_378;
float4 l9_444=l9_443;
float4 l9_445=mix(l9_367,l9_368,l9_444);
l9_366=l9_445;
gParticle.Color=l9_366;
gParticle.Velocity+=((gParticle.Force/float3(gParticle.Mass))*0.033330001);
gParticle.Force=float3(0.0);
int l9_446=gl_InstanceIndex;
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_446/500]*float4(gParticle.Position,1.0)).xyz;
int l9_447=gl_InstanceIndex;
int l9_448=l9_447/500;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_448][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_448][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_448][2].xyz)*gParticle.Velocity;
int l9_449=gl_InstanceIndex;
int l9_450=l9_449/500;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_450][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_450][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_450][2].xyz)*gParticle.Force;
int l9_451=gl_InstanceIndex;
int l9_452=gl_InstanceIndex;
int l9_453=gl_InstanceIndex;
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_451/500][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_452/500][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_453/500][2].xyz)))*gParticle.Size;
int l9_454=gl_InstanceIndex;
int l9_455=l9_454/500;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_455][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_455][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_455][2].xyz)*gParticle.Matrix;
...
float4 l9_459=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
...
Value_N12=gParticle.Velocity;
float3 Output_N13=float3(0.0);
Output_N13=-Value_N12;
float Output_N30=0.0;
Output_N30=length(Value_N12);
float3 Output_N266=float3(0.0);
Output_N266=Output_N13*float3(Output_N30);
...
float3 Value_N53=float3(0.0);
Value_N53=(*sc_set0.UserUniforms).Port_Import_N053;
float3 Value_N54=float3(0.0);
Value_N54=gParticle.Position;
...
Output_N321=(Value_N54+Value_N55)+Output_N320;
...
param_3*=(param_4*0.5);
float2 l9_461=param_3;
float param_5=(snoise(l9_461)*0.5)+0.5;
...
param_6*=(param_7*0.5);
float2 l9_462=param_6;
float param_8=(snoise(l9_462)*0.5)+0.5;
...
float2 l9_463=param_9;
float param_11=(snoise(l9_463)*0.5)+0.5;
...
Output_N337=Value_N53*Output_N336;
gParticle.Force+=Output_N337;
float3 Value_N46=float3(0.0);
Value_N46=(*sc_set0.UserUniforms).Port_Import_N046;
float3 Output_N56=float3(0.0);
float3 param_12=Value_N46;
float l9_464=dot(param_12,param_12);
float l9_465;
if (l9_464>0.0)
{
l9_465=1.0/sqrt(l9_464);
}
else
{
l9_465=0.0;
...
float l9_466=l9_465;
float3 param_13=param_12*l9_466;
Output_N56=param_13;
float Value_N57=0.0;
Value_N57=(*sc_set0.UserUniforms).Port_Import_N057;
float3 Output_N60=float3(0.0);
Output_N60=Output_N56*float3(Value_N57);
gParticle.Force+=Output_N60;
...
float4 l9_467=param_15;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_468=dot(l9_467,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_469=l9_468;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_469;
}
}
float4 l9_470=float4(param_15.x,-param_15.y,(param_15.z*0.5)+(param_15.w*0.5),param_15.w);
out.gl_Position=l9_470;
return out;
}
float l9_471;
...
{
l9_471=gParticle.Force.x;
}
gParticle.Force.x=l9_471;
float l9_472;
...
{
l9_472=gParticle.Force.y;
}
gParticle.Force.y=l9_472;
float l9_473;
...
{
l9_473=gParticle.Force.z;
}
gParticle.Force.z=l9_473;
...
{
l9_474=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_474;
float l9_475;
...
{
l9_475=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_475;
float l9_476;
...
{
l9_476=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_476;
...
float4 l9_479=param_16;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_480=dot(l9_479,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_481=l9_480;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_481;
}
}
float4 l9_482=float4(param_16.x,-param_16.y,(param_16.z*0.5)+(param_16.w*0.5),param_16.w);
out.gl_Position=l9_482;
...
float4 l9_486=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);

...
param.CopyId=float(param_1/257);
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/257]!=0);
}
else
{
l9_46=l9_45;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_88/257];
...
if ((*sc_set0.UserUniforms).vfxEmitParticle[l9_89/257]!=0)
{
ssGlobals param_1=Globals;
float l9_90=0.0;
float l9_91=(*sc_set0.UserUniforms).spawnAmount;
l9_90=l9_91;
gParticle.SpawnAmount+=fast::max(l9_90*param_1.gTimeDelta,0.0);
...
int l9_324=(257*((in.Interp_Particle_Index/257)+1))-1;

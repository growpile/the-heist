...
//float4 Port_Value_N058 7504
//float Port_Min_N008 7520
//float Port_Max_N008 7524
//float Port_Import_N268 7532
...
//float Port_Import_N285 7624
//float3 Port_Import_N284 7632
//float Port_Import_N041 7648
//float Port_Import_N059 7652
//float Port_Input0_N063 7660
//float Port_Import_N185 7664
//float Port_Input1_N227 7672
//float Port_Input2_N227 7676
//float Port_Input0_N066 7680
//float Port_Import_N188 7684
//float Port_Input1_N236 7692
//float Port_Input2_N236 7696
//float Port_Min_N038 7700
//float Port_Max_N038 7704
//float Port_Min_N023 7712
//float Port_Max_N023 7716
//float Port_Min_N125 7724
//float Port_Max_N125 7728
...
l9_355=(*sc_set0.UserUniforms).Port_Import_N013;
float3 l9_356=float3(0.0);
l9_356=(*sc_set0.UserUniforms).Port_Import_N016;
float3 l9_357=float3(0.0);
float3 l9_358=l9_355;
float3 l9_359=l9_356;
...
float3 l9_436=mix(l9_358,l9_359,l9_435.xyz);
l9_357=l9_436;
float3x3 l9_437=float3x3(float3(0.0),float3(0.0),float3(0.0));
float3 l9_438=l9_357;
float l9_439=cos(radians(l9_438.x));
float l9_440=sin(radians(l9_438.x));
float l9_441=cos(radians(l9_438.y));
float l9_442=sin(radians(l9_438.y));
float l9_443=cos(radians(l9_438.z));
float l9_444=sin(radians(l9_438.z));
float3x3 l9_445=float3x3(float3(l9_441*l9_443,(l9_439*l9_444)+((l9_440*l9_442)*l9_443),(l9_440*l9_444)-((l9_439*l9_442)*l9_443)),float3((-l9_441)*l9_444,(l9_439*l9_443)-((l9_440*l9_442)*l9_444),(l9_440*l9_443)+((l9_439*l9_442)*l9_444)),float3(l9_442,(-l9_440)*l9_441,l9_439*l9_441));
l9_437=l9_445;
gParticle.Matrix=l9_437;
float4 l9_446=float4(0.0);
float4 l9_447=(*sc_set0.UserUniforms).Tweak_N79;
l9_446=l9_447;
float4 l9_448=float4(0.0);
l9_448=l9_446;
float4 l9_449=float4(0.0);
float4 l9_450=(*sc_set0.UserUniforms).Tweak_N80;
l9_449=l9_450;
float4 l9_451=float4(0.0);
l9_451=l9_449;
float l9_452=0.0;
float l9_453=(*sc_set0.UserUniforms).Port_Min_N043;
float l9_454=(*sc_set0.UserUniforms).Port_Max_N043;
ssGlobals l9_455=param_1;
int l9_456=1;
bool l9_457=true;
bool l9_458=true;
bool l9_459=true;
float l9_460=43.0;
ssParticle l9_461=gParticle;
float l9_462=0.0;
float l9_463=l9_455.gTimeElapsed;
float4 l9_464=float4(0.0);
float4 l9_465=float4(0.0);
if (l9_457)
{
l9_465.x=floor(fract(l9_463)*1000.0);
}
if (l9_459)
{
l9_465.y=float(l9_461.Index1D^((l9_461.Index1D*15299)+l9_461.Index1D));
}
if (l9_458)
{
l9_465.z=l9_460;
}
l9_465.w=l9_462*1000.0;
int l9_466=int(l9_465.x);
int l9_467=int(l9_465.y);
int l9_468=int(l9_465.z);
int l9_469=int(l9_465.w);
int l9_470=(((l9_466*15299)^(l9_467*30133))^(l9_468*17539))^(l9_469*12113);
int l9_471=l9_470;
if (l9_456==1)
{
int l9_472=l9_471;
...
float2 l9_489=float2(l9_486,l9_488);
l9_464=float4(l9_489.x,l9_489.y,l9_464.z,l9_464.w);
}
else
{
if (l9_456==3)
...
float3 l9_506=float3(l9_501,l9_503,l9_505);
l9_464=float4(l9_506.x,l9_506.y,l9_506.z,l9_464.w);
}
else
{
int l9_507=l9_471;
...
float4 l9_528=float4(l9_521,l9_523,l9_525,l9_527);
l9_464=l9_528;
}
}
}
float4 l9_529=l9_464;
float4 l9_530=l9_529;
float l9_531=mix(l9_453,l9_454,l9_530.x);
l9_452=l9_531;
float4 l9_532=float4(0.0);
l9_532=mix(l9_448,l9_451,float4(l9_452));
gParticle.Color=l9_532;
float l9_533=0.0;
l9_533=(*sc_set0.UserUniforms).Port_Import_N285;
float3 l9_534=float3(0.0);
l9_534=(*sc_set0.UserUniforms).Port_Import_N284;
float3 l9_535=float3(0.0);
l9_535=gParticle.Position;
float3 l9_536=float3(0.0);
l9_536=l9_534-l9_535;
float3 l9_537=float3(0.0);
float3 l9_538=l9_536;
float l9_539=dot(l9_538,l9_538);
float l9_540;
if (l9_539>0.0)
{
l9_540=1.0/sqrt(l9_539);
}
else
{
l9_540=0.0;
...
float l9_541=l9_540;
float3 l9_542=l9_538*l9_541;
l9_537=l9_542;
float3 l9_543=float3(0.0);
l9_543=float3(l9_533)*l9_537;
gParticle.Force+=l9_543;

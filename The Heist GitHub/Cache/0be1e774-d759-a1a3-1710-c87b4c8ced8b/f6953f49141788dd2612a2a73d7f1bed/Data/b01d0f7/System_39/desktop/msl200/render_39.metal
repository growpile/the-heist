...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/4500]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(4500*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/4500]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/4500];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/4500]*float4(gParticle.Position,1.0)).xyz;
int l9_23=ssInstanceID/4500;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/4500];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
float4 l9_99=l9_98;
Output_N18=l9_99;
float3 Value1_N72=float3(0.0);
float Value2_N72=0.0;
float4 param_13=Output_N18;
float3 param_14=param_13.xyz;
float param_15=param_13.w;
Value1_N72=param_14;
Value2_N72=param_15;
float Output_N76=0.0;
Output_N76=Value2_N72*(*sc_set0.UserUniforms).Port_Input1_N076;
float4 Value_N75=float4(0.0);
Value_N75=float4(Value1_N72.x,Value1_N72.y,Value1_N72.z,Value_N75.w);
Value_N75.w=Output_N76;
...
float4 param_16=Value_N98;
float3 param_17=Value_N99;
float param_18=Value_N100;
float param_19=FrontFacing_N101;
float param_20=Value_N102;
float param_21=Value_N103;
float param_22=Value_N104;
float param_23=Value_N105;
ssGlobals param_24=Globals;
ssGlobals tempGlobals=param_24;
N106_ColorMult=param_16;
N106_NormalWorldSpace=param_17;
N106_vertexNormal=param_18!=0.0;
N106_frontFacing=param_19!=0.0;
N106_DiffuseStrength=param_20;
N106_SpecularStrength=param_21;
N106_SpecHighlightSize=param_22;
N106_AmbientStrength=param_23;

...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/1500];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/1500]*float4(gParticle.Position,1.0)).xyz;
int l9_23=ssInstanceID/1500;

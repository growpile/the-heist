...
//float Port_Multiplier_N052 7424
...
l9_449=(*sc_set0.UserUniforms).Port_Import_N042;
float l9_450=0.0;
float l9_451=(*sc_set0.UserUniforms).Port_Min_N043;
float l9_452=(*sc_set0.UserUniforms).Port_Max_N043;
ssGlobals l9_453=param_1;
int l9_454=1;
bool l9_455=true;
bool l9_456=true;
bool l9_457=true;
...
float l9_460=0.0;
float l9_461=l9_453.gTimeElapsed;
...
float l9_529=mix(l9_451,l9_452,l9_528.x);
l9_450=l9_529;
float4 l9_530=float4(0.0);
l9_530=mix(l9_448,l9_449,float4(l9_450));
gParticle.Color=l9_530;
float l9_531=0.0;
l9_531=(*sc_set0.UserUniforms).Port_Import_N285;
float3 l9_532=float3(0.0);
l9_532=(*sc_set0.UserUniforms).Port_Import_N284;
float3 l9_533=float3(0.0);
l9_533=gParticle.Position;
float3 l9_534=float3(0.0);
l9_534=l9_532-l9_533;
float3 l9_535=float3(0.0);
float3 l9_536=l9_534;
float l9_537=dot(l9_536,l9_536);
float l9_538;
if (l9_537>0.0)
{
l9_538=1.0/sqrt(l9_537);
}
else
{
l9_538=0.0;
...
float l9_539=l9_538;
float3 l9_540=l9_536*l9_539;
l9_535=l9_540;
float3 l9_541=float3(0.0);
l9_541=float3(l9_531)*l9_535;
gParticle.Force+=l9_541;
...
float4 l9_545=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
...
float l9_553=0.0;
float l9_554=param_6.gTimeElapsed;
...
float param_5=mix(param_3,param_4,l9_621.x);
Random_N38=param_5;
...
float l9_628=0.0;
float l9_629=param_10.gTimeElapsed;
...
float param_9=mix(param_7,param_8,l9_696.x);
Random_N23=param_9;
...
float l9_703=0.0;
float l9_704=param_14.gTimeElapsed;
...
float param_13=mix(param_11,param_12,l9_771.x);
...
float l9_772=dot(param_15,param_15);
float l9_773;
if (l9_772>0.0)
{
l9_773=1.0/sqrt(l9_772);
}
else
{
l9_773=0.0;
...
float l9_774=l9_773;
float3 param_16=param_15*l9_774;
...
float3 l9_775=normalize(param_17);
float l9_776=sin(radians(param_18));
float l9_777=cos(radians(param_18));
float l9_778=1.0-l9_777;
float3x3 param_19=float3x3(float3(((l9_778*l9_775.x)*l9_775.x)+l9_777,((l9_778*l9_775.x)*l9_775.y)-(l9_775.z*l9_776),((l9_778*l9_775.z)*l9_775.x)+(l9_775.y*l9_776)),float3(((l9_778*l9_775.x)*l9_775.y)+(l9_775.z*l9_776),((l9_778*l9_775.y)*l9_775.y)+l9_777,((l9_778*l9_775.y)*l9_775.z)-(l9_775.x*l9_776)),float3(((l9_778*l9_775.z)*l9_775.x)-(l9_775.y*l9_776),((l9_778*l9_775.y)*l9_775.z)+(l9_775.x*l9_776),((l9_778*l9_775.z)*l9_775.z)+l9_777));
...
float4 l9_779=param_21;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_780=dot(l9_779,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_781=l9_780;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_781;
}
}
float4 l9_782=float4(param_21.x,-param_21.y,(param_21.z*0.5)+(param_21.w*0.5),param_21.w);
out.gl_Position=l9_782;
return out;
}
float l9_783;
...
{
l9_783=gParticle.Force.x;
}
gParticle.Force.x=l9_783;
float l9_784;
...
{
l9_784=gParticle.Force.y;
}
gParticle.Force.y=l9_784;
float l9_785;
...
{
l9_785=gParticle.Force.z;
}
gParticle.Force.z=l9_785;
...
{
l9_786=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_786;
float l9_787;
...
{
l9_787=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_787;
float l9_788;
...
{
l9_788=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_788;
...
float4 l9_794=float4(param_22.x,-param_22.y,(param_22.z*0.5)+(param_22.w*0.5),param_22.w);
...
float4 l9_795=param_23;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_796=dot(l9_795,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_797=l9_796;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_797;
}
}
float4 l9_798=float4(param_23.x,-param_23.y,(param_23.z*0.5)+(param_23.w*0.5),param_23.w);
out.gl_Position=l9_798;
return out;
}
return out;
}

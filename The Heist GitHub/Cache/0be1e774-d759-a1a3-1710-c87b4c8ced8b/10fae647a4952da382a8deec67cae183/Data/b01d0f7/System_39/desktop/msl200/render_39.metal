...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/251]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_9=l9_8>=(251*((*sc_set0.UserUniforms).vfxNumCopies+1));
bool l9_10;
if (!l9_9)
{
l9_10=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/251]!=0)==false;
}
else
{
l9_10=l9_9;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/251];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/251]*float4(gParticle.Position,1.0)).xyz;
int l9_27=ssInstanceID/251;
...
float3 l9_29=gParticle.Position+(gParticle.Matrix*float3(v.position.x*gParticle.Size,v.position.y*gParticle.Size,0.0));
out.varPosAndMotion=float4(l9_29.x,l9_29.y,l9_29.z,out.varPosAndMotion.w);
float3 l9_30=gParticle.Matrix*float3(0.0,0.0,1.0);
...
float2 param_5=(*sc_set0.UserUniforms).Port_SizeMult_N035;
float2 param_6=(*sc_set0.UserUniforms).Port_PivotPoint_N035;
float param_7=(*sc_set0.UserUniforms).Port_VelocityStretchAmount_N035;
...
int l9_33=l9_32;
float3 l9_34=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_33][1].xyz);
float l9_35=length(gParticle.Velocity);
float l9_36=fast::max(l9_35*param_7,1.0);
if ((l9_35>0.029999999)&&(param_7>9.9999997e-05))
{
l9_34=normalize(gParticle.Velocity);
}
int l9_37=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_38=l9_37;
float3 l9_39=-normalize(-(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_38][2].xyz);
float3 l9_40=normalize(cross(l9_39,l9_34));
float3 l9_41=normalize(cross(l9_40,l9_39));
float2 l9_42=(param_8.Surface_UVCoord0-float2(0.5))+param_6;
float2x2 l9_43=float2x2(float2(gParticle.Matrix[0].x,gParticle.Matrix[0].y),float2(gParticle.Matrix[1].x,gParticle.Matrix[1].y));
l9_42=l9_43*l9_42;
out.varPosAndMotion=float4(gParticle.Position.x,gParticle.Position.y,gParticle.Position.z,out.varPosAndMotion.w);
float3 l9_44=out.varPosAndMotion.xyz+((-l9_40)*((gParticle.Size*l9_42.x)*param_5.x));
out.varPosAndMotion=float4(l9_44.x,l9_44.y,l9_44.z,out.varPosAndMotion.w);
float3 l9_45=out.varPosAndMotion.xyz+(l9_41*(((gParticle.Size*l9_42.y)*param_5.y)*l9_36));
out.varPosAndMotion=float4(l9_45.x,l9_45.y,l9_45.z,out.varPosAndMotion.w);
out.varNormalAndMotion=float4(l9_39.x,l9_39.y,l9_39.z,out.varNormalAndMotion.w);
out.varTangent=float4(l9_41.x,l9_41.y,l9_41.z,out.varTangent.w);
int l9_46=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_46=0;
...
int l9_47=l9_46;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_47]*float4(out.varPosAndMotion.xyz,1.0);
...
param_9.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_9.w))*l9_50)-1.0)*param_9.w;
}
}
float4 l9_51=param_9;
clipPosition=l9_51;
...
float4 l9_55=float4(param_10.x,-param_10.y,(param_10.z*0.5)+(param_10.w*0.5),param_10.w);
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/251];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
l9_20.Seed+=(floor(((((l9_23-l9_20.SpawnOffset)-0.0)+0.0)+7200.0)/3600.0)*4.32723);

...
float l9_569=dot(param_12,param_12);
float l9_570;
if (l9_569>0.0)
{
l9_570=1.0/sqrt(l9_569);
}
else
{
l9_570=0.0;
...
float l9_571=l9_570;
float3 param_13=param_12*l9_571;
...
float3 l9_572=normalize(param_14);
float l9_573=sin(radians(param_15));
float l9_574=cos(radians(param_15));
float l9_575=1.0-l9_574;
float3x3 param_16=float3x3(float3(((l9_575*l9_572.x)*l9_572.x)+l9_574,((l9_575*l9_572.x)*l9_572.y)-(l9_572.z*l9_573),((l9_575*l9_572.z)*l9_572.x)+(l9_572.y*l9_573)),float3(((l9_575*l9_572.x)*l9_572.y)+(l9_572.z*l9_573),((l9_575*l9_572.y)*l9_572.y)+l9_574,((l9_575*l9_572.y)*l9_572.z)-(l9_572.x*l9_573)),float3(((l9_575*l9_572.z)*l9_572.x)-(l9_572.y*l9_573),((l9_575*l9_572.y)*l9_572.z)+(l9_572.x*l9_573),((l9_575*l9_572.z)*l9_572.z)+l9_574));
...
float4 l9_576=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_577=dot(l9_576,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_578=l9_577;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_578;
}
}
float4 l9_579=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_579;
return out;
}
float l9_580;
...
{
l9_580=gParticle.Force.x;
}
gParticle.Force.x=l9_580;
float l9_581;
...
{
l9_581=gParticle.Force.y;
}
gParticle.Force.y=l9_581;
float l9_582;
...
{
l9_582=gParticle.Force.z;
}
gParticle.Force.z=l9_582;
...
{
l9_583=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_583;
float l9_584;
...
{
l9_584=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_584;
float l9_585;
...
{
l9_585=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_585;
...
float4 l9_588=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_589=dot(l9_588,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_590=l9_589;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_590;
}
}
float4 l9_591=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_591;
...
float4 l9_595=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);

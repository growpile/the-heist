...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/257]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_9=l9_8>=(257*((*sc_set0.UserUniforms).vfxNumCopies+1));
bool l9_10;
if (!l9_9)
{
l9_10=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/257]!=0)==false;
}
else
{
l9_10=l9_9;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/257];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/257]*float4(gParticle.Position,1.0)).xyz;
int l9_27=ssInstanceID/257;

...
//@input Physics.BodyComponent myBodyComponent
/** @type {BodyComponent} */
var myBodyComponent = script.myBodyComponent;
...
function setBodyDynamic(body) {
    ...
    if (body.setBodyType && Physics && Physics.BodyComponent && Physics.BodyComponent.BodyType) {
        body.setBodyType(Physics.BodyComponent.BodyType.Dynamic);
        return;
    }
    if (body.bodyType !== undefined && Physics && Physics.BodyComponent && Physics.BodyComponent.BodyType) {
...
function setBodyVelocity(body, velocityWorld) {
    if (!body) {
        return;
    }
    if (body.setVelocity) {
    ...
    if (body.addVelocity) {
        body.addVelocity(velocityWorld);
        return;
    }
    if (body.addForce) {
        body.addForce(velocityWorld);
    }
}

function setBodyAngularVelocity(body, angularVelocityWorld) {
    if (!body) {
        return;
    }
...
function startThrow() {
    ...
    if (body) {
        ...
        setBodyVelocity(body, velocityWorld);
        setBodyAngularVelocity(body, angularWorldRad);

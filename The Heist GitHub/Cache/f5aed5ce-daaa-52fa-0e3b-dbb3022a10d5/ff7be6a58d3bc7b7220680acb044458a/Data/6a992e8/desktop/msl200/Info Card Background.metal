...
Color_N0=l9_103;
float Output_N2=0.0;
float param_26=(*sc_set0.UserUniforms).Tweak_N2;
Output_N2=param_26;
float4 Output_N12=float4(0.0);
Output_N12=float4(1.0,1.0,1.0,Output_N2);
float4 Output_N14=float4(0.0);
Output_N14=Color_N0*Output_N12;

...
//float4 red 4400
//float progress 4416
//float2 Port_Scale_N001 4424
//float2 Port_Center_N001 4432
//float2 Port_Input1_N137 4440
//float Port_Input1_N138 4448
//float Port_Import_N140 4452
//float Port_Import_N142 4456
//float Port_Input1_N144 4460
//float Port_Input2_N144 4464
//float depthRef 4468
//}
...
float4 param_1=(*sc_set0.UserUniforms).green;
Output_N3=param_1;
float4 Output_N2=float4(0.0);
Output_N2=float4(Export_N145)*Output_N3;
float4 Output_N8=float4(0.0);
float4 param_2=(*sc_set0.UserUniforms).red;
Output_N8=param_2;
float4 Output_N7=float4(0.0);
Output_N7=float4(Export_N145)*Output_N8;
float Output_N6=0.0;
float param_3=(*sc_set0.UserUniforms).progress;
Output_N6=param_3;
float4 Output_N5=float4(0.0);
Output_N5=mix(Output_N2,Output_N7,float4(Output_N6));
...
float4 l9_5=fast::max(param_5,float4(0.0));
float4 param_6=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{

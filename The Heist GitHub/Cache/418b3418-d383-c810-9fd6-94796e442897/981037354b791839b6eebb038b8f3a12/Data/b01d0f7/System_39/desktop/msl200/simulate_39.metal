...
//float Port_TimeBias_N007 7392
//float Port_ValueA_N007 7396
//float Port_TimeA_N007 7400
//float Port_TimeTransition_N007 7404
//float Port_ValueB_N007 7408
//float Port_TimeB_N007 7412
//float3 Port_Value_N006 7424
//float Port_Value2_N111 7440
//float Port_Value3_N111 7444
//float Port_Value4_N111 7448
//float Port_Min_N009 7452
//float Port_Max_N009 7456
//float Port_Value2_N010 7460
//float Port_Value3_N010 7464
//float Port_Value_N008 7468
//}
...
float Port_TimeBias_N007;
float Port_ValueA_N007;
float Port_TimeA_N007;
float Port_TimeTransition_N007;
float Port_ValueB_N007;
float Port_TimeB_N007;
float3 Port_Value_N006;
float Port_Value2_N111;
float Port_Value3_N111;
float Port_Value4_N111;
float Port_Min_N009;
float Port_Max_N009;
float Port_Value2_N010;
float Port_Value3_N010;
...
#if (1)
{
l9_443=floor((l9_443*255.0)+0.5)/255.0;
}
#endif
float l9_444=l9_443;
float l9_445=l9_444;
...
float l9_493=l9_492;
float l9_494=l9_493;
gParticle.Color.w=l9_494;
float4 param_69=gParticle.Quaternion;
param_69=normalize(param_69.yzwx);
float l9_495=param_69.x*param_69.x;
float l9_496=param_69.y*param_69.y;
float l9_497=param_69.z*param_69.z;
float l9_498=param_69.x*param_69.z;
float l9_499=param_69.x*param_69.y;
float l9_500=param_69.y*param_69.z;
float l9_501=param_69.w*param_69.x;
float l9_502=param_69.w*param_69.y;
float l9_503=param_69.w*param_69.z;
float3x3 l9_504=float3x3(float3(1.0-(2.0*(l9_496+l9_497)),2.0*(l9_499+l9_503),2.0*(l9_498-l9_502)),float3(2.0*(l9_499-l9_503),1.0-(2.0*(l9_495+l9_497)),2.0*(l9_500+l9_501)),float3(2.0*(l9_498+l9_502),2.0*(l9_500-l9_501),1.0-(2.0*(l9_495+l9_496))));
gParticle.Matrix=l9_504;
...
float l9_90=0.0;
float l9_91=(*sc_set0.UserUniforms).Port_TimeBias_N007;
float l9_92=(*sc_set0.UserUniforms).Port_ValueA_N007;
float l9_93=(*sc_set0.UserUniforms).Port_TimeA_N007;
float l9_94=(*sc_set0.UserUniforms).Port_TimeTransition_N007;
float l9_95=(*sc_set0.UserUniforms).Port_ValueB_N007;
float l9_96=(*sc_set0.UserUniforms).Port_TimeB_N007;
ssGlobals l9_97=param_1;
float l9_98=((l9_93+l9_94)+l9_96)+9.9999997e-05;
float l9_99=l9_93/l9_98;
float l9_100=1.0-(l9_96/l9_98);
float l9_101=(mod((l9_97.gTimeElapsedShifted/l9_98)+l9_91,1.0)*2.0)-1.0;
float l9_102=abs(l9_101);
float l9_103=mix(l9_92,l9_95,fast::clamp((l9_102-l9_99)/(l9_100-l9_99),0.0,1.0));
l9_90=l9_103;
...
float l9_104=gParticle.Age;
bool l9_105=l9_104<=9.9999997e-05;
bool l9_106;
if (!l9_105)
{
l9_106=gParticle.Age>=(gParticle.Life-Globals.gTimeDelta);
}
else
{
l9_106=l9_105;
}
bool isSpawnCandidate=l9_106;
...
bool l9_107=isSpawnCandidate;
bool l9_108;
if (l9_107)
{
l9_108=(spawnWindowMin&&spawnWindowMax)||spawnRemainder;
}
else
{
l9_108=l9_107;
...
ssParticle l9_109=gParticle;
int l9_110=int(gParticle.CopyId);
float l9_111;
if ((*sc_set0.UserUniforms).overrideTimeEnabled==1)
{
l9_111=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_110];
}
else
{
l9_111=(*sc_set0.UserUniforms).sc_Time.x;
}
float l9_112=l9_111;
l9_109.Seed=(l9_109.Ratio1D*0.97637898)+0.151235;
l9_109.Seed+=(floor(((((l9_112-l9_109.SpawnOffset)-0.0)+0.0)+7200.0)/3600.0)*4.32723);
l9_109.Seed=fract(abs(l9_109.Seed));
int2 l9_113=int2(l9_109.Index1D%400,l9_109.Index1D/400);
l9_109.Seed2000=(float2(l9_113)+float2(1.0))/float2(399.0);
gParticle=l9_109;
float l9_114=44.0;
gParticle.Position=(float3(((floor(mod(gParticle.Index1DPerCopyF,floor(l9_114)))/l9_114)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/floor(l9_114))/l9_114)*2.0)-1.0,0.0)*20.0)+float3(1.0,1.0,0.0);
...
gParticle.Velocity=(*sc_set0.UserUniforms).Port_Value_N006;
float l9_115=0.0;
l9_115=gParticle.Ratio1DPerCopy;
float4 l9_116=float4(0.0);
l9_116.x=l9_115;
l9_116.y=(*sc_set0.UserUniforms).Port_Value2_N111;
l9_116.z=(*sc_set0.UserUniforms).Port_Value3_N111;
l9_116.w=(*sc_set0.UserUniforms).Port_Value4_N111;
float4 l9_117=float4(0.0);
float3 l9_118=l9_116.xyz;
float3 l9_119=l9_118.zzz;
float l9_120=3.0*fract(l9_118.x+0.16666667);
float l9_121=2.0*fract(l9_120);
float2 l9_122=l9_119.yz-((float2(1.0,l9_121)-float2(fast::max(0.0,l9_121-1.0)))*(l9_118.z*fast::clamp(l9_118.y,0.0,1.0)));
l9_119=float3(l9_119.x,l9_122.x,l9_122.y);
if (l9_120>=1.0)
{
l9_119=l9_119.zxy;
}
...
float3 l9_123=l9_119;
l9_117=float4(l9_123,l9_116.w);
gParticle.Color=l9_117;
float l9_124=0.0;
float l9_125=(*sc_set0.UserUniforms).Port_Min_N009;
float l9_126=(*sc_set0.UserUniforms).Port_Max_N009;
ssGlobals l9_127=param_2;
int l9_128=1;
bool l9_129=false;
bool l9_130=true;
bool l9_131=true;
float l9_132=9.0;
ssParticle l9_133=gParticle;
float l9_134=0.0;
float l9_135=l9_127.gTimeElapsed;
float4 l9_136=float4(0.0);
float4 l9_137=float4(0.0);
if (l9_129)
{
l9_137.x=floor(fract(l9_135)*1000.0);
}
if (l9_131)
{
l9_137.y=float(l9_133.Index1D^((l9_133.Index1D*15299)+l9_133.Index1D));
}
if (l9_130)
{
l9_137.z=l9_132;
}
l9_137.w=l9_134*1000.0;
int l9_138=int(l9_137.x);
int l9_139=int(l9_137.y);
int l9_140=int(l9_137.z);
int l9_141=int(l9_137.w);
int l9_142=(((l9_138*15299)^(l9_139*30133))^(l9_140*17539))^(l9_141*12113);
int l9_143=l9_142;
if (l9_128==1)
{
int l9_144=l9_143;
...
float2 l9_161=float2(l9_158,l9_160);
l9_136=float4(l9_161.x,l9_161.y,l9_136.z,l9_136.w);
}
else
{
if (l9_128==3)
...
float3 l9_178=float3(l9_173,l9_175,l9_177);
l9_136=float4(l9_178.x,l9_178.y,l9_178.z,l9_136.w);
}
else
{
int l9_179=l9_143;
...
float4 l9_200=float4(l9_193,l9_195,l9_197,l9_199);
l9_136=l9_200;
}
}
}
float4 l9_201=l9_136;
float4 l9_202=l9_201;
float l9_203=mix(l9_125,l9_126,l9_202.x);
l9_124=l9_203;
float3 l9_204=float3(0.0);
l9_204.x=l9_124;
l9_204.y=(*sc_set0.UserUniforms).Port_Value2_N010;
l9_204.z=(*sc_set0.UserUniforms).Port_Value3_N010;
gParticle.Position=l9_204;
float l9_205=(*sc_set0.UserUniforms).Port_Value_N008;
gParticle.Life=l9_205;
...
int l9_206=gl_InstanceIndex;
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_206/2001]*float4(gParticle.Position,1.0)).xyz;
int l9_207=gl_InstanceIndex;
int l9_208=l9_207/2001;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_208][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_208][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_208][2].xyz)*gParticle.Velocity;
int l9_209=gl_InstanceIndex;
int l9_210=l9_209/2001;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_210][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_210][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_210][2].xyz)*gParticle.Force;
int l9_211=gl_InstanceIndex;
int l9_212=gl_InstanceIndex;
int l9_213=gl_InstanceIndex;
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_211/2001][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_212/2001][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_213/2001][2].xyz)))*gParticle.Size;
int l9_214=gl_InstanceIndex;
int l9_215=l9_214/2001;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_215][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_215][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_215][2].xyz)*gParticle.Matrix;
...
float4 l9_219=float4(param_3.x,-param_3.y,(param_3.z*0.5)+(param_3.w*0.5),param_3.w);
...
float4 l9_221=param_5;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_222=dot(l9_221,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_223=l9_222;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_223;
}
}
float4 l9_224=float4(param_5.x,-param_5.y,(param_5.z*0.5)+(param_5.w*0.5),param_5.w);
out.gl_Position=l9_224;
return out;
}
float l9_225;
...
{
l9_225=gParticle.Force.x;
}
gParticle.Force.x=l9_225;
float l9_226;
...
{
l9_226=gParticle.Force.y;
}
gParticle.Force.y=l9_226;
float l9_227;
...
{
l9_227=gParticle.Force.z;
}
gParticle.Force.z=l9_227;
...
{
l9_228=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_228;
float l9_229;
...
{
l9_229=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_229;
float l9_230;
...
{
l9_230=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_230;
...
float4 l9_236=float4(param_6.x,-param_6.y,(param_6.z*0.5)+(param_6.w*0.5),param_6.w);
...
float4 l9_237=param_7;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_238=dot(l9_237,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_239=l9_238;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_239;
}
}
float4 l9_240=float4(param_7.x,-param_7.y,(param_7.z*0.5)+(param_7.w*0.5),param_7.w);
out.gl_Position=l9_240;
return out;
}
return out;
}
...
int l9_292=(2001*((in.Interp_Particle_Index/2001)+1))-1;

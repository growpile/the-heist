...
//ubo int UserUniforms 0:37:7552 {
//float4 sc_Time 1376
...
//float Port_Import_N033 7520
//float2 Port_Import_N034 7528
//}
...
main_vert_out out={};
int ssInstanceID=0;
int N47_FacingMode=0;
int N47_Alignment=0;
float N47_VelocityStretchAmount=0.0;
float2 N47_PivotPoint=float2(0.0);
sc_Vertex_t l9_0;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/2001];
...
float4 param_5=gParticle.Quaternion;
param_5=normalize(param_5.yzwx);
float l9_27=param_5.x*param_5.x;
float l9_28=param_5.y*param_5.y;
float l9_29=param_5.z*param_5.z;
float l9_30=param_5.x*param_5.z;
float l9_31=param_5.x*param_5.y;
float l9_32=param_5.y*param_5.z;
float l9_33=param_5.w*param_5.x;
float l9_34=param_5.w*param_5.y;
float l9_35=param_5.w*param_5.z;
float3x3 l9_36=float3x3(float3(1.0-(2.0*(l9_28+l9_29)),2.0*(l9_31+l9_35),2.0*(l9_30-l9_34)),float3(2.0*(l9_31-l9_35),1.0-(2.0*(l9_27+l9_29)),2.0*(l9_32+l9_33)),float3(2.0*(l9_30+l9_34),2.0*(l9_32-l9_33),1.0-(2.0*(l9_27+l9_28))));
gParticle.Matrix=l9_36;
float3 l9_37=gParticle.Position+(gParticle.Matrix*float3(v.position.x*gParticle.Size,v.position.y*gParticle.Size,0.0));
out.varPosAndMotion=float4(l9_37.x,l9_37.y,l9_37.z,out.varPosAndMotion.w);
float3 l9_38=gParticle.Matrix*float3(0.0,0.0,1.0);
out.varNormalAndMotion=float4(l9_38.x,l9_38.y,l9_38.z,out.varNormalAndMotion.w);
float3 l9_39=gParticle.Matrix*float3(1.0,0.0,0.0);
out.varTangent=float4(l9_39.x,l9_39.y,l9_39.z,out.varTangent.w);
...
float2 Value_N34=float2(0.0);
Value_N34=fast::clamp((*sc_set0.UserUniforms).Port_Import_N034,float2(-0.5),float2(0.5));
float param_6=Value_N58;
float param_7=Value_N66;
float param_8=Value_N33;
float2 param_9=Value_N34;
ssGlobals param_10=Globals;
ssGlobals tempGlobals=param_10;
N47_FacingMode=int(param_6);
N47_Alignment=int(param_7);
N47_VelocityStretchAmount=param_8;
N47_PivotPoint=param_9;
float l9_40=0.029999999;
float3 l9_41=float3(0.0,1.0,0.0);
float3 l9_42=gParticle.Velocity;
float l9_43=length(l9_42);
float l9_44=fast::max(l9_43*N47_VelocityStretchAmount,1.0);
if ((l9_43<l9_40)||(N47_VelocityStretchAmount<9.9999997e-05))
{
if (N47_Alignment==1)
{
int l9_45=0;
...
int l9_46=l9_45;
float3 l9_47=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_46][1].xyz;
l9_41=l9_47;
}
}
else
{
float3 l9_48=gParticle.Velocity;
l9_41=normalize(l9_48);
}
int l9_49=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_50=l9_49;
float4x4 l9_51=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_50];
float3 l9_52=l9_51[2].xyz;
if (N47_FacingMode==0)
{
float3 l9_53=(*sc_set0.UserUniforms).sc_Camera.position;
float3 l9_54=gParticle.Position;
l9_52=l9_53-l9_54;
}
l9_52=normalize(l9_52);
float3 l9_55=normalize(cross(l9_52,l9_41));
float3 l9_56=normalize(cross(l9_55,l9_52));
float2 l9_57=tempGlobals.Surface_UVCoord0;
float2 l9_58=(l9_57-float2(0.5))+N47_PivotPoint;
float4x4 l9_59=float4x4(float4(gParticle.Matrix[0].x,gParticle.Matrix[0].y,gParticle.Matrix[0].z,0.0),float4(gParticle.Matrix[1].x,gParticle.Matrix[1].y,gParticle.Matrix[1].z,0.0),float4(gParticle.Matrix[2].x,gParticle.Matrix[2].y,gParticle.Matrix[2].z,0.0),float4(0.0,0.0,0.0,1.0));
l9_58=(l9_59*float4(l9_58,0.0,1.0)).xy;
float3 l9_60=gParticle.Position;
float3 l9_61=l9_60;
float l9_62=gParticle.Size;
l9_61+=((-l9_55)*(l9_62*l9_58.x));
float l9_63=gParticle.Size;
l9_61+=(l9_56*((l9_63*l9_58.y)*l9_44));
float3 l9_64=l9_61;
out.varPosAndMotion=float4(l9_64.x,l9_64.y,l9_64.z,out.varPosAndMotion.w);
float3 l9_65=l9_56;
out.varTangent=float4(l9_65.x,l9_65.y,l9_65.z,out.varTangent.w);
float3 l9_66=l9_52;
out.varNormalAndMotion=float4(l9_66.x,l9_66.y,l9_66.z,out.varNormalAndMotion.w);
int l9_67=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_67=0;
...
param_11.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_11.w))*l9_71)-1.0)*param_11.w;
}
}
float4 l9_72=param_11;
clipPosition=l9_72;
...
float4 l9_76=float4(param_12.x,-param_12.y,(param_12.z*0.5)+(param_12.w*0.5),param_12.w);
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/2001];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
float3 l9_94=l9_93;
float3 l9_95=l9_94;
float4 l9_96=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_95.xy,bias(l9_89));
float4 l9_97=l9_96;
if (param_10)
{

...
//ubo int UserUniforms 0:35:7552 {
//float4 sc_Time 1376
...
//float Port_SpawnRate_N030 7392
//float Port_Import_N036 7396
//float3 Port_Import_N037 7408
//float3 Port_Import_N038 7424
//float Port_Import_N041 7440
//float Port_Import_N017 7444
//float Port_Import_N023 7448
//float Port_Import_N132 7452
//float Port_Import_N133 7456
//float Port_Import_N053 7460
//float3 Port_Import_N054 7472
//float4 Port_Import_N117 7488
//float4 Port_Import_N118 7504
//float Port_Min_N119 7520
//float Port_Max_N119 7524
//float Port_Value_N031 7528
//float Port_Import_N126 7532
//float Port_Import_N127 7536
//float Port_Import_N128 7540
//float Port_Input4_N137 7544
//float Port_Multiplier_N272 7548
//}
...
if ((*sc_set0.UserUniforms).vfxEmitParticle[l9_89/2001]!=0)
{
ssGlobals param_1=Globals;
gParticle.SpawnAmount+=fast::max((*sc_set0.UserUniforms).Port_SpawnRate_N030*param_1.gTimeDelta,0.0);
...
l9_95=0.0;
float l9_96=0.0;
l9_96=(*sc_set0.UserUniforms).Port_Import_N036;
float3 l9_97=float3(0.0);
l9_97=(*sc_set0.UserUniforms).Port_Import_N037;
float3 l9_98=float3(0.0);
l9_98=(*sc_set0.UserUniforms).Port_Import_N038;
float l9_99=0.0;
l9_99=fast::clamp((*sc_set0.UserUniforms).Port_Import_N041,0.0,1.0);
float l9_100=l9_95;
float l9_101=l9_96;
float3 l9_102=l9_97;
float3 l9_103=l9_98;
float l9_104=l9_99;
ssGlobals l9_105=param_2;
ssParticle l9_106=gParticle;
int l9_107=int(gParticle.CopyId);
float l9_108;
if ((*sc_set0.UserUniforms).overrideTimeEnabled==1)
{
l9_108=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_107];
}
else
{
l9_108=(*sc_set0.UserUniforms).sc_Time.x;
}
float l9_109=l9_108;
l9_106.Seed=(l9_106.Ratio1D*0.97637898)+0.151235;
l9_106.Seed+=(floor(((((l9_109-l9_106.SpawnOffset)-0.0)+0.0)+7200.0)/3600.0)*4.32723);
l9_106.Seed=fract(abs(l9_106.Seed));
int2 l9_110=int2(l9_106.Index1D%400,l9_106.Index1D/400);
l9_106.Seed2000=(float2(l9_110)+float2(1.0))/float2(399.0);
gParticle=l9_106;
float l9_111=44.0;
gParticle.Position=(float3(((floor(mod(gParticle.Index1DPerCopyF,floor(l9_111)))/l9_111)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/floor(l9_111))/l9_111)*2.0)-1.0,0.0)*20.0)+float3(1.0,1.0,0.0);
...
ssGlobals tempGlobals=l9_105;
N42_SphereType=int(l9_100);
N42_Radius=l9_101;
N42_Scale=l9_102;
N42_Center=l9_103;
N42_VolumeFill=l9_104;
bool l9_112=true;
bool l9_113=true;
bool l9_114=true;
float l9_115=0.0;
...
bool l9_120=l9_112;
float l9_121=42.0;
ssParticle l9_122=gParticle;
float l9_123=l9_115;
float l9_124=tempGlobals.gTimeElapsed;
float4 l9_125=float4(0.0);
float4 l9_126=float4(0.0);
if (l9_118)
{
l9_126.x=floor(fract(l9_124)*1000.0);
}
if (l9_120)
{
l9_126.y=float(l9_122.Index1D^((l9_122.Index1D*15299)+l9_122.Index1D));
}
if (l9_119)
{
l9_126.z=l9_121;
}
l9_126.w=l9_123*1000.0;
int l9_127=int(l9_126.x);
int l9_128=int(l9_126.y);
int l9_129=int(l9_126.z);
int l9_130=int(l9_126.w);
int l9_131=(((l9_127*15299)^(l9_128*30133))^(l9_129*17539))^(l9_130*12113);
int l9_132=l9_131;
if (l9_117==1)
{
int l9_133=l9_132;
...
int l9_142=l9_141;
int l9_143=l9_139*1399;
int l9_144=((l9_143*((l9_143*1471343)+101146501))+1559861749)&2147483647;
int l9_145=l9_144;
int l9_146=l9_142;
float l9_147=float(l9_146)*4.6566129e-10;
int l9_148=l9_145;
float l9_149=float(l9_148)*4.6566129e-10;
float2 l9_150=float2(l9_147,l9_149);
l9_125=float4(l9_150.x,l9_150.y,l9_125.z,l9_125.w);
}
else
{
if (l9_117==3)
...
float4 l9_189=float4(l9_182,l9_184,l9_186,l9_188);
l9_125=l9_189;
}
}
}
float4 l9_190=l9_125;
l9_116=l9_190.xyz;
float3 l9_191=l9_116;
...
float l9_204=l9_196;
float l9_205=tempGlobals.gTimeElapsed;
...
l9_197=l9_271.xyz;
float3 l9_272=l9_197;
float3 l9_273=l9_272;
float l9_274=1.0-N42_VolumeFill;
float l9_275=3.0;
float l9_276;
if (l9_274<=0.0)
{
...
{
l9_276=pow(l9_274,l9_275);
}
float l9_277=l9_276;
float l9_278=l9_277;
l9_192=mix(float3(l9_278),float3(1.0),l9_192);
float3 l9_279=l9_192;
float l9_280;
if (l9_279.x<=0.0)
{
l9_280=0.0;
...
{
l9_284=sqrt(l9_279.z);
}
float3 l9_285=float3(l9_281,l9_283,l9_284);
l9_192=l9_285;
l9_273=mix(float3(-1.0),float3(1.0),l9_273);
l9_273/=float3(length(l9_273+float3(9.9999997e-05)));
float3 l9_286=((l9_192*l9_273)*N42_Scale)*N42_Radius;
if (N42_SphereType==1)
{
l9_286.x=abs(l9_286.x);
}
else
{
if (N42_SphereType==2)
{
l9_286.y=abs(l9_286.y);
}
else
{
if (N42_SphereType==3)
{
l9_286.z=abs(l9_286.z);
}
}
}
l9_286+=N42_Center;
float3 l9_287=l9_286;
gParticle.Position=l9_287;
float l9_288=0.0;
l9_288=0.0;
float l9_289=0.0;
l9_289=(*sc_set0.UserUniforms).Port_Import_N017;
float l9_290=0.0;
l9_290=(*sc_set0.UserUniforms).Port_Import_N023;
float l9_291=0.0;
float l9_292=0.0;
float l9_293=l9_288;
float l9_294=l9_289;
float l9_295=l9_290;
ssGlobals l9_296=param_2;
tempGlobals=l9_296;
float l9_297=0.0;
float l9_298=0.0;
N24_SizeMode=int(l9_293);
N24_InputStart=l9_294;
N24_InputEnd=l9_295;
N24_OutputStart=N24_InputStart;
N24_OutputEnd=N24_InputEnd;
if (N24_SizeMode!=0)
{
float3 l9_299=(*sc_set0.UserUniforms).vfxLocalAabbMax;
float3 l9_300=(*sc_set0.UserUniforms).vfxLocalAabbMin;
float l9_301=length(l9_299-l9_300);
N24_OutputStart/=l9_301;
N24_OutputEnd/=l9_301;
}
l9_297=N24_OutputStart;
l9_298=N24_OutputEnd;
l9_291=l9_297;
l9_292=l9_298;
float l9_302=0.0;
float l9_303=l9_291;
float l9_304=l9_292;
ssGlobals l9_305=param_2;
int l9_306=1;
bool l9_307=false;
bool l9_308=true;
bool l9_309=true;
float l9_310=26.0;
ssParticle l9_311=gParticle;
float l9_312=0.0;
float l9_313=l9_305.gTimeElapsed;
float4 l9_314=float4(0.0);
float4 l9_315=float4(0.0);
if (l9_307)
{
l9_315.x=floor(fract(l9_313)*1000.0);
}
if (l9_309)
{
l9_315.y=float(l9_311.Index1D^((l9_311.Index1D*15299)+l9_311.Index1D));
}
if (l9_308)
{
l9_315.z=l9_310;
}
l9_315.w=l9_312*1000.0;
int l9_316=int(l9_315.x);
int l9_317=int(l9_315.y);
int l9_318=int(l9_315.z);
int l9_319=int(l9_315.w);
int l9_320=(((l9_316*15299)^(l9_317*30133))^(l9_318*17539))^(l9_319*12113);
int l9_321=l9_320;
if (l9_306==1)
{
int l9_322=l9_321;
...
float2 l9_339=float2(l9_336,l9_338);
l9_314=float4(l9_339.x,l9_339.y,l9_314.z,l9_314.w);
}
else
{
if (l9_306==3)
...
float3 l9_356=float3(l9_351,l9_353,l9_355);
l9_314=float4(l9_356.x,l9_356.y,l9_356.z,l9_314.w);
}
else
{
int l9_357=l9_321;
...
float4 l9_378=float4(l9_371,l9_373,l9_375,l9_377);
l9_314=l9_378;
}
}
}
float4 l9_379=l9_314;
float4 l9_380=l9_379;
float l9_381=mix(l9_303,l9_304,l9_380.x);
l9_302=l9_381;
gParticle.Size=l9_302;
float l9_382=0.0;
l9_382=(*sc_set0.UserUniforms).Port_Import_N132;
float l9_383=0.0;
l9_383=(*sc_set0.UserUniforms).Port_Import_N133;
float l9_384=0.0;
float l9_385=l9_382;
float l9_386=l9_383;
ssGlobals l9_387=param_2;
int l9_388=1;
bool l9_389=true;
bool l9_390=true;
bool l9_391=true;
...
float l9_394=0.0;
float l9_395=l9_387.gTimeElapsed;
...
float l9_463=mix(l9_385,l9_386,l9_462.x);
l9_384=l9_463;
float l9_464=l9_384;
gParticle.Mass=l9_464;
gParticle.Mass=fast::max(9.9999997e-06,gParticle.Mass);
float l9_465=0.0;
l9_465=(*sc_set0.UserUniforms).Port_Import_N053;
float3 l9_466=float3(0.0);
l9_466=(*sc_set0.UserUniforms).Port_Import_N054;
float3 l9_467=float3(0.0);
l9_467=gParticle.Position;
float3 l9_468=float3(0.0);
l9_468=l9_466-l9_467;
float3 l9_469=float3(0.0);
float3 l9_470=l9_468;
float l9_471=dot(l9_470,l9_470);
float l9_472;
if (l9_471>0.0)
{
l9_472=1.0/sqrt(l9_471);
}
else
{
l9_472=0.0;
...
float l9_473=l9_472;
float3 l9_474=l9_470*l9_473;
l9_469=l9_474;
float3 l9_475=float3(0.0);
l9_475=float3(l9_465)*l9_469;
gParticle.Force+=l9_475;
float4 l9_476=float4(0.0);
l9_476=(*sc_set0.UserUniforms).Port_Import_N117;
float4 l9_477=float4(0.0);
l9_477=(*sc_set0.UserUniforms).Port_Import_N118;
float l9_478=0.0;
float l9_479=(*sc_set0.UserUniforms).Port_Min_N119;
float l9_480=(*sc_set0.UserUniforms).Port_Max_N119;
ssGlobals l9_481=param_2;
int l9_482=1;
bool l9_483=true;
bool l9_484=true;
bool l9_485=true;
float l9_486=119.0;
ssParticle l9_487=gParticle;
float l9_488=0.0;
float l9_489=l9_481.gTimeElapsed;
float4 l9_490=float4(0.0);
float4 l9_491=float4(0.0);
if (l9_483)
{
l9_491.x=floor(fract(l9_489)*1000.0);
}
if (l9_485)
{
l9_491.y=float(l9_487.Index1D^((l9_487.Index1D*15299)+l9_487.Index1D));
}
if (l9_484)
{
l9_491.z=l9_486;
}
l9_491.w=l9_488*1000.0;
int l9_492=int(l9_491.x);
int l9_493=int(l9_491.y);
int l9_494=int(l9_491.z);
int l9_495=int(l9_491.w);
int l9_496=(((l9_492*15299)^(l9_493*30133))^(l9_494*17539))^(l9_495*12113);
int l9_497=l9_496;
if (l9_482==1)
{
int l9_498=l9_497;
...
float2 l9_515=float2(l9_512,l9_514);
l9_490=float4(l9_515.x,l9_515.y,l9_490.z,l9_490.w);
}
else
{
if (l9_482==3)
...
float3 l9_532=float3(l9_527,l9_529,l9_531);
l9_490=float4(l9_532.x,l9_532.y,l9_532.z,l9_490.w);
}
else
{
int l9_533=l9_497;
...
float4 l9_554=float4(l9_547,l9_549,l9_551,l9_553);
l9_490=l9_554;
}
}
}
float4 l9_555=l9_490;
float4 l9_556=l9_555;
float l9_557=mix(l9_479,l9_480,l9_556.x);
l9_478=l9_557;
float4 l9_558=float4(0.0);
l9_558=mix(l9_476,l9_477,float4(l9_478));
gParticle.Color=l9_558;
float l9_559=(*sc_set0.UserUniforms).Port_Value_N031;
gParticle.Life=l9_559;
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_560/2001]*float4(gParticle.Position,1.0)).xyz;
int l9_561=gl_InstanceIndex;
int l9_562=l9_561/2001;
gParticle.Velocity=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_562][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_562][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_562][2].xyz)*gParticle.Velocity;
int l9_563=gl_InstanceIndex;
int l9_564=l9_563/2001;
gParticle.Force=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_564][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_564][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_564][2].xyz)*gParticle.Force;
int l9_565=gl_InstanceIndex;
int l9_566=gl_InstanceIndex;
int l9_567=gl_InstanceIndex;
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_565/2001][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_566/2001][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_567/2001][2].xyz)))*gParticle.Size;
int l9_568=gl_InstanceIndex;
int l9_569=l9_568/2001;
gParticle.Matrix=float3x3((*sc_set0.UserUniforms).vfxModelMatrix[l9_569][0].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_569][1].xyz,(*sc_set0.UserUniforms).vfxModelMatrix[l9_569][2].xyz)*gParticle.Matrix;
...
float4 l9_570=param_3;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_571=dot(l9_570,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_572=l9_571;
...
{
out.varClipDistance=l9_572;
}
}
float4 l9_573=float4(param_3.x,-param_3.y,(param_3.z*0.5)+(param_3.w*0.5),param_3.w);
out.gl_Position=l9_573;
return out;
}
...
float4 l9_578=float4(param_5.x,-param_5.y,(param_5.z*0.5)+(param_5.w*0.5),param_5.w);
...
{
l9_579=gParticle.Force.x;
}
gParticle.Force.x=l9_579;
float l9_580;
...
{
l9_580=gParticle.Force.y;
}
gParticle.Force.y=l9_580;
float l9_581;
...
{
l9_581=gParticle.Force.z;
}
gParticle.Force.z=l9_581;
...
{
l9_582=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_582;
float l9_583;
...
{
l9_583=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_583;
float l9_584;
...
{
l9_584=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_584;
...
float4 l9_590=float4(param_6.x,-param_6.y,(param_6.z*0.5)+(param_6.w*0.5),param_6.w);
...
float4 l9_591=param_7;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_592=dot(l9_591,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_593=l9_592;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_593;
}
}
float4 l9_594=float4(param_7.x,-param_7.y,(param_7.z*0.5)+(param_7.w*0.5),param_7.w);
out.gl_Position=l9_594;
return out;
}
return out;
}

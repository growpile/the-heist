...
//}
//ubo int UserUniforms 0:24:4400 {
//float4 sc_Time 1376
...
//float vertexInset 4256
//float Port_Import_N223 4268
//float Port_Import_N037 4272
//float Port_Import_N049 4304
//float Port_Import_N005 4308
//float Port_Import_N041 4312
//float Port_Import_N252 4336
//float Port_Input1_N253 4340
//float Port_Input2_N253 4344
//float Port_Import_N247 4368
//float2 Port_Scale_N237 4376
...
float Port_Import_N218;
float Port_Import_N223;
float Port_Import_N037;
float3 Port_Import_N250;
float Port_Import_N049;
float Port_Import_N005;
float Port_Import_N041;
float3 Port_Import_N251;
float Port_Import_N252;
float Port_Input1_N253;
float Port_Input2_N253;
float3 Port_Import_N240;
float Port_Import_N247;
float2 Port_Scale_N237;
...
float3 Position_N182=float3(0.0);
Position_N182=Globals.SurfacePosition_ObjectSpace;
float Output_N11=0.0;
float param_1=(*sc_set0.UserUniforms).vertexInset;
Output_N11=param_1;
float Value_N34=0.0;
Value_N34=Output_N11;
float Value_N218=0.0;
Value_N218=Value_N34;
float3 AABBMax_N219=float3(0.0);
AABBMax_N219=(*sc_set0.UserUniforms).sc_LocalAabbMax;
float3 AABBMin_N220=float3(0.0);
AABBMin_N220=(*sc_set0.UserUniforms).sc_LocalAabbMin;
float3 Output_N221=float3(0.0);
Output_N221=AABBMax_N219-AABBMin_N220;
float Output_N222=0.0;
Output_N222=length(Output_N221);
float Value_N223=0.0;
Value_N223=(*sc_set0.UserUniforms).Port_Import_N223;
float Output_N224=0.0;
Output_N224=(Value_N218*Output_N222)*Value_N223;
float Export_N225=0.0;
Export_N225=Output_N224;
...
float l9_122=0.0;
l9_122=(*sc_set0.UserUniforms).Port_Import_N037;
float3 l9_123=float3(0.0);
l9_123=float3(l9_122);
param_5=l9_123;
float l9_124=0.0;
float l9_125=0.0;
float l9_126=0.0;
...
float l9_129=0.0;
l9_129=fast::clamp((*sc_set0.UserUniforms).Port_Import_N049,0.0,1.0);
l9_125=l9_129;
float l9_130;
if ((l9_125*1.0)!=0.0)
{
float l9_131=0.0;
l9_131=(*sc_set0.UserUniforms).Port_Import_N005;
float l9_132=0.0;
l9_132=l9_128.gTimeElapsed*l9_131;
float l9_133=0.0;
l9_133=(*sc_set0.UserUniforms).Port_Import_N041;
float l9_134=0.0;
l9_134=l9_132+l9_133;
l9_126=l9_134;
l9_130=l9_126;
}
else
{
float l9_135=0.0;
l9_135=(*sc_set0.UserUniforms).Port_Import_N041;
l9_127=l9_135;
l9_130=l9_127;
}
l9_124=l9_130;
float3 l9_136=float3(0.0);
l9_136=float3(l9_124);
param_6=l9_136;
float l9_137=0.0;
l9_137=(*sc_set0.UserUniforms).Port_Import_N252;
float l9_138=0.0;
l9_138=fast::clamp(l9_137+0.001,(*sc_set0.UserUniforms).Port_Input1_N253+0.001,(*sc_set0.UserUniforms).Port_Input2_N253+0.001)-0.001;
param_7=l9_138;
float3 l9_139=float3(0.0);
l9_139=param_9.SurfacePosition_ObjectSpace;
float3 l9_140=float3(0.0);
l9_140=l9_139;
float3 l9_141=float3(0.0);
l9_141=(*sc_set0.UserUniforms).sc_LocalAabbMax;
float3 l9_142=float3(0.0);
l9_142=(*sc_set0.UserUniforms).sc_LocalAabbMin;
float3 l9_143=float3(0.0);
l9_143=l9_141-l9_142;
float l9_144=0.0;
l9_144=length(l9_143);
float3 l9_145=float3(0.0);
l9_145=l9_140/(float3(l9_144)+float3(1.234e-06));
float3 l9_146=float3(0.0);
l9_146=l9_145;
float l9_147=0.0;
l9_147=fast::max((*sc_set0.UserUniforms).Port_Import_N247,0.0);
float3 l9_148=float3(0.0);
l9_148=l9_146*float3(l9_147);
param_3=l9_148;
float3 l9_149=float3(0.0);
l9_149=param_9.VertexNormal_ObjectSpace;
param_4=l9_149;
float3 l9_150=param_3;
float3 l9_151=param_4;
l9_150+=param_6;
l9_150*=param_5;
l9_151=abs(l9_151);
...
{
bool3 l9_157=bool3(l9_151.y>l9_151.z);
l9_156=int3(l9_157.x ? int3(1,2,0).x : int3(2,0,1).x,l9_157.y ? int3(1,2,0).y : int3(2,0,1).y,l9_157.z ? int3(1,2,0).z : int3(2,0,1).z);
}
int3 l9_158=l9_156;
float l9_159=l9_151.x;
float l9_160=l9_151.y;
bool l9_161=l9_159<l9_160;
bool l9_162;
if (l9_161)
{
l9_162=l9_151.x<l9_151.z;
}
else
{
l9_162=l9_161;
...
{
bool3 l9_164=bool3(l9_151.y<l9_151.z);
l9_163=int3(l9_164.x ? int3(1,2,0).x : int3(2,0,1).x,l9_164.y ? int3(1,2,0).y : int3(2,0,1).y,l9_164.z ? int3(1,2,0).z : int3(2,0,1).z);
}
int3 l9_165=l9_163;
int3 l9_166=(int3(3)-l9_165)-l9_158;
param_9.gTriplanarCoords=float2(l9_150[l9_158.y],l9_150[l9_158.z]);
float2 l9_167=float2(0.0);
l9_167=param_9.gTriplanarCoords;
float l9_168=0.0;
float2 l9_169=l9_167;
float2 l9_170=(*sc_set0.UserUniforms).Port_Scale_N237;
l9_169.x=floor(l9_169.x*10000.0)*9.9999997e-05;
l9_169.y=floor(l9_169.y*10000.0)*9.9999997e-05;
l9_169*=(l9_170*0.5);
float2 l9_171=l9_169;
float l9_172=(snoise(l9_171)*0.5)+0.5;
l9_172=floor(l9_172*10000.0)*9.9999997e-05;
l9_168=l9_172;
param_2=l9_168;
float l9_173=param_2;
param_9.gTriplanarCoords=float2(l9_150[l9_166.y],l9_150[l9_166.z]);
float2 l9_174=float2(0.0);
l9_174=param_9.gTriplanarCoords;
float l9_175=0.0;
float2 l9_176=l9_174;
float2 l9_177=(*sc_set0.UserUniforms).Port_Scale_N237;
l9_176.x=floor(l9_176.x*10000.0)*9.9999997e-05;
l9_176.y=floor(l9_176.y*10000.0)*9.9999997e-05;
l9_176*=(l9_177*0.5);
float2 l9_178=l9_176;
float l9_179=(snoise(l9_178)*0.5)+0.5;
l9_179=floor(l9_179*10000.0)*9.9999997e-05;
l9_175=l9_179;
param_2=l9_175;
float l9_180=param_2;
float2 l9_181=float2(l9_151[l9_158.x],l9_151[l9_166.x]);
l9_181=pow(l9_181,float2(1.0/(1.0-(param_7*0.99000001))));
float param_8=((l9_173*l9_181.x)+(l9_180*l9_181.y))/(l9_181.x+l9_181.y);
Output_N254=param_8;
float Export_N255=0.0;
Export_N255=Output_N254;
float3 Normal_N256=float3(0.0);
Normal_N256=Globals.VertexNormal_ObjectSpace;
float3 Output_N257=float3(0.0);
float3 param_10=Normal_N256;
float l9_182=dot(param_10,param_10);
float l9_183;
if (l9_182>0.0)
{
...
float l9_184=l9_183;
float3 param_11=param_10*l9_184;
Output_N257=param_11;
float3 Output_N258=float3(0.0);
Output_N258=(float3(Export_N225)*float3(Export_N255))*Output_N257;
float3 Output_N259=float3(0.0);
Output_N259=Position_N182+Output_N258;
float3 VectorOut_N260=float3(0.0);
VectorOut_N260=((*sc_set0.UserUniforms).sc_ModelMatrix*float4(Output_N259,1.0)).xyz;
float3 Export_N2=float3(0.0);
Export_N2=VectorOut_N260;
...
float3 l9_185=normalize(param_14);
out.varNormalAndMotion=float4(l9_185.x,l9_185.y,l9_185.z,out.varNormalAndMotion.w);
float3 l9_186=normalize(param_15);
out.varTangent=float4(l9_186.x,l9_186.y,l9_186.z,out.varTangent.w);
out.varTangent.w=in.tangent.w;
if ((int(UseViewSpaceDepthVariant_tmp)!=0)&&(((int(sc_OITDepthGatherPass_tmp)!=0)||(int(sc_OITCompositingPass_tmp)!=0))||(int(sc_OITDepthBoundsPass_tmp)!=0)))
{
float4 l9_187=param_12.position;
...
{
l9_189=gl_InstanceIndex%2;
}
int l9_190=l9_189;
l9_188=(*sc_set0.UserUniforms).sc_ProjectionMatrixInverseArray[l9_190]*l9_187;
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_192=l9_191;
l9_188=(*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_192]*l9_187;
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_194=l9_193;
l9_188=(*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_194]*l9_187;
}
else
{
l9_188=l9_187;
...
float4 l9_195=l9_188;
out.varViewSpaceDepth=-l9_195.z;
}
...
int l9_198=l9_197;
l9_196=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_198]*param_12.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_200=l9_199;
l9_196=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_200]*float4(out.varPosAndMotion.xyz,1.0);
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_202=l9_201;
l9_196=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_202]*float4(out.varPosAndMotion.xyz,1.0);
}
}
}
}
...
{
float4 l9_203=param_12.position;
float4 l9_204=l9_203;
if (sc_RenderingSpace_tmp==1)
{
l9_204=(*sc_set0.UserUniforms).sc_ModelMatrix*l9_203;
}
float4 l9_205=(*sc_set0.UserUniforms).sc_ProjectorMatrix*l9_204;
float2 l9_206=((l9_205.xy/float2(l9_205.w))*0.5)+float2(0.5);
out.varShadowTex=l9_206;
}
float4 l9_207=l9_196;
...
int l9_209=l9_208;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_209][2].w!=0.0)
{
float l9_210=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_207.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_207.w))*l9_210)-1.0)*l9_207.w;
}
}
float4 l9_211=l9_207;
l9_196=l9_211;
float4 l9_212=l9_196;
if ((int(sc_TAAEnabled_tmp)!=0))
{
float2 l9_213=l9_212.xy+((*sc_set0.UserUniforms).sc_TAAJitterOffset*l9_212.w);
l9_212=float4(l9_213.x,l9_213.y,l9_212.z,l9_212.w);
}
float4 l9_214=l9_212;
l9_196=l9_214;
float4 l9_215=l9_196;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_215.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
if (sc_StereoRenderingMode_tmp>0)
{
...
{
float l9_217=dot(l9_216,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_218=l9_217;
...
{
out.varClipDistance=l9_218;
}
}
float4 l9_219=float4(l9_215.x,-l9_215.y,(l9_215.z*0.5)+(l9_215.w*0.5),l9_215.w);
out.gl_Position=l9_219;
if ((int(sc_Voxelization_tmp)!=0))
{
sc_Vertex_t l9_221=param_12;
sc_Vertex_t l9_222=l9_221;
if ((int(sc_VertexBlending_tmp)!=0))
{
if ((int(sc_VertexBlendingUseNormals_tmp)!=0))
{
sc_Vertex_t l9_223=l9_222;
float3 l9_224=in.blendShape0Pos;
float3 l9_225=in.blendShape0Normal;
float l9_226=(*sc_set0.UserUniforms).weights0.x;
sc_Vertex_t l9_227=l9_223;
float3 l9_228=l9_224;
float l9_229=l9_226;
float3 l9_230=l9_227.position.xyz+(l9_228*l9_229);
l9_227.position=float4(l9_230.x,l9_230.y,l9_230.z,l9_227.position.w);
l9_223=l9_227;
l9_223.normal+=(l9_225*l9_226);
l9_222=l9_223;
sc_Vertex_t l9_231=l9_222;
float3 l9_232=in.blendShape1Pos;
float3 l9_233=in.blendShape1Normal;
float l9_234=(*sc_set0.UserUniforms).weights0.y;
sc_Vertex_t l9_235=l9_231;
float3 l9_236=l9_232;
float l9_237=l9_234;
float3 l9_238=l9_235.position.xyz+(l9_236*l9_237);
l9_235.position=float4(l9_238.x,l9_238.y,l9_238.z,l9_235.position.w);
l9_231=l9_235;
l9_231.normal+=(l9_233*l9_234);
l9_222=l9_231;
sc_Vertex_t l9_239=l9_222;
float3 l9_240=in.blendShape2Pos;
float3 l9_241=in.blendShape2Normal;
float l9_242=(*sc_set0.UserUniforms).weights0.z;
sc_Vertex_t l9_243=l9_239;
float3 l9_244=l9_240;
float l9_245=l9_242;
float3 l9_246=l9_243.position.xyz+(l9_244*l9_245);
l9_243.position=float4(l9_246.x,l9_246.y,l9_246.z,l9_243.position.w);
l9_239=l9_243;
l9_239.normal+=(l9_241*l9_242);
l9_222=l9_239;
}
else
{
sc_Vertex_t l9_247=l9_222;
float3 l9_248=in.blendShape0Pos;
float l9_249=(*sc_set0.UserUniforms).weights0.x;
float3 l9_250=l9_247.position.xyz+(l9_248*l9_249);
l9_247.position=float4(l9_250.x,l9_250.y,l9_250.z,l9_247.position.w);
l9_222=l9_247;
sc_Vertex_t l9_251=l9_222;
float3 l9_252=in.blendShape1Pos;
float l9_253=(*sc_set0.UserUniforms).weights0.y;
float3 l9_254=l9_251.position.xyz+(l9_252*l9_253);
l9_251.position=float4(l9_254.x,l9_254.y,l9_254.z,l9_251.position.w);
l9_222=l9_251;
sc_Vertex_t l9_255=l9_222;
float3 l9_256=in.blendShape2Pos;
float l9_257=(*sc_set0.UserUniforms).weights0.z;
float3 l9_258=l9_255.position.xyz+(l9_256*l9_257);
l9_255.position=float4(l9_258.x,l9_258.y,l9_258.z,l9_255.position.w);
l9_222=l9_255;
sc_Vertex_t l9_259=l9_222;
float3 l9_260=in.blendShape3Pos;
float l9_261=(*sc_set0.UserUniforms).weights0.w;
float3 l9_262=l9_259.position.xyz+(l9_260*l9_261);
l9_259.position=float4(l9_262.x,l9_262.y,l9_262.z,l9_259.position.w);
l9_222=l9_259;
sc_Vertex_t l9_263=l9_222;
float3 l9_264=in.blendShape4Pos;
float l9_265=(*sc_set0.UserUniforms).weights1.x;
float3 l9_266=l9_263.position.xyz+(l9_264*l9_265);
l9_263.position=float4(l9_266.x,l9_266.y,l9_266.z,l9_263.position.w);
l9_222=l9_263;
sc_Vertex_t l9_267=l9_222;
float3 l9_268=in.blendShape5Pos;
float l9_269=(*sc_set0.UserUniforms).weights1.y;
float3 l9_270=l9_267.position.xyz+(l9_268*l9_269);
l9_267.position=float4(l9_270.x,l9_270.y,l9_270.z,l9_267.position.w);
l9_222=l9_267;
}
}
l9_221=l9_222;
sc_Vertex_t l9_271=l9_221;
if (sc_SkinBonesCount_tmp>0)
{
float4 l9_272=float4(0.0);
if (sc_SkinBonesCount_tmp>0)
{
l9_272=float4(1.0,fract(in.boneData.yzw));
l9_272.x-=dot(l9_272.yzw,float3(1.0));
}
float4 l9_273=l9_272;
float4 l9_274=l9_273;
int l9_275=int(in.boneData.x);
int l9_276=int(in.boneData.y);
int l9_277=int(in.boneData.z);
int l9_278=int(in.boneData.w);
int l9_279=l9_275;
float4 l9_280=l9_271.position;
float3 l9_281=float3(0.0);
if (sc_SkinBonesCount_tmp>0)
{
int l9_282=l9_279;
float4 l9_283=(*sc_set0.sc_BonesUBO).sc_Bones[l9_282].boneMatrix[0];
float4 l9_284=(*sc_set0.sc_BonesUBO).sc_Bones[l9_282].boneMatrix[1];
float4 l9_285=(*sc_set0.sc_BonesUBO).sc_Bones[l9_282].boneMatrix[2];
float4 l9_286[3];
l9_286[0]=l9_283;
l9_286[1]=l9_284;
l9_286[2]=l9_285;
l9_281=float3(dot(l9_280,l9_286[0]),dot(l9_280,l9_286[1]),dot(l9_280,l9_286[2]));
}
else
{
l9_281=l9_280.xyz;
}
float3 l9_287=l9_281;
float3 l9_288=l9_287;
float l9_289=l9_274.x;
int l9_290=l9_276;
float4 l9_291=l9_271.position;
float3 l9_292=float3(0.0);
if (sc_SkinBonesCount_tmp>0)
{
int l9_293=l9_290;
float4 l9_294=(*sc_set0.sc_BonesUBO).sc_Bones[l9_293].boneMatrix[0];
float4 l9_295=(*sc_set0.sc_BonesUBO).sc_Bones[l9_293].boneMatrix[1];
float4 l9_296=(*sc_set0.sc_BonesUBO).sc_Bones[l9_293].boneMatrix[2];
float4 l9_297[3];
l9_297[0]=l9_294;
l9_297[1]=l9_295;
l9_297[2]=l9_296;
l9_292=float3(dot(l9_291,l9_297[0]),dot(l9_291,l9_297[1]),dot(l9_291,l9_297[2]));
}
else
{
l9_292=l9_291.xyz;
}
float3 l9_298=l9_292;
float3 l9_299=l9_298;
float l9_300=l9_274.y;
int l9_301=l9_277;
float4 l9_302=l9_271.position;
float3 l9_303=float3(0.0);
if (sc_SkinBonesCount_tmp>0)
{
int l9_304=l9_301;
float4 l9_305=(*sc_set0.sc_BonesUBO).sc_Bones[l9_304].boneMatrix[0];
float4 l9_306=(*sc_set0.sc_BonesUBO).sc_Bones[l9_304].boneMatrix[1];
float4 l9_307=(*sc_set0.sc_BonesUBO).sc_Bones[l9_304].boneMatrix[2];
float4 l9_308[3];
l9_308[0]=l9_305;
l9_308[1]=l9_306;
l9_308[2]=l9_307;
l9_303=float3(dot(l9_302,l9_308[0]),dot(l9_302,l9_308[1]),dot(l9_302,l9_308[2]));
}
else
{
l9_303=l9_302.xyz;
}
float3 l9_309=l9_303;
float3 l9_310=l9_309;
float l9_311=l9_274.z;
int l9_312=l9_278;
float4 l9_313=l9_271.position;
float3 l9_314=float3(0.0);
if (sc_SkinBonesCount_tmp>0)
{
int l9_315=l9_312;
float4 l9_316=(*sc_set0.sc_BonesUBO).sc_Bones[l9_315].boneMatrix[0];
float4 l9_317=(*sc_set0.sc_BonesUBO).sc_Bones[l9_315].boneMatrix[1];
float4 l9_318=(*sc_set0.sc_BonesUBO).sc_Bones[l9_315].boneMatrix[2];
float4 l9_319[3];
l9_319[0]=l9_316;
l9_319[1]=l9_317;
l9_319[2]=l9_318;
l9_314=float3(dot(l9_313,l9_319[0]),dot(l9_313,l9_319[1]),dot(l9_313,l9_319[2]));
}
else
{
l9_314=l9_313.xyz;
}
float3 l9_320=l9_314;
float3 l9_321=(((l9_288*l9_289)+(l9_299*l9_300))+(l9_310*l9_311))+(l9_320*l9_274.w);
l9_271.position=float4(l9_321.x,l9_321.y,l9_321.z,l9_271.position.w);
int l9_322=l9_275;
float3x3 l9_323=float3x3(float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_322].normalMatrix[0].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_322].normalMatrix[1].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_322].normalMatrix[2].xyz));
float3x3 l9_324=l9_323;
float3x3 l9_325=l9_324;
int l9_326=l9_276;
float3x3 l9_327=float3x3(float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_326].normalMatrix[0].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_326].normalMatrix[1].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_326].normalMatrix[2].xyz));
float3x3 l9_328=l9_327;
float3x3 l9_329=l9_328;
int l9_330=l9_277;
float3x3 l9_331=float3x3(float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_330].normalMatrix[0].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_330].normalMatrix[1].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_330].normalMatrix[2].xyz));
float3x3 l9_332=l9_331;
float3x3 l9_333=l9_332;
int l9_334=l9_278;
float3x3 l9_335=float3x3(float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_334].normalMatrix[0].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_334].normalMatrix[1].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_334].normalMatrix[2].xyz));
float3x3 l9_336=l9_335;
float3x3 l9_337=l9_336;
l9_271.normal=((((l9_325*l9_271.normal)*l9_274.x)+((l9_329*l9_271.normal)*l9_274.y))+((l9_333*l9_271.normal)*l9_274.z))+((l9_337*l9_271.normal)*l9_274.w);
l9_271.tangent=((((l9_325*l9_271.tangent)*l9_274.x)+((l9_329*l9_271.tangent)*l9_274.y))+((l9_333*l9_271.tangent)*l9_274.z))+((l9_337*l9_271.tangent)*l9_274.w);
}
l9_221=l9_271;
float l9_338=(*sc_set0.UserUniforms).voxelization_params_0.y;
float l9_339=(*sc_set0.UserUniforms).voxelization_params_0.z;
float l9_340=(*sc_set0.UserUniforms).voxelization_params_0.w;
float l9_341=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.x;
float l9_342=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.y;
float l9_343=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.z;
float l9_344=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.w;
float l9_345=(*sc_set0.UserUniforms).voxelization_params_frustum_nf.x;
float l9_346=(*sc_set0.UserUniforms).voxelization_params_frustum_nf.y;
float3 l9_347=(*sc_set0.UserUniforms).voxelization_params_camera_pos;
float l9_348=l9_338/l9_339;
int l9_349=gl_InstanceIndex;
int l9_350=l9_349;
l9_221.position=(*sc_set0.UserUniforms).sc_ModelMatrixVoxelization*l9_221.position;
float3 l9_351=l9_221.position.xyz;
float3 l9_352=float3(float(l9_350%int(l9_340))*l9_338,float(l9_350/int(l9_340))*l9_338,(float(l9_350)*l9_348)+l9_345);
float3 l9_353=l9_351+l9_352;
float4 l9_354=float4(l9_353-l9_347,1.0);
float l9_355=l9_341;
float l9_356=l9_342;
float l9_357=l9_343;
float l9_358=l9_344;
float l9_359=l9_345;
float l9_360=l9_346;
float4x4 l9_361=float4x4(float4(2.0/(l9_356-l9_355),0.0,0.0,(-(l9_356+l9_355))/(l9_356-l9_355)),float4(0.0,2.0/(l9_358-l9_357),0.0,(-(l9_358+l9_357))/(l9_358-l9_357)),float4(0.0,0.0,(-2.0)/(l9_360-l9_359),(-(l9_360+l9_359))/(l9_360-l9_359)),float4(0.0,0.0,0.0,1.0));
float4x4 l9_362=l9_361;
float4 l9_363=l9_362*l9_354;
l9_363.w=1.0;
out.varScreenPos=l9_363;
float4 l9_364=l9_363*1.0;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_364.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
if (sc_StereoRenderingMode_tmp>0)
{
out.varStereoViewID=gl_InstanceIndex%2;
...
if (sc_StereoRenderingMode_tmp==1)
{
float l9_366=dot(l9_365,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_367=l9_366;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_367;
}
}
float4 l9_368=float4(l9_364.x,-l9_364.y,(l9_364.z*0.5)+(l9_364.w*0.5),l9_364.w);
out.gl_Position=l9_368;
param_12=l9_221;
}
else
{
...
{
sc_Vertex_t l9_369=param_12;
sc_Vertex_t l9_370=l9_369;
if ((int(sc_VertexBlending_tmp)!=0))
{
if ((int(sc_VertexBlendingUseNormals_tmp)!=0))
{
sc_Vertex_t l9_371=l9_370;
float3 l9_372=in.blendShape0Pos;
float3 l9_373=in.blendShape0Normal;
float l9_374=(*sc_set0.UserUniforms).weights0.x;
sc_Vertex_t l9_375=l9_371;
float3 l9_376=l9_372;
float l9_377=l9_374;
float3 l9_378=l9_375.position.xyz+(l9_376*l9_377);
l9_375.position=float4(l9_378.x,l9_378.y,l9_378.z,l9_375.position.w);
l9_371=l9_375;
l9_371.normal+=(l9_373*l9_374);
l9_370=l9_371;
sc_Vertex_t l9_379=l9_370;
float3 l9_380=in.blendShape1Pos;
float3 l9_381=in.blendShape1Normal;
float l9_382=(*sc_set0.UserUniforms).weights0.y;
...
l9_370=l9_379;
sc_Vertex_t l9_387=l9_370;
float3 l9_388=in.blendShape2Pos;
float3 l9_389=in.blendShape2Normal;
float l9_390=(*sc_set0.UserUniforms).weights0.z;
...
{
sc_Vertex_t l9_395=l9_370;
float3 l9_396=in.blendShape0Pos;
float l9_397=(*sc_set0.UserUniforms).weights0.x;
float3 l9_398=l9_395.position.xyz+(l9_396*l9_397);
l9_395.position=float4(l9_398.x,l9_398.y,l9_398.z,l9_395.position.w);
l9_370=l9_395;
sc_Vertex_t l9_399=l9_370;
float3 l9_400=in.blendShape1Pos;
float l9_401=(*sc_set0.UserUniforms).weights0.y;
float3 l9_402=l9_399.position.xyz+(l9_400*l9_401);
l9_399.position=float4(l9_402.x,l9_402.y,l9_402.z,l9_399.position.w);
l9_370=l9_399;
sc_Vertex_t l9_403=l9_370;
float3 l9_404=in.blendShape2Pos;
float l9_405=(*sc_set0.UserUniforms).weights0.z;
float3 l9_406=l9_403.position.xyz+(l9_404*l9_405);
l9_403.position=float4(l9_406.x,l9_406.y,l9_406.z,l9_403.position.w);
l9_370=l9_403;
sc_Vertex_t l9_407=l9_370;
float3 l9_408=in.blendShape3Pos;
float l9_409=(*sc_set0.UserUniforms).weights0.w;
float3 l9_410=l9_407.position.xyz+(l9_408*l9_409);
l9_407.position=float4(l9_410.x,l9_410.y,l9_410.z,l9_407.position.w);
l9_370=l9_407;
sc_Vertex_t l9_411=l9_370;
float3 l9_412=in.blendShape4Pos;
float l9_413=(*sc_set0.UserUniforms).weights1.x;
float3 l9_414=l9_411.position.xyz+(l9_412*l9_413);
l9_411.position=float4(l9_414.x,l9_414.y,l9_414.z,l9_411.position.w);
l9_370=l9_411;
sc_Vertex_t l9_415=l9_370;
float3 l9_416=in.blendShape5Pos;
float l9_417=(*sc_set0.UserUniforms).weights1.y;
...
l9_369=l9_370;
sc_Vertex_t l9_419=l9_369;
if (sc_SkinBonesCount_tmp>0)
{
float4 l9_420=float4(0.0);
if (sc_SkinBonesCount_tmp>0)
{
l9_420=float4(1.0,fract(in.boneData.yzw));
l9_420.x-=dot(l9_420.yzw,float3(1.0));
}
float4 l9_421=l9_420;
float4 l9_422=l9_421;
int l9_423=int(in.boneData.x);
int l9_424=int(in.boneData.y);
int l9_425=int(in.boneData.z);
int l9_426=int(in.boneData.w);
int l9_427=l9_423;
float4 l9_428=l9_419.position;
float3 l9_429=float3(0.0);
if (sc_SkinBonesCount_tmp>0)
{
int l9_430=l9_427;
float4 l9_431=(*sc_set0.sc_BonesUBO).sc_Bones[l9_430].boneMatrix[0];
float4 l9_432=(*sc_set0.sc_BonesUBO).sc_Bones[l9_430].boneMatrix[1];
float4 l9_433=(*sc_set0.sc_BonesUBO).sc_Bones[l9_430].boneMatrix[2];
float4 l9_434[3];
l9_434[0]=l9_431;
l9_434[1]=l9_432;
l9_434[2]=l9_433;
l9_429=float3(dot(l9_428,l9_434[0]),dot(l9_428,l9_434[1]),dot(l9_428,l9_434[2]));
}
else
{
l9_429=l9_428.xyz;
}
float3 l9_435=l9_429;
float3 l9_436=l9_435;
float l9_437=l9_422.x;
int l9_438=l9_424;
float4 l9_439=l9_419.position;
...
float l9_448=l9_422.y;
int l9_449=l9_425;
float4 l9_450=l9_419.position;
...
float l9_459=l9_422.z;
int l9_460=l9_426;
float4 l9_461=l9_419.position;
...
float3 l9_469=(((l9_436*l9_437)+(l9_447*l9_448))+(l9_458*l9_459))+(l9_468*l9_422.w);
l9_419.position=float4(l9_469.x,l9_469.y,l9_469.z,l9_419.position.w);
int l9_470=l9_423;
float3x3 l9_471=float3x3(float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_470].normalMatrix[0].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_470].normalMatrix[1].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_470].normalMatrix[2].xyz));
float3x3 l9_472=l9_471;
float3x3 l9_473=l9_472;
int l9_474=l9_424;
float3x3 l9_475=float3x3(float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_474].normalMatrix[0].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_474].normalMatrix[1].xyz),float3((*sc_set0.sc_BonesUBO).sc_Bones[l9_474].normalMatrix[2].xyz));
float3x3 l9_476=l9_475;
...
l9_419.normal=((((l9_473*l9_419.normal)*l9_422.x)+((l9_477*l9_419.normal)*l9_422.y))+((l9_481*l9_419.normal)*l9_422.z))+((l9_485*l9_419.normal)*l9_422.w);
l9_419.tangent=((((l9_473*l9_419.tangent)*l9_422.x)+((l9_477*l9_419.tangent)*l9_422.y))+((l9_481*l9_419.tangent)*l9_422.z))+((l9_485*l9_419.tangent)*l9_422.w);
}
l9_369=l9_419;
float3 l9_486=(*sc_set0.UserUniforms).voxelization_params_camera_pos;
float2 l9_487=((l9_369.position.xy/float2(l9_369.position.w))*0.5)+float2(0.5);
out.varTex01=float4(l9_487.x,l9_487.y,out.varTex01.z,out.varTex01.w);
l9_369.position=(*sc_set0.UserUniforms).sc_ModelMatrixVoxelization*l9_369.position;
float3 l9_488=l9_369.position.xyz-l9_486;
l9_369.position=float4(l9_488.x,l9_488.y,l9_488.z,l9_369.position.w);
out.varPosAndMotion=float4(l9_369.position.xyz.x,l9_369.position.xyz.y,l9_369.position.xyz.z,out.varPosAndMotion.w);
float3 l9_489=normalize(l9_369.normal);
out.varNormalAndMotion=float4(l9_489.x,l9_489.y,l9_489.z,out.varNormalAndMotion.w);
float l9_490=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.x;
float l9_491=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.y;
float l9_492=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.z;
float l9_493=(*sc_set0.UserUniforms).voxelization_params_frustum_lrbt.w;
float l9_494=(*sc_set0.UserUniforms).voxelization_params_frustum_nf.x;
float l9_495=(*sc_set0.UserUniforms).voxelization_params_frustum_nf.y;
float l9_496=l9_490;
float l9_497=l9_491;
float l9_498=l9_492;
float l9_499=l9_493;
float l9_500=l9_494;
float l9_501=l9_495;
float4x4 l9_502=float4x4(float4(2.0/(l9_497-l9_496),0.0,0.0,(-(l9_497+l9_496))/(l9_497-l9_496)),float4(0.0,2.0/(l9_499-l9_498),0.0,(-(l9_499+l9_498))/(l9_499-l9_498)),float4(0.0,0.0,(-2.0)/(l9_501-l9_500),(-(l9_501+l9_500))/(l9_501-l9_500)),float4(0.0,0.0,0.0,1.0));
float4x4 l9_503=l9_502;
float4 l9_504=float4(0.0);
float3 l9_505=(l9_503*l9_369.position).xyz;
l9_504=float4(l9_505.x,l9_505.y,l9_505.z,l9_504.w);
l9_504.w=1.0;
out.varScreenPos=l9_504;
float4 l9_506=l9_504*1.0;
...
if (sc_StereoRenderingMode_tmp==1)
{
float l9_509=dot(l9_508,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_510=l9_509;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_510;
}
}
float4 l9_511=float4(l9_507.x,-l9_507.y,(l9_507.z*0.5)+(l9_507.w*0.5),l9_507.w);
out.gl_Position=l9_511;
param_12=l9_369;
}
}
v=param_12;
...
{
float4 l9_512=((*sc_set0.UserUniforms).sc_PrevFrameModelMatrix*(*sc_set0.UserUniforms).sc_ModelMatrixInverse)*float4(param_17,1.0);
float3 l9_513=param_17;
float3 l9_514=l9_512.xyz;
if ((int(sc_MotionVectorsPass_tmp)!=0))
{
int l9_515=0;
if (sc_StereoRenderingMode_tmp==0)
...
int l9_516=l9_515;
float4 l9_517=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_516]*float4(l9_513,1.0);
float2 l9_518=l9_517.xy/float2(l9_517.w);
l9_517=float4(l9_518.x,l9_518.y,l9_517.z,l9_517.w);
int l9_519=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_519=0;
...
{
l9_519=gl_InstanceIndex%2;
}
int l9_520=l9_519;
float4 l9_521=(*sc_set0.UserUniforms).sc_PrevFrameViewProjectionMatrixArray[l9_520]*float4(l9_514,1.0);
float2 l9_522=l9_521.xy/float2(l9_521.w);
l9_521=float4(l9_522.x,l9_522.y,l9_521.z,l9_521.w);
float2 l9_523=(l9_517.xy-l9_521.xy)*0.5;
out.varPosAndMotion.w=l9_523.x;
out.varNormalAndMotion.w=l9_523.y;
}
}

...
//sampler sampler Tweak_N12SmpSC 0:27
//sampler sampler Tweak_N14SmpSC 0:28
...
//texture texture2D Tweak_N12 0:4:0:27
//texture texture2D Tweak_N14 0:5:0:28
//texture texture2D baseTex 0:6:0:29
...
//float3x3 Tweak_N14Transform 4800
//float4 Tweak_N14UvMinMax 4848
//float4 Tweak_N14BorderColor 4864
//float progress 4880
//float4 baseColor 4896
//float3x3 Tweak_N12Transform 4960
//float4 Tweak_N12UvMinMax 5008
//float4 Tweak_N12BorderColor 5024
//float Port_Exponent_N000 5040
//float Port_Intensity_N000 5044
//float Port_Opacity_N007 5048
//float3 Port_Emissive_N007 5072
//float Port_Metallic_N007 5088
//float Port_Roughness_N007 5092
//float3 Port_AO_N007 5104
//float3 Port_SpecularAO_N007 5120
//float depthRef 5136
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N14 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_baseTex 33 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N12 35 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N14 36 0
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 37 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 38 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N12 39 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N14 40 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 41 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 42 0
//spec_const bool Tweak_N10 43 0
//spec_const bool Tweak_N12HasSwappedViews 44 0
//spec_const bool Tweak_N14HasSwappedViews 45 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N14 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N14 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 97 -1
//spec_const int Tweak_N12Layout 98 0
//spec_const int Tweak_N14Layout 99 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N14 [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N12 [[function_constant(35)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N14 [[function_constant(36)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N12 [[function_constant(39)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N14 [[function_constant(40)]];
...
constant bool Tweak_N10 [[function_constant(43)]];
constant bool Tweak_N10_tmp = is_function_constant_defined(Tweak_N10) ? Tweak_N10 : false;
constant bool Tweak_N12HasSwappedViews [[function_constant(44)]];
...
constant bool Tweak_N14HasSwappedViews [[function_constant(45)]];
...
constant bool sc_HasDiffuseEnvmap [[function_constant(68)]];
constant bool sc_HasDiffuseEnvmap_tmp = is_function_constant_defined(sc_HasDiffuseEnvmap) ? sc_HasDiffuseEnvmap : false;
constant bool sc_IsEditor [[function_constant(69)]];
constant bool sc_IsEditor_tmp = is_function_constant_defined(sc_IsEditor) ? sc_IsEditor : false;
constant bool sc_LightEstimation [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 [[function_constant(90)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N14 [[function_constant(91)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 [[function_constant(94)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N14 [[function_constant(95)]];
...
constant int Tweak_N12Layout [[function_constant(98)]];
constant int Tweak_N12Layout_tmp = is_function_constant_defined(Tweak_N12Layout) ? Tweak_N12Layout : 0;
constant int Tweak_N14Layout [[function_constant(99)]];
...
float Port_Opacity_N007;
float3 Port_Normal_N007;
float3 Port_Emissive_N007;
float Port_Metallic_N007;
float Port_Roughness_N007;
float3 Port_AO_N007;
float3 Port_SpecularAO_N007;
float depthRef;
};
struct sc_Bone_t
{
...
texture2d<float> Tweak_N14 [[id(5)]];
...
sampler Tweak_N12SmpSC [[id(27)]];
sampler Tweak_N14SmpSC [[id(28)]];
...
int l9_8=l9_3;
int l9_9=baseTexLayout_tmp;
int l9_10=l9_8;
float2 l9_11=l9_1;
bool l9_12=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_13=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_14=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_15=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_16=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_17=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_18=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_19=0.0;
...
float3 l9_84=l9_83;
float3 l9_85=l9_84;
float4 l9_86=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_85.xy,bias(l9_79));
float4 l9_87=l9_86;
if (l9_17)
{
...
int l9_95=l9_90;
int l9_96=Tweak_N14Layout_tmp;
int l9_97=l9_95;
float2 l9_98=l9_1;
bool l9_99=(int(SC_USE_UV_TRANSFORM_Tweak_N14_tmp)!=0);
float3x3 l9_100=(*sc_set0.UserUniforms).Tweak_N14Transform;
int2 l9_101=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14_tmp);
bool l9_102=(int(SC_USE_UV_MIN_MAX_Tweak_N14_tmp)!=0);
float4 l9_103=(*sc_set0.UserUniforms).Tweak_N14UvMinMax;
bool l9_104=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14_tmp)!=0);
float4 l9_105=(*sc_set0.UserUniforms).Tweak_N14BorderColor;
float l9_106=0.0;
...
float4 l9_173=sc_set0.Tweak_N14.sample(sc_set0.Tweak_N14SmpSC,l9_172.xy,bias(l9_166));
float4 l9_174=l9_173;
if (l9_104)
{
l9_174=mix(l9_105,l9_174,float4(l9_108));
}
float4 l9_175=l9_174;
l9_89=l9_175;
float l9_176=0.0;
float l9_177=(*sc_set0.UserUniforms).progress;
l9_176=l9_177;
float4 l9_178=float4(0.0);
l9_178=mix(l9_2,l9_89,float4(l9_176));
float4 l9_179=float4(0.0);
float4 l9_180=(*sc_set0.UserUniforms).baseColor;
l9_179=l9_180;
float l9_181=0.0;
float l9_182=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_183=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_184=param_4;
float l9_185=abs(dot(-l9_184.ViewDirWS,l9_184.VertexNormal_WorldSpace));
float l9_186=pow(1.0-l9_185,l9_182);
l9_186=fast::max(l9_186,0.0);
l9_186*=l9_183;
l9_181=l9_186;
float4 l9_187=float4(0.0);
l9_187=l9_179+float4(l9_181);
float4 l9_188=float4(0.0);
l9_188=l9_178+l9_187;
param_1=l9_188;
param_3=param_1;
}
else
...
float4 l9_190=(*sc_set0.UserUniforms).baseColor;
l9_189=l9_190;
float l9_191=0.0;
float l9_192=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_193=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_194=param_4;
float l9_195=abs(dot(-l9_194.ViewDirWS,l9_194.VertexNormal_WorldSpace));
float l9_196=pow(1.0-l9_195,l9_192);
l9_196=fast::max(l9_196,0.0);
l9_196*=l9_193;
l9_191=l9_196;
float4 l9_197=float4(0.0);
l9_197=l9_189+float4(l9_191);
param_2=l9_197;
param_3=param_2;
}
Output_N9=param_3;
...
float param_15=0.0;
bool l9_204=param_13&&(!param_11);
float l9_205=1.0;
float l9_206=param_7.x;
int l9_207=param_10.x;
if (l9_207==1)
{
l9_206=fract(l9_206);
}
...
param_7.x=l9_206;
float l9_211=param_7.y;
int l9_212=param_10.y;
if (l9_212==1)
{
l9_211=fract(l9_211);
}
...
float l9_218=param_7.x;
float l9_219=param_12.x;
float l9_220=param_12.z;
bool l9_221=l9_217;
float l9_222=l9_205;
...
float l9_227=param_7.y;
float l9_228=param_12.y;
float l9_229=param_12.w;
bool l9_230=l9_226;
float l9_231=l9_205;
...
float2 l9_234=param_7;
bool l9_235=param_8;
float3x3 l9_236=param_9;
if (l9_235)
{
...
param_7=l9_237;
float l9_238=param_7.x;
int l9_239=param_10.x;
bool l9_240=l9_204;
float l9_241=l9_205;
...
param_7.x=l9_238;
l9_205=l9_241;
float l9_249=param_7.y;
int l9_250=param_10.y;
bool l9_251=l9_204;
float l9_252=l9_205;
...
param_7.y=l9_249;
l9_205=l9_252;
float2 l9_260=param_7;
int l9_261=param_5;
int l9_262=param_6;
float l9_263=param_15;
...
float3 l9_269=l9_268;
float4 l9_270=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_269.xy,bias(l9_263));
float4 l9_271=l9_270;
if (param_13)
{
l9_271=mix(param_14,l9_271,float4(l9_205));
}
float4 l9_272=l9_271;
Color_N11=l9_272;
float4 Output_N13=float4(0.0);
Output_N13=Output_N9*Color_N11;
float4 Output_N7=float4(0.0);
float3 param_16=Output_N13.xyz;
float param_17=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_18=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_19=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_20=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_21=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_22=(*sc_set0.UserUniforms).Port_SpecularAO_N007;
ssGlobals param_24=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_24.BumpedNormal=param_24.VertexNormal_WorldSpace;
}
float l9_273=param_17;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_273<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_287=fast::max(param_25,float4(0.0));
float4 param_26=l9_287;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_290=fast::clamp(l9_289.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_290=fast::clamp(dot(l9_289.xyz,float3(l9_289.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_290=(1.0-dot(l9_289.xyz,float3(0.33333001)))*l9_289.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_290=(1.0-fast::clamp(dot(l9_289.xyz,float3(1.0)),0.0,1.0))*l9_289.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_290=fast::clamp(dot(l9_289.xyz,float3(1.0)),0.0,1.0)*l9_289.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_290=fast::clamp(dot(l9_289.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_290=dot(l9_289.xyz,float3(0.33333001))*l9_289.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_290=1.0-fast::clamp(dot(l9_289.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_291=l9_290;
float l9_292=l9_291;
float l9_293=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_292;
float3 l9_294=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_288.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_295=float4(l9_294.x,l9_294.y,l9_294.z,l9_293);
param_27=l9_295;
}
else
{
...
{
float4 l9_296=param_27;
float4 l9_297=float4(0.0);
float4 l9_298=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_299=out.sc_FragData0;
l9_298=l9_299;
}
else
{
float4 l9_300=gl_FragCoord;
float2 l9_301=l9_300.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_306=l9_305;
int l9_307=l9_306;
float3 l9_308=float3(l9_302,0.0);
int l9_309=l9_304;
int l9_310=l9_307;
if (l9_309==1)
{
l9_308.y=((2.0*l9_308.y)+float(l9_310))-1.0;
}
float2 l9_311=l9_308.xy;
l9_303=l9_311;
}
else
{
...
float4 l9_333=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_332.xy,bias(l9_326));
float4 l9_334=l9_333;
float4 l9_335=l9_334;
l9_298=l9_335;
}
float4 l9_336=l9_298;
float3 l9_337=l9_336.xyz;
float3 l9_338=l9_337;
float3 l9_339=l9_296.xyz;
...
l9_297=float4(l9_340.x,l9_340.y,l9_340.z,l9_297.w);
float3 l9_341=mix(l9_337,l9_297.xyz,float3(l9_296.w));
l9_297=float4(l9_341.x,l9_341.y,l9_341.z,l9_297.w);
l9_297.w=1.0;
float4 l9_342=l9_297;
param_27=l9_342;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_343=float4(in.varScreenPos.xyz,1.0);
param_27=l9_343;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_344=gl_FragCoord;
float l9_345=fast::clamp(abs(l9_344.z),0.0,1.0);
float4 l9_346=float4(l9_345,1.0-l9_345,1.0,1.0);
param_27=l9_346;
}
else
{
float4 l9_347=param_27;
float4 l9_348=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_348=float4(mix(float3(1.0),l9_347.xyz,float3(l9_347.w)),l9_347.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_349=l9_347.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_349=fast::clamp(l9_349,0.0,1.0);
}
l9_348=float4(l9_347.xyz*l9_349,l9_349);
}
else
{
l9_348=l9_347;
...
float4 l9_354=param_29;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_354.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_354;
return out;
}
} // FRAGMENT SHADER
...
Globals.SurfacePosition_WorldSpace=in.varPosAndMotion.xyz;
Globals.ViewDirWS=normalize((*sc_set0.UserUniforms).sc_Camera.position-Globals.SurfacePosition_WorldSpace);
float param=(*sc_set0.UserUniforms).Port_Opacity_N007;
float param_1=(*sc_set0.UserUniforms).Port_Roughness_N007;

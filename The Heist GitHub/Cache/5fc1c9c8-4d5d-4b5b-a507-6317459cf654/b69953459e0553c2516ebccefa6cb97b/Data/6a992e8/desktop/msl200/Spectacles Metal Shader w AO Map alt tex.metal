...
//sampler sampler Tweak_N18SmpSC 0:28
...
//texture texture2D Tweak_N18 0:5:0:28
...
//float3x3 Tweak_N12Transform 4816
//float4 Tweak_N12UvMinMax 4864
//float4 Tweak_N12BorderColor 4880
//float3x3 Tweak_N18Transform 4944
//float4 Tweak_N18UvMinMax 4992
//float4 Tweak_N18BorderColor 5008
//float progress 5024
//float Port_Exponent_N000 5028
//float Port_Intensity_N000 5032
//float Port_Opacity_N007 5036
//float3 Port_Emissive_N007 5056
//float Port_Metallic_N007 5072
//float Port_Roughness_N007 5076
//float3 Port_AO_N007 5088
//float3 Port_SpecularAO_N007 5104
//float depthRef 5120
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N18 32 0
...
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N18 36 0
...
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N18 40 0
...
//spec_const bool Tweak_N18HasSwappedViews 45 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N18 91 -1
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N18 95 -1
...
//spec_const int Tweak_N18Layout 99 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N18 [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N18 [[function_constant(36)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N18 [[function_constant(40)]];
...
constant bool Tweak_N18HasSwappedViews [[function_constant(45)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N18 [[function_constant(91)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N18 [[function_constant(95)]];
...
constant int Tweak_N18Layout [[function_constant(99)]];
...
texture2d<float> Tweak_N18 [[id(5)]];
...
float4 l9_90=(*sc_set0.UserUniforms).baseColor;
l9_89=l9_90;
float l9_91=0.0;
float l9_92=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_93=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_94=param_4;
float l9_95=abs(dot(-l9_94.ViewDirWS,l9_94.VertexNormal_WorldSpace));
float l9_96=pow(1.0-l9_95,l9_92);
l9_96=fast::max(l9_96,0.0);
l9_96*=l9_93;
l9_91=l9_96;
float4 l9_97=float4(0.0);
l9_97=l9_89+float4(l9_91);
float4 l9_98=float4(0.0);
l9_98=l9_2+l9_97;
param_1=l9_98;
param_3=param_1;
...
float4 l9_100=(*sc_set0.UserUniforms).baseColor;
l9_99=l9_100;
float l9_101=0.0;
float l9_102=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_103=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_104=param_4;
float l9_105=abs(dot(-l9_104.ViewDirWS,l9_104.VertexNormal_WorldSpace));
float l9_106=pow(1.0-l9_105,l9_102);
l9_106=fast::max(l9_106,0.0);
l9_106*=l9_103;
l9_101=l9_106;
float4 l9_107=float4(0.0);
l9_107=l9_99+float4(l9_101);
param_2=l9_107;
param_3=param_2;
}
Output_N9=param_3;
...
float param_15=0.0;
bool l9_114=param_13&&(!param_11);
float l9_115=1.0;
float l9_116=param_7.x;
int l9_117=param_10.x;
if (l9_117==1)
{
l9_116=fract(l9_116);
}
...
param_7.x=l9_116;
float l9_121=param_7.y;
int l9_122=param_10.y;
if (l9_122==1)
{
l9_121=fract(l9_121);
}
...
float l9_129=param_12.x;
float l9_130=param_12.z;
bool l9_131=l9_127;
float l9_132=l9_115;
...
float l9_137=param_7.y;
float l9_138=param_12.y;
float l9_139=param_12.w;
bool l9_140=l9_136;
float l9_141=l9_115;
...
float2 l9_144=param_7;
bool l9_145=param_8;
float3x3 l9_146=param_9;
if (l9_145)
{
...
param_7=l9_147;
float l9_148=param_7.x;
int l9_149=param_10.x;
bool l9_150=l9_114;
float l9_151=l9_115;
...
param_7.x=l9_148;
l9_115=l9_151;
float l9_159=param_7.y;
int l9_160=param_10.y;
bool l9_161=l9_114;
float l9_162=l9_115;
...
param_7.y=l9_159;
l9_115=l9_162;
float2 l9_170=param_7;
int l9_171=param_5;
int l9_172=param_6;
float l9_173=param_15;
...
float4 l9_180=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_179.xy,bias(l9_173));
float4 l9_181=l9_180;
if (param_13)
{
l9_181=mix(param_14,l9_181,float4(l9_115));
}
...
int l9_188=l9_183;
int param_16=Tweak_N18Layout_tmp;
int param_17=l9_188;
float2 param_18=UVCoord_N6;
bool param_19=(int(SC_USE_UV_TRANSFORM_Tweak_N18_tmp)!=0);
float3x3 param_20=(*sc_set0.UserUniforms).Tweak_N18Transform;
int2 param_21=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N18_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N18_tmp);
bool param_22=(int(SC_USE_UV_MIN_MAX_Tweak_N18_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N18UvMinMax;
bool param_24=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N18_tmp)!=0);
float4 param_25=(*sc_set0.UserUniforms).Tweak_N18BorderColor;
float param_26=0.0;
bool l9_189=param_24&&(!param_22);
float l9_190=1.0;
float l9_191=param_18.x;
int l9_192=param_21.x;
if (l9_192==1)
{
l9_191=fract(l9_191);
}
...
param_18.x=l9_191;
float l9_196=param_18.y;
int l9_197=param_21.y;
if (l9_197==1)
{
l9_196=fract(l9_196);
}
...
float l9_204=param_23.x;
float l9_205=param_23.z;
bool l9_206=l9_202;
float l9_207=l9_190;
...
float l9_212=param_18.y;
float l9_213=param_23.y;
float l9_214=param_23.w;
bool l9_215=l9_211;
float l9_216=l9_190;
...
float2 l9_219=param_18;
bool l9_220=param_19;
float3x3 l9_221=param_20;
if (l9_220)
{
...
param_18=l9_222;
float l9_223=param_18.x;
int l9_224=param_21.x;
bool l9_225=l9_189;
float l9_226=l9_190;
...
param_18.x=l9_223;
l9_190=l9_226;
float l9_234=param_18.y;
int l9_235=param_21.y;
bool l9_236=l9_189;
float l9_237=l9_190;
...
param_18.y=l9_234;
l9_190=l9_237;
float2 l9_245=param_18;
int l9_246=param_16;
int l9_247=param_17;
float l9_248=param_26;
...
float4 l9_255=sc_set0.Tweak_N18.sample(sc_set0.Tweak_N18SmpSC,l9_254.xy,bias(l9_248));
float4 l9_256=l9_255;
if (param_24)
{
l9_256=mix(param_25,l9_256,float4(l9_190));
}
float4 l9_257=l9_256;
Color_N15=l9_257;
float Output_N17=0.0;
float param_27=(*sc_set0.UserUniforms).progress;
Output_N17=param_27;
float4 Output_N16=float4(0.0);
Output_N16=mix(Color_N11,Color_N15,float4(Output_N17));
float4 Output_N13=float4(0.0);
Output_N13=Output_N9*Output_N16;
float4 Output_N7=float4(0.0);
float3 param_28=Output_N13.xyz;
float param_29=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_30=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_31=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_32=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_33=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_34=(*sc_set0.UserUniforms).Port_SpecularAO_N007;
ssGlobals param_36=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_36.BumpedNormal=param_36.VertexNormal_WorldSpace;
}
float l9_258=param_29;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_258<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_272=fast::max(param_37,float4(0.0));
float4 param_38=l9_272;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_281=param_39;
float4 l9_282=float4(0.0);
float4 l9_283=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_284=out.sc_FragData0;
l9_283=l9_284;
}
else
{
float4 l9_285=gl_FragCoord;
float2 l9_286=l9_285.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_291=l9_290;
int l9_292=l9_291;
float3 l9_293=float3(l9_287,0.0);
int l9_294=l9_289;
int l9_295=l9_292;
if (l9_294==1)
{
l9_293.y=((2.0*l9_293.y)+float(l9_295))-1.0;
}
float2 l9_296=l9_293.xy;
l9_288=l9_296;
}
else
{
...
int l9_307=l9_302;
float2 l9_308=l9_300;
int l9_309=sc_ScreenTextureLayout_tmp;
int l9_310=l9_307;
float l9_311=l9_301;
...
float4 l9_318=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_317.xy,bias(l9_311));
float4 l9_319=l9_318;
float4 l9_320=l9_319;
l9_283=l9_320;
}
float4 l9_321=l9_283;
float3 l9_322=l9_321.xyz;
float3 l9_323=l9_322;
float3 l9_324=l9_281.xyz;
...
l9_282=float4(l9_325.x,l9_325.y,l9_325.z,l9_282.w);
float3 l9_326=mix(l9_322,l9_282.xyz,float3(l9_281.w));
l9_282=float4(l9_326.x,l9_326.y,l9_326.z,l9_282.w);
l9_282.w=1.0;
float4 l9_327=l9_282;
param_39=l9_327;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_328=float4(in.varScreenPos.xyz,1.0);
param_39=l9_328;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_329=gl_FragCoord;
float l9_330=fast::clamp(abs(l9_329.z),0.0,1.0);
float4 l9_331=float4(l9_330,1.0-l9_330,1.0,1.0);
param_39=l9_331;
}
else
{
float4 l9_332=param_39;

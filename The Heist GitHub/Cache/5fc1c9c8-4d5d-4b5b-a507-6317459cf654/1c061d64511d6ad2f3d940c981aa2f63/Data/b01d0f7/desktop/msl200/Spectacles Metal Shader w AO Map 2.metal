...
//float3x3 Tweak_N12Transform 4832
//float4 Tweak_N12UvMinMax 4880
//float4 Tweak_N12BorderColor 4896
//float4 Port_Input1_N016 4912
//float Port_Exponent_N000 4928
//float Port_Intensity_N000 4932
//float Port_Opacity_N007 4936
...
l9_2=l9_88;
float l9_89=0.0;
float l9_90=(*sc_set0.UserUniforms).progress;
l9_89=l9_90;
float4 l9_91=float4(0.0);
l9_91=mix(l9_2,(*sc_set0.UserUniforms).Port_Input1_N016,float4(l9_89));
float4 l9_92=float4(0.0);
float4 l9_93=(*sc_set0.UserUniforms).baseColor;
l9_92=l9_93;
float l9_94=0.0;
float l9_95=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_96=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_97=param_4;
float l9_98=abs(dot(-l9_97.ViewDirWS,l9_97.VertexNormal_WorldSpace));
float l9_99=pow(1.0-l9_98,l9_95);
l9_99=fast::max(l9_99,0.0);
l9_99*=l9_96;
l9_94=l9_99;
float4 l9_100=float4(0.0);
l9_100=l9_92+float4(l9_94);
...
l9_102=l9_103;
float l9_104=0.0;
float l9_105=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_106=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_107=param_4;
float l9_108=abs(dot(-l9_107.ViewDirWS,l9_107.VertexNormal_WorldSpace));
float l9_109=pow(1.0-l9_108,l9_105);
l9_109=fast::max(l9_109,0.0);
l9_109*=l9_106;
l9_104=l9_109;
float4 l9_110=float4(0.0);
l9_110=l9_102+float4(l9_104);
param_2=l9_110;
param_3=param_2;
}
Output_N9=param_3;
...
float param_15=0.0;
bool l9_117=param_13&&(!param_11);
float l9_118=1.0;
float l9_119=param_7.x;
int l9_120=param_10.x;
if (l9_120==1)
{
l9_119=fract(l9_119);
}
...
param_7.x=l9_119;
float l9_124=param_7.y;
int l9_125=param_10.y;
if (l9_125==1)
{
l9_124=fract(l9_124);
}
...
float l9_131=param_7.x;
float l9_132=param_12.x;
float l9_133=param_12.z;
bool l9_134=l9_130;
float l9_135=l9_118;
...
float l9_140=param_7.y;
float l9_141=param_12.y;
float l9_142=param_12.w;
bool l9_143=l9_139;
float l9_144=l9_118;
...
float2 l9_147=param_7;
bool l9_148=param_8;
float3x3 l9_149=param_9;
if (l9_148)
{
...
param_7=l9_150;
float l9_151=param_7.x;
int l9_152=param_10.x;
bool l9_153=l9_117;
float l9_154=l9_118;
...
param_7.x=l9_151;
l9_118=l9_154;
float l9_162=param_7.y;
int l9_163=param_10.y;
bool l9_164=l9_117;
float l9_165=l9_118;
...
param_7.y=l9_162;
l9_118=l9_165;
float2 l9_173=param_7;
int l9_174=param_5;
int l9_175=param_6;
float l9_176=param_15;
...
float4 l9_183=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_182.xy,bias(l9_176));
float4 l9_184=l9_183;
if (param_13)
{
l9_184=mix(param_14,l9_184,float4(l9_118));
}
float4 l9_185=l9_184;
Color_N11=l9_185;
...
float l9_186=param_17;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_186<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_200=fast::max(param_25,float4(0.0));
float4 param_26=l9_200;
if (sc_ShaderCacheConstant_tmp!=0)
{

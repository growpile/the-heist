...
let WireFuseboxModule = (() => {
    ...
    var WireFuseboxModule = _classThis = class extends _classSuper {
        ...
        onAwake() {
            const self = this;
            this.registerSockets = (sockets) => this.registerSockets(sockets);
            this.unregisterSockets = (sockets) => this.unregisterSockets(sockets);
            this.isSocketOccupied = (socket) => this.isSocketOccupied(socket);
            this.occupySocket = (socket, wire) => this.occupySocket(socket, wire);
            this.releaseSocket = (wire) => this.releaseSocket(wire);
            this.getOccupancy = () => this.getOccupancy();
            this.getSockets = () => this.getSockets();
        }

...
//float Port_Import_N033 7392
//float2 Port_Import_N034 7400
//}
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/201]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_9=l9_8>=(201*((*sc_set0.UserUniforms).vfxNumCopies+1));
bool l9_10;
if (!l9_9)
{
l9_10=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/201]!=0)==false;
}
else
{
l9_10=l9_9;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/201];
...
param_1.Index1DPerCopy=param%201;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(201*((param/201)+1))-1;
...
param_1.SpawnOffset=floor(param_1.Index1DPerCopyF/400.0)*1.0;

...
class MenuViewTransitions {
    constructor() {
        ...
        this.popOutBumpScale = 1.1;
        this.popInOvershootScale = 1.12;
        this.popOutBumpDurationMs = 80;
        this.popOutShrinkDurationMs = 120;
        this.popInOvershootDurationMs = 150;
        this.popInSettleDurationMs = 100;
        this.elementStaggerMs = 80;

...
/** Staggered scale pop for menu screens and tab panels. */
class MenuViewTransitions {
    ...
    popInElement(element, transform, restScale, startDelayMs, onComplete) {
        ...
        const durationMs = this.popInOvershootDurationMs + this.popInSettleDurationMs;
        const settleTween = LSTween_1.LSTween.scaleFromToLocal(transform, vec3.zero(), restScale, durationMs)

...
class MenuViewTransitions {
    constructor() {
        ...
        /** Root / window shell — 50% of original 100ms phases. */
    ...
    popInRootThenElements(root, elements, onComplete) {
        ...
        const rootVisiblePopMs = rootHasVisibleOvershoot
            ? this.popInOvershootDurationMs + this.popInSettleDurationMs
        ...
        this.popInChildElementsWithBaseDelay(children, childBaseDelayMs, () => {
            childrenDone = true;
            tryFinish();
        });
    }

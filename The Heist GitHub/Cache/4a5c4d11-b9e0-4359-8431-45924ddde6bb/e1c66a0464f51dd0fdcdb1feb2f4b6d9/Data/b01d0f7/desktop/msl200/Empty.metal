...
//float2 Port_Scale_N009 4512
//float2 Port_Center_N009 4520
//float2 Port_Input1_N137 4528
//float Port_Input1_N138 4536
//float Port_Import_N140 4540
//float Port_Import_N142 4544
//float Port_Input1_N144 4548
//float Port_Input2_N144 4552
//float depthRef 4556
//}
...
CoordsOut_N9=((UVCoord_N0-(*sc_set0.UserUniforms).Port_Center_N009)*(*sc_set0.UserUniforms).Port_Scale_N009)+(*sc_set0.UserUniforms).Port_Center_N009;
...
float Value2_N6=0.0;
float4 param_12=Color_N1;
float3 param_13=param_12.xyz;
float param_14=param_12.w;
Value1_N6=param_13;
Value2_N6=param_14;
...
float4 l9_80=fast::max(param_16,float4(0.0));
float4 param_17=l9_80;
if (sc_ShaderCacheConstant_tmp!=0)
{

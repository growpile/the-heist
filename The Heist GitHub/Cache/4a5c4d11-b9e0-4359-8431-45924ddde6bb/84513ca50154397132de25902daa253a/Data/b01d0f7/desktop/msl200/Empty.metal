...
//sampler sampler Tweak_N12SmpSC 0:23
...
//texture texture2D Tweak_N12 0:4:0:23
...
//float3x3 Tweak_N12Transform 4576
//float4 Tweak_N12UvMinMax 4624
//float4 Tweak_N12BorderColor 4640
//float size 4656
//float rotation 4660
//float2 Port_Center_N009 4664
//float2 Port_Input1_N137 4672
//float Port_Input1_N138 4680
//float Port_Import_N140 4684
//float Port_Import_N142 4688
//float Port_Input1_N144 4692
//float Port_Input2_N144 4696
//float Port_RangeMinA_N020 4700
//float Port_RangeMaxA_N020 4704
//float Port_RangeMinB_N020 4708
//float Port_RangeMaxB_N020 4712
//float2 Port_Center_N014 4720
//float Port_Input1_N018 4728
//float2 Port_Center_N016 4736
//float depthRef 4744
//}
...
//spec_const bool Tweak_N12HasSwappedViews 40 0
...
constant bool Tweak_N12HasSwappedViews [[function_constant(40)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 [[function_constant(78)]];
...
constant int Tweak_N12Layout [[function_constant(81)]];
...
float Port_RangeMinA_N020;
float Port_RangeMaxA_N020;
float Port_RangeMinB_N020;
float Port_RangeMaxB_N020;
...
float param_1=(*sc_set0.UserUniforms).Tweak_N10;
Output_N10=param_1;
float2 CoordsOut_N9=float2(0.0);
CoordsOut_N9=((UVCoord_N0-(*sc_set0.UserUniforms).Port_Center_N009)*float2(Output_N10))+(*sc_set0.UserUniforms).Port_Center_N009;
...
{
l9_76=pow(Output_N139,Value_N140);
}
Output_N141=l9_76;
...
float param_16=(*sc_set0.UserUniforms).size;
Output_N19=param_16;
float ValueOut_N20=0.0;
ValueOut_N20=(((Output_N19-(*sc_set0.UserUniforms).Port_RangeMinA_N020)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N020-(*sc_set0.UserUniforms).Port_RangeMinA_N020)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N020-(*sc_set0.UserUniforms).Port_RangeMinB_N020))+(*sc_set0.UserUniforms).Port_RangeMinB_N020;
float2 CoordsOut_N14=float2(0.0);
CoordsOut_N14=((UVCoord_N13-(*sc_set0.UserUniforms).Port_Center_N014)*float2(ValueOut_N20))+(*sc_set0.UserUniforms).Port_Center_N014;
float Output_N17=0.0;
float param_17=(*sc_set0.UserUniforms).rotation;
Output_N17=param_17;
float Output_N18=0.0;
Output_N18=Output_N17*(*sc_set0.UserUniforms).Port_Input1_N018;
float2 CoordsOut_N16=float2(0.0);
float2 param_18=CoordsOut_N14;
float param_19=Output_N18;
float2 param_20=(*sc_set0.UserUniforms).Port_Center_N016;
float l9_77=sin(radians(param_19));
float l9_78=cos(radians(param_19));
float2 param_21=param_18-param_20;
param_21=float2(dot(float2(l9_78,l9_77),param_21),dot(float2(-l9_77,l9_78),param_21))+param_20;
CoordsOut_N16=param_21;
...
int l9_84=l9_79;
int param_22=Tweak_N12Layout_tmp;
int param_23=l9_84;
float2 param_24=CoordsOut_N16;
bool param_25=(int(SC_USE_UV_TRANSFORM_Tweak_N12_tmp)!=0);
float3x3 param_26=(*sc_set0.UserUniforms).Tweak_N12Transform;
int2 param_27=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12_tmp);
bool param_28=(int(SC_USE_UV_MIN_MAX_Tweak_N12_tmp)!=0);
float4 param_29=(*sc_set0.UserUniforms).Tweak_N12UvMinMax;
bool param_30=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12_tmp)!=0);
float4 param_31=(*sc_set0.UserUniforms).Tweak_N12BorderColor;
float param_32=0.0;
bool l9_85=param_30&&(!param_28);
float l9_86=1.0;
float l9_87=param_24.x;
int l9_88=param_27.x;
if (l9_88==1)
{
l9_87=fract(l9_87);
}
...
param_24.x=l9_87;
float l9_92=param_24.y;
int l9_93=param_27.y;
if (l9_93==1)
{
l9_92=fract(l9_92);
}
...
float l9_99=param_24.x;
float l9_100=param_29.x;
float l9_101=param_29.z;
bool l9_102=l9_98;
float l9_103=l9_86;
...
float l9_108=param_24.y;
float l9_109=param_29.y;
float l9_110=param_29.w;
bool l9_111=l9_107;
float l9_112=l9_86;
...
float2 l9_115=param_24;
bool l9_116=param_25;
float3x3 l9_117=param_26;
if (l9_116)
{
...
param_24.x=l9_119;
l9_86=l9_122;
float l9_130=param_24.y;
int l9_131=param_27.y;
bool l9_132=l9_85;
float l9_133=l9_86;
...
param_24.y=l9_130;
l9_86=l9_133;
float2 l9_141=param_24;
int l9_142=param_22;
int l9_143=param_23;
float l9_144=param_32;
...
float4 l9_151=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_150.xy,bias(l9_144));
float4 l9_152=l9_151;
if (param_30)
{
l9_152=mix(param_31,l9_152,float4(l9_86));
}
float4 l9_153=l9_152;
Color_N15=l9_153;
float4 Output_N11=float4(0.0);
Output_N11=float4(Export_N145)*Color_N15;
float4 Output_N7=float4(0.0);
Output_N7=float4(Value2_N6)*Output_N11;
float4 Value_N5=float4(0.0);
Value_N5=float4(Value1_N6.x,Value1_N6.y,Value1_N6.z,Value_N5.w);
Value_N5.w=Output_N7.x;
FinalColor=Value_N5;
float param_33=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_33<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_37,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_38=FinalColor;
float4 l9_224=param_38;
if (sc_ShaderCacheConstant_tmp!=0)
{

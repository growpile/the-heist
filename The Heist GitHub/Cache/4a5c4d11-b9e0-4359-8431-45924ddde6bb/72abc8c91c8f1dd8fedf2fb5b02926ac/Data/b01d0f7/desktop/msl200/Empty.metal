...
//float2 Port_Center_N009 4656
//float2 Port_Input1_N137 4664
//float Port_Input1_N138 4672
//float Port_Import_N140 4676
//float Port_Import_N142 4680
//float Port_Input1_N144 4684
//float Port_Input2_N144 4688
//float2 Port_Scale_N014 4696
//float2 Port_Center_N014 4704
//float4 Port_Input1_N016 4720
//float depthRef 4736
//}
...
CoordsOut_N14=((UVCoord_N13-(*sc_set0.UserUniforms).Port_Center_N014)*(*sc_set0.UserUniforms).Port_Scale_N014)+(*sc_set0.UserUniforms).Port_Center_N014;
...
int l9_82=l9_77;
int param_16=Tweak_N12Layout_tmp;
int param_17=l9_82;
float2 param_18=CoordsOut_N14;
bool param_19=(int(SC_USE_UV_TRANSFORM_Tweak_N12_tmp)!=0);
float3x3 param_20=(*sc_set0.UserUniforms).Tweak_N12Transform;
int2 param_21=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12_tmp);
bool param_22=(int(SC_USE_UV_MIN_MAX_Tweak_N12_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N12UvMinMax;
bool param_24=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12_tmp)!=0);
float4 param_25=(*sc_set0.UserUniforms).Tweak_N12BorderColor;
float param_26=0.0;
bool l9_83=param_24&&(!param_22);
float l9_84=1.0;
float l9_85=param_18.x;
int l9_86=param_21.x;
if (l9_86==1)
{
l9_85=fract(l9_85);
}
...
param_18.x=l9_85;
float l9_90=param_18.y;
int l9_91=param_21.y;
if (l9_91==1)
{
l9_90=fract(l9_90);
}
...
float l9_97=param_18.x;
float l9_98=param_23.x;
float l9_99=param_23.z;
bool l9_100=l9_96;
float l9_101=l9_84;
...
float l9_106=param_18.y;
float l9_107=param_23.y;
float l9_108=param_23.w;
bool l9_109=l9_105;
float l9_110=l9_84;
...
float2 l9_113=param_18;
bool l9_114=param_19;
float3x3 l9_115=param_20;
if (l9_114)
{
...
param_18=l9_116;
float l9_117=param_18.x;
int l9_118=param_21.x;
bool l9_119=l9_83;
float l9_120=l9_84;
...
param_18.x=l9_117;
l9_84=l9_120;
float l9_128=param_18.y;
int l9_129=param_21.y;
bool l9_130=l9_83;
float l9_131=l9_84;
...
param_18.y=l9_128;
l9_84=l9_131;
float2 l9_139=param_18;
int l9_140=param_16;
int l9_141=param_17;
float l9_142=param_26;
...
float4 l9_149=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_148.xy,bias(l9_142));
float4 l9_150=l9_149;
if (param_24)
{
l9_150=mix(param_25,l9_150,float4(l9_84));
}
float4 l9_151=l9_150;
Color_N15=l9_151;
float4 Output_N16=float4(0.0);
Output_N16=Color_N15+(*sc_set0.UserUniforms).Port_Input1_N016;
float4 Output_N11=float4(0.0);
Output_N11=float4(Export_N145)*Output_N16;
...
float2 l9_153=floor(mod(l9_152.xy,float2(4.0)));
float l9_154=(mod(dot(l9_153,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_27<l9_154)
{
discard_fragment();
}
...
float4 l9_155=fast::max(param_28,float4(0.0));
float4 param_29=l9_155;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_158=fast::clamp(l9_157.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_158=fast::clamp(dot(l9_157.xyz,float3(l9_157.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_158=(1.0-dot(l9_157.xyz,float3(0.33333001)))*l9_157.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_158=(1.0-fast::clamp(dot(l9_157.xyz,float3(1.0)),0.0,1.0))*l9_157.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_158=fast::clamp(dot(l9_157.xyz,float3(1.0)),0.0,1.0)*l9_157.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_158=fast::clamp(dot(l9_157.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_158=dot(l9_157.xyz,float3(0.33333001))*l9_157.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_158=1.0-fast::clamp(dot(l9_157.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_159=l9_158;
float l9_160=l9_159;
float l9_161=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_160;
float3 l9_162=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_156.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_163=float4(l9_162.x,l9_162.y,l9_162.z,l9_161);
param_30=l9_163;
}
else
{
...
{
float4 l9_167=out.sc_FragData0;
l9_166=l9_167;
}
else
{
...
float4 l9_204=l9_166;
float3 l9_205=l9_204.xyz;
float3 l9_206=l9_205;
float3 l9_207=l9_164.xyz;
...
l9_165=float4(l9_208.x,l9_208.y,l9_208.z,l9_165.w);
float3 l9_209=mix(l9_205,l9_165.xyz,float3(l9_164.w));
l9_165=float4(l9_209.x,l9_209.y,l9_209.z,l9_165.w);
l9_165.w=1.0;
float4 l9_210=l9_165;
param_30=l9_210;
}
else
{

...
float2 param_16=CoordsOut_N14;
float param_17=(*sc_set0.UserUniforms).Port_Rotation_N016;
float2 param_18=(*sc_set0.UserUniforms).Port_Center_N016;
float l9_77=sin(radians(param_17));
float l9_78=cos(radians(param_17));
float2 param_19=param_16-param_18;
param_19=float2(dot(float2(l9_78,l9_77),param_19),dot(float2(-l9_77,l9_78),param_19))+param_18;
...
int l9_84=l9_79;
int param_20=Tweak_N12Layout_tmp;
int param_21=l9_84;
float2 param_22=CoordsOut_N16;
bool param_23=(int(SC_USE_UV_TRANSFORM_Tweak_N12_tmp)!=0);
float3x3 param_24=(*sc_set0.UserUniforms).Tweak_N12Transform;
int2 param_25=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12_tmp);
bool param_26=(int(SC_USE_UV_MIN_MAX_Tweak_N12_tmp)!=0);
float4 param_27=(*sc_set0.UserUniforms).Tweak_N12UvMinMax;
bool param_28=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12_tmp)!=0);
float4 param_29=(*sc_set0.UserUniforms).Tweak_N12BorderColor;
float param_30=0.0;
bool l9_85=param_28&&(!param_26);
float l9_86=1.0;
float l9_87=param_22.x;
int l9_88=param_25.x;
if (l9_88==1)
{
l9_87=fract(l9_87);
}
...
param_22.x=l9_87;
float l9_92=param_22.y;
int l9_93=param_25.y;
if (l9_93==1)
{
l9_92=fract(l9_92);
}
...
float l9_99=param_22.x;
float l9_100=param_27.x;
float l9_101=param_27.z;
bool l9_102=l9_98;
float l9_103=l9_86;
...
float l9_108=param_22.y;
float l9_109=param_27.y;
float l9_110=param_27.w;
bool l9_111=l9_107;
float l9_112=l9_86;
...
float2 l9_115=param_22;
bool l9_116=param_23;
float3x3 l9_117=param_24;
if (l9_116)
{
...
param_22=l9_118;
float l9_119=param_22.x;
int l9_120=param_25.x;
bool l9_121=l9_85;
float l9_122=l9_86;
...
param_22.x=l9_119;
l9_86=l9_122;
float l9_130=param_22.y;
int l9_131=param_25.y;
bool l9_132=l9_85;
float l9_133=l9_86;
...
param_22.y=l9_130;
l9_86=l9_133;
float2 l9_141=param_22;
int l9_142=param_20;
int l9_143=param_21;
float l9_144=param_30;
...
if (param_28)
{
l9_152=mix(param_29,l9_152,float4(l9_86));
}
...
float4 l9_157=fast::max(param_32,float4(0.0));
float4 param_33=l9_157;
if (sc_ShaderCacheConstant_tmp!=0)
{

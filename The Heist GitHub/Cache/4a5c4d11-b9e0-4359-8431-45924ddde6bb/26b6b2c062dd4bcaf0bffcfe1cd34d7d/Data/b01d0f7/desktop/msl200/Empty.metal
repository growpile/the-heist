...
//float2 Port_Scale_N014 4704
//float2 Port_Center_N014 4712
//float Port_Input1_N018 4720
//float2 Port_Center_N016 4728
//float depthRef 4736
//}
...
float param_16=(*sc_set0.UserUniforms).rotation;
Output_N17=param_16;
...
float param_18=Output_N18;
float2 param_19=(*sc_set0.UserUniforms).Port_Center_N016;
float l9_77=sin(radians(param_18));
float l9_78=cos(radians(param_18));
float2 param_20=param_17-param_19;
param_20=float2(dot(float2(l9_78,l9_77),param_20),dot(float2(-l9_77,l9_78),param_20))+param_19;
CoordsOut_N16=param_20;
...
int l9_84=l9_79;
int param_21=Tweak_N12Layout_tmp;
int param_22=l9_84;
float2 param_23=CoordsOut_N16;
bool param_24=(int(SC_USE_UV_TRANSFORM_Tweak_N12_tmp)!=0);
float3x3 param_25=(*sc_set0.UserUniforms).Tweak_N12Transform;
int2 param_26=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12_tmp);
bool param_27=(int(SC_USE_UV_MIN_MAX_Tweak_N12_tmp)!=0);
float4 param_28=(*sc_set0.UserUniforms).Tweak_N12UvMinMax;
bool param_29=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12_tmp)!=0);
float4 param_30=(*sc_set0.UserUniforms).Tweak_N12BorderColor;
float param_31=0.0;
bool l9_85=param_29&&(!param_27);
float l9_86=1.0;
float l9_87=param_23.x;
int l9_88=param_26.x;
if (l9_88==1)
{
l9_87=fract(l9_87);
}
...
param_23.x=l9_87;
float l9_92=param_23.y;
int l9_93=param_26.y;
if (l9_93==1)
{
l9_92=fract(l9_92);
}
...
float l9_99=param_23.x;
float l9_100=param_28.x;
float l9_101=param_28.z;
bool l9_102=l9_98;
float l9_103=l9_86;
...
float l9_108=param_23.y;
float l9_109=param_28.y;
float l9_110=param_28.w;
bool l9_111=l9_107;
float l9_112=l9_86;
...
float2 l9_115=param_23;
bool l9_116=param_24;
float3x3 l9_117=param_25;
if (l9_116)
{
...
param_23=l9_118;
float l9_119=param_23.x;
int l9_120=param_26.x;
bool l9_121=l9_85;
float l9_122=l9_86;
...
param_23.x=l9_119;
l9_86=l9_122;
float l9_130=param_23.y;
int l9_131=param_26.y;
bool l9_132=l9_85;
float l9_133=l9_86;
...
param_23.y=l9_130;
l9_86=l9_133;
float2 l9_141=param_23;
int l9_142=param_21;
int l9_143=param_22;
float l9_144=param_31;
...
if (param_29)
{
l9_152=mix(param_30,l9_152,float4(l9_86));
}
...
float4 l9_157=fast::max(param_33,float4(0.0));
float4 param_34=l9_157;
if (sc_ShaderCacheConstant_tmp!=0)
{

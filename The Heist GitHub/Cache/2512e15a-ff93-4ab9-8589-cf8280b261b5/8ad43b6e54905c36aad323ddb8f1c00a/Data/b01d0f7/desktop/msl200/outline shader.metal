...
//float Tweak_N0 4384
//float Tweak_N1 4388
//float Port_Import_N028 4396
//float Port_RangeMinA_N029 4400
//float Port_RangeMaxA_N029 4404
//float Port_RangeMinB_N029 4408
//float Port_RangeMaxB_N029 4412
//float Port_Import_N030 4416
//float Port_Input1_N031 4420
//float Port_Import_N032 4424
//float Port_Input1_N033 4428
//float depthRef 4432
//}
...
float3 Normal_N24=float3(0.0);
Normal_N24=Globals.VertexNormal_ObjectSpace;
float Output_N0=0.0;
float param_1=(*sc_set0.UserUniforms).Tweak_N0;
Output_N0=param_1;
float Output_N1=0.0;
float param_2=(*sc_set0.UserUniforms).Tweak_N1;
Output_N1=param_2;
float Rim_N25=0.0;
float3 param_3=Normal_N24;
...
float Value_N23=0.0;
Value_N23=Rim_N25;
float4 HSV_N27=float4(0.0);
float3 param_8=float4(Value_N23).xyz;
float3 l9_2=float3(0.0);
float3 l9_3=param_8;
float3 l9_4=fast::clamp(l9_3,float3(0.0),float3(1.0));
param_8=l9_4;
float l9_5=fast::max(fast::max(param_8.x,param_8.y),param_8.z);
l9_2.z=l9_5;
float l9_6=l9_5-fast::min(fast::min(param_8.x,param_8.y),param_8.z);
float3 l9_7=float3(0.0,0.33333334,0.66666669)+(((param_8.yzx-param_8.zxy)*0.16666667)/float3(l9_6));
float2 l9_8;
if (l9_6==0.0)
{
l9_8=float2(0.0);
...
l9_8=float2(l9_9,l9_6/l9_5);
}
l9_2=float3(l9_8.x,l9_8.y,l9_2.z);
float3 l9_11=l9_2;
HSV_N27=float4(l9_11,float4(Value_N23).w);
float Value_N28=0.0;
Value_N28=fast::clamp((*sc_set0.UserUniforms).Port_Import_N028,-180.0,180.0);
float ValueOut_N29=0.0;
ValueOut_N29=(((Value_N28-(*sc_set0.UserUniforms).Port_RangeMinA_N029)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N029-(*sc_set0.UserUniforms).Port_RangeMinA_N029)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N029-(*sc_set0.UserUniforms).Port_RangeMinB_N029))+(*sc_set0.UserUniforms).Port_RangeMinB_N029;
float Value_N30=0.0;
Value_N30=fast::clamp((*sc_set0.UserUniforms).Port_Import_N030,-100.0,100.0);
float Output_N31=0.0;
Output_N31=Value_N30*(*sc_set0.UserUniforms).Port_Input1_N031;
float Value_N32=0.0;
Value_N32=fast::clamp((*sc_set0.UserUniforms).Port_Import_N032,-100.0,100.0);
float Output_N33=0.0;
Output_N33=Value_N32*(*sc_set0.UserUniforms).Port_Input1_N033;
float3 Value_N34=float3(0.0);
Value_N34.x=ValueOut_N29;
Value_N34.y=Output_N31;
Value_N34.z=Output_N33;
float4 Output_N35=float4(0.0);
Output_N35=HSV_N27+float4(Value_N34,0.0);
float4 RGB_N36=float4(0.0);
float3 param_9=Output_N35.xyz;
float3 l9_12=param_9.zzz;
float l9_13=3.0*fract(param_9.x+0.16666667);
float l9_14=2.0*fract(l9_13);
float l9_15=param_9.y;
float l9_16=fast::clamp(l9_15,0.0,1.0);
float2 l9_17=l9_12.yz-((float2(1.0,l9_14)-float2(fast::max(0.0,l9_14-1.0)))*(param_9.z*l9_16));
...
float3 l9_18=l9_12;
RGB_N36=float4(l9_18,Output_N35.w);
float4 Export_N37=float4(0.0);
Export_N37=RGB_N36;
FinalColor=Export_N37;
...
float4 l9_22=fast::max(param_11,float4(0.0));
float4 param_12=l9_22;
if (sc_ShaderCacheConstant_tmp!=0)
{

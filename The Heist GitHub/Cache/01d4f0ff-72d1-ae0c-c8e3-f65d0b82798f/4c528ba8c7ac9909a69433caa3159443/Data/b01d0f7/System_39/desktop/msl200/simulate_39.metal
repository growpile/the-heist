...
float4 l9_453=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_454=dot(l9_453,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_455=l9_454;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_455;
}
}
float4 l9_456=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_456;
...
float4 l9_457=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_458=dot(l9_457,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_459=l9_458;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_459;
}
}
float4 l9_460=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_460;
return out;
}
return out;
}

...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/700]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(700*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/700]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/700];
...
param_1.Index1DPerCopy=param%700;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(700*((param/700)+1))-1;

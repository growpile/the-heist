...
param.CopyId=float(param_1/700);
...
float l9_8=float(l9_7)/699.0;
param_3.Ratio1D=l9_8;
int l9_9=param_3.Index1DPerCopy;
float l9_10=float(l9_9)/699.0;
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/700]!=0);
}
else
{
l9_46=l9_45;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/700];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_358/700]*float4(gParticle.Position,1.0)).xyz;
int l9_359=gl_InstanceIndex;
int l9_360=l9_359/700;
...
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_363/700][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_364/700][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_365/700][2].xyz)))*gParticle.Size;
int l9_366=gl_InstanceIndex;
int l9_367=l9_366/700;

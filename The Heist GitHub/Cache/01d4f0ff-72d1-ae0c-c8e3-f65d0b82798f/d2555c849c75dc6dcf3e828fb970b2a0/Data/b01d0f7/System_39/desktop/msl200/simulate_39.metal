...
//ubo int UserUniforms 0:35:7664 {
//float4 sc_Time 1376
...
//float Port_Import_N013 7392
//float Port_Import_N014 7396
//float Port_Import_N021 7400
//float Port_Import_N023 7404
//float3 Port_Import_N038 7408
//float3 Port_Min_N041 7424
//float3 Port_Max_N041 7440
//float Port_Min_N044 7456
//float Port_Max_N044 7460
//float Port_Import_N047 7464
//float3 Port_Import_N048 7472
//float3 Port_Import_N004 7488
//float3 Port_Import_N073 7504
...
//float Port_Import_N030 7632
//float Port_Import_N031 7636
//float Port_Min_N024 7640
//float Port_Max_N024 7644
//float Port_Import_N252 7652
//}
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[l9_358/500]*float4(gParticle.Position,1.0)).xyz;
int l9_359=gl_InstanceIndex;
int l9_360=l9_359/500;
...
gParticle.Size=fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_363/500][0].xyz),fast::max(length((*sc_set0.UserUniforms).vfxModelMatrix[l9_364/500][1].xyz),length((*sc_set0.UserUniforms).vfxModelMatrix[l9_365/500][2].xyz)))*gParticle.Size;
int l9_366=gl_InstanceIndex;
int l9_367=l9_366/500;
...
float4 l9_463=param_18;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_464=dot(l9_463,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_465=l9_464;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_465;
}
}
float4 l9_466=float4(param_18.x,-param_18.y,(param_18.z*0.5)+(param_18.w*0.5),param_18.w);
out.gl_Position=l9_466;
...
float4 l9_470=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);

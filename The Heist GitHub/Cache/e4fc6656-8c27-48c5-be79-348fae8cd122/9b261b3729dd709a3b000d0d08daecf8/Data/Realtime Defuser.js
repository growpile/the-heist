...
async function ensureRoomRegistration() {
    ...
    // Generate a room code and upsert; retry on conflict without pre-select (avoids RLS on select)
...
async function generateUniqueRoomCode(table, excludeMap) {
    ...
    while (attempt < 20) {
        ...
        // No select here to avoid RLS; uniqueness handled by insert conflicts
        attempt++;
    }
    return null;
}

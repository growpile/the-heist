...
//float Tweak_N18 4672
//float4 screenColor 4688
//float progress 4704
//float4 Port_Input0_N005 4720
//float2 Port_Center_N010 4736
//float3 Port_Value1_N020 4752
...
float param_25=(*sc_set0.UserUniforms).Tweak_N18;
Output_N18=param_25;
float4 Output_N17=float4(0.0);
Output_N17=mix(Value_N13,Value_N20,float4(Output_N18));
...
float4 param_26=(*sc_set0.UserUniforms).screenColor;
Output_N3=param_26;
float4 Output_N2=float4(0.0);
Output_N2=float4(Export_N145)*Output_N3;
float4 Output_N12=float4(0.0);
float4 param_28=Output_N17;
float4 param_29=Output_N2;
float4 l9_152=param_28;
float4 l9_153=param_29;
float3 l9_154=l9_152.xyz*l9_152.w;
l9_152=float4(l9_154.x,l9_154.y,l9_154.z,l9_152.w);
float4 param_27=l9_152+(l9_153*(1.0-l9_152.w));
Output_N12=param_27;
float Output_N6=0.0;
float param_30=(*sc_set0.UserUniforms).progress;
Output_N6=param_30;
...
float4 l9_158=fast::max(param_32,float4(0.0));
float4 param_33=l9_158;
if (sc_ShaderCacheConstant_tmp!=0)
{

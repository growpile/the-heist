...
//sampler sampler Tweak_N15SmpSC 0:23
//sampler sampler Tweak_N8SmpSC 0:24
...
//texture texture2D Tweak_N15 0:4:0:23
//texture texture2D Tweak_N8 0:5:0:24
...
//float3x3 Tweak_N15Transform 4432
//float4 Tweak_N15UvMinMax 4480
//float4 Tweak_N15BorderColor 4496
//float Tweak_N22 4512
//float3x3 Tweak_N8Transform 4576
//float4 Tweak_N8UvMinMax 4624
//float4 Tweak_N8BorderColor 4640
//float state 4656
//float progress 4660
//float4 Port_Input0_N005 4672
//float3 Port_Value1_N020 4688
//float Port_Multiplier_N011 4704
//float Port_Input1_N024 4708
//float Port_Input1_N025 4712
//float Port_RangeMinA_N028 4716
//float Port_RangeMaxA_N028 4720
//float Port_RangeMinB_N028 4724
//float Port_RangeMaxB_N028 4728
//float2 Port_Center_N010 4736
//float3 Port_Value1_N013 4752
//float2 Port_Scale_N001 4768
//float2 Port_Center_N001 4776
//float2 Port_Input1_N137 4784
//float Port_Input1_N138 4792
//float Port_Import_N140 4796
//float Port_Import_N142 4800
//float Port_Input1_N144 4804
//float Port_Input2_N144 4808
//float4 Port_Input1_N018 4816
//float4 Port_Input1_N002 4832
//float depthRef 4852
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N15 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N8 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N15 34 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N8 35 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 36 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N15 37 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N8 38 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 39 0
//spec_const bool Tweak_N15HasSwappedViews 40 0
//spec_const bool Tweak_N8HasSwappedViews 41 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N15 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N8 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N15 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N8 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int Tweak_N15Layout 81 0
//spec_const int Tweak_N8Layout 82 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N15 [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N15 [[function_constant(34)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N8 [[function_constant(35)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N15 [[function_constant(37)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N8 [[function_constant(38)]];
...
constant bool Tweak_N15HasSwappedViews [[function_constant(40)]];
...
constant bool Tweak_N8HasSwappedViews [[function_constant(41)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N15 [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N8 [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N15 [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N8 [[function_constant(79)]];
...
constant int Tweak_N15Layout [[function_constant(81)]];
constant int Tweak_N15Layout_tmp = is_function_constant_defined(Tweak_N15Layout) ? Tweak_N15Layout : 0;
constant int Tweak_N8Layout [[function_constant(82)]];
...
float state;
float progress;
float4 Port_Input0_N005;
float3 Port_Value1_N020;
float Port_Multiplier_N011;
...
texture2d<float> Tweak_N15 [[id(4)]];
texture2d<float> Tweak_N8 [[id(5)]];
...
sampler Tweak_N15SmpSC [[id(23)]];
sampler Tweak_N8SmpSC [[id(24)]];
...
float Time_N11=0.0;
Time_N11=Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Multiplier_N011;
float Output_N22=0.0;
float param_1=(*sc_set0.UserUniforms).Tweak_N22;
Output_N22=param_1;
float Output_N21=0.0;
Output_N21=Time_N11*Output_N22;
float Output_N23=0.0;
Output_N23=fract(Output_N21);
float Output_N24=0.0;
Output_N24=Output_N23*(*sc_set0.UserUniforms).Port_Input1_N024;
float Output_N25=0.0;
Output_N25=Output_N24-(*sc_set0.UserUniforms).Port_Input1_N025;
float Output_N26=0.0;
Output_N26=abs(Output_N25);
float Output_N27=0.0;
Output_N27=1.0-Output_N26;
float ValueOut_N28=0.0;
ValueOut_N28=(((Output_N27-(*sc_set0.UserUniforms).Port_RangeMinA_N028)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N028-(*sc_set0.UserUniforms).Port_RangeMinA_N028)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N028-(*sc_set0.UserUniforms).Port_RangeMinB_N028))+(*sc_set0.UserUniforms).Port_RangeMinB_N028;
float2 CoordsOut_N10=float2(0.0);
CoordsOut_N10=((UVCoord_N9-(*sc_set0.UserUniforms).Port_Center_N010)*float2(ValueOut_N28))+(*sc_set0.UserUniforms).Port_Center_N010;
...
int l9_6=l9_1;
int param_2=Tweak_N15Layout_tmp;
int param_3=l9_6;
float2 param_4=CoordsOut_N10;
bool param_5=(int(SC_USE_UV_TRANSFORM_Tweak_N15_tmp)!=0);
float3x3 param_6=(*sc_set0.UserUniforms).Tweak_N15Transform;
int2 param_7=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N15_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N15_tmp);
bool param_8=(int(SC_USE_UV_MIN_MAX_Tweak_N15_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).Tweak_N15UvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N15_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).Tweak_N15BorderColor;
float param_12=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.Tweak_N15.sample(sc_set0.Tweak_N15SmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_10)
{
...
Value_N20=float4((*sc_set0.UserUniforms).Port_Value1_N020.x,(*sc_set0.UserUniforms).Port_Value1_N020.y,(*sc_set0.UserUniforms).Port_Value1_N020.z,Value_N20.w);
Value_N20.w=Color_N16.x;
float4 Color_N7=float4(0.0);
int l9_76;
...
int l9_81=l9_76;
int param_13=Tweak_N8Layout_tmp;
int param_14=l9_81;
float2 param_15=CoordsOut_N10;
bool param_16=(int(SC_USE_UV_TRANSFORM_Tweak_N8_tmp)!=0);
float3x3 param_17=(*sc_set0.UserUniforms).Tweak_N8Transform;
int2 param_18=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8_tmp);
bool param_19=(int(SC_USE_UV_MIN_MAX_Tweak_N8_tmp)!=0);
float4 param_20=(*sc_set0.UserUniforms).Tweak_N8UvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).Tweak_N8BorderColor;
float param_23=0.0;
...
float4 l9_148=sc_set0.Tweak_N8.sample(sc_set0.Tweak_N8SmpSC,l9_147.xy,bias(l9_141));
...
Value_N13=float4((*sc_set0.UserUniforms).Port_Value1_N013.x,(*sc_set0.UserUniforms).Port_Value1_N013.y,(*sc_set0.UserUniforms).Port_Value1_N013.z,Value_N13.w);
Value_N13.w=Color_N7.x;
float Output_N3=0.0;
float param_24=(*sc_set0.UserUniforms).state;
Output_N3=param_24;
float4 Output_N17=float4(0.0);
Output_N17=mix(Value_N20,Value_N13,float4(Output_N3));
float2 UVCoord_N136=float2(0.0);
UVCoord_N136=Globals.Surface_UVCoord0;
float2 CoordsOut_N1=float2(0.0);
CoordsOut_N1=((UVCoord_N136-(*sc_set0.UserUniforms).Port_Center_N001)*(*sc_set0.UserUniforms).Port_Scale_N001)+(*sc_set0.UserUniforms).Port_Center_N001;
float Output_N137=0.0;
Output_N137=distance(CoordsOut_N1,(*sc_set0.UserUniforms).Port_Input1_N137);
...
{
l9_151=pow(Output_N139,Value_N140);
}
Output_N141=l9_151;
...
Output_N18=float4(Export_N145)*(*sc_set0.UserUniforms).Port_Input1_N018;
float4 Output_N2=float4(0.0);
Output_N2=float4(Export_N145)*(*sc_set0.UserUniforms).Port_Input1_N002;
float4 Output_N14=float4(0.0);
Output_N14=mix(Output_N18,Output_N2,float4(Output_N3));
float4 Output_N12=float4(0.0);
float4 param_26=Output_N17;
float4 param_27=Output_N14;
float4 l9_152=param_26;
float4 l9_153=param_27;
float3 l9_154=l9_152.xyz*l9_152.w;
l9_152=float4(l9_154.x,l9_154.y,l9_154.z,l9_152.w);
float4 param_25=l9_152+(l9_153*(1.0-l9_152.w));
Output_N12=param_25;
float Output_N6=0.0;
float param_28=(*sc_set0.UserUniforms).progress;
Output_N6=param_28;
float4 Output_N5=float4(0.0);
Output_N5=mix((*sc_set0.UserUniforms).Port_Input0_N005,Output_N12,float4(Output_N6));
...
float4 l9_158=fast::max(param_30,float4(0.0));
float4 param_31=l9_158;
if (sc_ShaderCacheConstant_tmp!=0)
{

...
//float4 screenColor 4624
//float progress 4640
//float2 Port_Scale_N001 4648
//float2 Port_Center_N001 4656
...
{
l9_1=pow(Output_N139,Value_N140);
}
Output_N141=l9_1;
...
float4 param_1=(*sc_set0.UserUniforms).screenColor;
Output_N3=param_1;
float4 Output_N2=float4(0.0);
Output_N2=float4(Export_N145)*Output_N3;
float Output_N6=0.0;
float param_2=(*sc_set0.UserUniforms).progress;
Output_N6=param_2;
...
{
l9_0=pow(Output_N139,Value_N140);
}
Output_N141=l9_0;
float Value_N142=0.0;
Value_N142=(*sc_set0.UserUniforms).Port_Import_N142;
...
Export_N145=Output_N144;
float4 Output_N3=float4(0.0);
float4 param=(*sc_set0.UserUniforms).screenColor;
Output_N3=param;
float4 Output_N2=float4(0.0);
Output_N2=float4(Export_N145)*Output_N3;
float Output_N6=0.0;
...
float3 param_3=in.varPosAndMotion.xyz;
float3 param_4=in.varNormalAndMotion.xyz;
float param_5=0.0;
float3 l9_4=param_3;
float3 l9_5=param_4;
float l9_6=param_5;
uint l9_7=0u;
uint3 l9_8=uint3(round((l9_4-(*sc_set0.UserUniforms).sc_RayTracingOriginOffset)*(*sc_set0.UserUniforms).sc_RayTracingOriginScale));
out.sc_RayTracingPositionAndMask=uint4(l9_8.x,l9_8.y,l9_8.z,out.sc_RayTracingPositionAndMask.w);
out.sc_RayTracingPositionAndMask.w=(*sc_set0.UserUniforms).sc_RayTracingReceiverMask;
float3 l9_9=l9_5;
float l9_10=dot(abs(l9_9),float3(1.0));
l9_9/=float3(l9_10);
float2 l9_11=float2(fast::clamp(-l9_9.z,0.0,1.0));
float2 l9_12=l9_9.xy+mix(-l9_11,l9_11,step(float2(0.0),l9_9.xy));
uint l9_13=as_type<uint>(half2(l9_12));
uint2 l9_14=uint2(l9_13&65535u,l9_13>>16u);
out.sc_RayTracingNormalAndMore=uint4(l9_14.x,l9_14.y,out.sc_RayTracingNormalAndMore.z,out.sc_RayTracingNormalAndMore.w);
out.sc_RayTracingNormalAndMore.z=l9_7;
uint l9_15=uint(fast::clamp(l9_6,0.0,1.0)*1000.0);
l9_15 |= (((*sc_set0.UserUniforms).sc_RayTracingReceiverId%32u)<<10u);
out.sc_RayTracingNormalAndMore.w=l9_15;
return out;
}

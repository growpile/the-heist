...
//float4 screenColor 4544
//float progress 4560
//float4 Port_Input0_N005 4576
//float2 Port_Center_N010 4592
//float4 Port_Input1_N017 4608
//float4 Port_Input2_N017 4624
//float2 Port_Scale_N001 4640
//float2 Port_Center_N001 4648
//float2 Port_Input1_N137 4656
//float Port_Input1_N138 4664
//float Port_Import_N140 4668
//float Port_Import_N142 4672
//float Port_Input1_N144 4676
//float Port_Input2_N144 4680
//float depthRef 4688
//}
...
Output_N17=mix(Value_N13,(*sc_set0.UserUniforms).Port_Input1_N017,(*sc_set0.UserUniforms).Port_Input2_N017);
...
float4 param_14=(*sc_set0.UserUniforms).screenColor;
Output_N3=param_14;
float4 Output_N2=float4(0.0);
Output_N2=float4(Export_N145)*Output_N3;
float4 Output_N12=float4(0.0);
float4 param_16=Output_N17;
float4 param_17=Output_N2;
float4 l9_77=param_16;
float4 l9_78=param_17;
float3 l9_79=l9_77.xyz*l9_77.w;
l9_77=float4(l9_79.x,l9_79.y,l9_79.z,l9_77.w);
float4 param_15=l9_77+(l9_78*(1.0-l9_77.w));
Output_N12=param_15;
float Output_N6=0.0;
float param_18=(*sc_set0.UserUniforms).progress;
Output_N6=param_18;
...
float4 l9_83=fast::max(param_20,float4(0.0));
float4 param_21=l9_83;
if (sc_ShaderCacheConstant_tmp!=0)
{

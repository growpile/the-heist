...
Output_N3=(*sc_set0.UserUniforms).Port_Value_N003;
...
float4 l9_5=fast::max(param_2,float4(0.0));
float4 param_3=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float3 param_1=in.varPosAndMotion.xyz;
float3 param_2=in.varNormalAndMotion.xyz;
float param_3=0.0;
float3 l9_4=param_1;
float3 l9_5=param_2;
float l9_6=param_3;

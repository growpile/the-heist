...
float4 param_27=(*sc_set0.UserUniforms).Port_Base_N012;
...
float4 param_25=l9_151+(l9_152*(1.0-l9_151.w));
Output_N12=param_25;
float Output_N6=0.0;
...
float4 l9_157=fast::max(param_30,float4(0.0));
float4 param_31=l9_157;
if (sc_ShaderCacheConstant_tmp!=0)
{

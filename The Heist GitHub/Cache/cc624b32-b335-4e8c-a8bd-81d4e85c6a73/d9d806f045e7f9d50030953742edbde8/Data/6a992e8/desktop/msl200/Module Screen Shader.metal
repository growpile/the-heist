...
//float4 Tweak_N14 4384
//float3x3 Tweak_N8Transform 4448
//float4 Tweak_N8UvMinMax 4496
//float4 Tweak_N8BorderColor 4512
//float Tweak_N11 4528
//float3x3 Tweak_N15Transform 4592
//float4 Tweak_N15UvMinMax 4640
//float4 Tweak_N15BorderColor 4656
//float4 screenColor 4672
//float progress 4688
//float4 Port_Input0_N005 4704
//float2 Port_Center_N010 4720
//float3 Port_Value1_N020 4736
//float4 Port_Input2_N017 4752
...
float4 param_1=(*sc_set0.UserUniforms).Tweak_N14;
Output_N14=param_1;
float2 UVCoord_N9=float2(0.0);
UVCoord_N9=Globals.Surface_UVCoord0;
float Output_N11=0.0;
float param_2=(*sc_set0.UserUniforms).Tweak_N11;
Output_N11=param_2;
...
int l9_6=l9_1;
int param_3=Tweak_N8Layout_tmp;
int param_4=l9_6;
float2 param_5=CoordsOut_N10;
bool param_6=(int(SC_USE_UV_TRANSFORM_Tweak_N8_tmp)!=0);
float3x3 param_7=(*sc_set0.UserUniforms).Tweak_N8Transform;
int2 param_8=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8_tmp);
bool param_9=(int(SC_USE_UV_MIN_MAX_Tweak_N8_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N8UvMinMax;
bool param_11=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).Tweak_N8BorderColor;
float param_13=0.0;
...
Value_N13=float4(Output_N14.xyz.x,Output_N14.xyz.y,Output_N14.xyz.z,Value_N13.w);
...
int l9_81=l9_76;
int param_14=Tweak_N15Layout_tmp;
int param_15=l9_81;
float2 param_16=CoordsOut_N10;
bool param_17=(int(SC_USE_UV_TRANSFORM_Tweak_N15_tmp)!=0);
float3x3 param_18=(*sc_set0.UserUniforms).Tweak_N15Transform;
int2 param_19=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N15_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N15_tmp);
bool param_20=(int(SC_USE_UV_MIN_MAX_Tweak_N15_tmp)!=0);
float4 param_21=(*sc_set0.UserUniforms).Tweak_N15UvMinMax;
bool param_22=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N15_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N15BorderColor;
float param_24=0.0;
...
Output_N17=mix(Value_N13,Value_N20,(*sc_set0.UserUniforms).Port_Input2_N017);
...
float4 param_25=(*sc_set0.UserUniforms).screenColor;
Output_N3=param_25;
float4 Output_N2=float4(0.0);
Output_N2=float4(Export_N145)*Output_N3;
float4 Output_N12=float4(0.0);
float4 param_27=Output_N17;
float4 param_28=Output_N2;
float4 l9_152=param_27;
float4 l9_153=param_28;
float3 l9_154=l9_152.xyz*l9_152.w;
l9_152=float4(l9_154.x,l9_154.y,l9_154.z,l9_152.w);
float4 param_26=l9_152+(l9_153*(1.0-l9_152.w));
Output_N12=param_26;
float Output_N6=0.0;
float param_29=(*sc_set0.UserUniforms).progress;
Output_N6=param_29;
...
float4 l9_158=fast::max(param_31,float4(0.0));
float4 param_32=l9_158;
if (sc_ShaderCacheConstant_tmp!=0)
{

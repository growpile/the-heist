...
//sampler sampler Tweak_N15SmpSC 0:22
...
//texture texture2D Tweak_N15 0:4:0:22
...
//float state 4516
//float progress 4520
//float4 Port_Input0_N005 4528
//float4 Port_Input0_N017 4544
//float3 Port_Value1_N020 4560
//float2 Port_Center_N010 4576
//float2 Port_Scale_N001 4584
//float2 Port_Center_N001 4592
//float2 Port_Input1_N137 4600
//float Port_Input1_N138 4608
//float Port_Import_N140 4612
//float Port_Import_N142 4616
//float Port_Input1_N144 4620
//float Port_Input2_N144 4624
//float4 Port_Input1_N002 4640
//float depthRef 4660
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N15 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N15 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N15HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N15 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N15 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int Tweak_N15Layout 75 0
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N15 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N15 [[function_constant(35)]];
...
constant bool Tweak_N15HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N15 [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N15 [[function_constant(73)]];
...
constant int Tweak_N15Layout [[function_constant(75)]];
...
float Output_N3=0.0;
float param_13=(*sc_set0.UserUniforms).state;
Output_N3=param_13;
float4 Output_N17=float4(0.0);
Output_N17=mix((*sc_set0.UserUniforms).Port_Input0_N017,Value_N20,float4(Output_N3));
...
float4 param_15=Output_N17;
float4 param_16=Output_N2;
float4 l9_77=param_15;
float4 l9_78=param_16;
float3 l9_79=l9_77.xyz*l9_77.w;
l9_77=float4(l9_79.x,l9_79.y,l9_79.z,l9_77.w);
float4 param_14=l9_77+(l9_78*(1.0-l9_77.w));
Output_N12=param_14;
float Output_N6=0.0;
float param_17=(*sc_set0.UserUniforms).progress;
Output_N6=param_17;
...
float4 l9_83=fast::max(param_19,float4(0.0));
float4 param_20=l9_83;
if (sc_ShaderCacheConstant_tmp!=0)
{

...
//float progress 4532
//float2 Port_Center_N010 4536
//float Port_Input0_N005 4544
//float Port_Input1_N005 4548
//float depthRef 4556
//}
...
Output_N6=param_14;
float Output_N5=0.0;
Output_N5=mix((*sc_set0.UserUniforms).Port_Input0_N005,(*sc_set0.UserUniforms).Port_Input1_N005,Output_N6);
float4 Output_N12=float4(0.0);
float4 param_16=Value_N13;
float4 param_17=float4(Output_N5);
float4 l9_76=param_16;
float4 l9_77=param_17;
float3 l9_78=l9_76.xyz*l9_76.w;
l9_76=float4(l9_78.x,l9_78.y,l9_78.z,l9_76.w);
float4 param_15=l9_76+(l9_77*(1.0-l9_76.w));
Output_N12=param_15;
...
float4 l9_82=fast::max(param_19,float4(0.0));
float4 param_20=l9_82;
if (sc_ShaderCacheConstant_tmp!=0)
{

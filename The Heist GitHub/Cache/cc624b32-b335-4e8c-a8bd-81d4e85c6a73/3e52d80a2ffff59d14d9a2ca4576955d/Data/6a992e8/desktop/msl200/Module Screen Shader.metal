...
//float3x3 Tweak_N8Transform 4560
//float4 Tweak_N8UvMinMax 4608
//float4 Tweak_N8BorderColor 4624
//float state 4640
//float progress 4644
//float4 Port_Input0_N005 4656
//float3 Port_Value1_N020 4672
//float2 Port_Scale_N010 4688
//float2 Port_Center_N010 4696
//float3 Port_Value1_N013 4704
//float2 Port_Scale_N001 4720
//float2 Port_Center_N001 4728
//float2 Port_Input1_N137 4736
//float Port_Input1_N138 4744
//float Port_Import_N140 4748
//float Port_Import_N142 4752
//float Port_Input1_N144 4756
//float Port_Input2_N144 4760
//float4 Port_Input1_N018 4768
...
CoordsOut_N10=((UVCoord_N9-(*sc_set0.UserUniforms).Port_Center_N010)*(*sc_set0.UserUniforms).Port_Scale_N010)+(*sc_set0.UserUniforms).Port_Center_N010;
...
int l9_6=l9_1;
int param_1=Tweak_N15Layout_tmp;
int param_2=l9_6;
float2 param_3=CoordsOut_N10;
bool param_4=(int(SC_USE_UV_TRANSFORM_Tweak_N15_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).Tweak_N15Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N15_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N15_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_Tweak_N15_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).Tweak_N15UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N15_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N15BorderColor;
float param_11=0.0;
...
int l9_81=l9_76;
int param_12=Tweak_N8Layout_tmp;
int param_13=l9_81;
float2 param_14=CoordsOut_N10;
bool param_15=(int(SC_USE_UV_TRANSFORM_Tweak_N8_tmp)!=0);
float3x3 param_16=(*sc_set0.UserUniforms).Tweak_N8Transform;
int2 param_17=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8_tmp);
bool param_18=(int(SC_USE_UV_MIN_MAX_Tweak_N8_tmp)!=0);
float4 param_19=(*sc_set0.UserUniforms).Tweak_N8UvMinMax;
bool param_20=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8_tmp)!=0);
float4 param_21=(*sc_set0.UserUniforms).Tweak_N8BorderColor;
float param_22=0.0;
...
float Output_N3=0.0;
float param_23=(*sc_set0.UserUniforms).state;
Output_N3=param_23;
...
float4 param_25=Output_N17;
float4 param_26=Output_N14;
float4 l9_152=param_25;
float4 l9_153=param_26;
float3 l9_154=l9_152.xyz*l9_152.w;
l9_152=float4(l9_154.x,l9_154.y,l9_154.z,l9_152.w);
float4 param_24=l9_152+(l9_153*(1.0-l9_152.w));
Output_N12=param_24;
float Output_N6=0.0;

...
the Open Font License (OFL) are to stimulate worldwide
development of collaborative font projects, to support the font

creation
efforts of academic and linguistic communities, and to provide a free and
open framework in which fonts may be

shared and improved in partnership
with others.
...
requirement for fonts to remain
...
refers to the set of files released by the Copyright
...
writer or other person who contributed to the
...
Font Software, to use, study, copy, merge, embed, modify,
...
name(s) of the Copyright Holder(s) or the Author(s) of the Font
...
must be distributed entirely

under this license, and must not be
distributed under any other license. The requirement for fonts to
remain under this

license does not apply to any document created
using the Font Software.


TERMINATION

This license becomes null and void if any

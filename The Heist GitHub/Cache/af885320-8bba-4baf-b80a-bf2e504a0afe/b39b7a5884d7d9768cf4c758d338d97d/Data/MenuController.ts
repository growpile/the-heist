...
export class MenuController extends BaseScriptComponent {
  ...
  /** After gameplay — snap menu visible (no scale race with stale tweens). */
  returnFromGameplay(callback?: () => void): void {
    ...
    print("[MenuController] returnFromGameplay — snap restore")
  ...
  /**
   * Immediate menu restore after gameplay — avoids scale/pop callbacks that can
   * no-op when transitionToken or menuScaleGeneration changes mid-flight.
   */

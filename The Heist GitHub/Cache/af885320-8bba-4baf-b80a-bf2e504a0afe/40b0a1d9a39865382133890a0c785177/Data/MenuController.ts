...
export class MenuController extends BaseScriptComponent {
  ...
  @input
  @hint("World Y offset from camera (cm). Pitch/Headlock still control XZ; only height is pinned.")
  ...
  @input
  @hint("Main menu tabs in left-to-right order (button + tab content elements).")
  tabs: MenuTab[] = []
  ...
  @input
  @allowUndefined
  @hint("Main menu shell (Main Menu object). Tab bar pieces go in elements; tab panels in tabs[].")

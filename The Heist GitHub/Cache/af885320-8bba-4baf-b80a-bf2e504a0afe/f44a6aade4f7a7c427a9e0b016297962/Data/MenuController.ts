...
export class MenuController extends BaseScriptComponent {
  ...
  private restoreMainMenuFromHidden(callback?: () => void): void {
    ...
    const startContentPop = () => {
      ...
      const prepareList = mainRoot ? [mainRoot, ...childElements] : childElements
      this.transitions.prepareElementsForPopIn(prepareList)
  ...
  private getMainMenuChildPopElements(): SceneObject[] {

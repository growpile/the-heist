...
//float2 Port_Direction_N012 4384
//float Port_Speed_N012 4392
//float2 Port_Scale_N001 4400
//float2 Port_Direction_N013 4408
//float Port_Speed_N013 4416
//float2 Port_Scale_N014 4424
//float Port_Input1_N003 4432
//float Port_Input1_N005 4436
//float Port_Height_N000 4440
//float2 Port_Direction_N016 4448
//float Port_Speed_N016 4456
//float2 Port_Scale_N007 4464
//float2 Port_Direction_N017 4472
//float Port_Speed_N017 4480
//float2 Port_Scale_N018 4488
//float Port_Input1_N008 4496
//float Port_Input1_N009 4500
//float depthRef 4504
//}
...
float2 Port_Direction_N012;
float Port_Speed_N012;
...
float Port_Height_N000;
float2 Port_Direction_N016;
float Port_Speed_N016;
float2 Port_Scale_N007;
float2 Port_Direction_N017;
float Port_Speed_N017;
...
CoordsOut_N12=UVCoord_N2+((*sc_set0.UserUniforms).Port_Direction_N012*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N012));
float Noise_N1=0.0;
float2 param_1=CoordsOut_N12;
float2 param_2=(*sc_set0.UserUniforms).Port_Scale_N001;
param_1.x=floor(param_1.x*10000.0)*9.9999997e-05;
param_1.y=floor(param_1.y*10000.0)*9.9999997e-05;
param_1*=(param_2*0.5);
float2 l9_1=param_1;
float param_3=(snoise(l9_1)*0.5)+0.5;
param_3=floor(param_3*10000.0)*9.9999997e-05;
Noise_N1=param_3;
float2 CoordsOut_N13=float2(0.0);
CoordsOut_N13=UVCoord_N2+((*sc_set0.UserUniforms).Port_Direction_N013*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N013));
float Noise_N14=0.0;
float2 param_4=CoordsOut_N13;
float2 param_5=(*sc_set0.UserUniforms).Port_Scale_N014;
param_4.x=floor(param_4.x*10000.0)*9.9999997e-05;
param_4.y=floor(param_4.y*10000.0)*9.9999997e-05;
param_4*=(param_5*0.5);
float2 l9_2=param_4;
float param_6=(snoise(l9_2)*0.5)+0.5;
param_6=floor(param_6*10000.0)*9.9999997e-05;
Noise_N14=param_6;
float Output_N15=0.0;
Output_N15=Noise_N1*Noise_N14;
float Output_N3=0.0;
Output_N3=step(Output_N15,(*sc_set0.UserUniforms).Port_Input1_N003);
float Output_N5=0.0;
Output_N5=step(Output_N15,(*sc_set0.UserUniforms).Port_Input1_N005);
float Output_N6=0.0;
Output_N6=Output_N3-Output_N5;
float2 CoordsOut_N0=float2(0.0);
float2 param_7=UVCoord_N2;
float param_8=(*sc_set0.UserUniforms).Port_Height_N000;
ssGlobals param_10=Globals;
float3 l9_3=param_10.VertexTangent_WorldSpace;
float3 l9_4=param_10.VertexBinormal_WorldSpace;
float3 l9_5=param_10.ViewDirWS;
float3 l9_6=float3(dot(l9_5,l9_3),dot(l9_5,l9_4),dot(l9_5,param_10.VertexNormal_WorldSpace));
float2 l9_7;
if (l9_6.z>0.0)
{
l9_7=(-l9_6.xy)/float2(l9_6.z);
}
else
{
l9_7=float2(0.0);
...
float2 l9_8=l9_7;
float2 param_9=param_7+(l9_8*param_8);
CoordsOut_N0=param_9;
float2 CoordsOut_N16=float2(0.0);
CoordsOut_N16=CoordsOut_N0+((*sc_set0.UserUniforms).Port_Direction_N016*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N016));
float Noise_N7=0.0;
float2 param_11=CoordsOut_N16;
float2 param_12=(*sc_set0.UserUniforms).Port_Scale_N007;
param_11.x=floor(param_11.x*10000.0)*9.9999997e-05;
param_11.y=floor(param_11.y*10000.0)*9.9999997e-05;
param_11*=(param_12*0.5);
float2 l9_9=param_11;
float param_13=(snoise(l9_9)*0.5)+0.5;
param_13=floor(param_13*10000.0)*9.9999997e-05;
Noise_N7=param_13;
float2 CoordsOut_N17=float2(0.0);
CoordsOut_N17=CoordsOut_N0+((*sc_set0.UserUniforms).Port_Direction_N017*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N017));
float Noise_N18=0.0;
float2 param_14=CoordsOut_N17;
float2 param_15=(*sc_set0.UserUniforms).Port_Scale_N018;
param_14.x=floor(param_14.x*10000.0)*9.9999997e-05;
param_14.y=floor(param_14.y*10000.0)*9.9999997e-05;
param_14*=(param_15*0.5);
float2 l9_10=param_14;
float param_16=(snoise(l9_10)*0.5)+0.5;
param_16=floor(param_16*10000.0)*9.9999997e-05;
Noise_N18=param_16;
float Output_N19=0.0;
Output_N19=Noise_N7*Noise_N18;
float Output_N8=0.0;
Output_N8=step(Output_N19,(*sc_set0.UserUniforms).Port_Input1_N008);
float Output_N9=0.0;
Output_N9=step(Output_N19,(*sc_set0.UserUniforms).Port_Input1_N009);
float Output_N10=0.0;
Output_N10=Output_N8-Output_N9;
float Output_N11=0.0;
Output_N11=Output_N6+Output_N10;
FinalColor=float4(Output_N11);
...
float4 l9_14=fast::max(param_18,float4(0.0));
float4 param_19=l9_14;
if (sc_ShaderCacheConstant_tmp!=0)
{

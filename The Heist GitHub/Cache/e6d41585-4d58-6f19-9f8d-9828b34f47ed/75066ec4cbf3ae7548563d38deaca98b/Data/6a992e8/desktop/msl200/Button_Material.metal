...
//}
//ubo int UserUniforms 0:28:4848 {
//float4 sc_Time 1376
...
//float4 Port_Input1_N034 4720
//float Port_Input0_N038 4736
//float Port_Input1_N038 4740
//float4 Port_Import_N104 4752
//float4 Port_Import_N105 4768
//float Port_Input0_N117 4784
//float Port_Input1_N117 4788
//float Port_RangeMinA_N106 4792
//float Port_RangeMaxA_N106 4796
//float Port_RangeMinB_N106 4800
//float Port_RangeMaxB_N106 4804
//float2 Port_Import_N107 4808
//float2 Port_Center_N108 4816
//float2 Port_Import_N109 4824
//float2 Port_Import_N111 4832
//float Port_Input1_N116 4840
//float Port_Input2_N116 4844
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_baseTex2 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex2 35 0
...
//spec_const bool baseTex2HasSwappedViews 40 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex2 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex2 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 75 -1
//spec_const int baseTex2Layout 76 0
...
constant bool SC_USE_UV_MIN_MAX_baseTex2 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_baseTex2 [[function_constant(35)]];
...
constant bool baseTex2HasSwappedViews [[function_constant(40)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTex2 [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_baseTex2 [[function_constant(74)]];
...
constant int baseTex2Layout [[function_constant(76)]];
...
int l9_72=l9_67;
int l9_73=baseTex2Layout_tmp;
int l9_74=l9_72;
float2 l9_75=l9_66;
bool l9_76=(int(SC_USE_UV_TRANSFORM_baseTex2_tmp)!=0);
float3x3 l9_77=(*sc_set0.UserUniforms).baseTex2Transform;
int2 l9_78=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex2_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex2_tmp);
bool l9_79=(int(SC_USE_UV_MIN_MAX_baseTex2_tmp)!=0);
float4 l9_80=(*sc_set0.UserUniforms).baseTex2UvMinMax;
bool l9_81=(int(SC_USE_CLAMP_TO_BORDER_baseTex2_tmp)!=0);
float4 l9_82=(*sc_set0.UserUniforms).baseTex2BorderColor;
float l9_83=0.0;
...
float4 l9_150=sc_set0.baseTex2.sample(sc_set0.baseTex2SmpSC,l9_149.xy,bias(l9_143));
...
l9_65=l9_153;
float l9_154=0.0;
float l9_155=(*sc_set0.UserUniforms).state;
l9_154=l9_155;
float4 l9_156=float4(0.0);
l9_156=mix(l9_65,(*sc_set0.UserUniforms).Port_Input1_N034,float4(l9_154));
float4 l9_157=float4(0.0);
float4 l9_158=(*sc_set0.UserUniforms).baseColor;
l9_157=l9_158;
float4 l9_159=float4(0.0);
l9_159=l9_156*l9_157;
l9_59=l9_159;
l9_62=l9_59;
}
else
...
float4 l9_161=(*sc_set0.UserUniforms).baseColor;
l9_160=l9_161;
l9_60=l9_160;
l9_62=l9_60;
}
...
l9_162=float4(l9_57)*l9_58;
float4 l9_163=float4(0.0);
float4 l9_164=(*sc_set0.UserUniforms).strokeColor;
l9_163=l9_164;
float l9_165=0.0;
l9_165=smoothstep((*sc_set0.UserUniforms).Port_Input0_N038,(*sc_set0.UserUniforms).Port_Input1_N038,l9_51);
float l9_166=0.0;
float l9_167=(*sc_set0.UserUniforms).strokeThickness;
l9_166=l9_167;
float l9_168=0.0;
l9_168=l9_0+l9_166;
float l9_169=0.0;
l9_169=smoothstep(l9_168,l9_166,l9_51);
float l9_170=0.0;
l9_170=l9_165*l9_169;
float l9_171=0.0;
float l9_172=l9_170;
float l9_173=l9_172;
bool l9_174=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_175;
if (l9_174)
{
l9_175=!PreviewInfo.Saved;
}
else
{
l9_175=l9_174;
...
if (l9_175)
{
l9_176=27==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_176=l9_175;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=float4(l9_173,l9_173,l9_173,1.0);
PreviewInfo.Color.w=1.0;
}
l9_171=l9_173;
float4 l9_177=float4(0.0);
l9_177=mix(l9_162,l9_163,float4(l9_171));
param=l9_177;
param_2=param;
}
else
{
float l9_178=0.0;
float l9_179=(*sc_set0.UserUniforms).Port_Value_N061;
float l9_180=l9_179+0.001;
l9_180-=0.001;
l9_178=l9_180;
float2 l9_181=float2(0.0);
l9_181=param_3.Surface_UVCoord0;
float2 l9_182=float2(0.0);
l9_182=((l9_181-(*sc_set0.UserUniforms).Port_Center_N013)*(*sc_set0.UserUniforms).Port_Scale_N013)+(*sc_set0.UserUniforms).Port_Center_N013;
float2 l9_183=float2(0.0);
float2 l9_184=float2(0.0);
float2 l9_185=(*sc_set0.UserUniforms).Port_Default_N040;
float2 l9_186;
if ((int(Tweak_N65_tmp)!=0))
{
float2 l9_187=float2(0.0);
float2 l9_188=(*sc_set0.UserUniforms).baseTexSize.xy;
l9_187=l9_188;
float2 l9_189=float2(0.0);
float l9_190=0.0;
float l9_191=0.0;
float2 l9_192=l9_187;
float2 l9_193=float2(l9_192);
float l9_194=l9_192.x;
float l9_195=l9_192.y;
l9_189=l9_193;
l9_190=l9_194;
l9_191=l9_195;
float l9_196=0.0;
l9_196=fast::min(l9_190,l9_191);
float2 l9_197=float2(0.0);
l9_197=l9_189/(float2(l9_196)+float2(1.234e-06));
l9_184=l9_197;
l9_186=l9_184;
}
else
...
l9_198=l9_182*l9_183;
float2 l9_199=float2(0.0);
l9_199=l9_198;
float2 l9_200=float2(0.0);
float2 l9_201=(*sc_set0.UserUniforms).Port_Value_N002;
float2 l9_202=l9_201+float2(0.001);
l9_202-=float2(0.001);
l9_200=l9_202;
float2 l9_203=float2(0.0);
l9_203=l9_200*l9_183;
float2 l9_204=float2(0.0);
l9_204=l9_203;
float2 l9_205=float2(0.0);
l9_205=l9_199-l9_204;
float2 l9_206=float2(0.0);
l9_206=abs(l9_205);
float2 l9_207=float2(0.0);
float2 l9_208=(*sc_set0.UserUniforms).boxBounds;
l9_207=l9_208;
float2 l9_209=float2(0.0);
l9_209=fast::clamp(l9_207,(*sc_set0.UserUniforms).Port_Input1_N089,(*sc_set0.UserUniforms).Port_Input2_N089);
float2 l9_210=float2(0.0);
l9_210=float2((*sc_set0.UserUniforms).Port_Input0_N036)/(l9_183+float2(1.234e-06));
float l9_211=0.0;
float l9_212=(*sc_set0.UserUniforms).cornerRadius;
l9_211=l9_212;
float2 l9_213=float2(0.0);
l9_213=l9_210*float2(l9_211);
float2 l9_214=float2(0.0);
l9_214=l9_209-l9_213;
float2 l9_215=float2(0.0);
l9_215=l9_214*l9_183;
float2 l9_216=float2(0.0);
l9_216=l9_215;
float2 l9_217=float2(0.0);
l9_217=l9_206-l9_216;
float2 l9_218=float2(0.0);
float2 l9_219=l9_217;
float2 l9_220=l9_219;
bool l9_221=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_222;
if (l9_221)
{
l9_222=!PreviewInfo.Saved;
}
else
{
l9_222=l9_221;
...
if (l9_222)
{
l9_223=8==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_223=l9_222;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=float4(l9_220,0.0,1.0);
PreviewInfo.Color.w=1.0;
}
l9_218=l9_220;
float2 l9_224=float2(0.0);
l9_224=fast::max(l9_218,(*sc_set0.UserUniforms).Port_Input1_N028);
float l9_225=0.0;
l9_225=length(l9_224);
float l9_226=0.0;
l9_226=l9_211;
float l9_227=0.0;
l9_227=l9_225-l9_226;
float l9_228=0.0;
l9_228=l9_227;
float l9_229=0.0;
float l9_230=l9_228;
float l9_231=l9_230;
bool l9_232=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_233;
if (l9_232)
{
l9_233=!PreviewInfo.Saved;
}
else
{
l9_233=l9_232;
...
if (l9_233)
{
l9_234=10==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_234=l9_233;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=float4(l9_231,l9_231,l9_231,1.0);
PreviewInfo.Color.w=1.0;
}
l9_229=l9_231;
float l9_235=0.0;
l9_235=smoothstep(l9_178,(*sc_set0.UserUniforms).Port_Input1_N023,l9_229);
float4 l9_236=float4(0.0);
float4 l9_237=float4(0.0);
float4 l9_238=float4(0.0);
ssGlobals l9_239=param_3;
float4 l9_240;
if ((int(Tweak_N65_tmp)!=0))
{
...
l9_242=((l9_241-(*sc_set0.UserUniforms).Port_Center_N013)*(*sc_set0.UserUniforms).Port_Scale_N013)+(*sc_set0.UserUniforms).Port_Center_N013;
float4 l9_243=float4(0.0);
float2 l9_244=l9_242;
int l9_245;
if ((int(baseTex2HasSwappedViews_tmp)!=0))
{
int l9_246=0;
...
int l9_250=l9_245;
int l9_251=baseTex2Layout_tmp;
int l9_252=l9_250;
float2 l9_253=l9_244;
bool l9_254=(int(SC_USE_UV_TRANSFORM_baseTex2_tmp)!=0);
float3x3 l9_255=(*sc_set0.UserUniforms).baseTex2Transform;
int2 l9_256=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex2_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex2_tmp);
bool l9_257=(int(SC_USE_UV_MIN_MAX_baseTex2_tmp)!=0);
float4 l9_258=(*sc_set0.UserUniforms).baseTex2UvMinMax;
bool l9_259=(int(SC_USE_CLAMP_TO_BORDER_baseTex2_tmp)!=0);
float4 l9_260=(*sc_set0.UserUniforms).baseTex2BorderColor;
float l9_261=0.0;
...
float4 l9_328=sc_set0.baseTex2.sample(sc_set0.baseTex2SmpSC,l9_327.xy,bias(l9_321));
...
l9_243=l9_331;
float l9_332=0.0;
float l9_333=(*sc_set0.UserUniforms).state;
l9_332=l9_333;
float4 l9_334=float4(0.0);
l9_334=mix(l9_243,(*sc_set0.UserUniforms).Port_Input1_N034,float4(l9_332));
float4 l9_335=float4(0.0);
float4 l9_336=(*sc_set0.UserUniforms).baseColor;
l9_335=l9_336;
float4 l9_337=float4(0.0);
l9_337=l9_334*l9_335;
l9_237=l9_337;
l9_240=l9_237;
}
else
...
float4 l9_339=(*sc_set0.UserUniforms).baseColor;
l9_338=l9_339;
l9_238=l9_338;
l9_240=l9_238;
}

...
//}
//ubo int UserUniforms 0:26:4656 {
//float4 sc_Time 1376
...
//float Port_Value_N057 4416
//float3 Port_Input2_N052 4432
//float Port_Value_N061 4448
//float Port_Input1_N023 4452
//float2 Port_Scale_N013 4456
//float2 Port_Center_N013 4464
//float2 Port_Default_N040 4472
//float2 Port_Value_N002 4488
//float2 Port_Input1_N089 4504
//float2 Port_Input2_N089 4512
//float Port_Input0_N036 4520
//float2 Port_Input1_N028 4536
//float4 Port_Import_N104 4560
//float4 Port_Import_N105 4576
//float Port_Input0_N117 4592
//float Port_Input1_N117 4596
//float Port_RangeMinA_N106 4600
//float Port_RangeMaxA_N106 4604
//float Port_RangeMinB_N106 4608
//float Port_RangeMaxB_N106 4612
//float2 Port_Import_N107 4616
//float2 Port_Center_N108 4624
//float2 Port_Import_N109 4632
//float2 Port_Import_N111 4640
//float Port_Input1_N116 4648
//float Port_Input2_N116 4652
//}
...
constant bool baseTexHasSwappedViews [[function_constant(39)]];
...
float2 param_3=(*sc_set0.UserUniforms).Port_Default_N040;
float2 param_4;
if ((int(Tweak_N65_tmp)!=0))
{
float2 l9_0=float2(0.0);
float2 l9_1=(*sc_set0.UserUniforms).baseTexSize.xy;
l9_0=l9_1;
float2 l9_2=float2(0.0);
float l9_3=0.0;
float l9_4=0.0;
float2 l9_5=l9_0;
float2 l9_6=float2(l9_5);
float l9_7=l9_5.x;
float l9_8=l9_5.y;
l9_2=l9_6;
l9_3=l9_7;
l9_4=l9_8;
float l9_9=0.0;
l9_9=fast::min(l9_3,l9_4);
float2 l9_10=float2(0.0);
l9_10=l9_2/(float2(l9_9)+float2(1.234e-06));
param_2=l9_10;
param_4=param_2;
}
else
...
float2 param_5=(*sc_set0.UserUniforms).Port_Value_N002;
float2 param_6=param_5+float2(0.001);
param_6-=float2(0.001);
Output_N2=param_6;
...
float2 param_7=(*sc_set0.UserUniforms).boxBounds;
Output_N15=param_7;
...
float2 param_10=param_9;
bool l9_11=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_12;
if (l9_11)
{
l9_12=!PreviewInfo.Saved;
}
else
{
l9_12=l9_11;
...
if (l9_12)
{
l9_13=8==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_13=l9_12;
...
PreviewInfo.Color=float4(param_10,0.0,1.0);
...
float param_11=Export_N24;
float param_12=param_11;
...
if (l9_15)
{
l9_16=10==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_16=l9_15;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=float4(param_12,param_12,param_12,1.0);
PreviewInfo.Color.w=1.0;
}
Output_N10=param_12;
...
l9_17=param_16.Surface_UVCoord0;
float2 l9_18=float2(0.0);
l9_18=((l9_17-(*sc_set0.UserUniforms).Port_Center_N013)*(*sc_set0.UserUniforms).Port_Scale_N013)+(*sc_set0.UserUniforms).Port_Center_N013;
...
Value_N91=float4(Output_N48.xyz.x,Output_N48.xyz.y,Output_N48.xyz.z,Value_N91.w);
...
{
l9_118=fast::clamp(l9_117.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_118=fast::clamp(dot(l9_117.xyz,float3(l9_117.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_118=(1.0-dot(l9_117.xyz,float3(0.33333001)))*l9_117.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_118=(1.0-fast::clamp(dot(l9_117.xyz,float3(1.0)),0.0,1.0))*l9_117.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_118=fast::clamp(dot(l9_117.xyz,float3(1.0)),0.0,1.0)*l9_117.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_118=fast::clamp(dot(l9_117.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_118=dot(l9_117.xyz,float3(0.33333001))*l9_117.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_118=1.0-fast::clamp(dot(l9_117.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_119=l9_118;
float l9_120=l9_119;
float l9_121=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_120;
float3 l9_122=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_116.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_123=float4(l9_122.x,l9_122.y,l9_122.z,l9_121);
param_18=l9_123;
}
else
{
...
{
float4 l9_124=param_18;
float4 l9_125=float4(0.0);
float4 l9_126=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_127=out.sc_FragData0;
l9_126=l9_127;
}
else
{
float4 l9_128=gl_FragCoord;
float2 l9_129=l9_128.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_134=l9_133;
int l9_135=l9_134;
float3 l9_136=float3(l9_130,0.0);
int l9_137=l9_132;
int l9_138=l9_135;
if (l9_137==1)
{
l9_136.y=((2.0*l9_136.y)+float(l9_138))-1.0;
}
float2 l9_139=l9_136.xy;
l9_131=l9_139;
}
else
{
...
int l9_152=sc_ScreenTextureLayout_tmp;
int l9_153=l9_150;
float l9_154=l9_144;
...
float4 l9_161=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_160.xy,bias(l9_154));
float4 l9_162=l9_161;
float4 l9_163=l9_162;
l9_126=l9_163;
}
float4 l9_164=l9_126;
float3 l9_165=l9_164.xyz;
float3 l9_166=l9_165;
float3 l9_167=l9_124.xyz;
float3 l9_168=definedBlend(l9_166,l9_167,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_125=float4(l9_168.x,l9_168.y,l9_168.z,l9_125.w);
float3 l9_169=mix(l9_165,l9_125.xyz,float3(l9_124.w));
l9_125=float4(l9_169.x,l9_169.y,l9_169.z,l9_125.w);
l9_125.w=1.0;
float4 l9_170=l9_125;
param_18=l9_170;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_171=float4(in.varScreenPos.xyz,1.0);
param_18=l9_171;
}
else
{
...
float l9_173=fast::clamp(abs(l9_172.z),0.0,1.0);
float4 l9_174=float4(l9_173,1.0-l9_173,1.0,1.0);
param_18=l9_174;
}
else
{
float4 l9_175=param_18;
float4 l9_176=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_176=float4(mix(float3(1.0),l9_175.xyz,float3(l9_175.w)),l9_175.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_177=l9_175.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_177=fast::clamp(l9_177,0.0,1.0);
}
l9_176=float4(l9_175.xyz*l9_177,l9_177);
}
else
{
l9_176=l9_175;
...
float4 l9_182=param_20;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_182.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_182;
return out;
}
} // FRAGMENT SHADER

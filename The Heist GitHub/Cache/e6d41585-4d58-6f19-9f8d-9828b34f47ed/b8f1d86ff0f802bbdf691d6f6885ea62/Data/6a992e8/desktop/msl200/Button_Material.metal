...
//float4 Port_Input1_N034 4576
//float Port_Input0_N038 4592
//float Port_Input1_N038 4596
//float4 Port_Import_N104 4608
//float4 Port_Import_N105 4624
//float Port_Input0_N117 4640
//float Port_Input1_N117 4644
//float Port_RangeMinA_N106 4648
//float Port_RangeMaxA_N106 4652
//float Port_RangeMinB_N106 4656
//float Port_RangeMaxB_N106 4660
//float2 Port_Import_N107 4664
//float2 Port_Center_N108 4672
//float2 Port_Import_N109 4680
//float2 Port_Import_N111 4688
//float Port_Input1_N116 4696
//float Port_Input2_N116 4700
//}
...
int l9_250=l9_245;
int l9_251=baseTexLayout_tmp;
int l9_252=l9_250;
float2 l9_253=l9_244;
bool l9_254=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_255=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_256=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_257=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_258=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_259=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_260=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_261=0.0;
...
float4 l9_328=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_327.xy,bias(l9_321));

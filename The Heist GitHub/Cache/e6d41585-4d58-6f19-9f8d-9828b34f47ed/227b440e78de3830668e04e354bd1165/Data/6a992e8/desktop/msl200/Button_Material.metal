...
{
float4 l9_335=gl_FragCoord;
float2 l9_336=floor(mod(l9_335.xy,float2(4.0)));
float l9_337=(mod(dot(l9_336,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_7<l9_337)
{
discard_fragment();
}

...
constant bool Tweak_N65 [[function_constant(40)]];
...
constant bool baseTex2HasSwappedViews [[function_constant(43)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTex2 [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_baseTex2 [[function_constant(79)]];
...
constant int baseTex2Layout [[function_constant(82)]];
...
int l9_161=l9_156;
int l9_162=baseTexLayout_tmp;
int l9_163=l9_161;
float2 l9_164=l9_155;
bool l9_165=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_166=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_167=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_168=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_169=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_170=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_171=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_172=0.0;
...
float4 l9_239=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_238.xy,bias(l9_232));
...
int l9_339=l9_334;
int l9_340=baseTex2Layout_tmp;
int l9_341=l9_339;
float2 l9_342=l9_333;
bool l9_343=(int(SC_USE_UV_TRANSFORM_baseTex2_tmp)!=0);
float3x3 l9_344=(*sc_set0.UserUniforms).baseTex2Transform;
int2 l9_345=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex2_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex2_tmp);
bool l9_346=(int(SC_USE_UV_MIN_MAX_baseTex2_tmp)!=0);
float4 l9_347=(*sc_set0.UserUniforms).baseTex2UvMinMax;
bool l9_348=(int(SC_USE_CLAMP_TO_BORDER_baseTex2_tmp)!=0);
float4 l9_349=(*sc_set0.UserUniforms).baseTex2BorderColor;
float l9_350=0.0;
...
float4 l9_417=sc_set0.baseTex2.sample(sc_set0.baseTex2SmpSC,l9_416.xy,bias(l9_410));
...
int l9_428=l9_423;
int l9_429=baseTexLayout_tmp;
int l9_430=l9_428;
float2 l9_431=l9_422;
bool l9_432=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_433=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_434=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_435=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_436=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_437=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_438=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_439=0.0;
...
float4 l9_506=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_505.xy,bias(l9_499));
...
{
float4 l9_519=gl_FragCoord;
float2 l9_520=floor(mod(l9_519.xy,float2(4.0)));
float l9_521=(mod(dot(l9_520,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_7<l9_521)
{
discard_fragment();
}
...
{
l9_524=fast::clamp(l9_523.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_524=fast::clamp(dot(l9_523.xyz,float3(l9_523.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_524=(1.0-dot(l9_523.xyz,float3(0.33333001)))*l9_523.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_524=(1.0-fast::clamp(dot(l9_523.xyz,float3(1.0)),0.0,1.0))*l9_523.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_524=fast::clamp(dot(l9_523.xyz,float3(1.0)),0.0,1.0)*l9_523.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_524=fast::clamp(dot(l9_523.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_524=dot(l9_523.xyz,float3(0.33333001))*l9_523.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_524=1.0-fast::clamp(dot(l9_523.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_525=l9_524;
float l9_526=l9_525;
float l9_527=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_526;
float3 l9_528=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_522.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_529=float4(l9_528.x,l9_528.y,l9_528.z,l9_527);
param_8=l9_529;
}
else
{
...
{
float4 l9_530=param_8;
float4 l9_531=float4(0.0);
float4 l9_532=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_533=out.sc_FragData0;
l9_532=l9_533;
}
else
{
float4 l9_534=gl_FragCoord;
float2 l9_535=l9_534.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_540=l9_539;
int l9_541=l9_540;
float3 l9_542=float3(l9_536,0.0);
int l9_543=l9_538;
int l9_544=l9_541;
if (l9_543==1)
{
l9_542.y=((2.0*l9_542.y)+float(l9_544))-1.0;
}
float2 l9_545=l9_542.xy;
l9_537=l9_545;
}
else
{
...
int l9_556=l9_551;
float2 l9_557=l9_549;
int l9_558=sc_ScreenTextureLayout_tmp;
int l9_559=l9_556;
float l9_560=l9_550;
...
float4 l9_567=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_566.xy,bias(l9_560));
float4 l9_568=l9_567;
float4 l9_569=l9_568;
l9_532=l9_569;
}
float4 l9_570=l9_532;
float3 l9_571=l9_570.xyz;
float3 l9_572=l9_571;
float3 l9_573=l9_530.xyz;
float3 l9_574=definedBlend(l9_572,l9_573,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_531=float4(l9_574.x,l9_574.y,l9_574.z,l9_531.w);
float3 l9_575=mix(l9_571,l9_531.xyz,float3(l9_530.w));
l9_531=float4(l9_575.x,l9_575.y,l9_575.z,l9_531.w);
l9_531.w=1.0;
float4 l9_576=l9_531;
param_8=l9_576;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_577=float4(in.varScreenPos.xyz,1.0);
param_8=l9_577;
}
else
{
...
float l9_579=fast::clamp(abs(l9_578.z),0.0,1.0);
float4 l9_580=float4(l9_579,1.0-l9_579,1.0,1.0);
param_8=l9_580;
}
else
{
float4 l9_581=param_8;
float4 l9_582=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_582=float4(mix(float3(1.0),l9_581.xyz,float3(l9_581.w)),l9_581.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_583=l9_581.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_583=fast::clamp(l9_583,0.0,1.0);
}
l9_582=float4(l9_581.xyz*l9_583,l9_583);
}
else
{
l9_582=l9_581;
...
float4 l9_588=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_588.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_588;
return out;
}
} // FRAGMENT SHADER

  ...
  private encodeTexture(texture: Texture): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        ...
        } else if ((Base64 as {encodeTexture?: (t: Texture, q: number, e: number) => string}).encodeTexture) {
          const syncEncode = (Base64 as {encodeTexture: (t: Texture, q: number, e: number) => string}).encodeTexture

...
// @input float targetStreamFps = 10 {"hint":"Frames per second drained from buffer and sent over realtime (keep low for 250KB limit)."}
// @input float maxFrameBuffer = 3 {"hint":"Max encoded frames queued before dropping oldest (live AR keeps newest)."}
// @input float maxEncodeFps = 15 {"hint":"Max encode starts per second in onNewFrame (independent of send FPS)."}

...
type CameraAccessHandlerApi = ScriptComponent & {
  startStreaming?: (options: Record<string, unknown>) => void
  stopStreaming?: () => void
}
...
export class CoopNetworkController extends BaseScriptComponent {
  ...
  @input
  @allowUndefined
  @hint("Camera Access Handler on this object or elsewhere — encodes glasses feed for spectators.")

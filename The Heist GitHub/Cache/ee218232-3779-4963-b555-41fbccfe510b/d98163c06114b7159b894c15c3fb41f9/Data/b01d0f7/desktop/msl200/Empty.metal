...
//float Tweak_N11 4768
//float Port_Exponent_N005 4772
//float Port_Intensity_N005 4776
//float Port_Opacity_N000 4780
//float3 Port_Emissive_N000 4800
//float Port_Roughness_N000 4816
...
float param_5=(*sc_set0.UserUniforms).Tweak_N11;
Output_N11=param_5;
float4 Output_N0=float4(0.0);
float3 param_6=Output_N8.xyz;
float param_7=(*sc_set0.UserUniforms).Port_Opacity_N000;
float3 param_8=(*sc_set0.UserUniforms).Port_Emissive_N000;
float param_9=Output_N11;
float param_10=(*sc_set0.UserUniforms).Port_Roughness_N000;
float3 param_11=(*sc_set0.UserUniforms).Port_AO_N000;
float3 param_12=(*sc_set0.UserUniforms).Port_SpecularAO_N000;
ssGlobals param_14=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_14.BumpedNormal=param_14.VertexNormal_WorldSpace;
}
float l9_187=param_7;
...
float4 l9_201=fast::max(param_15,float4(0.0));
float4 param_16=l9_201;
if (sc_ShaderCacheConstant_tmp!=0)
{

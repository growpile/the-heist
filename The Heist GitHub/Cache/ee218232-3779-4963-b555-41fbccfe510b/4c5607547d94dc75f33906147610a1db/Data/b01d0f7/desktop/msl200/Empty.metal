...
l9_280=l9_193+(*sc_set0.UserUniforms).Port_Input1_N021;
...
float4 l9_283=float4(1.0);
float4 l9_284=float4(0.0);
ssGlobals l9_285=param_4;
float4 l9_286;
if ((int(enableRim_tmp)!=0))
{
float l9_287=0.0;
float l9_288=(*sc_set0.UserUniforms).Port_Exponent_N005;
float l9_289=(*sc_set0.UserUniforms).Port_Intensity_N005;
ssGlobals l9_290=l9_285;
float l9_291=abs(dot(-l9_290.ViewDirWS,l9_290.VertexNormal_WorldSpace));
float l9_292=pow(1.0-l9_291,l9_288);
l9_292=fast::max(l9_292,0.0);
l9_292*=l9_289;
l9_287=l9_292;
float4 l9_293=float4(0.0);
float4 l9_294=(*sc_set0.UserUniforms).rimColor;
l9_293=l9_294;
float4 l9_295=float4(0.0);
l9_295=float4(l9_287)*l9_293;
float2 l9_296=float2(0.0);
l9_296=l9_285.Surface_UVCoord0;
...
int l9_303=l9_298;
int l9_304=albedoTexLayout_tmp;
int l9_305=l9_303;
float2 l9_306=l9_296;
bool l9_307=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_308=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_309=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_310=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_311=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_312=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_313=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_314=0.0;
...
float4 l9_381=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_380.xy,bias(l9_374));
...
l9_385=l9_285.Surface_UVCoord0;
...
int l9_392=l9_387;
int l9_393=albedoTexLayout_tmp;
int l9_394=l9_392;
float2 l9_395=l9_385;
bool l9_396=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_397=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_398=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_399=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_400=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_401=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_402=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_403=0.0;
...
float4 l9_470=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_469.xy,bias(l9_463));
float4 l9_471=l9_470;
if (l9_401)
{
l9_471=mix(l9_402,l9_471,float4(l9_405));
}
...
l9_473=param_8.Surface_UVCoord0;
...
int l9_480=l9_475;
int l9_481=normalTexLayout_tmp;
int l9_482=l9_480;
float2 l9_483=l9_473;
bool l9_484=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_485=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_486=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_487=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_488=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_489=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_490=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_491=0.0;
...
float4 l9_558=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_557.xy,bias(l9_551));
...
float l9_561=param_12;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_561<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_562=gl_FragCoord;
float2 l9_563=floor(mod(l9_562.xy,float2(4.0)));
float l9_564=(mod(dot(l9_563,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_561<l9_564)
{
discard_fragment();
}
...
float4 l9_575=fast::max(param_21,float4(0.0));
float4 param_22=l9_575;
if (sc_ShaderCacheConstant_tmp!=0)
{

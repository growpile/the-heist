...
//float3 Port_Normal_N005 4640
//float Port_Exponent_N005 4656
//float Port_Intensity_N005 4660
//float4 Port_Input1_N010 4672
//float4 Port_Input2_N008 4688
//float Port_Opacity_N000 4704
//float3 Port_Emissive_N000 4736
//float Port_Metallic_N000 4752
//float Port_Roughness_N000 4756
//float3 Port_AO_N000 4768
//float3 Port_SpecularAO_N000 4784
//float depthRef 4800
//}
...
//spec_const bool enableRim 35 0
...
constant bool enableRim [[function_constant(35)]];
...
l9_11=l9_10+(*sc_set0.UserUniforms).Port_Input1_N010;
param_1=l9_11;
param_3=param_1;
}
else
...
float4 l9_26=fast::max(param_14,float4(0.0));
float4 param_15=l9_26;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_30=l9_29;
float l9_31=l9_30;
float l9_32=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_31;
float3 l9_33=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_27.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
float4 l9_35=param_16;
float4 l9_36=float4(0.0);
float4 l9_37=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_38=out.sc_FragData0;
l9_37=l9_38;
}
else
{
...
l9_36=float4(l9_79.x,l9_79.y,l9_79.z,l9_36.w);
float3 l9_80=mix(l9_76,l9_36.xyz,float3(l9_35.w));
l9_36=float4(l9_80.x,l9_80.y,l9_80.z,l9_36.w);
l9_36.w=1.0;
float4 l9_81=l9_36;
param_16=l9_81;
}

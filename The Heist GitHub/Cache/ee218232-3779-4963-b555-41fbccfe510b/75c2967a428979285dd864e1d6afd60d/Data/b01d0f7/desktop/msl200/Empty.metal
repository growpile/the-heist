...
float4 l9_105=float4(1.0);
float4 l9_106=float4(0.0);
ssGlobals l9_107=l9_4;
float4 l9_108;
...
int l9_116=l9_111;
int l9_117=albedoTexLayout_tmp;
int l9_118=l9_116;
float2 l9_119=l9_109;
bool l9_120=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_121=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_122=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_123=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_124=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_125=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_126=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_127=0.0;
...
float4 l9_194=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_193.xy,bias(l9_187));
float4 l9_195=l9_194;
if (l9_125)
{
l9_195=mix(l9_126,l9_195,float4(l9_129));
}
...
float4 l9_198=(*sc_set0.UserUniforms).baseColor;
l9_197=l9_198;
l9_106=l9_197;
l9_108=l9_106;
}
...
l9_305=l9_294.Surface_UVCoord0;
...
int l9_312=l9_307;
int l9_313=albedoTexLayout_tmp;
int l9_314=l9_312;
float2 l9_315=l9_305;
bool l9_316=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_317=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_318=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_319=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_320=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_321=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_322=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_323=0.0;
...
float4 l9_390=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_389.xy,bias(l9_383));
...
float4 l9_395=float4(1.0);
float4 l9_396=float4(0.0);
ssGlobals l9_397=l9_294;
float4 l9_398;
if ((int(enableAlbedo_tmp)!=0))
{
...
int l9_406=l9_401;
int l9_407=albedoTexLayout_tmp;
int l9_408=l9_406;
float2 l9_409=l9_399;
bool l9_410=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_411=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_412=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_413=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_414=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_415=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_416=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_417=0.0;
...
float4 l9_484=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_483.xy,bias(l9_477));

...
//float3 Port_Albedo_N000 4640
//float Port_Opacity_N000 4656
//float3 Port_Emissive_N000 4688
//float3 Port_AO_N000 4704
//float3 Port_SpecularAO_N000 4720
//float depthRef 4736
//}
...
float param_1=(*sc_set0.UserUniforms).metallic;
Output_N11=param_1;
float Output_N12=0.0;
float param_2=(*sc_set0.UserUniforms).roughness;
Output_N12=param_2;
float4 Output_N0=float4(0.0);
float3 param_3=(*sc_set0.UserUniforms).Port_Albedo_N000;
float param_4=(*sc_set0.UserUniforms).Port_Opacity_N000;
float3 param_5=(*sc_set0.UserUniforms).Port_Emissive_N000;
float param_6=Output_N11;
float param_7=Output_N12;
float3 param_8=(*sc_set0.UserUniforms).Port_AO_N000;
float3 param_9=(*sc_set0.UserUniforms).Port_SpecularAO_N000;
...
float4 l9_15=fast::max(param_12,float4(0.0));
float4 param_13=l9_15;
if (sc_ShaderCacheConstant_tmp!=0)
{

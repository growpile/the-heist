...
//sampler sampler Tweak_N2SmpSC 0:25
...
//texture texture2D Tweak_N2 0:4:0:25
...
//float3x3 Tweak_N2Transform 4688
//float4 Tweak_N2UvMinMax 4736
//float4 Tweak_N2BorderColor 4752
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 82 -1
...
//spec_const int Tweak_N2Layout 86 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 [[function_constant(82)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 [[function_constant(84)]];
...
constant int Tweak_N2Layout [[function_constant(86)]];
...
int l9_17=l9_12;
int l9_18=Tweak_N2Layout_tmp;
int l9_19=l9_17;
float2 l9_20=l9_10;
bool l9_21=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 l9_22=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 l9_23=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool l9_24=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 l9_25=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool l9_26=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 l9_27=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float l9_28=0.0;
...
float3 l9_93=l9_92;
float3 l9_94=l9_93;
float4 l9_95=sc_set0.Tweak_N2.sample(sc_set0.Tweak_N2SmpSC,l9_94.xy,bias(l9_88));
float4 l9_96=l9_95;
if (l9_26)
{
...
int l9_106=l9_101;
int l9_107=Tweak_N2Layout_tmp;
int l9_108=l9_106;
float2 l9_109=l9_99;
bool l9_110=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 l9_111=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 l9_112=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool l9_113=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 l9_114=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool l9_115=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 l9_116=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float l9_117=0.0;
...
float3 l9_183=l9_182;
float4 l9_184=sc_set0.Tweak_N2.sample(sc_set0.Tweak_N2SmpSC,l9_183.xy,bias(l9_177));
float4 l9_185=l9_184;
if (l9_115)
{

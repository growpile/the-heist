...
//float3 Port_Normal_N005 4768
//float Port_Exponent_N005 4784
//float Port_Intensity_N005 4788
//float Port_Opacity_N000 4792
//float3 Port_Emissive_N000 4816
//float Port_Metallic_N000 4832
//float Port_Roughness_N000 4836
...
{
float l9_1=0.0;
float3 l9_2=(*sc_set0.UserUniforms).Port_Normal_N005;
float l9_3=(*sc_set0.UserUniforms).Port_Exponent_N005;
float l9_4=(*sc_set0.UserUniforms).Port_Intensity_N005;
ssGlobals l9_5=param_4;
l9_2=float3x3(float3(l9_5.VertexTangent_WorldSpace),float3(l9_5.VertexBinormal_WorldSpace),float3(l9_5.VertexNormal_WorldSpace))*l9_2;
float l9_6=abs(dot(-l9_5.ViewDirWS,l9_2));
float l9_7=pow(1.0-l9_6,l9_3);
l9_7=fast::max(l9_7,0.0);
l9_7*=l9_4;
l9_1=l9_7;
float4 l9_8=float4(0.0);
float4 l9_9=(*sc_set0.UserUniforms).rimColor;
l9_8=l9_9;
float4 l9_10=float4(0.0);
l9_10=float4(l9_1)*l9_8;
float2 l9_11=float2(0.0);
l9_11=param_4.Surface_UVCoord0;
...
int l9_18=l9_13;
int l9_19=Tweak_N2Layout_tmp;
int l9_20=l9_18;
float2 l9_21=l9_11;
bool l9_22=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 l9_23=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 l9_24=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool l9_25=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 l9_26=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 l9_28=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float l9_29=0.0;
...
float3 l9_94=l9_93;
float3 l9_95=l9_94;
float4 l9_96=sc_set0.Tweak_N2.sample(sc_set0.Tweak_N2SmpSC,l9_95.xy,bias(l9_89));
float4 l9_97=l9_96;
if (l9_27)
{
...
l9_100=param_4.Surface_UVCoord0;
...
int l9_107=l9_102;
int l9_108=Tweak_N2Layout_tmp;
int l9_109=l9_107;
float2 l9_110=l9_100;
bool l9_111=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 l9_112=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 l9_113=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool l9_114=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 l9_115=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool l9_116=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 l9_117=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float l9_118=0.0;
...
float4 l9_185=sc_set0.Tweak_N2.sample(sc_set0.Tweak_N2SmpSC,l9_184.xy,bias(l9_178));
...
float l9_188=param_6;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_188<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_202=fast::max(param_14,float4(0.0));
float4 param_15=l9_202;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_211=param_16;
float4 l9_212=float4(0.0);
float4 l9_213=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_214=out.sc_FragData0;
l9_213=l9_214;
}
else
{
float4 l9_215=gl_FragCoord;
float2 l9_216=l9_215.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_221=l9_220;
int l9_222=l9_221;
float3 l9_223=float3(l9_217,0.0);
int l9_224=l9_219;
int l9_225=l9_222;
if (l9_224==1)
{
l9_223.y=((2.0*l9_223.y)+float(l9_225))-1.0;
}
float2 l9_226=l9_223.xy;
l9_218=l9_226;
}
else
{
...
int l9_237=l9_232;
float2 l9_238=l9_230;
int l9_239=sc_ScreenTextureLayout_tmp;
int l9_240=l9_237;
float l9_241=l9_231;
...
float4 l9_248=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_247.xy,bias(l9_241));
float4 l9_249=l9_248;
float4 l9_250=l9_249;
l9_213=l9_250;
}
float4 l9_251=l9_213;
float3 l9_252=l9_251.xyz;
float3 l9_253=l9_252;
float3 l9_254=l9_211.xyz;
...
l9_212=float4(l9_255.x,l9_255.y,l9_255.z,l9_212.w);
float3 l9_256=mix(l9_252,l9_212.xyz,float3(l9_211.w));
l9_212=float4(l9_256.x,l9_256.y,l9_256.z,l9_212.w);
l9_212.w=1.0;
float4 l9_257=l9_212;
param_16=l9_257;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_258=float4(in.varScreenPos.xyz,1.0);
param_16=l9_258;
}
else
{
...
float l9_260=fast::clamp(abs(l9_259.z),0.0,1.0);
float4 l9_261=float4(l9_260,1.0-l9_260,1.0,1.0);
param_16=l9_261;
}
else
{
float4 l9_262=param_16;

...
int l9_479=l9_474;
int l9_480=normalTexLayout_tmp;
int l9_481=l9_479;
float2 l9_482=l9_472;
bool l9_483=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_484=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_485=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_486=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_487=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_488=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_489=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_490=0.0;
...
float4 l9_557=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_556.xy,bias(l9_550));

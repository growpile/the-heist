...
//}
//ubo int UserUniforms 0:39:4928 {
...
//float4 Port_Input2_N008 4800
//float Port_Opacity_N000 4816
//float3 Port_Emissive_N000 4848
//float Port_Metallic_N000 4864
//float Port_Roughness_N000 4868
//float3 Port_AO_N000 4880
//float3 Port_SpecularAO_N000 4896
//float depthRef 4912
//}
...
float4 param_2=(*sc_set0.UserUniforms).Port_Input2_N008;
...
float l9_100=param_6;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_100<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_114=fast::max(param_14,float4(0.0));
float4 param_15=l9_114;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_126=out.sc_FragData0;
l9_125=l9_126;
}
else
{
float4 l9_127=gl_FragCoord;
float2 l9_128=l9_127.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_133=l9_132;
int l9_134=l9_133;
float3 l9_135=float3(l9_129,0.0);
int l9_136=l9_131;
int l9_137=l9_134;
if (l9_136==1)
{
l9_135.y=((2.0*l9_135.y)+float(l9_137))-1.0;
}
float2 l9_138=l9_135.xy;
l9_130=l9_138;
}
else
{
...
int l9_151=sc_ScreenTextureLayout_tmp;
int l9_152=l9_149;
float l9_153=l9_143;
...
float3 l9_159=l9_158;
float4 l9_160=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_159.xy,bias(l9_153));
float4 l9_161=l9_160;
float4 l9_162=l9_161;
l9_125=l9_162;
}
float4 l9_163=l9_125;
float3 l9_164=l9_163.xyz;
float3 l9_165=l9_164;
float3 l9_166=l9_123.xyz;
...
l9_124=float4(l9_167.x,l9_167.y,l9_167.z,l9_124.w);
float3 l9_168=mix(l9_164,l9_124.xyz,float3(l9_123.w));
l9_124=float4(l9_168.x,l9_168.y,l9_168.z,l9_124.w);
l9_124.w=1.0;
float4 l9_169=l9_124;
param_16=l9_169;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_170=float4(in.varScreenPos.xyz,1.0);
param_16=l9_170;
}
else
{
...
float l9_172=fast::clamp(abs(l9_171.z),0.0,1.0);
float4 l9_173=float4(l9_172,1.0-l9_172,1.0,1.0);
param_16=l9_173;
}
else
{
float4 l9_174=param_16;

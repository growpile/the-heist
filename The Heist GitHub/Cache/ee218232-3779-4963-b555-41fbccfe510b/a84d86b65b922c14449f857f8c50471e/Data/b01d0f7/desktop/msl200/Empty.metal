...
//sampler sampler albedoTexSmpSC 0:25
...
//texture texture2D albedoTex 0:4:0:25
...
//}
//ubo int UserUniforms 0:39:4880 {
...
//float Port_Exponent_N005 4768
//float Port_Intensity_N005 4772
//float Port_Opacity_N000 4776
//float3 Port_Emissive_N000 4800
//float Port_Metallic_N000 4816
//float Port_Roughness_N000 4820
//float3 Port_AO_N000 4832
//float3 Port_SpecularAO_N000 4848
//float depthRef 4864
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_albedoTex 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_albedoTex 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool UseViewSpaceDepthVariant 37 1
//spec_const bool albedoTexHasSwappedViews 38 0
//spec_const bool enableRim 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_albedoTex 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_albedoTex 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85 -1
//spec_const int albedoTexLayout 86 0
...
constant bool SC_USE_UV_MIN_MAX_albedoTex [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_albedoTex [[function_constant(35)]];
...
constant bool albedoTexHasSwappedViews [[function_constant(38)]];
...
constant bool enableRim [[function_constant(39)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_albedoTex [[function_constant(82)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_albedoTex [[function_constant(84)]];
...
constant int albedoTexLayout [[function_constant(86)]];
...
{
float l9_1=0.0;
float l9_2=(*sc_set0.UserUniforms).Port_Exponent_N005;
float l9_3=(*sc_set0.UserUniforms).Port_Intensity_N005;
ssGlobals l9_4=param_4;
float l9_5=abs(dot(-l9_4.ViewDirWS,l9_4.VertexNormal_WorldSpace));
float l9_6=pow(1.0-l9_5,l9_2);
l9_6=fast::max(l9_6,0.0);
l9_6*=l9_3;
l9_1=l9_6;
float4 l9_7=float4(0.0);
float4 l9_8=(*sc_set0.UserUniforms).rimColor;
l9_7=l9_8;
float4 l9_9=float4(0.0);
l9_9=float4(l9_1)*l9_7;
...
int l9_17=l9_12;
int l9_18=albedoTexLayout_tmp;
int l9_19=l9_17;
float2 l9_20=l9_10;
bool l9_21=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_22=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_23=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_24=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_25=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_26=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_27=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_28=0.0;
...
float3 l9_93=l9_92;
float3 l9_94=l9_93;
float4 l9_95=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_94.xy,bias(l9_88));
float4 l9_96=l9_95;
if (l9_26)
{
...
int l9_106=l9_101;
int l9_107=albedoTexLayout_tmp;
int l9_108=l9_106;
float2 l9_109=l9_99;
bool l9_110=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_111=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_112=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_113=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_114=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_115=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_116=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_117=0.0;
...
float3 l9_183=l9_182;
float4 l9_184=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_183.xy,bias(l9_177));
float4 l9_185=l9_184;
if (l9_115)
{
...
float3 param_5=Output_N8.xyz;
float param_6=(*sc_set0.UserUniforms).Port_Opacity_N000;
float3 param_7=(*sc_set0.UserUniforms).Port_Emissive_N000;
float param_8=(*sc_set0.UserUniforms).Port_Metallic_N000;
float param_9=(*sc_set0.UserUniforms).Port_Roughness_N000;
float3 param_10=(*sc_set0.UserUniforms).Port_AO_N000;
float3 param_11=(*sc_set0.UserUniforms).Port_SpecularAO_N000;
ssGlobals param_13=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_13.BumpedNormal=param_13.VertexNormal_WorldSpace;
}
float l9_187=param_6;
...
float4 l9_201=fast::max(param_14,float4(0.0));
float4 param_15=l9_201;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_204=fast::clamp(l9_203.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_204=fast::clamp(dot(l9_203.xyz,float3(l9_203.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_204=(1.0-dot(l9_203.xyz,float3(0.33333001)))*l9_203.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_204=(1.0-fast::clamp(dot(l9_203.xyz,float3(1.0)),0.0,1.0))*l9_203.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_204=fast::clamp(dot(l9_203.xyz,float3(1.0)),0.0,1.0)*l9_203.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_204=fast::clamp(dot(l9_203.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_204=dot(l9_203.xyz,float3(0.33333001))*l9_203.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_204=1.0-fast::clamp(dot(l9_203.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_205=l9_204;
float l9_206=l9_205;
float l9_207=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_206;
float3 l9_208=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_202.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_209=float4(l9_208.x,l9_208.y,l9_208.z,l9_207);
param_16=l9_209;
}
else
{
...
{
float4 l9_210=param_16;
float4 l9_211=float4(0.0);
float4 l9_212=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_213=out.sc_FragData0;
l9_212=l9_213;
}
else
{
float4 l9_214=gl_FragCoord;
float2 l9_215=l9_214.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_220=l9_219;
int l9_221=l9_220;
float3 l9_222=float3(l9_216,0.0);
int l9_223=l9_218;
int l9_224=l9_221;
if (l9_223==1)
{
l9_222.y=((2.0*l9_222.y)+float(l9_224))-1.0;
}
float2 l9_225=l9_222.xy;
l9_217=l9_225;
}
else
{
...
float4 l9_247=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_246.xy,bias(l9_240));
float4 l9_248=l9_247;
float4 l9_249=l9_248;
l9_212=l9_249;
}
float4 l9_250=l9_212;
float3 l9_251=l9_250.xyz;
float3 l9_252=l9_251;
float3 l9_253=l9_210.xyz;
...
l9_211=float4(l9_254.x,l9_254.y,l9_254.z,l9_211.w);
float3 l9_255=mix(l9_251,l9_211.xyz,float3(l9_210.w));
l9_211=float4(l9_255.x,l9_255.y,l9_255.z,l9_211.w);
l9_211.w=1.0;
float4 l9_256=l9_211;
param_16=l9_256;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_257=float4(in.varScreenPos.xyz,1.0);
param_16=l9_257;
}
else
{
...
float l9_259=fast::clamp(abs(l9_258.z),0.0,1.0);
float4 l9_260=float4(l9_259,1.0-l9_259,1.0,1.0);
param_16=l9_260;
}
else
{
float4 l9_261=param_16;

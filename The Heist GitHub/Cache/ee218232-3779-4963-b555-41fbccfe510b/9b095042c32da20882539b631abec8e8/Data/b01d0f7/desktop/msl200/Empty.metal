...
//float3x3 Tweak_N2Transform 4672
//float4 Tweak_N2UvMinMax 4720
//float4 Tweak_N2BorderColor 4736
//float2 Port_UVCoord_N001 4752
//float Port_Opacity_N000 4760
//float3 Port_Emissive_N000 4784
//float Port_Metallic_N000 4800
//float Port_Roughness_N000 4804
//float3 Port_AO_N000 4816
//float3 Port_SpecularAO_N000 4832
//float depthRef 4848
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 84 -1
//spec_const int Tweak_N2Layout 85 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 [[function_constant(81)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 [[function_constant(83)]];
...
constant int Tweak_N2Layout [[function_constant(85)]];
...
int l9_6=l9_1;
int param_1=Tweak_N2Layout_tmp;
int param_2=l9_6;
float2 param_3=(*sc_set0.UserUniforms).Port_UVCoord_N001;
bool param_4=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float param_11=0.0;
...
float3 param_12=Color_N1.xyz;
float param_13=(*sc_set0.UserUniforms).Port_Opacity_N000;
float3 param_14=(*sc_set0.UserUniforms).Port_Emissive_N000;
float param_15=(*sc_set0.UserUniforms).Port_Metallic_N000;
float param_16=(*sc_set0.UserUniforms).Port_Roughness_N000;
...
{
param_20.BumpedNormal=param_20.VertexNormal_WorldSpace;
}
float l9_76=param_13;
...
float4 l9_90=fast::max(param_21,float4(0.0));
float4 param_22=l9_90;
if (sc_ShaderCacheConstant_tmp!=0)
{

...
//}
//ubo int UserUniforms 0:43:5152 {
...
//float Port_Exponent_N005 5040
//float Port_Intensity_N005 5044
//float Port_Opacity_N000 5048
//float4 Port_Input2_N019 5056
//float3 Port_Emissive_N000 5072
//float Port_Metallic_N000 5088
//float Port_Roughness_N000 5092
//float3 Port_AO_N000 5104
//float3 Port_SpecularAO_N000 5120
//float depthRef 5136
//}
...
//spec_const bool enableNormals 47 0
//spec_const bool enableRim 48 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_albedoTex 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_aoTex 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_albedoTex 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_aoTex 97 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 98 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 99 -1
//spec_const int albedoTexLayout 100 0
//spec_const int aoTexLayout 101 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_albedoTex [[function_constant(92)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_aoTex [[function_constant(93)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_albedoTex [[function_constant(96)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_aoTex [[function_constant(97)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture [[function_constant(98)]];
...
l9_193=l9_279;
float l9_280=0.0;
float l9_281=(*sc_set0.UserUniforms).aoScale;
l9_280=l9_281;
float4 l9_282=float4(0.0);
l9_282=l9_193+float4(l9_280);
...
float4 l9_285=float4(1.0);
float4 l9_286=float4(0.0);
ssGlobals l9_287=param_4;
float4 l9_288;
if ((int(enableRim_tmp)!=0))
{
float l9_289=0.0;
float l9_290=(*sc_set0.UserUniforms).Port_Exponent_N005;
float l9_291=(*sc_set0.UserUniforms).Port_Intensity_N005;
ssGlobals l9_292=l9_287;
float l9_293=abs(dot(-l9_292.ViewDirWS,l9_292.VertexNormal_WorldSpace));
float l9_294=pow(1.0-l9_293,l9_290);
l9_294=fast::max(l9_294,0.0);
l9_294*=l9_291;
l9_289=l9_294;
float4 l9_295=float4(0.0);
float4 l9_296=(*sc_set0.UserUniforms).rimColor;
l9_295=l9_296;
float4 l9_297=float4(0.0);
l9_297=float4(l9_289)*l9_295;
float2 l9_298=float2(0.0);
l9_298=l9_287.Surface_UVCoord0;
...
int l9_305=l9_300;
int l9_306=albedoTexLayout_tmp;
int l9_307=l9_305;
float2 l9_308=l9_298;
bool l9_309=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_310=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_311=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_312=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_313=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_314=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_315=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_316=0.0;
...
float4 l9_383=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_382.xy,bias(l9_376));
float4 l9_384=l9_383;
if (l9_314)
{
l9_384=mix(l9_315,l9_384,float4(l9_318));
}
float4 l9_385=l9_384;
l9_299=l9_385;
float4 l9_386=float4(0.0);
l9_386=l9_297+l9_299;
l9_285=l9_386;
l9_288=l9_285;
}
else
...
l9_387=l9_287.Surface_UVCoord0;
...
int l9_394=l9_389;
int l9_395=albedoTexLayout_tmp;
int l9_396=l9_394;
float2 l9_397=l9_387;
bool l9_398=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 l9_399=(*sc_set0.UserUniforms).albedoTexTransform;
int2 l9_400=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool l9_401=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 l9_402=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool l9_403=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 l9_404=(*sc_set0.UserUniforms).albedoTexBorderColor;
float l9_405=0.0;
bool l9_406=l9_403&&(!l9_401);
float l9_407=1.0;
float l9_408=l9_397.x;
int l9_409=l9_400.x;
if (l9_409==1)
{
l9_408=fract(l9_408);
...
if (l9_414==2)
{
float l9_415=fract(l9_413);
float l9_416=l9_413-l9_415;
float l9_417=step(0.25,fract(l9_416*0.5));
l9_413=mix(l9_415,1.0-l9_415,fast::clamp(l9_417,0.0,1.0));
}
}
l9_397.y=l9_413;
if (l9_401)
...
float l9_420=l9_397.x;
float l9_421=l9_402.x;
float l9_422=l9_402.z;
bool l9_423=l9_419;
float l9_424=l9_407;
...
float l9_429=l9_397.y;
float l9_430=l9_402.y;
float l9_431=l9_402.w;
bool l9_432=l9_428;
float l9_433=l9_407;
...
float2 l9_436=l9_397;
bool l9_437=l9_398;
float3x3 l9_438=l9_399;
if (l9_437)
{
l9_436=float2((l9_438*float3(l9_436,1.0)).xy);
}
float2 l9_439=l9_436;
l9_397=l9_439;
float l9_440=l9_397.x;
int l9_441=l9_400.x;
bool l9_442=l9_406;
float l9_443=l9_407;
...
float4 l9_472=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_471.xy,bias(l9_465));
float4 l9_473=l9_472;
if (l9_403)
{
l9_473=mix(l9_404,l9_473,float4(l9_407));
}
...
l9_475=param_8.Surface_UVCoord0;
...
int l9_482=l9_477;
int l9_483=normalTexLayout_tmp;
int l9_484=l9_482;
float2 l9_485=l9_475;
bool l9_486=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_487=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_488=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_489=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_490=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_491=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_492=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_493=0.0;
...
float4 l9_560=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_559.xy,bias(l9_553));
...
float4 l9_577=fast::max(param_19,float4(0.0));
float4 param_20=l9_577;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_580=fast::clamp(l9_579.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_580=fast::clamp(dot(l9_579.xyz,float3(l9_579.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_580=(1.0-dot(l9_579.xyz,float3(0.33333001)))*l9_579.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_580=(1.0-fast::clamp(dot(l9_579.xyz,float3(1.0)),0.0,1.0))*l9_579.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_580=fast::clamp(dot(l9_579.xyz,float3(1.0)),0.0,1.0)*l9_579.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_580=fast::clamp(dot(l9_579.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_580=dot(l9_579.xyz,float3(0.33333001))*l9_579.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_580=1.0-fast::clamp(dot(l9_579.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_581=l9_580;
float l9_582=l9_581;
float l9_583=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_582;
float3 l9_584=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_578.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_585=float4(l9_584.x,l9_584.y,l9_584.z,l9_583);
param_21=l9_585;
}
else
{
...
{
float4 l9_586=param_21;
float4 l9_587=float4(0.0);
float4 l9_588=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_589=out.sc_FragData0;
l9_588=l9_589;
}
else
{
float4 l9_590=gl_FragCoord;
float2 l9_591=l9_590.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_596=l9_595;
int l9_597=l9_596;
float3 l9_598=float3(l9_592,0.0);
int l9_599=l9_594;
int l9_600=l9_597;
if (l9_599==1)
{
l9_598.y=((2.0*l9_598.y)+float(l9_600))-1.0;
}
float2 l9_601=l9_598.xy;
l9_593=l9_601;
}
else
{
...
int l9_612=l9_607;
float2 l9_613=l9_605;
int l9_614=sc_ScreenTextureLayout_tmp;
int l9_615=l9_612;
float l9_616=l9_606;
...
float4 l9_623=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_622.xy,bias(l9_616));
float4 l9_624=l9_623;
float4 l9_625=l9_624;
l9_588=l9_625;
}
float4 l9_626=l9_588;
float3 l9_627=l9_626.xyz;
float3 l9_628=l9_627;
float3 l9_629=l9_586.xyz;
float3 l9_630=definedBlend(l9_628,l9_629,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_587=float4(l9_630.x,l9_630.y,l9_630.z,l9_587.w);
float3 l9_631=mix(l9_627,l9_587.xyz,float3(l9_586.w));
l9_587=float4(l9_631.x,l9_631.y,l9_631.z,l9_587.w);
l9_587.w=1.0;
float4 l9_632=l9_587;
param_21=l9_632;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_633=float4(in.varScreenPos.xyz,1.0);
param_21=l9_633;
}
else
{
...
float l9_635=fast::clamp(abs(l9_634.z),0.0,1.0);
float4 l9_636=float4(l9_635,1.0-l9_635,1.0,1.0);
param_21=l9_636;
}
else
{
...
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_638=float4(mix(float3(1.0),l9_637.xyz,float3(l9_637.w)),l9_637.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_639=l9_637.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_639=fast::clamp(l9_639,0.0,1.0);
}
l9_638=float4(l9_637.xyz*l9_639,l9_639);
}
else
{
l9_638=l9_637;
...
float4 l9_644=param_23;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_644.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_644;
return out;
}
} // FRAGMENT SHADER

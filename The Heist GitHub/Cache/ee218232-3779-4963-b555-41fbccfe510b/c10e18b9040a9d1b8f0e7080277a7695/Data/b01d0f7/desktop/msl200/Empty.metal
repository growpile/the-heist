...
//}
//ubo int UserUniforms 0:39:4768 {
//float4 sc_Time 1376
...
//float3x3 albedoTexTransform 4672
//float4 albedoTexUvMinMax 4720
//float4 albedoTexBorderColor 4736
//float depthRef 4752
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_albedoTex 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_albedoTex 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int albedoTexLayout 75 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_albedoTex [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_albedoTex [[function_constant(73)]];
...
constant int albedoTexLayout [[function_constant(75)]];
...
int l9_6=l9_1;
int param_1=albedoTexLayout_tmp;
int param_2=l9_6;
float2 param_3=UVCoord_N3;
bool param_4=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).albedoTexTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).albedoTexBorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
int l9_5=l9_0;
int param=albedoTexLayout_tmp;
int param_1=l9_5;
float2 param_2=UVCoord_N3;
bool param_3=(int(SC_USE_UV_TRANSFORM_albedoTex_tmp)!=0);
float3x3 param_4=(*sc_set0.UserUniforms).albedoTexTransform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_albedoTex_tmp,SC_SOFTWARE_WRAP_MODE_V_albedoTex_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_albedoTex_tmp)!=0);
float4 param_7=(*sc_set0.UserUniforms).albedoTexUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_albedoTex_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).albedoTexBorderColor;
float param_10=0.0;
...
float3 l9_70=l9_69;
float3 l9_71=l9_70;
float4 l9_72=sc_set0.albedoTex.sample(sc_set0.albedoTexSmpSC,l9_71.xy,bias(l9_65));
float4 l9_73=l9_72;
if (param_8)
{
...
float param_14=0.0;
float3 l9_78=param_12;
float3 l9_79=param_13;
float l9_80=param_14;
uint l9_81=0u;

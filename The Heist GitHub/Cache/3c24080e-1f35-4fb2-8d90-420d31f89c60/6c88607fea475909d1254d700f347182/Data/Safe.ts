...
export class Safe extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">Game Config</span>')
  @input
  bombTimer: number = 300
  ...
  private timerController!: SafeTimerController
  private moduleManager!: SafeModuleManager
  private solveSequence!: SafeSolveSequence
  ...
  init(safeType: SafeType): void {
    ...
    const {moduleList} = this.moduleManager.configureModules(safeType, safeContext, this as unknown as ScriptComponent)

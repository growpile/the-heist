...
// @input SceneObject safeRoot {"hint":"Safe mesh + modules only. Scaled away on win/fail exit; keep post-game UI outside this object."}
...
// @input SceneObject antennaGlow {"hint":"Idle pulse — local scale ping-pongs 1↔3 over 1s per direction."}
// @ui {"widget":"separator"}
...
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #34D399;\">Win ending</span>"}
// @input SceneObject winPostgameViewRoot {"hint":"Root scaled 0→1 when the safe is solved."}
// @input Component.Text winTimeSolvedText {"hint":"Solve-time label (SSS:M count-up)."}
// @input AssignableType winMenuButton {"hint":"Menu button — wire Safe.backToMenu on trigger up."}
// @ui {"widget":"separator"}
// @ui {"widget":"label", "label":"<span style=\"color: #F87171;\">Fail ending</span>"}
// @input SceneObject failPostgameViewRoot {"hint":"Root scaled 0→1 when the timer runs out."}
// @input AssignableType_1 failMenuButton {"hint":"Menu button — wire Safe.backToMenu on trigger up."}
// @ui {"widget":"separator"}

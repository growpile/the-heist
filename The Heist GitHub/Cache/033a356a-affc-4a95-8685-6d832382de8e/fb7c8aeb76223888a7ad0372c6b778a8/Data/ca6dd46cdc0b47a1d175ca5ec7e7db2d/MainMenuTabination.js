...
const SnapOS2_1 = require("SpectaclesUIKit.lspkg/Scripts/Themes/SnapOS-2.0/SnapOS2");
const RoundedRectangleVisual_1 = require("SpectaclesUIKit.lspkg/Scripts/Visuals/RoundedRectangle/RoundedRectangleVisual");
const SELECTED_STYLE = SnapOS2_1.SnapOS2Styles.PrimaryNeutral;
const DESELECTED_STYLE = SnapOS2_1.SnapOS2Styles.Secondary;
/**
...
let MainMenuTabination = (() => {
    ...
    var MainMenuTabination = _classThis = class extends _classSuper {
        ...
        applyTabStyle(button, style) {
            const buttonInternal = button;
            ...
            const newVisual = new RoundedRectangleVisual_1.RoundedRectangleVisual({
                sceneObject: button.getSceneObject(),
                style: {
                    visualElementType: button.typeString,
                    style: style
                },
                transparent: style === SnapOS2_1.SnapOS2Styles.Ghost
            });

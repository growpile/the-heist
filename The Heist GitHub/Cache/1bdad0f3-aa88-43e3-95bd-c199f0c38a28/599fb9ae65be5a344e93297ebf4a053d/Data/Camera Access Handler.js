...
function initUpdateEvent() {
    ...
    updateEvent.bind(function() {
        ...
        if (latestTexture) {
            // print("Latest texture size: " + latestTexture.getWidth() + "x" + latestTexture.getHeight());
        }
        ...
        var texToEncode = compositeRenderTexture || latestTexture;
        if (!texToEncode) { isEncoding = false; return; }

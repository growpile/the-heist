...
// @input int inputMode {"widget":"combobox", "values":[{"label":"Keep Aspect Ratio", "value":"float"}, {"label":"vec3", "value":"vec3"}, {"label":"color", "value":"color"}],"showIf":"downsampleTexture"}
// @input int maxResolution = 250 {"showIf":"keepAspectRatio"}
// @input vec2 resolution

...
function printEncodedString(result) {
    print("Encoded texture: " + result)s
...
script.createEvent("LateUpdateEvent").bind(function() {
    ...
    if(cameraTextureDisplayImage && latestFrame) {
        ...
        // scaledRenderTargetTexture.control.scaleResolution = 2;
        scaledRenderTargetTexture.control.resolution = new vec2(150, 150);
        print(scaledRenderTargetTexture.getWidth());
    }

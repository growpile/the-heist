...
var textureUtils = require('LensStudio:TextureUtils');
var DownsampleMethod = textureUtils.DownsampleMethod || { Bilinear: 0 };

function encodeDownsampled(texture) {
    var small = textureUtils.downsample(texture, 200, 200, DownsampleMethod.Bilinear);
    return encode(small);
}
...
script.createEvent("LateUpdateEvent").bind(function() {
    ...
    if(cameraTextureDisplayImage && latestFrame) cameraTextureDisplayImage.mainPass.baseTex = latestFrame;

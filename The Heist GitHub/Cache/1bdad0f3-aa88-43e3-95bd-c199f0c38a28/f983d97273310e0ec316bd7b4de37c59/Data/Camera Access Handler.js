...
script.createEvent('OnStartEvent').bind(() => {
    ...
    var compositeCameraSetup = script.virtualRenderCameraSetup.instantiate(script.getSceneObject());
    compositeRenderTexture.resolution = script.finalCompositeResolutionTarget(
    compositeCameraSetup.getComponent('Component.Camera')

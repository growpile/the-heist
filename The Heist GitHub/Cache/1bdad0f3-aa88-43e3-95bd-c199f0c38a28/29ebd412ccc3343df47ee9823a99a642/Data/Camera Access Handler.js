...
function handleImageRequest(imageRequest) {
    ...
    print(imageRequest.resolution)
    if (script.useCrop) imageRequest.cropRect = Rect.create(script.cropValue.x, script.cropValue.y, script.cropValue.z, script.cropValue.w)
    print(imageRequest.cropRect);
}

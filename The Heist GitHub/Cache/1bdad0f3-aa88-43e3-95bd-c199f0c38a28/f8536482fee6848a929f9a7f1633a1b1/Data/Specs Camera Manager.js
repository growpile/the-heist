...
// @input int maxResolution = 250 {"showIf":"downsampleTexture","showIfValue":"1", "label":"Max Resolution (px)"}
// @input bool externalReceiver = false
// @ui {"widget":"group_start", "label":"Downsample Settings", "showIf":"downsampleTexture"}
// @input int inputMode {"widget":"combobox", "values":[{"label":"Default Resolution", "value":"0"}, {"label":"Custom Resolution", "value":"1"}]}
// @ui {"widget":"separator"}
// @ui {"widget":"group_end"}

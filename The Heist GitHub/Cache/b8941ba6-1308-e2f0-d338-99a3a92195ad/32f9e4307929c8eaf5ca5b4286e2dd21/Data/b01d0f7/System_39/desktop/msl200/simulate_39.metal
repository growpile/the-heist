...
//ubo int UserUniforms 0:37:7792 {
//float4 sc_Time 1376
...
//int trailLength 7392
//float trailOffset 7396
//float3 Port_Import_N180 7440
//float Port_Input1_N003 7456
//float Port_Input1_N097 7460
//float2 Port_Scale_N099 7464
//float2 Port_Input1_N100 7472
//float2 Port_Scale_N101 7480
//float2 Port_Input1_N149 7488
//float2 Port_Scale_N148 7496
//float Port_RangeMinA_N090 7520
//float Port_RangeMaxA_N090 7524
//float3 Port_Import_N110 7536
//float Port_Import_N053 7552
//float Port_Import_N054 7556
//float4 Port_Import_N010 7568
//float4 Port_Import_N011 7584
//float Port_Import_N055 7604
//float2 Port_Input0_N185 7608
//float2 Port_Input1_N185 7616
//float Port_Input0_N133 7632
//float Port_Import_N109 7636
//float Port_Input1_N135 7644
//float Port_Input2_N135 7648
//float Port_Input0_N107 7652
//float Port_Import_N111 7656
//float Port_Input1_N116 7664
//float Port_Input2_N116 7668
//float Port_Input1_N159 7676
//float Port_RangeMinA_N158 7680
//float Port_RangeMinB_N158 7688
//float Port_RangeMaxB_N158 7692
//float3 Port_Import_N065 7696
//float3 Port_Import_N077 7712
//float3 Port_Import_N078 7728
//float Port_Multiplier_N079 7744
//float3 Port_Import_N122 7760
//float Port_Input1_N124 7776
//float Port_Input1_N130 7780
//}
...
float2 Port_Scale_N099;
float2 Port_Input1_N100;
float2 Port_Scale_N101;
float2 Port_Input1_N149;
float2 Port_Scale_N148;
float3 Port_Import_N103;
float Port_RangeMinA_N090;
float Port_RangeMaxA_N090;
float3 Port_Import_N110;
float Port_Import_N053;
float Port_Import_N054;
float Port_Import_N005;
float4 Port_Import_N010;
float4 Port_Import_N011;
float Port_Import_N000;
float Port_Import_N055;
float2 Port_Input0_N185;
float2 Port_Input1_N185;
...
float3 Port_Import_N078;
float Port_Multiplier_N079;
float3 Port_Import_N122;
float Port_Input1_N124;
float Port_Input1_N130;
};
struct sc_Set0
{
...
param.CopyId=float(param_1/15000);
...
param_3.SpawnOffset=param_3.Ratio1D*15.0;
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/15000]!=0);
}
else
{
l9_46=l9_45;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/15000];
...
l9_21=(*sc_set0.UserUniforms).Port_Import_N180;
float l9_22=0.0;
l9_22=gParticle.Index1DPerCopyF;
float l9_23=0.0;
float l9_24=float((*sc_set0.UserUniforms).trailLength);
l9_23=l9_24;
float l9_25=0.0;
l9_25=l9_22/(l9_23+1.234e-06);
float l9_26=0.0;
l9_26=floor(l9_25);
float l9_27=0.0;
l9_27=l9_26*(*sc_set0.UserUniforms).Port_Input1_N003;
float l9_28=0.0;
l9_28=l9_27+(*sc_set0.UserUniforms).Port_Input1_N097;
float2 l9_29=float2(0.0);
l9_29.x=l9_27;
l9_29.y=l9_28;
float2 l9_30=float2(0.0);
float2 l9_31=l9_29;
float2 l9_32=(*sc_set0.UserUniforms).Port_Scale_N099;
l9_31=floor(l9_31*l9_32);
float2 l9_33=l9_31;
int l9_34=int(l9_33.x);
int l9_35=int(l9_33.y);
int l9_36=(l9_34*15299)^(l9_35*30133);
int l9_37=l9_36;
int l9_38=l9_37;
int l9_39=((l9_38*((l9_38*1471343)+101146501))+1559861749)&2147483647;
int l9_40=l9_39;
int l9_41=l9_37*1399;
...
float2 l9_48=float2(l9_45,l9_47);
float2 l9_49=l9_48;
float2 l9_50=l9_49;
l9_30=l9_50;
float2 l9_51=float2(0.0);
l9_51=l9_29+(*sc_set0.UserUniforms).Port_Input1_N100;
float2 l9_52=float2(0.0);
float2 l9_53=l9_51;
float2 l9_54=(*sc_set0.UserUniforms).Port_Scale_N101;
l9_53=floor(l9_53*l9_54);
float2 l9_55=l9_53;
int l9_56=int(l9_55.x);
int l9_57=int(l9_55.y);
int l9_58=(l9_56*15299)^(l9_57*30133);
int l9_59=l9_58;
int l9_60=l9_59;
...
l9_73=l9_29+(*sc_set0.UserUniforms).Port_Input1_N149;
float2 l9_74=float2(0.0);
float2 l9_75=l9_73;
float2 l9_76=(*sc_set0.UserUniforms).Port_Scale_N148;
l9_75=floor(l9_75*l9_76);
float2 l9_77=l9_75;
int l9_78=int(l9_77.x);
int l9_79=int(l9_77.y);
int l9_80=(l9_78*15299)^(l9_79*30133);
int l9_81=l9_80;
int l9_82=l9_81;
...
float2 l9_92=float2(l9_89,l9_91);
float2 l9_93=l9_92;
float2 l9_94=l9_93;
l9_74=l9_94;
...
l9_97=(*sc_set0.UserUniforms).Port_Import_N110;
float3 l9_98=float3(0.0);
l9_98=-l9_97;
float3 l9_99=float3(0.0);
l9_99=(((l9_96-float3((*sc_set0.UserUniforms).Port_RangeMinA_N090))/float3(((*sc_set0.UserUniforms).Port_RangeMaxA_N090-(*sc_set0.UserUniforms).Port_RangeMinA_N090)+1e-06))*(l9_97.x-l9_98.x))+float3(l9_98.x);
float3 l9_100=float3(0.0);
l9_100=l9_21+l9_99;
gParticle.Position=l9_100;
float l9_101=0.0;
l9_101=(*sc_set0.UserUniforms).Port_Import_N053;
float l9_102=0.0;
l9_102=(*sc_set0.UserUniforms).Port_Import_N054;
float l9_103=0.0;
l9_103=l9_74.x;
float l9_104=0.0;
l9_104=mix(l9_101,l9_102,l9_103);
float l9_105=l9_104;
gParticle.Mass=l9_105;
gParticle.Mass=fast::max(9.9999997e-06,gParticle.Mass);
float4 l9_106=float4(0.0);
l9_106=(*sc_set0.UserUniforms).Port_Import_N010;
float4 l9_107=float4(0.0);
l9_107=(*sc_set0.UserUniforms).Port_Import_N011;
float l9_108=0.0;
l9_108=fract(l9_25);
float l9_109=0.0;
l9_109=l9_108;
float4 l9_110=float4(0.0);
l9_110=mix(l9_106,l9_107,float4(l9_109));
gParticle.Color=l9_110;
...
float4 l9_111=param_1;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_112=dot(l9_111,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_113=l9_112;
...
{
out.varClipDistance=l9_113;
}
}
float4 l9_114=float4(param_1.x,-param_1.y,(param_1.z*0.5)+(param_1.w*0.5),param_1.w);
out.gl_Position=l9_114;
return out;
}
float Value_N55=0.0;
Value_N55=(*sc_set0.UserUniforms).Port_Import_N055;
float Value_N91=0.0;
Value_N91=gParticle.Index1DPerCopyF;
float Output_N4=0.0;
float param_2=float((*sc_set0.UserUniforms).trailLength);
Output_N4=param_2;
float Output_N94=0.0;
Output_N94=Value_N91/(Output_N4+1.234e-06);
float Output_N96=0.0;
Output_N96=floor(Output_N94);
float Output_N3=0.0;
Output_N3=Output_N96*(*sc_set0.UserUniforms).Port_Input1_N003;
float Output_N97=0.0;
Output_N97=Output_N3+(*sc_set0.UserUniforms).Port_Input1_N097;
float2 Value_N98=float2(0.0);
Value_N98.x=Output_N3;
Value_N98.y=Output_N97;
float2 Output_N149=float2(0.0);
Output_N149=Value_N98+(*sc_set0.UserUniforms).Port_Input1_N149;
float2 Random_N148=float2(0.0);
float2 param_3=Output_N149;
float2 param_4=(*sc_set0.UserUniforms).Port_Scale_N148;
param_3=floor(param_3*param_4);
float2 l9_116=param_3;
int l9_117=int(l9_116.x);
int l9_118=int(l9_116.y);
int l9_119=(l9_117*15299)^(l9_118*30133);
int l9_120=l9_119;
int l9_121=l9_120;
int l9_122=((l9_121*((l9_121*1471343)+101146501))+1559861749)&2147483647;
int l9_123=l9_122;
int l9_124=l9_120*1399;
...
float2 l9_131=float2(l9_128,l9_130);
float2 l9_132=l9_131;
float2 param_5=l9_132;
Random_N148=param_5;
float2 Output_N185=float2(0.0);
Output_N185=mix((*sc_set0.UserUniforms).Port_Input0_N185,(*sc_set0.UserUniforms).Port_Input1_N185,Random_N148);
float Value_N108=0.0;
Value_N108=Output_N185.x;
float Value_N63=0.0;
...
Output_N104=1.0-Value_N88;
float Value_N111=0.0;
Value_N111=(*sc_set0.UserUniforms).Port_Import_N111;
float Output_N147=0.0;
Output_N147=Value_N111/(Value_N86+1.234e-06);
float Value_N105=0.0;
Value_N105=Output_N147;
float Output_N107=0.0;
Output_N107=(*sc_set0.UserUniforms).Port_Input0_N107/(Value_N105+1.234e-06);
float Output_N115=0.0;
Output_N115=Output_N104*Output_N107;
...
Output_N117=Output_N135*Output_N116;
float Export_N118=0.0;
Export_N118=Output_N117;
float Output_N119=0.0;
Output_N119=mix(Value_N55,Value_N108,Export_N118);
gParticle.Size=Output_N119;
float3 Value_N153=float3(0.0);
Value_N153=gParticle.Position;
float Output_N19=0.0;
Output_N19=fract(Output_N94);
float Value_N2=0.0;
Value_N2=Output_N19;
float Value_N157=0.0;
Value_N157=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float Output_N26=0.0;
float param_6=(*sc_set0.UserUniforms).trailOffset;
Output_N26=param_6;
float Output_N24=0.0;
Output_N24=Output_N4*Output_N26;
float Value_N155=0.0;
Value_N155=Output_N24;
float ValueOut_N158=0.0;
float param_7=Value_N157;
float param_9=(*sc_set0.UserUniforms).Port_RangeMinA_N158;
float param_10=Value_N155;
float param_11=(*sc_set0.UserUniforms).Port_RangeMinB_N158;
float param_12=(*sc_set0.UserUniforms).Port_RangeMaxB_N158;
float param_8=(((param_7-param_9)/((param_10-param_9)+1e-06))*(param_12-param_11))+param_11;
float l9_133;
if (param_12>param_11)
{
l9_133=fast::clamp(param_8,param_11,param_12);
}
else
{
l9_133=fast::clamp(param_8,param_12,param_11);
}
param_8=l9_133;
ValueOut_N158=param_8;
float Output_N159=0.0;
Output_N159=mix(Value_N2,(*sc_set0.UserUniforms).Port_Input1_N159,ValueOut_N158);
float Time_N160=0.0;
Time_N160=Globals.gTimeDelta*Output_N159;
float3 Value_N65=float3(0.0);
Value_N65=(*sc_set0.UserUniforms).Port_Import_N065;
float3 Value_N76=float3(0.0);
Value_N76=gParticle.Position;
float3 Value_N77=float3(0.0);
Value_N77=(*sc_set0.UserUniforms).Port_Import_N077;
float3 Value_N78=float3(0.0);
Value_N78=(*sc_set0.UserUniforms).Port_Import_N078;
float Time_N79=0.0;
Time_N79=Globals.gTimeElapsedShifted*(*sc_set0.UserUniforms).Port_Multiplier_N079;
float3 Output_N120=float3(0.0);
Output_N120=Value_N78*float3(Time_N79);
float3 Output_N121=float3(0.0);
Output_N121=(Value_N76+Value_N77)+Output_N120;
float3 Value_N122=float3(0.0);
Value_N122=(*sc_set0.UserUniforms).Port_Import_N122;
float3 Output_N123=float3(0.0);
Output_N123=Output_N121+Value_N122;
float3 Output_N124=float3(0.0);
Output_N124=Value_N122*float3((*sc_set0.UserUniforms).Port_Input1_N124);
float3 Output_N125=float3(0.0);
Output_N125=float3(1.0)/Output_N124;
float3 Output_N126=float3(0.0);
Output_N126=Output_N123*Output_N125;
float4 Color_N128=float4(0.0);
float3 param_13=Output_N126;
float param_14=0.0;
float4 l9_134=sc_set0.noiseTex.sample(sc_set0.noiseTexSmpSC,param_13,level(param_14));
Color_N128=l9_134;
float4 Output_N130=float4(0.0);
Output_N130=Color_N128*float4((*sc_set0.UserUniforms).Port_Input1_N130);
float4 Output_N131=float4(0.0);
Output_N131=Output_N130-float4(1.0);
float3 Output_N284=float3(0.0);
Output_N284=Value_N65*Output_N131.xyz;
float3 Output_N170=float3(0.0);
Output_N170=float3(Time_N160)*Output_N284;
float3 Output_N176=float3(0.0);
Output_N176=Value_N153+Output_N170;
gParticle.Position=Output_N176;
gParticle.Velocity=Output_N284;
float3x3 param_15=gParticle.Matrix;
gParticle.Quaternion=matrixToQuaternion(param_15);
...
float4 l9_137=param_16;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_138=dot(l9_137,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_139=l9_138;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_139;
}
}
float4 l9_140=float4(param_16.x,-param_16.y,(param_16.z*0.5)+(param_16.w*0.5),param_16.w);
out.gl_Position=l9_140;
...
float4 l9_144=float4(param_17.x,-param_17.y,(param_17.z*0.5)+(param_17.w*0.5),param_17.w);

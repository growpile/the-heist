...
//float Port_Input1_N037 7392
//float Port_Value_N172 7396
//float Port_RangeMinA_N169 7400
//float Port_RangeMaxA_N169 7404
//float Port_RangeMinB_N169 7408
//float Port_RangeMaxB_N169 7412
//float Port_Input1_N093 7420
//float3 Port_Input1_N181 7424
//float Port_Input1_N171 7440
//float2 Port_Input1_N137 7448
//float Port_Input1_N138 7456
//float Port_Import_N140 7460
//float Port_Import_N142 7464
//float Port_Input1_N144 7468
//float Port_Input2_N144 7472
//}
...
float Port_RangeMinA_N169;
float Port_RangeMaxA_N169;
float Port_RangeMinB_N169;
float Port_RangeMaxB_N169;
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/15000]!=0);
}
else
{
l9_46=l9_45;
...
bool l9_4=l9_3>=(15000*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/15000]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/15000];
...
gParticle.Position=((*sc_set0.UserUniforms).vfxModelMatrix[ssInstanceID/15000]*float4(gParticle.Position,1.0)).xyz;
int l9_23=ssInstanceID/15000;
...
Output_N37=UVCoord_N184-float2((*sc_set0.UserUniforms).Port_Input1_N037);
float Value1_N38=0.0;
float Value2_N38=0.0;
float2 param_4=Output_N37;
...
float param_7=1.0;
float3 param_8=(*sc_set0.UserUniforms).Port_Input1_N181;
...
l9_30=length(l9_29);
float l9_31=0.0;
float l9_32=(*sc_set0.UserUniforms).Port_Value_N172;
float l9_33=l9_32+0.001;
l9_33-=0.001;
l9_31=l9_33;
float l9_34=0.0;
l9_34=float(l9_30<l9_31);
float l9_35=0.0;
l9_35=gParticle.Size;
float l9_36=0.0;
float l9_37=l9_35;
float l9_38=(*sc_set0.UserUniforms).Port_RangeMinA_N169;
float l9_39=(*sc_set0.UserUniforms).Port_RangeMaxA_N169;
float l9_40=(*sc_set0.UserUniforms).Port_RangeMinB_N169;
float l9_41=(*sc_set0.UserUniforms).Port_RangeMaxB_N169;
float l9_42=(((l9_37-l9_38)/((l9_39-l9_38)+1e-06))*(l9_41-l9_40))+l9_40;
float l9_43;
if (l9_41>l9_40)
{
l9_43=fast::clamp(l9_42,l9_40,l9_41);
}
else
{
l9_43=fast::clamp(l9_42,l9_41,l9_40);
}
l9_42=l9_43;
l9_36=l9_42;
float l9_44=0.0;
l9_44=l9_36;
float l9_45=0.0;
l9_45=float(l9_44<(*sc_set0.UserUniforms).Port_Input1_N093);
float l9_46=0.0;
float l9_47=l9_34;
...
float l9_55=l9_54;
float3 l9_56=l9_52*l9_55;
l9_51=l9_56;
param_9=l9_51;
param_10=param_9;
}
Output_N181=param_10;
...
float3 param_11=Output_N368;
float l9_57=dot(param_11,param_11);
float l9_58;
if (l9_57>0.0)
{
...
float l9_59=l9_58;
float3 param_12=param_11*l9_59;
Output_N369=param_12;
float3 Result_N41=float3(0.0);
Result_N41=cross(Output_N181,Output_N369);
float3 Output_N42=float3(0.0);
float3 param_13=Result_N41;
float l9_60=dot(param_13,param_13);
float l9_61;
if (l9_60>0.0)
{
...
float l9_62=l9_61;
float3 param_14=param_13*l9_62;
Output_N42=param_14;
float3 Output_N43=float3(0.0);
Output_N43=(float3(Value_N162)*float3(Value1_N38))*Output_N42;
...
Value_N167=gParticle.Size;
float ValueOut_N169=0.0;
float param_15=Value_N167;
float param_17=(*sc_set0.UserUniforms).Port_RangeMinA_N169;
float param_18=(*sc_set0.UserUniforms).Port_RangeMaxA_N169;
float param_19=(*sc_set0.UserUniforms).Port_RangeMinB_N169;
float param_20=(*sc_set0.UserUniforms).Port_RangeMaxB_N169;
float param_16=(((param_15-param_17)/((param_18-param_17)+1e-06))*(param_20-param_19))+param_19;
float l9_63;
if (param_20>param_19)
{
l9_63=fast::clamp(param_16,param_19,param_20);
}
else
{
l9_63=fast::clamp(param_16,param_20,param_19);
}
param_16=l9_63;
ValueOut_N169=param_16;
float Value_N163=0.0;
Value_N163=ValueOut_N169;
...
Output_N45=((float3(Value_N162)*float3(Value2_N38))*float3(Output_N171))*Output_N181;
float3 Output_N46=float3(0.0);
Output_N46=(Value_N161+Output_N43)+Output_N45;
float3 param_21=Output_N46;
out.varPosAndMotion=float4(param_21.x,param_21.y,param_21.z,out.varPosAndMotion.w);
float3 param_22=Output_N181;
out.varTangent=float4(param_22.x,param_22.y,param_22.z,out.varTangent.w);
float3 Result_N194=float3(0.0);
Result_N194=cross(Output_N181,Output_N42);
float3 Output_N195=float3(0.0);
float3 param_23=Result_N194;
float l9_64=dot(param_23,param_23);
float l9_65;
if (l9_64>0.0)
{
...
float l9_66=l9_65;
float3 param_24=param_23*l9_66;
Output_N195=param_24;
float3 param_25=Output_N195;
...
param_26.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_26.w))*l9_71)-1.0)*param_26.w;
}
}
float4 l9_72=param_26;
clipPosition=l9_72;
...
float4 l9_76=float4(param_27.x,-param_27.y,(param_27.z*0.5)+(param_27.w*0.5),param_27.w);
...
float4 Value_N84=float4(0.0);
Value_N84=float4(Value_N20.xyz.x,Value_N20.xyz.y,Value_N20.xyz.z,Value_N84.w);
Value_N84.w=Export_N145;
float4 param_2=Value_N84;

...
function updateFollow() {
    ...
    if (script.wireEndSocket && handleManipulation && handleManipulation.setCanTranslate) {
        ...
        if (d2 <= script.connectThreshold) {
            ...
            handleManipulation.setCanTranslate(false);
            var enableEvent = script.createEvent("DelayedCallbackEvent");
            enableEvent.bind(function () {
                handleManipulation.setCanTranslate(true);
            });
            enableEvent.reset(0.3);
        }
    }

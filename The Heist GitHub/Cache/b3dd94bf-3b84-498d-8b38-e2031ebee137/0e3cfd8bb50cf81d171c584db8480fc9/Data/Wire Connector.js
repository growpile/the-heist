...
function init() {
    if (script.wireHandle) {
        handleInteractable = script.wireHandle.getComponents("Component.ScriptComponent");
        if (handleInteractable) {
            if (handleInteractable.onTriggerStart) {
                handleInteractable.onTriggerStart.add(onHandleTriggerStart);
            }
            if (handleInteractable.onTriggerEnd) {
                handleInteractable.onTriggerEnd.add(onHandleTriggerEnd);
            }
        }
    }
}

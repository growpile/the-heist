...
function updateFollow() {
    ...
    if (originTransform && script.debugText) {
        var dist = headTransform.getWorldPosition().distance(originTransform.getWorldPosition());
        script.debugText.text = dist.toFixed(2);
        print("Wire distance: " + dist.toFixed(2));
    }
}

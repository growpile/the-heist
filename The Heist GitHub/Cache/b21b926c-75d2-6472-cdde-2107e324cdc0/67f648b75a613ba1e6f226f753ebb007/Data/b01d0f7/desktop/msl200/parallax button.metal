...
//sampler sampler ormTexSmpSC 0:30
...
//texture texture2D ormTex 0:7:0:30
...
//}
//ubo int UserUniforms 0:43:5248 {
...
//float4 rimTint0 4624
//float4 rimTint1 4640
//float state 4656
//float3x3 baseTexTransform 4720
//float4 baseTexUvMinMax 4768
//float4 baseTexBorderColor 4784
//float4 baseColor0 4800
//float4 baseColor1 4816
//float4 innerGlowColor0 4832
//float4 innerGlowColor1 4848
//float glowAmount 4864
//float3x3 normalTexTransform 4928
//float4 normalTexUvMinMax 4976
//float4 normalTexBorderColor 4992
//float3x3 ormTexTransform 5056
//float4 ormTexUvMinMax 5104
//float4 ormTexBorderColor 5120
//float metallic 5136
//float roughness 5140
//float Port_Exponent_N015 5144
//float Port_Intensity_N015 5148
//float Port_Height_N002 5152
//float Port_Input1_N005 5156
//float Port_Input1_N010 5160
//float Port_Input1_N030 5164
//float Port_Input2_N030 5168
//float Port_Opacity_N013 5172
//float2 Port_UVCoord_N020 5176
//float3 Port_Emissive_N013 5184
//float2 Port_UVCoord_N022 5200
//float3 Port_SpecularAO_N013 5216
//float depthRef 5232
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_ormTex 34 0
...
//spec_const bool SC_USE_UV_MIN_MAX_ormTex 38 0
...
//spec_const bool SC_USE_UV_TRANSFORM_ormTex 42 0
...
//spec_const bool normalTexHasSwappedViews 46 0
//spec_const bool ormTexHasSwappedViews 47 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_ormTex 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_ormTex 96 -1
//spec_const int baseTexLayout 97 0
//spec_const int intensityTextureLayout 98 0
//spec_const int normalTexLayout 99 0
//spec_const int ormTexLayout 100 0
...
constant bool SC_USE_CLAMP_TO_BORDER_ormTex [[function_constant(34)]];
constant bool SC_USE_CLAMP_TO_BORDER_ormTex_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_ormTex) ? SC_USE_CLAMP_TO_BORDER_ormTex : false;
...
constant bool SC_USE_UV_MIN_MAX_ormTex [[function_constant(38)]];
constant bool SC_USE_UV_MIN_MAX_ormTex_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_ormTex) ? SC_USE_UV_MIN_MAX_ormTex : false;
...
constant bool SC_USE_UV_TRANSFORM_ormTex [[function_constant(42)]];
constant bool SC_USE_UV_TRANSFORM_ormTex_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_ormTex) ? SC_USE_UV_TRANSFORM_ormTex : false;
...
constant bool normalTexHasSwappedViews [[function_constant(46)]];
...
constant bool ormTexHasSwappedViews [[function_constant(47)]];
constant bool ormTexHasSwappedViews_tmp = is_function_constant_defined(ormTexHasSwappedViews) ? ormTexHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_normalTex [[function_constant(91)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_ormTex [[function_constant(92)]];
constant int SC_SOFTWARE_WRAP_MODE_U_ormTex_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_ormTex) ? SC_SOFTWARE_WRAP_MODE_U_ormTex : -1;
...
constant int SC_SOFTWARE_WRAP_MODE_V_normalTex [[function_constant(95)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_ormTex [[function_constant(96)]];
constant int SC_SOFTWARE_WRAP_MODE_V_ormTex_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_ormTex) ? SC_SOFTWARE_WRAP_MODE_V_ormTex : -1;
...
constant int normalTexLayout [[function_constant(99)]];
constant int normalTexLayout_tmp = is_function_constant_defined(normalTexLayout) ? normalTexLayout : 0;
constant int ormTexLayout [[function_constant(100)]];
constant int ormTexLayout_tmp = is_function_constant_defined(ormTexLayout) ? ormTexLayout : 0;
...
float4 baseColor0;
float4 baseColor1;
float4 innerGlowColor0;
float4 innerGlowColor1;
float glowAmount;
...
float4 ormTexDims;
float4 ormTexView;
float3x3 ormTexTransform;
float4 ormTexUvMinMax;
float4 ormTexBorderColor;
float metallic;
float roughness;
float Port_Exponent_N015;
float Port_Intensity_N015;
float Port_Height_N002;
float Port_Input1_N005;
float Port_Input1_N010;
float Port_Input1_N030;
float Port_Input2_N030;
float Port_Opacity_N013;
float2 Port_UVCoord_N020;
float3 Port_Emissive_N013;
float2 Port_UVCoord_N022;
...
sampler normalTexSmpSC [[id(29)]];
sampler ormTexSmpSC [[id(30)]];
...
float Rim_N15=0.0;
float param_1=(*sc_set0.UserUniforms).Port_Exponent_N015;
float param_2=(*sc_set0.UserUniforms).Port_Intensity_N015;
ssGlobals param_4=Globals;
float l9_1=abs(dot(-param_4.ViewDirWS,param_4.VertexNormal_WorldSpace));
float param_3=pow(1.0-l9_1,param_1);
param_3=fast::max(param_3,0.0);
param_3*=param_2;
Rim_N15=param_3;
float4 Output_N18=float4(0.0);
float4 param_5=(*sc_set0.UserUniforms).rimTint0;
Output_N18=param_5;
float4 Output_N33=float4(0.0);
float4 param_6=(*sc_set0.UserUniforms).rimTint1;
Output_N33=param_6;
float Output_N37=0.0;
float param_7=(*sc_set0.UserUniforms).state;
Output_N37=param_7;
float4 Output_N32=float4(0.0);
Output_N32=mix(Output_N18,Output_N33,float4(Output_N37));
float4 Output_N16=float4(0.0);
Output_N16=float4(Rim_N15)*Output_N32;
float2 UVCoord_N3=float2(0.0);
UVCoord_N3=Globals.UVCoord2;
...
int l9_7=l9_2;
int param_8=baseTexLayout_tmp;
int param_9=l9_7;
float2 param_10=UVCoord_N3;
bool param_11=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 param_12=(*sc_set0.UserUniforms).baseTexTransform;
int2 param_13=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool param_14=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool param_16=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 param_17=(*sc_set0.UserUniforms).baseTexBorderColor;
float param_18=0.0;
...
float3 l9_72=l9_71;
float3 l9_73=l9_72;
float4 l9_74=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_73.xy,bias(l9_67));
float4 l9_75=l9_74;
if (param_16)
{
...
float4 param_19=(*sc_set0.UserUniforms).baseColor0;
Output_N12=param_19;
float4 Output_N35=float4(0.0);
float4 param_20=(*sc_set0.UserUniforms).baseColor1;
Output_N35=param_20;
float4 Output_N34=float4(0.0);
Output_N34=mix(Output_N12,Output_N35,float4(Output_N37));
float4 Output_N9=float4(0.0);
Output_N9=Color_N0*Output_N34;
float2 CoordsOut_N2=float2(0.0);
float2 param_21=UVCoord_N3;
float param_22=(*sc_set0.UserUniforms).Port_Height_N002;
ssGlobals param_24=Globals;
float3 l9_77=param_24.VertexTangent_WorldSpace;
float3 l9_78=param_24.VertexBinormal_WorldSpace;
float3 l9_79=param_24.ViewDirWS;
float3 l9_80=float3(dot(l9_79,l9_77),dot(l9_79,l9_78),dot(l9_79,param_24.VertexNormal_WorldSpace));
float2 l9_81;
if (l9_80.z>0.0)
{
l9_81=(-l9_80.xy)/float2(l9_80.z);
}
else
{
l9_81=float2(0.0);
...
float2 l9_82=l9_81;
float2 param_23=param_21+(l9_82*param_22);
CoordsOut_N2=param_23;
float2 Output_N5=float2(0.0);
Output_N5=CoordsOut_N2-float2((*sc_set0.UserUniforms).Port_Input1_N005);
float Output_N6=0.0;
Output_N6=length(Output_N5);
float Output_N10=0.0;
Output_N10=Output_N6*(*sc_set0.UserUniforms).Port_Input1_N010;
float Output_N7=0.0;
Output_N7=1.0-Output_N10;
float4 Output_N11=float4(0.0);
float4 param_25=(*sc_set0.UserUniforms).innerGlowColor0;
Output_N11=param_25;
float4 Output_N28=float4(0.0);
float4 param_26=(*sc_set0.UserUniforms).innerGlowColor1;
Output_N28=param_26;
float4 Output_N36=float4(0.0);
Output_N36=mix(Output_N11,Output_N28,float4(Output_N37));
float4 Output_N8=float4(0.0);
Output_N8=float4(Output_N7)*Output_N36;
float4 Output_N30=float4(0.0);
Output_N30=fast::clamp(Output_N8+float4(0.001),float4((*sc_set0.UserUniforms).Port_Input1_N030)+float4(0.001),float4((*sc_set0.UserUniforms).Port_Input2_N030)+float4(0.001))-float4(0.001);
float Output_N31=0.0;
float param_27=(*sc_set0.UserUniforms).glowAmount;
Output_N31=param_27;
float4 Output_N14=float4(0.0);
Output_N14=Output_N30*float4(Output_N31);
float4 Output_N29=float4(0.0);
Output_N29=Output_N9+Output_N14;
float4 Color_N20=float4(0.0);
float2 param_28=(*sc_set0.UserUniforms).Port_UVCoord_N020;
int l9_83;
...
int l9_88=l9_83;
int l9_89=normalTexLayout_tmp;
int l9_90=l9_88;
float2 l9_91=param_28;
bool l9_92=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_93=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_94=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_95=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_96=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_97=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_98=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_99=0.0;
bool l9_100=l9_97&&(!l9_95);
float l9_101=1.0;
float l9_102=l9_91.x;
int l9_103=l9_94.x;
if (l9_103==1)
{
l9_102=fract(l9_102);
...
float l9_114=l9_91.x;
float l9_115=l9_96.x;
float l9_116=l9_96.z;
bool l9_117=l9_113;
float l9_118=l9_101;
...
float l9_123=l9_91.y;
float l9_124=l9_96.y;
float l9_125=l9_96.w;
bool l9_126=l9_122;
float l9_127=l9_101;
...
float4 l9_166=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_165.xy,bias(l9_159));
float4 l9_167=l9_166;
if (l9_97)
{
l9_167=mix(l9_98,l9_167,float4(l9_101));
}
float4 l9_168=l9_167;
float4 param_29=l9_168;
float3 l9_169=(param_29.xyz*1.9921875)-float3(1.0);
param_29=float4(l9_169.x,l9_169.y,l9_169.z,param_29.w);
Color_N20=param_29;
float4 Color_N22=float4(0.0);
float2 param_30=(*sc_set0.UserUniforms).Port_UVCoord_N022;
int l9_170;
if ((int(ormTexHasSwappedViews_tmp)!=0))
{
int l9_171=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_175=l9_170;
int l9_176=ormTexLayout_tmp;
int l9_177=l9_175;
float2 l9_178=param_30;
bool l9_179=(int(SC_USE_UV_TRANSFORM_ormTex_tmp)!=0);
float3x3 l9_180=(*sc_set0.UserUniforms).ormTexTransform;
int2 l9_181=int2(SC_SOFTWARE_WRAP_MODE_U_ormTex_tmp,SC_SOFTWARE_WRAP_MODE_V_ormTex_tmp);
bool l9_182=(int(SC_USE_UV_MIN_MAX_ormTex_tmp)!=0);
float4 l9_183=(*sc_set0.UserUniforms).ormTexUvMinMax;
bool l9_184=(int(SC_USE_CLAMP_TO_BORDER_ormTex_tmp)!=0);
float4 l9_185=(*sc_set0.UserUniforms).ormTexBorderColor;
float l9_186=0.0;
...
float4 l9_253=sc_set0.ormTex.sample(sc_set0.ormTexSmpSC,l9_252.xy,bias(l9_246));
...
float4 param_31=l9_255;
float3 l9_256=(param_31.xyz*1.9921875)-float3(1.0);
param_31=float4(l9_256.x,l9_256.y,l9_256.z,param_31.w);
Color_N22=param_31;
float Value1_N23=0.0;
float Value2_N23=0.0;
float Value3_N23=0.0;
float4 param_32=Color_N22;
float param_33=param_32.x;
float param_34=param_32.y;
float param_35=param_32.z;
Value1_N23=param_33;
Value2_N23=param_34;
Value3_N23=param_35;
float Output_N25=0.0;
float param_36=(*sc_set0.UserUniforms).metallic;
Output_N25=param_36;
float Output_N24=0.0;
Output_N24=Value1_N23*Output_N25;
float Output_N26=0.0;
float param_37=(*sc_set0.UserUniforms).roughness;
Output_N26=param_37;
float Output_N27=0.0;
Output_N27=Value2_N23*Output_N26;
float4 Output_N13=float4(0.0);
float3 param_38=Output_N29.xyz;
float param_39=(*sc_set0.UserUniforms).Port_Opacity_N013;
float3 param_40=Color_N20.xyz;
float3 param_41=(*sc_set0.UserUniforms).Port_Emissive_N013;
float param_42=Output_N24;
float param_43=Output_N27;
float3 param_44=float3(Value3_N23);
float3 param_45=(*sc_set0.UserUniforms).Port_SpecularAO_N013;
ssGlobals param_47=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_47.BumpedNormal=float3x3(float3(param_47.VertexTangent_WorldSpace),float3(param_47.VertexBinormal_WorldSpace),float3(param_47.VertexNormal_WorldSpace))*param_40;
}
float l9_257=param_39;
...
float4 l9_271=fast::max(param_48,float4(0.0));
float4 param_49=l9_271;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_280=param_50;
float4 l9_281=float4(0.0);
float4 l9_282=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_283=out.sc_FragData0;
l9_282=l9_283;
}
else
{
float4 l9_284=gl_FragCoord;
float2 l9_285=l9_284.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_290=l9_289;
int l9_291=l9_290;
float3 l9_292=float3(l9_286,0.0);
int l9_293=l9_288;
int l9_294=l9_291;
if (l9_293==1)
{
l9_292.y=((2.0*l9_292.y)+float(l9_294))-1.0;
}
float2 l9_295=l9_292.xy;
l9_287=l9_295;
}
else
{
...
float4 l9_317=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_316.xy,bias(l9_310));
float4 l9_318=l9_317;
float4 l9_319=l9_318;
l9_282=l9_319;
}
float4 l9_320=l9_282;
float3 l9_321=l9_320.xyz;
float3 l9_322=l9_321;
float3 l9_323=l9_280.xyz;
...
l9_281=float4(l9_324.x,l9_324.y,l9_324.z,l9_281.w);
float3 l9_325=mix(l9_321,l9_281.xyz,float3(l9_280.w));
l9_281=float4(l9_325.x,l9_325.y,l9_325.z,l9_281.w);
l9_281.w=1.0;
float4 l9_326=l9_281;
param_50=l9_326;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_327=float4(in.varScreenPos.xyz,1.0);
param_50=l9_327;
}
else
{
...
float l9_329=fast::clamp(abs(l9_328.z),0.0,1.0);
float4 l9_330=float4(l9_329,1.0-l9_329,1.0,1.0);
param_50=l9_330;
}
else
{
float4 l9_331=param_50;
float4 l9_332=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_332=float4(mix(float3(1.0),l9_331.xyz,float3(l9_331.w)),l9_331.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_333=l9_331.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_333=fast::clamp(l9_333,0.0,1.0);
}
l9_332=float4(l9_331.xyz*l9_333,l9_333);
}
else
{
l9_332=l9_331;
...
float4 l9_338=param_52;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_338.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_338;
return out;
}
} // FRAGMENT SHADER
...
Globals.UVCoord2=in.Interpolator_UVCoord2;
float4 Color_N20=float4(0.0);
float2 param=(*sc_set0.UserUniforms).Port_UVCoord_N020;
int l9_0;
if ((int(normalTexHasSwappedViews_tmp)!=0))
{
int l9_1=0;
...
float4 l9_85=l9_84;
float4 param_1=l9_85;
float3 l9_86=(param_1.xyz*1.9921875)-float3(1.0);
param_1=float4(l9_86.x,l9_86.y,l9_86.z,param_1.w);
Color_N20=param_1;
float4 Color_N22=float4(0.0);
float2 param_2=(*sc_set0.UserUniforms).Port_UVCoord_N022;
int l9_87;
if ((int(ormTexHasSwappedViews_tmp)!=0))
{
int l9_88=0;
...
int l9_92=l9_87;
int l9_93=ormTexLayout_tmp;
int l9_94=l9_92;
float2 l9_95=param_2;
bool l9_96=(int(SC_USE_UV_TRANSFORM_ormTex_tmp)!=0);
float3x3 l9_97=(*sc_set0.UserUniforms).ormTexTransform;
int2 l9_98=int2(SC_SOFTWARE_WRAP_MODE_U_ormTex_tmp,SC_SOFTWARE_WRAP_MODE_V_ormTex_tmp);
bool l9_99=(int(SC_USE_UV_MIN_MAX_ormTex_tmp)!=0);
float4 l9_100=(*sc_set0.UserUniforms).ormTexUvMinMax;
bool l9_101=(int(SC_USE_CLAMP_TO_BORDER_ormTex_tmp)!=0);
float4 l9_102=(*sc_set0.UserUniforms).ormTexBorderColor;
float l9_103=0.0;
...
float3 l9_168=l9_167;
float3 l9_169=l9_168;
float4 l9_170=sc_set0.ormTex.sample(sc_set0.ormTexSmpSC,l9_169.xy,bias(l9_163));
float4 l9_171=l9_170;
if (l9_101)
{
l9_171=mix(l9_102,l9_171,float4(l9_105));
}
float4 l9_172=l9_171;
float4 param_3=l9_172;
float3 l9_173=(param_3.xyz*1.9921875)-float3(1.0);
param_3=float4(l9_173.x,l9_173.y,l9_173.z,param_3.w);
Color_N22=param_3;
float Value2_N23=0.0;
float4 param_4=Color_N22;
...
float Output_N27=0.0;
Output_N27=Value2_N23*Output_N26;
float param_7=(*sc_set0.UserUniforms).Port_Opacity_N013;
float3 param_8=Color_N20.xyz;
float param_9=Output_N27;
ssGlobals param_10=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_10.BumpedNormal=float3x3(float3(param_10.VertexTangent_WorldSpace),float3(param_10.VertexBinormal_WorldSpace),float3(param_10.VertexNormal_WorldSpace))*param_8;
}
float l9_174=param_7;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_174<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float3 l9_178=param_10.PositionWS;
float3 l9_179=param_10.BumpedNormal;
float l9_180=param_9;
float3 l9_181=l9_178;
float3 l9_182=l9_179;
float l9_183=l9_180;
uint l9_184=0u;
uint3 l9_185=uint3(round((l9_181-(*sc_set0.UserUniforms).sc_RayTracingOriginOffset)*(*sc_set0.UserUniforms).sc_RayTracingOriginScale));
out.sc_RayTracingPositionAndMask=uint4(l9_185.x,l9_185.y,l9_185.z,out.sc_RayTracingPositionAndMask.w);
out.sc_RayTracingPositionAndMask.w=(*sc_set0.UserUniforms).sc_RayTracingReceiverMask;
float3 l9_186=l9_182;
float l9_187=dot(abs(l9_186),float3(1.0));
l9_186/=float3(l9_187);
float2 l9_188=float2(fast::clamp(-l9_186.z,0.0,1.0));
float2 l9_189=l9_186.xy+mix(-l9_188,l9_188,step(float2(0.0),l9_186.xy));
uint l9_190=as_type<uint>(half2(l9_189));
uint2 l9_191=uint2(l9_190&65535u,l9_190>>16u);
out.sc_RayTracingNormalAndMore=uint4(l9_191.x,l9_191.y,out.sc_RayTracingNormalAndMore.z,out.sc_RayTracingNormalAndMore.w);
out.sc_RayTracingNormalAndMore.z=l9_184;
uint l9_192=uint(fast::clamp(l9_183,0.0,1.0)*1000.0);
l9_192 |= (((*sc_set0.UserUniforms).sc_RayTracingReceiverId%32u)<<10u);
out.sc_RayTracingNormalAndMore.w=l9_192;
return out;
}

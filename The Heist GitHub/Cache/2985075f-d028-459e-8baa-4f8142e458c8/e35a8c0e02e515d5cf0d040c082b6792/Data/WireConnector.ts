...
/** Target total slide from inner reel to head along outer wire +X (legacy JS used 1.25). */
const RETURN_OFFSET_TOTAL_SLIDE = 1.25
/** Prefab head is already this far ahead of inner reel on outer +X before init runs. */
const PREFAB_HEAD_LEAD_ON_SLIDE = 0.5
...
export class WireConnector extends BaseScriptComponent {
  ...
  /** Match legacy Wire Connector.js: inner reel up axis in world space (not outer +X). */

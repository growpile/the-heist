...
export class WireConnector extends BaseScriptComponent {
  ...
  private wireScriptRef(): ScriptComponent {
    return this as unknown as ScriptComponent
  }
  ...
  private refreshTransformRefs(): void {
    ...
    if (this.wireHead) {
      this.headTransform = this.wireHead.getTransform()
    }
    if (this.wireEnd) {
      this.endTransform = this.wireEnd.getTransform()
    }
    if (this.wireHandle) {
      this.handleTransform = this.wireHandle.getTransform()
    }
  }

...
let WireConnector = (() => {
    ...
    var WireConnector = _classThis = class extends _classSuper {
        ...
        buildSmoothPath(startPos, endPos, segments, radius) {
            ...
            const controlB = new vec3(endPos.x - normDir.x * radius * elbowCurvature, endPos.y - normDir.y * radius * elbowCurvature, endPos.z - normDir.z * radius * elbowCurvature);

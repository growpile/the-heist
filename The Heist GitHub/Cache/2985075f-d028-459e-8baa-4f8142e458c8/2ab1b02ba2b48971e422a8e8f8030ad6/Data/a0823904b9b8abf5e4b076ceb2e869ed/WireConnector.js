...
let WireConnector = (() => {
    ...
    var WireConnector = _classThis = class extends _classSuper {
        ...
        bindPublicApi() {
            ...
            api.init = () => this.init();
            api.disconnect = (silent) => this.disconnect(silent);
            api.disable = () => this.disable();
            api.returnConnections = () => this.returnConnections();
            api.setManager = (manager) => this.setManager(manager);
        }
        readInputObject(key) {
            const api = this;
        ...
        init() {
            ...
            if (!this.headTransform || !this.endTransform) {
                print("[WireConnector] Missing wireHead/wireEnd on " +
        ...
        updateFollow() {
            ...
            const shouldUpdate = this.initialized ||
                this.isFollowing ||
                this.isReturning ||
                !!this.currentSocket ||
                this.meshCooldownFrames > 0;

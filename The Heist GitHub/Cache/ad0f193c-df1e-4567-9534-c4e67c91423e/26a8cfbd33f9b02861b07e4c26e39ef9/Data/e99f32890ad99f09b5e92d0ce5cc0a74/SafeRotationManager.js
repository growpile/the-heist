    ...
    var SafeRotationManager = _classThis = class extends _classSuper {
        ...
        animateYawDelta(deltaRadians, durationSec) {
            ...
            const tween = LSTween_1.LSTween.rawTween(durationMs)
                ...
                this.rotateTransform?.setLocalRotation(quat.fromEulerVec(new vec3(this.baseEuler.x, this.baseEuler.y + yaw, this.baseEuler.z)));
            })
                .onComplete(() => {
        ...
        animateGroundRotation(deltaRadians, durationSec) {
            ...
            const groundStart = this.groundMaterial.mainPass.rotation;
        ...
        playIconBump(index) {
            ...
            LSTween_1.LSTween.scaleFromToLocal(transform, rest, bump, 80)
                .easing(Easing_1.default.Quadratic.Out)
                .chain(LSTween_1.LSTween.scaleFromToLocal(transform, bump, rest, 120).easing(Easing_1.default.Quadratic.In))
                .start();
        }

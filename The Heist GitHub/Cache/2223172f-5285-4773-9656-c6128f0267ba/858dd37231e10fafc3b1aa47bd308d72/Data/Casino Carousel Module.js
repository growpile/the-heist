        ...
        (function(tfm, startQ, anim, totalRad, spinIndex, spinDuration, targetStepValue) {
            anim.updateEvent.bind(function() {
                ...
                if (t >= 1) {
                    ...
                    global.playSfx(14, 1, global.appState.getStorage("masterVolume") * 0.8);
                    ...
                    if (remaining <= 0) {
                        ...
                        if (expectedDirection) {
                            print("Carousel expected direction: " + expectedDirection);
                        }
                        if (callback) { callback(); }
                    }
                }
...
script.createEvent("UpdateEvent").bind(function(eventData){
    ...
    if (!isLeverAnimating && leverAnimState === "idle" && verticalDistance >= (leverMinDistance || 0)) {
        ...
        global.playSfx(global.utils.rng(10, 12), 1, global.appState.getStorage("masterVolume") * 0.7)
...
script.modulePenalty = function() {
    script.safeComponent.applyPenalty(10);
};

        ...
        (function(tfm, startQ, anim) {
            anim.updateEvent.bind(function() {
                ...
                for (var m = 0; m < spinnerMaterials.length; m++) {
                    ...
                    if (mat && mat.mainPass && mat.mainPass.progress !== undefined) {
                        var progress = smoothT < 0.5 ? smoothT * 2 : (1 - smoothT) * 2;
                ...
                if (t >= 1) {
                    ...
                    for (var m2 = 0; m2 < spinnerMaterials.length; m2++) {
                        ...
                        if (mat2 && mat2.mainPass && mat2.mainPass.progress !== undefined) {

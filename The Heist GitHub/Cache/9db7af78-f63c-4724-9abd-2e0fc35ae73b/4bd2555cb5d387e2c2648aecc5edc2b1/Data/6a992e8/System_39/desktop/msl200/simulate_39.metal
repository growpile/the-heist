...
//float Port_Import_N285 7500
//float3 Port_Import_N284 7504
...
param.CopyId=float(param_1/3000);
...
l9_46=!(UserUniforms.vfxBatchEnable[l9_47/3000]!=0);
}
else
{
l9_46=l9_45;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_4/3000];

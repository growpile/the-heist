...
//ubo int UserUniforms 0:35:7808 {
//float4 sc_Time 1376
...
//float3 Port_Import_N013 7504
//float3 Port_Import_N016 7520
//float Port_Min_N043 7568
//float Port_Max_N043 7572
//float Port_Import_N092 7576
//float Port_Import_N108 7580
//float Port_Import_N109 7584
//float Port_Import_N111 7588
//float Port_Import_N041 7592
//float Port_Import_N059 7596
//float Port_Input0_N063 7604
//float Port_Import_N185 7608
//float Port_Input1_N227 7616
//float Port_Input2_N227 7620
//float Port_Input0_N066 7624
//float Port_Import_N188 7628
//float Port_Input1_N236 7636
//float Port_Input2_N236 7640
//float Port_Min_N125 7644
//float Port_Max_N125 7648
//float Port_Import_N163 7680
//float3 Port_Import_N193 7696
//float3 Port_Import_N194 7712
//float3 Port_Import_N195 7728
//float3 Port_Import_N196 7744
//float2 Port_Scale_N198 7760
//float2 Port_Scale_N199 7768
//float2 Port_Scale_N200 7776
//float3 Port_Input1_N202 7792
//}
...
float Value_N68=0.0;
Value_N68=0.0;
float param_3=Value_N92;
float param_4=Value_N108;
float param_5=Value_N109;
float param_6=Value_N111;
float param_7=Value_N68;
ssGlobals param_8=Globals;
tempGlobals=param_8;
N71_SizeMin=param_3;
N71_SizeMax=param_4;
N71_FadeInTime=param_5;
N71_FadeOutTime=param_6;
N71_SizeMode=int(param_7);
float l9_489=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_490=l9_489;
float l9_491=gParticle.Life;
float l9_492=l9_491;
float l9_493=l9_490;
float l9_494=N71_FadeInTime/l9_492;
float l9_495=N71_FadeOutTime/l9_492;
float l9_496=fast::clamp(l9_493/l9_494,0.0,1.0);
float l9_497=fast::clamp((1.0-l9_493)/l9_495,0.0,1.0);
float l9_498=l9_496*l9_497;
float l9_499=l9_498;
float l9_500=mix(N71_SizeMin,N71_SizeMax,l9_499);
if (N71_SizeMode==1)
{
float3 l9_501=(*sc_set0.UserUniforms).vfxLocalAabbMax;
float3 l9_502=(*sc_set0.UserUniforms).vfxLocalAabbMin;
l9_500/=length(l9_501-l9_502);
}
float l9_503=l9_500;
gParticle.Size=l9_503;
...
float param_9=(*sc_set0.UserUniforms).Port_Min_N125;
float param_10=(*sc_set0.UserUniforms).Port_Max_N125;
...
bool l9_507=true;
float l9_508=125.0;
ssParticle l9_509=gParticle;
float l9_510=0.0;
float l9_511=param_12.gTimeElapsed;
float4 l9_512=float4(0.0);
float4 l9_513=float4(0.0);
if (l9_505)
{
l9_513.x=floor(fract(l9_511)*1000.0);
}
if (l9_507)
{
l9_513.y=float(l9_509.Index1D^((l9_509.Index1D*15299)+l9_509.Index1D));
}
if (l9_506)
{
l9_513.z=l9_508;
}
l9_513.w=l9_510*1000.0;
int l9_514=int(l9_513.x);
int l9_515=int(l9_513.y);
int l9_516=int(l9_513.z);
int l9_517=int(l9_513.w);
int l9_518=(((l9_514*15299)^(l9_515*30133))^(l9_516*17539))^(l9_517*12113);
int l9_519=l9_518;
if (l9_504==1)
{
int l9_520=l9_519;
int l9_521=l9_520;
int l9_522=((l9_521*((l9_521*1471343)+101146501))+1559861749)&2147483647;
int l9_523=l9_522;
...
int l9_529=l9_528;
int l9_530=l9_526*1399;
int l9_531=((l9_530*((l9_530*1471343)+101146501))+1559861749)&2147483647;
int l9_532=l9_531;
int l9_533=l9_529;
float l9_534=float(l9_533)*4.6566129e-10;
int l9_535=l9_532;
float l9_536=float(l9_535)*4.6566129e-10;
float2 l9_537=float2(l9_534,l9_536);
l9_512=float4(l9_537.x,l9_537.y,l9_512.z,l9_512.w);
}
else
{
if (l9_504==3)
...
float4 l9_576=float4(l9_569,l9_571,l9_573,l9_575);
l9_512=l9_576;
}
}
}
float4 l9_577=l9_512;
float4 l9_578=l9_577;
float param_11=mix(param_9,param_10,l9_578.x);
Random_N125=param_11;
...
float3 param_13=Value_N161;
float l9_579=dot(param_13,param_13);
float l9_580;
if (l9_579>0.0)
{
l9_580=1.0/sqrt(l9_579);
}
else
{
l9_580=0.0;
...
float l9_581=l9_580;
float3 param_14=param_13*l9_581;
Output_N162=param_14;
...
float3 param_15=Output_N162;
float param_16=Value_N163;
float3 l9_582=normalize(param_15);
float l9_583=sin(radians(param_16));
float l9_584=cos(radians(param_16));
float l9_585=1.0-l9_584;
float3x3 param_17=float3x3(float3(((l9_585*l9_582.x)*l9_582.x)+l9_584,((l9_585*l9_582.x)*l9_582.y)-(l9_582.z*l9_583),((l9_585*l9_582.z)*l9_582.x)+(l9_582.y*l9_583)),float3(((l9_585*l9_582.x)*l9_582.y)+(l9_582.z*l9_583),((l9_585*l9_582.y)*l9_582.y)+l9_584,((l9_585*l9_582.y)*l9_582.z)-(l9_582.x*l9_583)),float3(((l9_585*l9_582.z)*l9_582.x)-(l9_582.y*l9_583),((l9_585*l9_582.y)*l9_582.z)+(l9_582.x*l9_583),((l9_585*l9_582.z)*l9_582.z)+l9_584));
Matrix_N164=param_17;
...
float3 Value_N193=float3(0.0);
Value_N193=(*sc_set0.UserUniforms).Port_Import_N193;
float3 Value_N194=float3(0.0);
Value_N194=(*sc_set0.UserUniforms).Port_Import_N194;
float3 Value_N195=float3(0.0);
Value_N195=(*sc_set0.UserUniforms).Port_Import_N195;
float3 Value_N196=float3(0.0);
Value_N196=(*sc_set0.UserUniforms).Port_Import_N196;
float2 pXY_N197=float2(0.0);
float2 pYZ_N197=float2(0.0);
float2 pZX_N197=float2(0.0);
float3 param_18=Value_N194;
float3 param_19=Value_N195;
float3 param_20=Value_N196;
ssGlobals param_24=Globals;
tempGlobals=param_24;
float2 param_21=float2(0.0);
float2 param_22=float2(0.0);
float2 param_23=float2(0.0);
N197_Scale=param_18;
N197_Offset=param_19;
N197_Animate=param_20;
float3 l9_586=gParticle.Position;
float3 l9_587=l9_586;
float l9_588=tempGlobals.gTimeElapsedShifted;
l9_587+=(N197_Offset+(N197_Animate*l9_588));
l9_587/=N197_Scale;
N197_pXY=l9_587.xy+float2(4.3828201,0.312727);
N197_pYZ=l9_587.yz+float2(0.37720999,2.2231121);
N197_pZX=l9_587.zx+float2(2.0698199,0.881576);
param_21=N197_pXY;
param_22=N197_pYZ;
param_23=N197_pZX;
pXY_N197=param_21;
pYZ_N197=param_22;
pZX_N197=param_23;
float Noise_N198=0.0;
float2 param_25=pXY_N197;
float2 param_26=(*sc_set0.UserUniforms).Port_Scale_N198;
param_25.x=floor(param_25.x*10000.0)*9.9999997e-05;
param_25.y=floor(param_25.y*10000.0)*9.9999997e-05;
param_25*=(param_26*0.5);
float2 l9_589=param_25;
float param_27=(snoise(l9_589)*0.5)+0.5;
param_27=floor(param_27*10000.0)*9.9999997e-05;
Noise_N198=param_27;
float Noise_N199=0.0;
float2 param_28=pYZ_N197;
float2 param_29=(*sc_set0.UserUniforms).Port_Scale_N199;
param_28.x=floor(param_28.x*10000.0)*9.9999997e-05;
param_28.y=floor(param_28.y*10000.0)*9.9999997e-05;
param_28*=(param_29*0.5);
float2 l9_590=param_28;
float param_30=(snoise(l9_590)*0.5)+0.5;
param_30=floor(param_30*10000.0)*9.9999997e-05;
Noise_N199=param_30;
float Noise_N200=0.0;
float2 param_31=pZX_N197;
float2 param_32=(*sc_set0.UserUniforms).Port_Scale_N200;
param_31.x=floor(param_31.x*10000.0)*9.9999997e-05;
param_31.y=floor(param_31.y*10000.0)*9.9999997e-05;
param_31*=(param_32*0.5);
float2 l9_591=param_31;
float param_33=(snoise(l9_591)*0.5)+0.5;
param_33=floor(param_33*10000.0)*9.9999997e-05;
Noise_N200=param_33;
float3 Value_N201=float3(0.0);
Value_N201.x=Noise_N198;
Value_N201.y=Noise_N199;
Value_N201.z=Noise_N200;
float3 Output_N202=float3(0.0);
Output_N202=Value_N201*(*sc_set0.UserUniforms).Port_Input1_N202;
float3 Output_N203=float3(0.0);
Output_N203=Output_N202-float3(1.0);
float3 Output_N204=float3(0.0);
Output_N204=Value_N193*Output_N203;
gParticle.Force+=Output_N204;
float3x3 param_34=gParticle.Matrix;
gParticle.Quaternion=matrixToQuaternion(param_34);
float Drift=0.0049999999;
if (gParticle.Dead)
{
float4 param_35=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_592=param_35;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_593=dot(l9_592,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_594=l9_593;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_594;
}
}
float4 l9_595=float4(param_35.x,-param_35.y,(param_35.z*0.5)+(param_35.w*0.5),param_35.w);
out.gl_Position=l9_595;
return out;
}
float l9_596;
...
{
l9_596=gParticle.Force.x;
}
gParticle.Force.x=l9_596;
float l9_597;
...
{
l9_597=gParticle.Force.y;
}
gParticle.Force.y=l9_597;
float l9_598;
...
{
l9_598=gParticle.Force.z;
}
gParticle.Force.z=l9_598;
...
{
l9_599=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_599;
float l9_600;
...
{
l9_600=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_600;
float l9_601;
...
{
l9_601=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_601;
...
Vertex.y=l9_603;
Vertex+=Offset;
float4 param_36=float4((Vertex*2.0)-float2(1.0),1.0,1.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_607=float4(param_36.x,-param_36.y,(param_36.z*0.5)+(param_36.w*0.5),param_36.w);
...
if (gParticle.Dead)
{
float4 param_37=float4(4334.0,4334.0,4334.0,0.0);
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_611=float4(param_37.x,-param_37.y,(param_37.z*0.5)+(param_37.w*0.5),param_37.w);

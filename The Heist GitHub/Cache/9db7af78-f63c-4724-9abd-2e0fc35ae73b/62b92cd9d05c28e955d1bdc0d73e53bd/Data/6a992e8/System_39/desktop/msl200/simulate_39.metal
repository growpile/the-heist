...
float l9_521=0.0;
float l9_522=param_12.gTimeElapsed;
...
float param_11=mix(param_9,param_10,l9_589.x);
...
float l9_590=dot(param_13,param_13);
float l9_591;
if (l9_590>0.0)
{
l9_591=1.0/sqrt(l9_590);
}
else
{
l9_591=0.0;
...
float l9_592=l9_591;
float3 param_14=param_13*l9_592;
...
float3 l9_593=normalize(param_15);
float l9_594=sin(radians(param_16));
float l9_595=cos(radians(param_16));
float l9_596=1.0-l9_595;
float3x3 param_17=float3x3(float3(((l9_596*l9_593.x)*l9_593.x)+l9_595,((l9_596*l9_593.x)*l9_593.y)-(l9_593.z*l9_594),((l9_596*l9_593.z)*l9_593.x)+(l9_593.y*l9_594)),float3(((l9_596*l9_593.x)*l9_593.y)+(l9_593.z*l9_594),((l9_596*l9_593.y)*l9_593.y)+l9_595,((l9_596*l9_593.y)*l9_593.z)-(l9_593.x*l9_594)),float3(((l9_596*l9_593.z)*l9_593.x)-(l9_593.y*l9_594),((l9_596*l9_593.y)*l9_593.z)+(l9_593.x*l9_594),((l9_596*l9_593.z)*l9_593.z)+l9_595));
...
float3 l9_597=gParticle.Position;
float3 l9_598=l9_597;
float l9_599=tempGlobals.gTimeElapsedShifted;
l9_598+=(N197_Offset+(N197_Animate*l9_599));
l9_598/=N197_Scale;
N197_pXY=l9_598.xy+float2(4.3828201,0.312727);
N197_pYZ=l9_598.yz+float2(0.37720999,2.2231121);
N197_pZX=l9_598.zx+float2(2.0698199,0.881576);
param_21=N197_pXY;
param_22=N197_pYZ;
param_23=N197_pZX;
pXY_N197=param_21;
...
float2 l9_600=param_25;
float param_27=(snoise(l9_600)*0.5)+0.5;
...
float2 l9_601=param_28;
float param_30=(snoise(l9_601)*0.5)+0.5;
...
float2 l9_602=param_31;
float param_33=(snoise(l9_602)*0.5)+0.5;
...
float4 l9_603=param_35;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_604=dot(l9_603,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_605=l9_604;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_605;
}
}
float4 l9_606=float4(param_35.x,-param_35.y,(param_35.z*0.5)+(param_35.w*0.5),param_35.w);
out.gl_Position=l9_606;
return out;
}
float l9_607;
...
{
l9_607=gParticle.Force.x;
}
gParticle.Force.x=l9_607;
float l9_608;
...
{
l9_608=gParticle.Force.y;
}
gParticle.Force.y=l9_608;
float l9_609;
...
{
l9_609=gParticle.Force.z;
}
gParticle.Force.z=l9_609;
...
{
l9_610=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_610;
float l9_611;
...
{
l9_611=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_611;
float l9_612;
...
{
l9_612=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_612;
...
float4 l9_618=float4(param_36.x,-param_36.y,(param_36.z*0.5)+(param_36.w*0.5),param_36.w);
...
float4 l9_622=float4(param_37.x,-param_37.y,(param_37.z*0.5)+(param_37.w*0.5),param_37.w);

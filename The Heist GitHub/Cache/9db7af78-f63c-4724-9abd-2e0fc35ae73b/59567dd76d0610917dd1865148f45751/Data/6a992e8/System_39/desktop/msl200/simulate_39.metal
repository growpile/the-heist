...
bool l9_508=true;
float l9_509=125.0;
ssParticle l9_510=gParticle;
float l9_511=0.0;
float l9_512=param_12.gTimeElapsed;
float4 l9_513=float4(0.0);
float4 l9_514=float4(0.0);
if (l9_506)
{
l9_514.x=floor(fract(l9_512)*1000.0);
}
if (l9_508)
{
l9_514.y=float(l9_510.Index1D^((l9_510.Index1D*15299)+l9_510.Index1D));
}
if (l9_507)
{
l9_514.z=l9_509;
}
l9_514.w=l9_511*1000.0;
int l9_515=int(l9_514.x);
int l9_516=int(l9_514.y);
int l9_517=int(l9_514.z);
int l9_518=int(l9_514.w);
int l9_519=(((l9_515*15299)^(l9_516*30133))^(l9_517*17539))^(l9_518*12113);
int l9_520=l9_519;
if (l9_505==1)
{
int l9_521=l9_520;
...
int l9_527=l9_520;
int l9_528=l9_527;
int l9_529=((l9_528*((l9_528*1471343)+101146501))+1559861749)&2147483647;
int l9_530=l9_529;
int l9_531=l9_527*1399;
int l9_532=((l9_531*((l9_531*1471343)+101146501))+1559861749)&2147483647;
int l9_533=l9_532;
int l9_534=l9_530;
float l9_535=float(l9_534)*4.6566129e-10;
int l9_536=l9_533;
float l9_537=float(l9_536)*4.6566129e-10;
float2 l9_538=float2(l9_535,l9_537);
l9_513=float4(l9_538.x,l9_538.y,l9_513.z,l9_513.w);
}
else
{
if (l9_505==3)
...
float3 l9_555=float3(l9_550,l9_552,l9_554);
l9_513=float4(l9_555.x,l9_555.y,l9_555.z,l9_513.w);
}
else
{
int l9_556=l9_520;
...
float4 l9_577=float4(l9_570,l9_572,l9_574,l9_576);
l9_513=l9_577;
}
}
}
float4 l9_578=l9_513;
float4 l9_579=l9_578;
float param_11=mix(param_9,param_10,l9_579.x);
...
float l9_580=dot(param_13,param_13);
float l9_581;
if (l9_580>0.0)
{
l9_581=1.0/sqrt(l9_580);
}
else
{
l9_581=0.0;
...
float l9_582=l9_581;
float3 param_14=param_13*l9_582;
...
float3 l9_583=normalize(param_15);
float l9_584=sin(radians(param_16));
float l9_585=cos(radians(param_16));
float l9_586=1.0-l9_585;
float3x3 param_17=float3x3(float3(((l9_586*l9_583.x)*l9_583.x)+l9_585,((l9_586*l9_583.x)*l9_583.y)-(l9_583.z*l9_584),((l9_586*l9_583.z)*l9_583.x)+(l9_583.y*l9_584)),float3(((l9_586*l9_583.x)*l9_583.y)+(l9_583.z*l9_584),((l9_586*l9_583.y)*l9_583.y)+l9_585,((l9_586*l9_583.y)*l9_583.z)-(l9_583.x*l9_584)),float3(((l9_586*l9_583.z)*l9_583.x)-(l9_583.y*l9_584),((l9_586*l9_583.y)*l9_583.z)+(l9_583.x*l9_584),((l9_586*l9_583.z)*l9_583.z)+l9_585));
...
float4 l9_587=param_19;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_588=dot(l9_587,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_589=l9_588;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_589;
}
}
float4 l9_590=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
out.gl_Position=l9_590;
return out;
}
float l9_591;
...
{
l9_591=gParticle.Force.x;
}
gParticle.Force.x=l9_591;
float l9_592;
...
{
l9_592=gParticle.Force.y;
}
gParticle.Force.y=l9_592;
float l9_593;
...
{
l9_593=gParticle.Force.z;
}
gParticle.Force.z=l9_593;
...
{
l9_594=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_594;
float l9_595;
...
{
l9_595=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_595;
float l9_596;
...
{
l9_596=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_596;
...
float4 l9_599=param_20;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_600=dot(l9_599,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_601=l9_600;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_601;
}
}
float4 l9_602=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);
out.gl_Position=l9_602;
...
float4 l9_606=float4(param_21.x,-param_21.y,(param_21.z*0.5)+(param_21.w*0.5),param_21.w);

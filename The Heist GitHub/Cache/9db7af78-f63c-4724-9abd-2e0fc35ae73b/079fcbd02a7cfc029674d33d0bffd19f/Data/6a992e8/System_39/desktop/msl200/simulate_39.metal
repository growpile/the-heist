...
l9_316=gParticle.Position;
float3 l9_317=float3(0.0);
float3 l9_318=l9_316;
float l9_319=dot(l9_318,l9_318);
float l9_320;
if (l9_319>0.0)
{
l9_320=1.0/sqrt(l9_319);
}
else
{
l9_320=0.0;
...
float l9_321=l9_320;
float3 l9_322=l9_318*l9_321;
l9_317=l9_322;
float l9_323=0.0;
float l9_324=(*sc_set0.UserUniforms).explosionForce;
l9_323=l9_324;
float3 l9_325=float3(0.0);
l9_325=l9_317*float3(l9_323);
gParticle.Force=l9_325;
float3 l9_326=float3(0.0);
l9_326=(*sc_set0.UserUniforms).Port_Import_N013;
float3 l9_327=float3(0.0);
l9_327=(*sc_set0.UserUniforms).Port_Import_N016;
float3 l9_328=float3(0.0);
float3 l9_329=l9_326;
float3 l9_330=l9_327;
ssGlobals l9_331=param_1;
int l9_332=3;
bool l9_333=true;
bool l9_334=true;
bool l9_335=true;
...
float l9_338=0.0;
float l9_339=l9_331.gTimeElapsed;
...
float3 l9_407=mix(l9_329,l9_330,l9_406.xyz);
l9_328=l9_407;
float3x3 l9_408=float3x3(float3(0.0),float3(0.0),float3(0.0));
float3 l9_409=l9_328;
float l9_410=cos(radians(l9_409.x));
float l9_411=sin(radians(l9_409.x));
float l9_412=cos(radians(l9_409.y));
float l9_413=sin(radians(l9_409.y));
float l9_414=cos(radians(l9_409.z));
float l9_415=sin(radians(l9_409.z));
float3x3 l9_416=float3x3(float3(l9_412*l9_414,(l9_410*l9_415)+((l9_411*l9_413)*l9_414),(l9_411*l9_415)-((l9_410*l9_413)*l9_414)),float3((-l9_412)*l9_415,(l9_410*l9_414)-((l9_411*l9_413)*l9_415),(l9_411*l9_414)+((l9_410*l9_413)*l9_415)),float3(l9_413,(-l9_411)*l9_412,l9_410*l9_412));
l9_408=l9_416;
gParticle.Matrix=l9_408;
float4 l9_417=float4(0.0);
float4 l9_418=(*sc_set0.UserUniforms).Tweak_N79;
l9_417=l9_418;
float4 l9_419=float4(0.0);
l9_419=l9_417;
float4 l9_420=float4(0.0);
float4 l9_421=(*sc_set0.UserUniforms).Tweak_N80;
l9_420=l9_421;
float4 l9_422=float4(0.0);
l9_422=l9_420;
float l9_423=0.0;
float l9_424=(*sc_set0.UserUniforms).Port_Min_N043;
float l9_425=(*sc_set0.UserUniforms).Port_Max_N043;
ssGlobals l9_426=param_1;
int l9_427=1;
bool l9_428=true;
bool l9_429=true;
bool l9_430=true;
float l9_431=43.0;
ssParticle l9_432=gParticle;
float l9_433=0.0;
float l9_434=l9_426.gTimeElapsed;
float4 l9_435=float4(0.0);
float4 l9_436=float4(0.0);
if (l9_428)
{
l9_436.x=floor(fract(l9_434)*1000.0);
}
if (l9_430)
{
l9_436.y=float(l9_432.Index1D^((l9_432.Index1D*15299)+l9_432.Index1D));
}
if (l9_429)
{
l9_436.z=l9_431;
}
l9_436.w=l9_433*1000.0;
int l9_437=int(l9_436.x);
int l9_438=int(l9_436.y);
int l9_439=int(l9_436.z);
int l9_440=int(l9_436.w);
int l9_441=(((l9_437*15299)^(l9_438*30133))^(l9_439*17539))^(l9_440*12113);
int l9_442=l9_441;
if (l9_427==1)
{
int l9_443=l9_442;
...
float2 l9_460=float2(l9_457,l9_459);
l9_435=float4(l9_460.x,l9_460.y,l9_435.z,l9_435.w);
}
else
{
if (l9_427==3)
...
float3 l9_477=float3(l9_472,l9_474,l9_476);
l9_435=float4(l9_477.x,l9_477.y,l9_477.z,l9_435.w);
}
else
{
int l9_478=l9_442;
...
float4 l9_499=float4(l9_492,l9_494,l9_496,l9_498);
l9_435=l9_499;
}
}
}
float4 l9_500=l9_435;
float4 l9_501=l9_500;
float l9_502=mix(l9_424,l9_425,l9_501.x);
l9_423=l9_502;
float4 l9_503=float4(0.0);
l9_503=mix(l9_419,l9_422,float4(l9_423));

...
//float3 Port_Import_N177 7584
//float3 Port_Import_N178 7600
//float3 Port_Import_N179 7616
//float3 Port_Import_N180 7632
//float2 Port_Scale_N182 7648
//float2 Port_Scale_N006 7656
//float2 Port_Scale_N184 7664
//float3 Port_Input1_N032 7680
//float Port_Import_N092 7696
//float Port_Import_N108 7700
//float Port_Import_N109 7704
//float Port_Import_N111 7708
//float Port_Import_N041 7712
//float Port_Import_N059 7716
//float Port_Input0_N063 7724
//float Port_Import_N185 7728
//float Port_Input1_N227 7736
//float Port_Input2_N227 7740
//float Port_Input0_N066 7744
//float Port_Import_N188 7748
//float Port_Input1_N236 7756
//float Port_Input2_N236 7760
//float Port_Min_N125 7764
//float Port_Max_N125 7768
//float Port_Import_N163 7792
//}
...
float Port_Min_N043;
float Port_Max_N043;
float3 Port_Import_N177;
float3 Port_Import_N178;
float3 Port_Import_N179;
float3 Port_Import_N180;
float2 Port_Scale_N182;
float2 Port_Scale_N006;
float2 Port_Scale_N184;
float3 Port_Input1_N032;
...
float3 N181_Scale=float3(0.0);
float3 N181_Offset=float3(0.0);
float3 N181_Animate=float3(0.0);
float2 N181_pXY=float2(0.0);
float2 N181_pYZ=float2(0.0);
float2 N181_pZX=float2(0.0);
int N71_SizeMode=0;
...
l9_484=(*sc_set0.UserUniforms).Port_Import_N177;
float3 l9_485=float3(0.0);
l9_485=(*sc_set0.UserUniforms).Port_Import_N178;
float3 l9_486=float3(0.0);
l9_486=(*sc_set0.UserUniforms).Port_Import_N179;
float3 l9_487=float3(0.0);
l9_487=(*sc_set0.UserUniforms).Port_Import_N180;
float2 l9_488=float2(0.0);
float2 l9_489=float2(0.0);
float2 l9_490=float2(0.0);
float3 l9_491=l9_485;
float3 l9_492=l9_486;
float3 l9_493=l9_487;
ssGlobals l9_494=param_1;
tempGlobals=l9_494;
...
N181_Offset=l9_492;
N181_Animate=l9_493;
float3 l9_498=gParticle.Position;
float3 l9_499=l9_498;
float l9_500=tempGlobals.gTimeElapsedShifted;
l9_499+=(N181_Offset+(N181_Animate*l9_500));
l9_499/=N181_Scale;
N181_pXY=l9_499.xy+float2(4.3828201,0.312727);
N181_pYZ=l9_499.yz+float2(0.37720999,2.2231121);
N181_pZX=l9_499.zx+float2(2.0698199,0.881576);
l9_495=N181_pXY;
l9_496=N181_pYZ;
l9_497=N181_pZX;
l9_488=l9_495;
...
l9_490=l9_497;
float l9_501=0.0;
float2 l9_502=l9_488;
float2 l9_503=(*sc_set0.UserUniforms).Port_Scale_N182;
l9_502.x=floor(l9_502.x*10000.0)*9.9999997e-05;
l9_502.y=floor(l9_502.y*10000.0)*9.9999997e-05;
l9_502*=(l9_503*0.5);
float2 l9_504=l9_502;
float l9_505=(snoise(l9_504)*0.5)+0.5;
l9_505=floor(l9_505*10000.0)*9.9999997e-05;
l9_501=l9_505;
float l9_506=0.0;
float2 l9_507=l9_489;
float2 l9_508=(*sc_set0.UserUniforms).Port_Scale_N006;
l9_507.x=floor(l9_507.x*10000.0)*9.9999997e-05;
l9_507.y=floor(l9_507.y*10000.0)*9.9999997e-05;
l9_507*=(l9_508*0.5);
float2 l9_509=l9_507;
float l9_510=(snoise(l9_509)*0.5)+0.5;
l9_510=floor(l9_510*10000.0)*9.9999997e-05;
l9_506=l9_510;
float l9_511=0.0;
float2 l9_512=l9_490;
float2 l9_513=(*sc_set0.UserUniforms).Port_Scale_N184;
l9_512.x=floor(l9_512.x*10000.0)*9.9999997e-05;
l9_512.y=floor(l9_512.y*10000.0)*9.9999997e-05;
l9_512*=(l9_513*0.5);
float2 l9_514=l9_512;
float l9_515=(snoise(l9_514)*0.5)+0.5;
l9_515=floor(l9_515*10000.0)*9.9999997e-05;
l9_511=l9_515;
...
l9_517=l9_516*(*sc_set0.UserUniforms).Port_Input1_N032;
float3 l9_518=float3(0.0);
l9_518=l9_517-float3(1.0);
float3 l9_519=float3(0.0);
l9_519=l9_484*l9_518;
gParticle.Force+=l9_519;
...
float4 l9_520=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_521=dot(l9_520,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_522=l9_521;
...
{
out.varClipDistance=l9_522;
}
}
float4 l9_523=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_523;
return out;
}
float Value_N92=0.0;
...
float l9_525=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_526=l9_525;
float l9_527=gParticle.Life;
float l9_528=l9_527;
float l9_529=l9_526;
float l9_530=N71_FadeInTime/l9_528;
float l9_531=N71_FadeOutTime/l9_528;
float l9_532=fast::clamp(l9_529/l9_530,0.0,1.0);
float l9_533=fast::clamp((1.0-l9_529)/l9_531,0.0,1.0);
float l9_534=l9_532*l9_533;
float l9_535=l9_534;
float l9_536=mix(N71_SizeMin,N71_SizeMax,l9_535);
if (N71_SizeMode==1)
{
float3 l9_537=(*sc_set0.UserUniforms).vfxLocalAabbMax;
float3 l9_538=(*sc_set0.UserUniforms).vfxLocalAabbMin;
l9_536/=length(l9_537-l9_538);
}
float l9_539=l9_536;
gParticle.Size=l9_539;
...
float l9_546=0.0;
float l9_547=param_12.gTimeElapsed;
...
float param_11=mix(param_9,param_10,l9_614.x);
...
float l9_615=dot(param_13,param_13);
float l9_616;
if (l9_615>0.0)
{
l9_616=1.0/sqrt(l9_615);
}
else
{
l9_616=0.0;
...
float l9_617=l9_616;
float3 param_14=param_13*l9_617;
...
float3 l9_618=normalize(param_15);
float l9_619=sin(radians(param_16));
float l9_620=cos(radians(param_16));
float l9_621=1.0-l9_620;
float3x3 param_17=float3x3(float3(((l9_621*l9_618.x)*l9_618.x)+l9_620,((l9_621*l9_618.x)*l9_618.y)-(l9_618.z*l9_619),((l9_621*l9_618.z)*l9_618.x)+(l9_618.y*l9_619)),float3(((l9_621*l9_618.x)*l9_618.y)+(l9_618.z*l9_619),((l9_621*l9_618.y)*l9_618.y)+l9_620,((l9_621*l9_618.y)*l9_618.z)-(l9_618.x*l9_619)),float3(((l9_621*l9_618.z)*l9_618.x)-(l9_618.y*l9_619),((l9_621*l9_618.y)*l9_618.z)+(l9_618.x*l9_619),((l9_621*l9_618.z)*l9_618.z)+l9_620));
...
float4 l9_625=float4(param_19.x,-param_19.y,(param_19.z*0.5)+(param_19.w*0.5),param_19.w);
...
{
l9_626=gParticle.Force.x;
}
gParticle.Force.x=l9_626;
float l9_627;
...
{
l9_627=gParticle.Force.y;
}
gParticle.Force.y=l9_627;
float l9_628;
...
{
l9_628=gParticle.Force.z;
}
gParticle.Force.z=l9_628;
...
{
l9_629=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_629;
float l9_630;
...
{
l9_630=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_630;
float l9_631;
...
{
l9_631=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_631;
...
if (sc_StereoRenderingMode_tmp==1)
{
float l9_635=dot(l9_634,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_636=l9_635;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_636;
}
}
float4 l9_637=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);
out.gl_Position=l9_637;
...
float4 l9_638=param_21;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_639=dot(l9_638,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_640=l9_639;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_640;
}
}
float4 l9_641=float4(param_21.x,-param_21.y,(param_21.z*0.5)+(param_21.w*0.5),param_21.w);
out.gl_Position=l9_641;
return out;
}
return out;
}

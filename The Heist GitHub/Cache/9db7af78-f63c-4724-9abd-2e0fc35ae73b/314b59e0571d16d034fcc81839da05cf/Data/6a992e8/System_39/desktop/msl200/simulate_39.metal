...
//float3 Port_Import_N033 7632
//float Port_Import_N077 7648
//float Port_Import_N092 7652
//float Port_Import_N108 7656
//float Port_Import_N109 7660
//float Port_Import_N111 7664
//float Port_Import_N041 7668
//float Port_Import_N059 7672
//float Port_Input0_N063 7680
//float Port_Import_N185 7684
//float Port_Input1_N227 7692
//float Port_Input2_N227 7696
//float Port_Input0_N066 7700
//float Port_Import_N188 7704
//float Port_Input1_N236 7712
//float Port_Input2_N236 7716
//float Port_Min_N125 7720
//float Port_Max_N125 7724
...
float3 l9_495=float3(0.0);
l9_495=(*sc_set0.UserUniforms).Port_Import_N033;
float3 l9_496=float3(0.0);
float3 l9_497=l9_495;
float l9_498=dot(l9_497,l9_497);
float l9_499;
if (l9_498>0.0)
{
l9_499=1.0/sqrt(l9_498);
}
else
{
l9_499=0.0;
...
float l9_500=l9_499;
float3 l9_501=l9_497*l9_500;
l9_496=l9_501;
float l9_502=0.0;
l9_502=(*sc_set0.UserUniforms).Port_Import_N077;
float3 l9_503=float3(0.0);
l9_503=l9_496*float3(l9_502);
gParticle.Force+=l9_503;
...
float4 l9_504=param_2;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_505=dot(l9_504,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_506=l9_505;
...
{
out.varClipDistance=l9_506;
}
}
float4 l9_507=float4(param_2.x,-param_2.y,(param_2.z*0.5)+(param_2.w*0.5),param_2.w);
out.gl_Position=l9_507;
return out;
}
float Value_N92=0.0;
...
float l9_509=fast::clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_510=l9_509;
float l9_511=gParticle.Life;
float l9_512=l9_511;
float l9_513=l9_510;
float l9_514=N71_FadeInTime/l9_512;
float l9_515=N71_FadeOutTime/l9_512;
float l9_516=fast::clamp(l9_513/l9_514,0.0,1.0);
float l9_517=fast::clamp((1.0-l9_513)/l9_515,0.0,1.0);
float l9_518=l9_516*l9_517;
float l9_519=l9_518;
float l9_520=mix(N71_SizeMin,N71_SizeMax,l9_519);
if (N71_SizeMode==1)
{
float3 l9_521=(*sc_set0.UserUniforms).vfxLocalAabbMax;
float3 l9_522=(*sc_set0.UserUniforms).vfxLocalAabbMin;
l9_520/=length(l9_521-l9_522);
}
float l9_523=l9_520;
gParticle.Size=l9_523;
...
bool l9_527=true;
float l9_528=125.0;
ssParticle l9_529=gParticle;
float l9_530=0.0;
float l9_531=param_12.gTimeElapsed;
float4 l9_532=float4(0.0);
float4 l9_533=float4(0.0);
if (l9_525)
{
l9_533.x=floor(fract(l9_531)*1000.0);
}
if (l9_527)
{
l9_533.y=float(l9_529.Index1D^((l9_529.Index1D*15299)+l9_529.Index1D));
}
if (l9_526)
{
l9_533.z=l9_528;
}
l9_533.w=l9_530*1000.0;
int l9_534=int(l9_533.x);
int l9_535=int(l9_533.y);
int l9_536=int(l9_533.z);
int l9_537=int(l9_533.w);
int l9_538=(((l9_534*15299)^(l9_535*30133))^(l9_536*17539))^(l9_537*12113);
int l9_539=l9_538;
if (l9_524==1)
{
int l9_540=l9_539;
...
int l9_552=l9_551;
int l9_553=l9_549;
float l9_554=float(l9_553)*4.6566129e-10;
int l9_555=l9_552;
float l9_556=float(l9_555)*4.6566129e-10;
float2 l9_557=float2(l9_554,l9_556);
l9_532=float4(l9_557.x,l9_557.y,l9_532.z,l9_532.w);
}
else
{
if (l9_524==3)
...
float3 l9_574=float3(l9_569,l9_571,l9_573);
l9_532=float4(l9_574.x,l9_574.y,l9_574.z,l9_532.w);
}
else
{
int l9_575=l9_539;
...
float4 l9_596=float4(l9_589,l9_591,l9_593,l9_595);
l9_532=l9_596;
}
}
}
float4 l9_597=l9_532;
float4 l9_598=l9_597;
float param_11=mix(param_9,param_10,l9_598.x);
...
float l9_599=dot(param_13,param_13);
float l9_600;
if (l9_599>0.0)
{
l9_600=1.0/sqrt(l9_599);
}
else
{
l9_600=0.0;
...
float l9_601=l9_600;
float3 param_14=param_13*l9_601;
...
float3 l9_602=normalize(param_15);
float l9_603=sin(radians(param_16));
float l9_604=cos(radians(param_16));
float l9_605=1.0-l9_604;
float3x3 param_17=float3x3(float3(((l9_605*l9_602.x)*l9_602.x)+l9_604,((l9_605*l9_602.x)*l9_602.y)-(l9_602.z*l9_603),((l9_605*l9_602.z)*l9_602.x)+(l9_602.y*l9_603)),float3(((l9_605*l9_602.x)*l9_602.y)+(l9_602.z*l9_603),((l9_605*l9_602.y)*l9_602.y)+l9_604,((l9_605*l9_602.y)*l9_602.z)-(l9_602.x*l9_603)),float3(((l9_605*l9_602.z)*l9_602.x)-(l9_602.y*l9_603),((l9_605*l9_602.y)*l9_602.z)+(l9_602.x*l9_603),((l9_605*l9_602.z)*l9_602.z)+l9_604));
...
{
l9_610=gParticle.Force.x;
}
gParticle.Force.x=l9_610;
float l9_611;
...
{
l9_611=gParticle.Force.y;
}
gParticle.Force.y=l9_611;
float l9_612;
...
{
l9_612=gParticle.Force.z;
}
gParticle.Force.z=l9_612;
...
{
l9_613=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_613;
float l9_614;
...
{
l9_614=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_614;
float l9_615;
...
{
l9_615=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_615;
...
float4 l9_618=param_20;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_619=dot(l9_618,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_620=l9_619;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_620;
}
}
float4 l9_621=float4(param_20.x,-param_20.y,(param_20.z*0.5)+(param_20.w*0.5),param_20.w);
out.gl_Position=l9_621;
...
float4 l9_625=float4(param_21.x,-param_21.y,(param_21.z*0.5)+(param_21.w*0.5),param_21.w);

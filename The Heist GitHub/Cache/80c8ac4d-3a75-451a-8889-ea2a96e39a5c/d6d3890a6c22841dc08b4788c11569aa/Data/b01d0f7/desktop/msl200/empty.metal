...
//float4 Port_Input1_N008 4768
//float Port_Exponent_N000 4784
//float Port_Intensity_N000 4788
//float Port_Exponent_N011 4792
//float Port_Intensity_N011 4796
//float Port_Opacity_N007 4800
//float3 Port_Emissive_N007 4832
//float Port_Metallic_N007 4848
//float Port_Roughness_N007 4852
//float3 Port_AO_N007 4864
//float3 Port_SpecularAO_N007 4880
//float depthRef 4896
//}
...
constant bool Tweak_N10 [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTex [[function_constant(82)]];
...
float Port_Exponent_N011;
float Port_Intensity_N011;
...
l9_89=l9_2+(*sc_set0.UserUniforms).Port_Input1_N008;
param_1=l9_89;
param_3=param_1;
}
else
...
float l9_99=0.0;
float l9_100=(*sc_set0.UserUniforms).Port_Exponent_N011;
float l9_101=(*sc_set0.UserUniforms).Port_Intensity_N011;
ssGlobals l9_102=param_4;
float l9_103=abs(dot(-l9_102.ViewDirWS,l9_102.VertexNormal_WorldSpace));
float l9_104=1.0-pow(1.0-l9_103,l9_100);
l9_104=fast::max(l9_104,0.0);
l9_104*=l9_101;
l9_99=l9_104;
float4 l9_105=float4(0.0);
l9_105=l9_98*float4(l9_99);
param_2=l9_105;
param_3=param_2;
}
Output_N9=param_3;
float4 Output_N7=float4(0.0);
float3 param_5=Output_N9.xyz;
float param_6=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_7=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_8=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_9=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_10=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_11=(*sc_set0.UserUniforms).Port_SpecularAO_N007;
ssGlobals param_13=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_13.BumpedNormal=param_13.VertexNormal_WorldSpace;
}
float l9_106=param_6;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_106<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_120=fast::max(param_14,float4(0.0));
float4 param_15=l9_120;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_123=fast::clamp(l9_122.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_123=fast::clamp(dot(l9_122.xyz,float3(l9_122.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_123=(1.0-dot(l9_122.xyz,float3(0.33333001)))*l9_122.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_123=(1.0-fast::clamp(dot(l9_122.xyz,float3(1.0)),0.0,1.0))*l9_122.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_123=fast::clamp(dot(l9_122.xyz,float3(1.0)),0.0,1.0)*l9_122.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_123=fast::clamp(dot(l9_122.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_123=dot(l9_122.xyz,float3(0.33333001))*l9_122.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_123=1.0-fast::clamp(dot(l9_122.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_124=l9_123;
float l9_125=l9_124;
float l9_126=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_125;
float3 l9_127=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_121.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_128=float4(l9_127.x,l9_127.y,l9_127.z,l9_126);
param_16=l9_128;
}
else
{
...
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_132=out.sc_FragData0;
l9_131=l9_132;
}
else
{
float4 l9_133=gl_FragCoord;
float2 l9_134=l9_133.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_139=l9_138;
int l9_140=l9_139;
float3 l9_141=float3(l9_135,0.0);
int l9_142=l9_137;
int l9_143=l9_140;
if (l9_142==1)
{
l9_141.y=((2.0*l9_141.y)+float(l9_143))-1.0;
}
float2 l9_144=l9_141.xy;
l9_136=l9_144;
}
else
{
...
float4 l9_166=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_165.xy,bias(l9_159));
float4 l9_167=l9_166;
float4 l9_168=l9_167;
l9_131=l9_168;
}
float4 l9_169=l9_131;
float3 l9_170=l9_169.xyz;
float3 l9_171=l9_170;
float3 l9_172=l9_129.xyz;
float3 l9_173=definedBlend(l9_171,l9_172,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_130=float4(l9_173.x,l9_173.y,l9_173.z,l9_130.w);
float3 l9_174=mix(l9_170,l9_130.xyz,float3(l9_129.w));
l9_130=float4(l9_174.x,l9_174.y,l9_174.z,l9_130.w);
l9_130.w=1.0;
float4 l9_175=l9_130;
param_16=l9_175;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_176=float4(in.varScreenPos.xyz,1.0);
param_16=l9_176;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_177=gl_FragCoord;
float l9_178=fast::clamp(abs(l9_177.z),0.0,1.0);
float4 l9_179=float4(l9_178,1.0-l9_178,1.0,1.0);
param_16=l9_179;
}
else
{
float4 l9_180=param_16;
float4 l9_181=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_181=float4(mix(float3(1.0),l9_180.xyz,float3(l9_180.w)),l9_180.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_182=l9_180.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_182=fast::clamp(l9_182,0.0,1.0);
}
l9_181=float4(l9_180.xyz*l9_182,l9_182);
}
else
{
l9_181=l9_180;

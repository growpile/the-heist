...
float4 param_12=(*sc_set0.UserUniforms).baseColor;
Output_N1=param_12;
float Rim_N0=0.0;
float param_13=(*sc_set0.UserUniforms).Port_Exponent_N000;
float param_14=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals param_16=Globals;
float l9_76=abs(dot(-param_16.ViewDirWS,param_16.VertexNormal_WorldSpace));
float param_15=pow(1.0-l9_76,param_13);
...
Output_N8=Color_N3+Output_N2;
float4 Output_N7=float4(0.0);
float3 param_17=Output_N8.xyz;
float param_18=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_19=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_20=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_21=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_22=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_23=(*sc_set0.UserUniforms).Port_SpecularAO_N007;
ssGlobals param_25=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_25.BumpedNormal=param_25.VertexNormal_WorldSpace;
}
float l9_77=param_18;
...
float4 l9_91=fast::max(param_26,float4(0.0));
float4 param_27=l9_91;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_100=param_28;
float4 l9_101=float4(0.0);
float4 l9_102=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_103=out.sc_FragData0;
l9_102=l9_103;
}
else
{
...
float4 l9_140=l9_102;
float3 l9_141=l9_140.xyz;
float3 l9_142=l9_141;
float3 l9_143=l9_100.xyz;
...
l9_101=float4(l9_144.x,l9_144.y,l9_144.z,l9_101.w);
float3 l9_145=mix(l9_141,l9_101.xyz,float3(l9_100.w));
l9_101=float4(l9_145.x,l9_145.y,l9_145.z,l9_101.w);
l9_101.w=1.0;
float4 l9_146=l9_101;
param_28=l9_146;
}
else
{

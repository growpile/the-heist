...
//float Port_Exponent_N011 4776
//float Port_Intensity_N011 4780
//float Port_Opacity_N007 4784
...
float l9_98=0.0;
float l9_99=(*sc_set0.UserUniforms).Port_Exponent_N011;
float l9_100=(*sc_set0.UserUniforms).Port_Intensity_N011;
ssGlobals l9_101=param_4;
float l9_102=abs(dot(-l9_101.ViewDirWS,l9_101.VertexNormal_WorldSpace));
float l9_103=1.0-pow(1.0-l9_102,l9_99);
l9_103=fast::max(l9_103,0.0);
l9_103*=l9_100;
l9_98=l9_103;
float4 l9_104=float4(0.0);
l9_104=l9_97+float4(l9_98);
...
{
float4 l9_106=float4(0.0);
float4 l9_107=(*sc_set0.UserUniforms).baseColor;
l9_106=l9_107;
float l9_108=0.0;
float l9_109=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_110=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_111=param_4;
float l9_112=abs(dot(-l9_111.ViewDirWS,l9_111.VertexNormal_WorldSpace));
float l9_113=pow(1.0-l9_112,l9_109);
l9_113=fast::max(l9_113,0.0);
l9_113*=l9_110;
l9_108=l9_113;
float4 l9_114=float4(0.0);
l9_114=l9_106+float4(l9_108);
float l9_115=0.0;
float l9_116=(*sc_set0.UserUniforms).Port_Exponent_N011;
float l9_117=(*sc_set0.UserUniforms).Port_Intensity_N011;
ssGlobals l9_118=param_4;
float l9_119=abs(dot(-l9_118.ViewDirWS,l9_118.VertexNormal_WorldSpace));
float l9_120=1.0-pow(1.0-l9_119,l9_116);
l9_120=fast::max(l9_120,0.0);
l9_120*=l9_117;
l9_115=l9_120;
float4 l9_121=float4(0.0);
l9_121=l9_114+float4(l9_115);
param_2=l9_121;
param_3=param_2;
}
Output_N9=param_3;
...
float l9_122=param_6;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_122<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_124=floor(mod(l9_123.xy,float2(4.0)));
float l9_125=(mod(dot(l9_124,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_122<l9_125)
{
discard_fragment();
}
...
float4 l9_136=fast::max(param_14,float4(0.0));
float4 param_15=l9_136;
if (sc_ShaderCacheConstant_tmp!=0)
{

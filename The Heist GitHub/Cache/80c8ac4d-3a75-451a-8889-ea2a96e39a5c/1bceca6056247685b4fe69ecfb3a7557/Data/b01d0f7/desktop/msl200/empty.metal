...
//float Port_Exponent_N011 4648
//float Port_Intensity_N011 4652
//float4 Port_Input1_N008 4656
//float Port_Opacity_N007 4672
//float3 Port_Emissive_N007 4704
//float Port_Metallic_N007 4720
//float Port_Roughness_N007 4724
//float3 Port_AO_N007 4736
//float3 Port_SpecularAO_N007 4752
//float depthRef 4768
//}
...
//spec_const bool Tweak_N10 34 0
...
constant bool Tweak_N10 [[function_constant(34)]];
...
float l9_10=0.0;
float l9_11=(*sc_set0.UserUniforms).Port_Exponent_N011;
float l9_12=(*sc_set0.UserUniforms).Port_Intensity_N011;
ssGlobals l9_13=param_4;
float l9_14=abs(dot(-l9_13.ViewDirWS,l9_13.VertexNormal_WorldSpace));
float l9_15=1.0-pow(1.0-l9_14,l9_11);
l9_15=fast::max(l9_15,0.0);
l9_15*=l9_12;
l9_10=l9_15;
float4 l9_16=float4(0.0);
l9_16=l9_9*float4(l9_10);
float4 l9_17=float4(0.0);
l9_17=l9_16+(*sc_set0.UserUniforms).Port_Input1_N008;
param_1=l9_17;
param_3=param_1;
}
else
...
float4 l9_19=(*sc_set0.UserUniforms).baseColor;
l9_18=l9_19;
float l9_20=0.0;
float l9_21=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_22=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_23=param_4;
float l9_24=abs(dot(-l9_23.ViewDirWS,l9_23.VertexNormal_WorldSpace));
float l9_25=pow(1.0-l9_24,l9_21);
l9_25=fast::max(l9_25,0.0);
l9_25*=l9_22;
l9_20=l9_25;
float4 l9_26=float4(0.0);
l9_26=l9_18+float4(l9_20);
float l9_27=0.0;
float l9_28=(*sc_set0.UserUniforms).Port_Exponent_N011;
float l9_29=(*sc_set0.UserUniforms).Port_Intensity_N011;
ssGlobals l9_30=param_4;
float l9_31=abs(dot(-l9_30.ViewDirWS,l9_30.VertexNormal_WorldSpace));
float l9_32=1.0-pow(1.0-l9_31,l9_28);
l9_32=fast::max(l9_32,0.0);
l9_32*=l9_29;
l9_27=l9_32;
float4 l9_33=float4(0.0);
l9_33=l9_26*float4(l9_27);
param_2=l9_33;
param_3=param_2;
}
Output_N9=param_3;
...
{
if (l9_34<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_36=floor(mod(l9_35.xy,float2(4.0)));
float l9_37=(mod(dot(l9_36,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_34<l9_37)
{
discard_fragment();
}
...
float4 l9_48=fast::max(param_14,float4(0.0));
float4 param_15=l9_48;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_57=param_16;
float4 l9_58=float4(0.0);
float4 l9_59=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_60=out.sc_FragData0;
l9_59=l9_60;
}
else
{
float4 l9_61=gl_FragCoord;
float2 l9_62=l9_61.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_63=l9_62;
...
int l9_67=l9_66;
int l9_68=l9_67;
float3 l9_69=float3(l9_63,0.0);
int l9_70=l9_65;
int l9_71=l9_68;
if (l9_70==1)
{
l9_69.y=((2.0*l9_69.y)+float(l9_71))-1.0;
}
float2 l9_72=l9_69.xy;
l9_64=l9_72;
}
else
{
...
int l9_83=l9_78;
float2 l9_84=l9_76;
int l9_85=sc_ScreenTextureLayout_tmp;
int l9_86=l9_83;
float l9_87=l9_77;
float2 l9_88=l9_84;
int l9_89=l9_85;
...
float3 l9_92=l9_91;
float3 l9_93=l9_92;
float4 l9_94=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_93.xy,bias(l9_87));
float4 l9_95=l9_94;
float4 l9_96=l9_95;
l9_59=l9_96;
}
...
l9_58=float4(l9_101.x,l9_101.y,l9_101.z,l9_58.w);
float3 l9_102=mix(l9_98,l9_58.xyz,float3(l9_57.w));
l9_58=float4(l9_102.x,l9_102.y,l9_102.z,l9_58.w);
l9_58.w=1.0;
float4 l9_103=l9_58;
param_16=l9_103;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_104=float4(in.varScreenPos.xyz,1.0);
param_16=l9_104;
}
else
{
...
float l9_106=fast::clamp(abs(l9_105.z),0.0,1.0);
float4 l9_107=float4(l9_106,1.0-l9_106,1.0,1.0);
param_16=l9_107;
}
else
{
float4 l9_108=param_16;
float4 l9_109=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_109=float4(mix(float3(1.0),l9_108.xyz,float3(l9_108.w)),l9_108.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_110=l9_108.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_110=fast::clamp(l9_110,0.0,1.0);
}
l9_109=float4(l9_108.xyz*l9_110,l9_110);
}
else
{
l9_109=l9_108;
...
float4 l9_115=param_18;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_115.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_115;
return out;
}
} // FRAGMENT SHADER

...
{
float l9_106=0.0;
float l9_107=(*sc_set0.UserUniforms).Port_Exponent_N011;
float l9_108=(*sc_set0.UserUniforms).Port_Intensity_N011;
ssGlobals l9_109=param_4;
float l9_110=abs(dot(-l9_109.ViewDirWS,l9_109.VertexNormal_WorldSpace));
float l9_111=1.0-pow(1.0-l9_110,l9_107);
l9_111=fast::max(l9_111,0.0);
l9_111*=l9_108;
l9_106=l9_111;
param_2=l9_106;
...
float l9_112=param_6;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_112<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_126=fast::max(param_14,float4(0.0));
float4 param_15=l9_126;
if (sc_ShaderCacheConstant_tmp!=0)
{

...
//float4 Port_Import_N059 4624
//float4 Port_Import_N060 4640
//float Port_Input0_N086 4656
//float Port_Input1_N086 4660
//float Port_RangeMinA_N062 4664
//float Port_RangeMaxA_N062 4668
//float Port_RangeMinB_N062 4672
//float Port_RangeMaxB_N062 4676
//float2 Port_Import_N063 4680
//float2 Port_Center_N065 4688
//float2 Port_Import_N066 4696
//float2 Port_Import_N068 4704
//float Port_Input1_N083 4712
//float Port_Input2_N083 4716
//float Port_Opacity_N007 4720
//float3 Port_Emissive_N007 4752
//float Port_Metallic_N007 4768
//float Port_Roughness_N007 4772
//float3 Port_AO_N007 4784
//float3 Port_SpecularAO_N007 4800
//float depthRef 4816
//}
...
float3 param_1=Export_N88.xyz;
float param_2=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_3=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_4=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_5=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_6=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_7=(*sc_set0.UserUniforms).Port_SpecularAO_N007;
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_8=float4(param_1,param_2);
}
else
{
float3 l9_5=param_1;
...
float4 l9_15=fast::max(param_10,float4(0.0));
float4 param_11=l9_15;
if (sc_ShaderCacheConstant_tmp!=0)
{

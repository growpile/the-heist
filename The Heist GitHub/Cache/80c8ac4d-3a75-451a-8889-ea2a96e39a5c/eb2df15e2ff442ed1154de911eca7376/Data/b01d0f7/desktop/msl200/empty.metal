...
//}
//ubo int UserUniforms 0:37:4752 {
...
//float Port_Opacity_N007 4648
//float3 Port_Emissive_N007 4672
//float Port_Metallic_N007 4688
//float Port_Roughness_N007 4692
//float3 Port_AO_N007 4704
//float3 Port_SpecularAO_N007 4720
//float depthRef 4736
//}
...
float l9_1=abs(dot(-param_5.ViewDirWS,param_5.VertexNormal_WorldSpace));
...
float3 param_6=Output_N2.xyz;
float param_7=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_8=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_9=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_10=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_11=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_12=(*sc_set0.UserUniforms).Port_SpecularAO_N007;
...
float4 l9_16=fast::max(param_15,float4(0.0));
float4 param_16=l9_16;
if (sc_ShaderCacheConstant_tmp!=0)
{

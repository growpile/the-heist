...
Output_N8=Color_N3+(*sc_set0.UserUniforms).Port_Input1_N008;
float4 Output_N7=float4(0.0);
float3 param_12=Output_N8.xyz;
float param_13=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_14=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_15=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_16=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_17=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_18=(*sc_set0.UserUniforms).Port_SpecularAO_N007;

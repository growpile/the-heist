...
Output_N7=param_24;
float Ratio_N9=0.0;
float param_26=dot(Globals.ViewDirWS,Globals.VertexNormal_WorldSpace);
float l9_91=fast::clamp(param_26,0.0,1.0);
Ratio_N9=l9_91;
float4 Output_N10=float4(0.0);
Output_N10=mix(Output_N7,(*sc_set0.UserUniforms).Port_Input1_N010,float4(Ratio_N9));

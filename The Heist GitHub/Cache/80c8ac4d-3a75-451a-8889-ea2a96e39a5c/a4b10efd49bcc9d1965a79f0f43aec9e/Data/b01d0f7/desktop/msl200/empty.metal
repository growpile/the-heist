...
//float4 Port_Input1_N009 4640
//float4 Port_Input2_N009 4656
//float Port_Exponent_N000 4672
//float Port_Intensity_N000 4676
//float Port_Opacity_N007 4680
...
Output_N1=param_4;
float Rim_N0=0.0;
float param_5=(*sc_set0.UserUniforms).Port_Exponent_N000;
float param_6=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals param_8=Globals;
float l9_1=abs(dot(-param_8.ViewDirWS,param_8.VertexNormal_WorldSpace));
...
float3 param_9=Output_N8.xyz;
float param_10=(*sc_set0.UserUniforms).Port_Opacity_N007;
float3 param_11=(*sc_set0.UserUniforms).Port_Emissive_N007;
float param_12=(*sc_set0.UserUniforms).Port_Metallic_N007;
float param_13=(*sc_set0.UserUniforms).Port_Roughness_N007;
float3 param_14=(*sc_set0.UserUniforms).Port_AO_N007;
float3 param_15=(*sc_set0.UserUniforms).Port_SpecularAO_N007;
...
float4 l9_16=fast::max(param_18,float4(0.0));
float4 param_19=l9_16;
if (sc_ShaderCacheConstant_tmp!=0)
{

...
float l9_115=param_6;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_115<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_117=floor(mod(l9_116.xy,float2(4.0)));
float l9_118=(mod(dot(l9_117,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_115<l9_118)
{
discard_fragment();
}
...
float4 l9_129=fast::max(param_14,float4(0.0));
float4 param_15=l9_129;
if (sc_ShaderCacheConstant_tmp!=0)
{

...
//float3 Port_Scale_N007 4512
//float3 Port_Offset_N007 4528
//float Port_Sharpness_N007 4544
//float2 Port_UVCoord_N003 4592
//float depthRef 4600
//}
...
float3 Port_Scale_N007;
float3 Port_Offset_N007;
float Port_Sharpness_N007;
float3 Port_Position_N007;
float3 Port_Normal_N007;
float2 Port_UVCoord_N003;
float depthRef;
};
struct sc_Bone_t
{
...
float3 param_2=(*sc_set0.UserUniforms).Port_Scale_N007;
float3 param_3=(*sc_set0.UserUniforms).Port_Offset_N007;
float param_4=(*sc_set0.UserUniforms).Port_Sharpness_N007;
ssGlobals param_6=Globals;
float3 l9_1=param_6.SurfacePosition_ObjectSpace;
float3 l9_2=param_6.VertexNormal_ObjectSpace;
l9_1+=param_3;
l9_1*=param_2;
l9_2=abs(l9_2);
param_6.gTriplanarCoords=l9_1.yz;
...
int l9_9=l9_4;
int l9_10=baseTexLayout_tmp;
int l9_11=l9_9;
float2 l9_12=(*sc_set0.UserUniforms).Port_UVCoord_N003;
bool l9_13=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_14=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_15=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_16=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_17=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_18=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_19=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_20=0.0;
...
float3 l9_85=l9_84;
float3 l9_86=l9_85;
float4 l9_87=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_86.xy,bias(l9_80));
float4 l9_88=l9_87;
if (l9_18)
{
...
l9_3=l9_89;
param_1=l9_3;
float4 l9_90=param_1;
param_6.gTriplanarCoords=l9_1.zx;
...
int l9_99=l9_97;
float2 l9_100=(*sc_set0.UserUniforms).Port_UVCoord_N003;
...
l9_91=l9_177;
param_1=l9_91;
float4 l9_178=param_1;
param_6.gTriplanarCoords=l9_1.xy;
...
int l9_185=l9_180;
int l9_186=baseTexLayout_tmp;
int l9_187=l9_185;
float2 l9_188=(*sc_set0.UserUniforms).Port_UVCoord_N003;
bool l9_189=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_190=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_191=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_192=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_193=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_194=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_195=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_196=0.0;
...
float4 l9_263=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_262.xy,bias(l9_256));
float4 l9_264=l9_263;
if (l9_194)
{
l9_264=mix(l9_195,l9_264,float4(l9_198));
}
float4 l9_265=l9_264;
l9_179=l9_265;
param_1=l9_179;
float4 l9_266=param_1;
float3 l9_267=l9_2;
l9_267=pow(l9_267,float3(1.0/(1.0-(param_4*0.99000001))));
float4 param_5=(((l9_90*l9_267.x)+(l9_178*l9_267.y))+(l9_266*l9_267.z))/float4((l9_267.x+l9_267.y)+l9_267.z);
Output_N7=param_5;
...
{
float4 l9_268=gl_FragCoord;
float2 l9_269=floor(mod(l9_268.xy,float2(4.0)));
float l9_270=(mod(dot(l9_269,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_7<l9_270)
{
discard_fragment();
}
...
float4 l9_271=fast::max(param_8,float4(0.0));
float4 param_9=l9_271;
if (sc_ShaderCacheConstant_tmp!=0)
{

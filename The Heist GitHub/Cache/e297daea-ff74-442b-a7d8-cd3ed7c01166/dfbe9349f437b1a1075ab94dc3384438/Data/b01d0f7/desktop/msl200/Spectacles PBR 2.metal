...
Value1_N35=param_22;
FinalColor=float4(Value1_N35,0.0);
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
...
float4 l9_721=fast::max(param_23,float4(0.0));
float4 param_24=l9_721;
if (sc_ShaderCacheConstant_tmp!=0)
{

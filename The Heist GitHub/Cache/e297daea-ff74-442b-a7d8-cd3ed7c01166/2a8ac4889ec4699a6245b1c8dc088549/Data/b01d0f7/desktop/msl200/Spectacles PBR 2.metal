...
//float opacityMultiplier 5096
//float2 Port_Center_N031 5104
//float Port_Opacity_N000 5112
...
int l9_624=l9_619;
int l9_625=normalTexLayout_tmp;
int l9_626=l9_624;
float2 l9_627=l9_618;
bool l9_628=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_629=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_630=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_631=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_632=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_633=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_634=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_635=0.0;
...
float4 l9_702=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_701.xy,bias(l9_695));
...
float3 l9_706=(l9_705.xyz*1.9921875)-float3(1.0);
l9_705=float4(l9_706.x,l9_706.y,l9_706.z,l9_705.w);
l9_617=l9_705;
param_5=l9_617;
param_7=param_5;
}
...
float l9_707=param_12;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_707<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_708=gl_FragCoord;
float2 l9_709=floor(mod(l9_708.xy,float2(4.0)));
float l9_710=(mod(dot(l9_709,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_707<l9_710)
{
discard_fragment();
}
...
float3 l9_711=param_11;
float l9_712=param_12;
float3 l9_713=param_20.BumpedNormal;
float3 l9_714=param_20.PositionWS;
float3 l9_715=param_20.ViewDirWS;
float3 l9_716=param_14;
float l9_717=param_15;
float l9_718=param_16;
float3 l9_719=param_17;
float3 l9_720=param_18;
param_19=ngsCalculateLighting(l9_711,l9_712,l9_713,l9_714,l9_715,l9_716,l9_717,l9_718,l9_719,l9_720,in.varStereoViewID,sc_set0.sc_EnvmapDiffuse,sc_set0.sc_EnvmapDiffuseSmpSC,sc_set0.sc_EnvmapSpecular,sc_set0.sc_EnvmapSpecularSmpSC,sc_set0.sc_ScreenTexture,sc_set0.sc_ScreenTextureSmpSC,sc_set0.sc_RayTracingReflections,sc_set0.sc_RayTracingReflectionsSmpSC,sc_set0.sc_RayTracingGlobalIllumination,sc_set0.sc_RayTracingGlobalIlluminationSmpSC,sc_set0.sc_RayTracingShadows,sc_set0.sc_RayTracingShadowsSmpSC,gl_FragCoord,(*sc_set0.UserUniforms),in.varShadowTex,sc_set0.sc_ShadowTexture,sc_set0.sc_ShadowTextureSmpSC,out.sc_FragData0,sc_set0.sc_SSAOTexture,sc_set0.sc_SSAOTextureSmpSC);
}
param_19=fast::max(param_19,float4(0.0));
Output_N0=param_19;
float3 Value1_N35=float3(0.0);
float Value2_N35=0.0;
float4 param_21=Output_N0;
float3 param_22=param_21.xyz;
float param_23=param_21.w;
Value1_N35=param_22;
Value2_N35=param_23;
float Output_N37=0.0;
float param_24=(*sc_set0.UserUniforms).opacityMultiplier;
Output_N37=param_24;
float Output_N38=0.0;
Output_N38=Value2_N35*Output_N37;
float4 Value_N36=float4(0.0);
Value_N36=float4(Value1_N35.x,Value1_N35.y,Value1_N35.z,Value_N36.w);
Value_N36.w=Output_N38;
...
float4 l9_721=fast::max(param_25,float4(0.0));
float4 param_26=l9_721;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_724=fast::clamp(l9_723.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_724=fast::clamp(dot(l9_723.xyz,float3(l9_723.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_724=(1.0-dot(l9_723.xyz,float3(0.33333001)))*l9_723.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_724=(1.0-fast::clamp(dot(l9_723.xyz,float3(1.0)),0.0,1.0))*l9_723.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_724=fast::clamp(dot(l9_723.xyz,float3(1.0)),0.0,1.0)*l9_723.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_724=fast::clamp(dot(l9_723.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_724=dot(l9_723.xyz,float3(0.33333001))*l9_723.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_724=1.0-fast::clamp(dot(l9_723.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_725=l9_724;
float l9_726=l9_725;
float l9_727=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_726;
float3 l9_728=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_722.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_729=float4(l9_728.x,l9_728.y,l9_728.z,l9_727);
param_27=l9_729;
}
else
{
...
{
float4 l9_730=param_27;
float4 l9_731=float4(0.0);
float4 l9_732=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_733=out.sc_FragData0;
l9_732=l9_733;
}
else
{
float4 l9_734=gl_FragCoord;
float2 l9_735=l9_734.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_740=l9_739;
int l9_741=l9_740;
float3 l9_742=float3(l9_736,0.0);
int l9_743=l9_738;
int l9_744=l9_741;
if (l9_743==1)
{
l9_742.y=((2.0*l9_742.y)+float(l9_744))-1.0;
}
float2 l9_745=l9_742.xy;
l9_737=l9_745;
}
else
{
...
int l9_756=l9_751;
float2 l9_757=l9_749;
int l9_758=sc_ScreenTextureLayout_tmp;
int l9_759=l9_756;
float l9_760=l9_750;
float2 l9_761=l9_757;
int l9_762=l9_758;
int l9_763=l9_759;
float3 l9_764=float3(0.0);
if (l9_762==0)
{
l9_764=float3(l9_761,0.0);
}
else
{
if (l9_762==1)
{
l9_764=float3(l9_761.x,(l9_761.y*0.5)+(0.5-(float(l9_763)*0.5)),0.0);
}
else
{
l9_764=float3(l9_761,float(l9_763));
}
}
float3 l9_765=l9_764;
float3 l9_766=l9_765;
float4 l9_767=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_766.xy,bias(l9_760));
float4 l9_768=l9_767;
float4 l9_769=l9_768;
l9_732=l9_769;
}
float4 l9_770=l9_732;
float3 l9_771=l9_770.xyz;
float3 l9_772=l9_771;
float3 l9_773=l9_730.xyz;
float3 l9_774=definedBlend(l9_772,l9_773,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_731=float4(l9_774.x,l9_774.y,l9_774.z,l9_731.w);
float3 l9_775=mix(l9_771,l9_731.xyz,float3(l9_730.w));
l9_731=float4(l9_775.x,l9_775.y,l9_775.z,l9_731.w);
l9_731.w=1.0;
float4 l9_776=l9_731;
param_27=l9_776;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_777=float4(in.varScreenPos.xyz,1.0);
param_27=l9_777;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_778=gl_FragCoord;
float l9_779=fast::clamp(abs(l9_778.z),0.0,1.0);
float4 l9_780=float4(l9_779,1.0-l9_779,1.0,1.0);
param_27=l9_780;
}
else
{
float4 l9_781=param_27;
float4 l9_782=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_782=float4(mix(float3(1.0),l9_781.xyz,float3(l9_781.w)),l9_781.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_783=l9_781.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_783=fast::clamp(l9_783,0.0,1.0);
}
l9_782=float4(l9_781.xyz*l9_783,l9_783);
}
else
{
l9_782=l9_781;
...
float4 l9_788=param_29;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_788.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_788;
return out;
}
} // FRAGMENT SHADER

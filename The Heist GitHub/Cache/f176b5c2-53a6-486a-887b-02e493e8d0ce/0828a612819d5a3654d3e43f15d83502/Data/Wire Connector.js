...
function init() {
    ...
    if (startHeadLocal) {
        var localOffset = baseTransform ? baseTransform.worldPointToLocal(baseTransform.getWorldPosition().add(returnOffset)) : vec3.zero();
        startHeadLocal = startHeadLocal.add(localOffset);
    }
    if (startHandleLocal) {
        var localOffset2 = baseTransform ? baseTransform.worldPointToLocal(baseTransform.getWorldPosition().add(returnOffset)) : vec3.zero();

...
let GameFlowController = (() => {
    ...
    var GameFlowController = _classThis = class extends _classSuper {
        ...
        handleSafeFailed() {
            ...
            global.utils.delay(0, () => {
                ...
                if (global.appState.safe?.object === prefabRoot) {
                    global.appState.safe = undefined;
                }
            });
        }
        ...
        getGroundPlanePropertyPath(material, key) {
        ...
        setGroundPlaneProperty(key, value) {
        ...
        animateGroundPlaneProperty(key, value, duration, callback) {
            const material = this.resolveGroundPlaneMaterial();
            if (!material) {
                callback?.();
                return;

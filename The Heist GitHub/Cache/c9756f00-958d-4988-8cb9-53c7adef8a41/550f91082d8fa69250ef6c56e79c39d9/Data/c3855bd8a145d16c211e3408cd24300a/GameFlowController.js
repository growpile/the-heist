...
let GameFlowController = (() => {
    ...
    var GameFlowController = _classThis = class extends _classSuper {
        ...
        playersReady() {
            ...
            this.hidePanel(this.roomWindow, () => {
        ...
        handleSafeComplete(safeType, solvedInSeconds) {
            print(safeType);
            this.setSolvedSeconds(solvedInSeconds);
        ...
        backToMenu() {
            ...
            if (state === "winPostGame" || state === "losePostGame") {
                if (state === "winPostGame") {
                    this.hidePanel(this.solvedWindow, () => {
                        this.menuController?.show();
                    });
                }
                else {
                    this.hidePanel(this.timedWindow, () => {
                        this.menuController?.show();
                    });
                }
            }
            else if (state === "tutorialWinPostGame") {
                this.hidePanel(this.tutorialSolvedWindow, () => {
                    this.menuController?.show();
                });
            }
        }
        ...
        replayTutorial() {
            ...
            this.hidePanel(this.settingsWindow, () => {
        ...
        async beginNetworkFlow() {
            ...
            this.hidePanel(this.loadingWindow, () => {
        ...
        // ---------- UI Panels (formerly GameUIController) ----------
        ...
        showPanel(panel) {
            ...
            const tween = LSTween_1.LSTween.scaleToWorld(panel.getTransform(), new vec3(1, 1, 1), PANEL_SHOW_MS)
                ...
                .start();
            this.activePanelTweens.push(tween);
        }

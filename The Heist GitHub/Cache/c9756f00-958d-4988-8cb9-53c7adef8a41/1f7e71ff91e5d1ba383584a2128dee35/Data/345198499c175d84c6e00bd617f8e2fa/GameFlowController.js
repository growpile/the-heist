...
let GameFlowController = (() => {
    ...
    var GameFlowController = _classThis = class extends _classSuper {
        ...
        /** Create Room button: pop main menu off, show room UI, then connect. */
        createRoom() {
            if (global.appState.inTransition || this.surfacePlacementActive) {
                return;
            }
            ...
            this.menuController?.popMainMenuAndShowRoom(() => {
        ...
        /** Room view CTA: hide UI and run surface anchoring before coop safe spawn. */
        startTeamSession() {
            if (global.appState.inTransition || this.surfacePlacementActive) {
                return;
            }
            print("[GameFlowController] startTeamSession()");
            global.playSfx(1, 1, global.appState.checkStorage("masterVolume") * 1);
            this.menuController?.hide(() => {
        ...
        /** Legacy scene callback name for room view play / ready button. */
        playersReady() {
            this.startTeamSession();
        }

...
var debugState = {
  left: { tracked: false, faceDown: false, distance: null, close: false },
  right: { tracked: false, faceDown: false, distance: null, close: false },
};
...
function updateDebug() {
  ...
  var orbitHand =
    activeHand && activeHand.handType ? activeHand.handType : "none";
  var left = debugState.left;
  ...
  lines.push(
    "Left tracked:" +
      ...
      left.faceDown +
      " dist:" +
      (left.distance ? left.distance.toFixed(1) : "-") +
      " close:" +
      left.close
  );
  lines.push(
    "Right tracked:" +
      ...
      right.faceDown +
      " dist:" +
      (right.distance ? right.distance.toFixed(1) : "-") +
      " close:" +
      right.close
  );
  lines.push(

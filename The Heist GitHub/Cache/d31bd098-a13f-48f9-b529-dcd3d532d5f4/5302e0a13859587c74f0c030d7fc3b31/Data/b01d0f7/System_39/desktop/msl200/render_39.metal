...
if (!l9_42)
{
l9_43=!(UserUniforms.vfxBatchEnable[ssInstanceID/170]!=0);
}
else
{
l9_43=l9_42;
...
bool l9_4=l9_3>=(170*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/170]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[ssInstanceID/170];
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/170];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
param_1.Index1DPerCopy=param%170;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(170*((param/170)+1))-1;
...
float param_12=0.0;
bool l9_27=param_10&&(!param_8);
float l9_28=1.0;
float l9_29=param_4.x;
int l9_30=param_7.x;
if (l9_30==1)
{
l9_29=fract(l9_29);
...
float l9_42=param_9.x;
float l9_43=param_9.z;
bool l9_44=l9_40;
float l9_45=l9_28;
...
float l9_50=param_4.y;
float l9_51=param_9.y;
float l9_52=param_9.w;
bool l9_53=l9_49;
float l9_54=l9_28;
...
float2 l9_57=param_4;
bool l9_58=param_5;
float3x3 l9_59=param_6;
if (l9_58)
{
...
param_4.y=l9_72;
l9_28=l9_75;
float2 l9_83=param_4;
int l9_84=param_2;
int l9_85=param_3;
float l9_86=param_12;
float2 l9_87=l9_83;
int l9_88=l9_84;
int l9_89=l9_85;
...
float3 l9_91=l9_90;
float3 l9_92=l9_91;
float4 l9_93=sc_set0.mainTex.sample(sc_set0.mainTexSmpSC,l9_92.xy,bias(l9_86));
float4 l9_94=l9_93;
if (param_10)
{
l9_94=mix(param_11,l9_94,float4(l9_28));
}
float4 l9_95=l9_94;
Color_N18=l9_95;
...
l9_97=float4(l9_140.x,l9_140.y,l9_140.z,l9_97.w);
float3 l9_141=mix(l9_137,l9_97.xyz,float3(l9_96.w));
l9_97=float4(l9_141.x,l9_141.y,l9_141.z,l9_97.w);
l9_97.w=1.0;
float4 l9_142=l9_97;
param_14=l9_142;
}
...
float4 l9_151=param_14;
Output_Color0=l9_151;

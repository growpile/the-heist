...
function onUpdate() {
    ...
    // Face position is the front face center; shift the detection center forward by half the depth
    var detectionCenter = center.add(axisConfig.axisWorld.uniformScale(axisConfig.axisSize * 0.5));

...
function onUpdate() {
    ...
    var size = script.buttonFace.script.getSceneObject().script.getSceneObject().getComponent('Physics.ColliderComponent')
    ...
    var allowProgressEvents = !(usePinchAnim && isEditor);
    if (allowProgressEvents) {

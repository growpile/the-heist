...
//sampler sampler Tweak_N12SmpSC 0:26
...
//texture texture2D Tweak_N12 0:4:0:26
//texture texture2D baseTex 0:5:0:27
...
//float3x3 Tweak_N12Transform 4800
//float4 Tweak_N12UvMinMax 4848
//float4 Tweak_N12BorderColor 4864
//float4 Port_Input1_N014 4880
//float Port_Exponent_N000 4896
//float Port_Intensity_N000 4900
//float Port_Opacity_N007 4904
//float3 Port_Emissive_N007 4928
//float Port_Metallic_N007 4944
//float Port_Roughness_N007 4948
//float3 Port_AO_N007 4960
//float3 Port_SpecularAO_N007 4976
//float depthRef 4992
//}
...
//spec_const bool Tweak_N12HasSwappedViews 41 0
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N12 [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N12 [[function_constant(37)]];
...
constant bool Tweak_N12HasSwappedViews [[function_constant(41)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 [[function_constant(86)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTex [[function_constant(87)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 [[function_constant(89)]];
...
constant int Tweak_N12Layout [[function_constant(92)]];
constant int Tweak_N12Layout_tmp = is_function_constant_defined(Tweak_N12Layout) ? Tweak_N12Layout : 0;
constant int baseTexLayout [[function_constant(93)]];
...
l9_89=l9_2*(*sc_set0.UserUniforms).Port_Input1_N014;
param_1=l9_89;
param_3=param_1;
}
else
...
l9_90=param_4.Surface_UVCoord0;
...
int l9_97=l9_92;
int l9_98=baseTexLayout_tmp;
int l9_99=l9_97;
float2 l9_100=l9_90;
bool l9_101=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_102=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_103=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_104=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_105=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_106=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_107=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_108=0.0;
bool l9_109=l9_106&&(!l9_104);
float l9_110=1.0;
float l9_111=l9_100.x;
int l9_112=l9_103.x;
if (l9_112==1)
{
l9_111=fract(l9_111);
...
float l9_123=l9_100.x;
float l9_124=l9_105.x;
float l9_125=l9_105.z;
bool l9_126=l9_122;
float l9_127=l9_110;
...
float l9_132=l9_100.y;
float l9_133=l9_105.y;
float l9_134=l9_105.w;
bool l9_135=l9_131;
float l9_136=l9_110;
...
float2 l9_139=l9_100;
bool l9_140=l9_101;
float3x3 l9_141=l9_102;
if (l9_140)
{
...
float4 l9_175=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_174.xy,bias(l9_168));
float4 l9_176=l9_175;
if (l9_106)
{
l9_176=mix(l9_107,l9_176,float4(l9_110));
}
float4 l9_177=l9_176;
l9_91=l9_177;
float4 l9_178=float4(0.0);
l9_178=l9_91*(*sc_set0.UserUniforms).Port_Input1_N014;
float l9_179=0.0;
float l9_180=(*sc_set0.UserUniforms).Port_Exponent_N000;
float l9_181=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals l9_182=param_4;
float l9_183=abs(dot(-l9_182.ViewDirWS,l9_182.VertexNormal_WorldSpace));
float l9_184=pow(1.0-l9_183,l9_180);
l9_184=fast::max(l9_184,0.0);
l9_184*=l9_181;
l9_179=l9_184;
float4 l9_185=float4(0.0);
l9_185=l9_178+float4(l9_179);
param_2=l9_185;
param_3=param_2;
}
Output_N9=param_3;
...
float param_15=0.0;
bool l9_192=param_13&&(!param_11);
float l9_193=1.0;
float l9_194=param_7.x;
int l9_195=param_10.x;
if (l9_195==1)
{
l9_194=fract(l9_194);
}
...
param_7.x=l9_194;
float l9_199=param_7.y;
int l9_200=param_10.y;
if (l9_200==1)
{
l9_199=fract(l9_199);
}
...
float l9_207=param_12.x;
float l9_208=param_12.z;
bool l9_209=l9_205;
float l9_210=l9_193;
...
float l9_215=param_7.y;
float l9_216=param_12.y;
float l9_217=param_12.w;
bool l9_218=l9_214;
float l9_219=l9_193;
...
float2 l9_222=param_7;
bool l9_223=param_8;
float3x3 l9_224=param_9;
if (l9_223)
{
...
param_7=l9_225;
float l9_226=param_7.x;
int l9_227=param_10.x;
bool l9_228=l9_192;
float l9_229=l9_193;
...
param_7.x=l9_226;
l9_193=l9_229;
float l9_237=param_7.y;
int l9_238=param_10.y;
bool l9_239=l9_192;
float l9_240=l9_193;
...
param_7.y=l9_237;
l9_193=l9_240;
float2 l9_248=param_7;
int l9_249=param_5;
int l9_250=param_6;
float l9_251=param_15;
...
float4 l9_258=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_257.xy,bias(l9_251));
float4 l9_259=l9_258;
if (param_13)
{
l9_259=mix(param_14,l9_259,float4(l9_193));
}
...
float l9_261=param_17;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_261<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_263=floor(mod(l9_262.xy,float2(4.0)));
float l9_264=(mod(dot(l9_263,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_261<l9_264)
{
discard_fragment();
}
...
float4 l9_275=fast::max(param_25,float4(0.0));
float4 param_26=l9_275;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_284=param_27;
float4 l9_285=float4(0.0);
float4 l9_286=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_287=out.sc_FragData0;
l9_286=l9_287;
}
else
{
...
int l9_310=l9_305;
float2 l9_311=l9_303;
int l9_312=sc_ScreenTextureLayout_tmp;
int l9_313=l9_310;
float l9_314=l9_304;
...
float4 l9_321=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_320.xy,bias(l9_314));
float4 l9_322=l9_321;
float4 l9_323=l9_322;
l9_286=l9_323;
}
float4 l9_324=l9_286;
float3 l9_325=l9_324.xyz;
float3 l9_326=l9_325;
float3 l9_327=l9_284.xyz;
float3 l9_328=definedBlend(l9_326,l9_327,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_285=float4(l9_328.x,l9_328.y,l9_328.z,l9_285.w);
float3 l9_329=mix(l9_325,l9_285.xyz,float3(l9_284.w));
l9_285=float4(l9_329.x,l9_329.y,l9_329.z,l9_285.w);
l9_285.w=1.0;
float4 l9_330=l9_285;
param_27=l9_330;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_331=float4(in.varScreenPos.xyz,1.0);
param_27=l9_331;
}
else
{
...
float l9_333=fast::clamp(abs(l9_332.z),0.0,1.0);
float4 l9_334=float4(l9_333,1.0-l9_333,1.0,1.0);
param_27=l9_334;
}
else
{
float4 l9_335=param_27;
float4 l9_336=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_336=float4(mix(float3(1.0),l9_335.xyz,float3(l9_335.w)),l9_335.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_337=l9_335.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_337=fast::clamp(l9_337,0.0,1.0);
}
l9_336=float4(l9_335.xyz*l9_337,l9_337);
}
else
{
l9_336=l9_335;
...
float4 l9_342=param_29;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_342.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_342;
return out;
}
} // FRAGMENT SHADER

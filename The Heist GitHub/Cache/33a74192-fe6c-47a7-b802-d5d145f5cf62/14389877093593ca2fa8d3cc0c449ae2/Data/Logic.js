...
script.playareaPositioned = function() {
    ...
    global.utils.animateScale(script.menuElements[0], false, new vec3(1, 1, 1), 0.1, function() {
        print("scaled up");
    })
        global.utils.animateScale(script.menuElements[1], false, new vec3(1, 1, 1), 0.1, function() {
        print("scaled up");
    })
        global.utils.animateScale(script.menuElements[2], false, new vec3(1, 1, 1), 0.1, function() {
        print("scaled up");
    })
        global.utils.animateScale(script.menuElements[3], false, new vec3(1, 1, 1), 0.1, function() {
        print("scaled up");
    })
}

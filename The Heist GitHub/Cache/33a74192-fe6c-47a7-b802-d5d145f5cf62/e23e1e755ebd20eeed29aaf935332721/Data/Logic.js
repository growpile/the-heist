...
script.startSolo = function() {
    ...
    global.tweenManager.startTween(script.menuElements[1], "pinch-animation", function() {
        hideMenu("soloPlay", function() {
            script.cardboardPrefab.instantiate(safeOrigin.getParent());
        });
    });
}
...
script.cardboardReady = function() {
    ...
    global.utils.delay(0.5, function() {
        global.utils.animatePosition(safeOrigin, true, new vec3(0, 0, -10), 0.25, function() {
            print("Safe Dropped.");
            global.playSfx(4, 1, 0.6);
            global.playSfx(5, 1, 0.6);
            global.playSfx(6, 1, 0.6);
            global.playSfx(7, 1, 0.6);
            global.playSfx(8, 1, 0.6);
            playSafeLandingVFX()
        });
    });
}

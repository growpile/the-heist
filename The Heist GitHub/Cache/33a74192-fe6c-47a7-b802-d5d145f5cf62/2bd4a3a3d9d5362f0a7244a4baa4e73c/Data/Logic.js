    ...
    global.utils.delay(1, function() {
        ...
        global.utils.animateScale(safeObject, true, overshootScale, 0.2, function() {
            global.utils.animateScale(safeObject, true, finalScale, 0.05, function() {
                ...
                global.playSfx(4, global.appState.getStorage("masterVolume") * 0.7, 1);
                global.playSfx(5, global.appState.getStorage("masterVolume") * 0.7, 1);
                global.playSfx(6, global.appState.getStorage("masterVolume") * 0.7, 1);
                global.playSfx(7, global.appState.getStorage("masterVolume") * 0.7, 1);
                global.playSfx(8, global.appState.getStorage("masterVolume") * 0.7, 1);
                playSafeLandingVFX()
...
script.startSolo = function() {
    ...
    global.playSfx(1, global.appState.getStorage("masterVolume") * 1, 1);
...
function showMenu(callback) {
    ...
    function animateNext() {
        ...
        animateWithOvershoot(element, new vec3(1.1, 1.1, 1.1), new vec3(1, 1, 1), function() {
            global.playSfx(0, global.appState.getStorage("masterVolume") * 0.7, 0.6);
            animateNext();
        });
    }

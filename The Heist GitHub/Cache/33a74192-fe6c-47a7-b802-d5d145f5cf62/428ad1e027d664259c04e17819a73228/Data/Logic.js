...
script.startSolo = function() {
    ...
    print("Starting Solo Play...");
     global.tweenManager.startTween(script.menuElements[1], "pinch-animation1", function()
    global.tweenManager.startTween(script.menuElements[1], "pinch-animation2", function() {

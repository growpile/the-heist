...
script.startSolo = function() {
    ...
    script.menuElements[1].getComponents("Component.ScriptComponent")[3].play3DParticles();
...
script.startTeam = function() {
    ...
    global.playSfx(1, 1, global.appState.checkStorage("masterVolume") * 1);
    global.tweenManager.startTween(script.menuElements[2], "pinch-animation", function() {

    ...
    global.utils.delay(1, function() {
        ...
        global.utils.animateScale(safeObject, true, overshootScale, 0.2, function() {
            global.utils.animateScale(safeObject, true, finalScale, 0.05, function() {
                ...
                global.playSfx(5, global.appState.getStorage("masterVolume") * 1, 1);
                global.playSfx(6, global.appState.getStorage("masterVolume") * 1, 1);
                global.playSfx(7, global.appState.getStorage("masterVolume") * 1, 1);
                global.playSfx(8, global.appState.getStorage("masterVolume") * 1, 1);
                playSafeLandingVFX()

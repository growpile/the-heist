...
script.openSettings = function() {
    ...
    hideMenu("settings", function() {
        ...
        print(global.appState.checkStorage("enabledGloves"));
        print(global.appState.checkStorage("enabledGloves") == true ? 0 : 1);
        script.glovesToggle.currentValue = global.appState.checkStorage("enabledGloves") == true ? 0 : 1;

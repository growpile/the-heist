...
global.safeComplete = function() {
    global.utils.animateScale(script.getSceneObject(), true, new vec3(0, 0, 0), 0.25, function() {
        
    });

    global.utils.delay(3, function() {
        global.uiKitDirector.toggleUIComposite("solvedWindow", true);
        global.uiKitDirector.newWorldScale("solvedWindow", new vec3(1,1,1), 0.1, function() {
            print("scaled up");
        });
    });
}

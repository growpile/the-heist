    ...
    global.utils.delay(1, function() {
        ...
        global.utils.delay(1, function() {
            ...
            global.utils.delay(3, function() {
                global.tweenManager.startTween(tweens, "intro-label-fade-out", function() {
                    global.delay(1, function() {
                        global.tweenManager.startTween(tweens, "intro-logo-fade-out", function() {
                            global.tweenManager.startTween(tweens, "intro-logo-fade-out", function() {
                                global.tweenManager.startTween(tweens, "intro-table-hint-fade-out", function() {
                            });
                        });
                    });
                });

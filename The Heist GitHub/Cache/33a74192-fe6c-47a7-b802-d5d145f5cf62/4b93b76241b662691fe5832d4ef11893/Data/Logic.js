...
script.startSolo = function() {
    ...
    global.tweenManager.startTween(script.menuElements[1], "pinch-animation", function() {
        hideMenu("soloPlay", function() {
            safeIntro();
            // var cardboardSequenceObject = script.cardboardPrefab.instantiate(safeOrigin.getParent());
            // cardboardSequenceObject.getComponents("Component.ScriptComponent")[2].playSequence();
        });
    });
}
...
function safeIntro() {
    ...
    var overshootScale = new vec3(1.1, 1.1, 1.1);
    global.utils.animateScale(safeObject, true, overshootScale, 0.08, function() {
        global.utils.animateScale(safeObject, true, finalScale, 0.07, function() {
    ...
    // safeObject.getTransform().setLocalScale(new vec3(0, 0, 0));
    // global.utils.animateScale(safeObject, true, new vec3(0.35, 0.35, 0.35), 0.1, function() {
    //     global.utils.delay(1.5, function() {
    //         global.utils.animateScale(safeObject, true, new vec3(1, 1, 1), 0.1, function() {
    //             print("Scaled Up!");
    //             safeComponent.init();
    //             playSafeLandingVFX()
    //         })
    //     })
    //     global.utils.animateShake(
    //         safeObject,
    //         true,
    //         2, // duration in seconds
    //         true, // position shake
    //         true, // rotation shake
    //         new vec3(1, 1, 3), // position amplitude
    //         [9, 14], // position [frequiency, smoothing]
    //         new vec3(2, 4, 2.5), // rotation amplitude
    //         [20, 14], // rotation [frequiency, smoothing]
    //         12, // return speed
    //         true, // ease-in-out
    ...
    //     global.utils.animatePosition(safeOrigin, true, new vec3(0, 0, -10), 0.25, function() {
    //         print("Safe Dropped.");
    //         // global.playSfx(4, 1, 1);
    //         // global.playSfx(5, 1, 1);
    //         // global.playSfx(6, 1, 1);
    ...
    //             }
    //         );
    // global.utils.animateScale(safeObject, true, new vec3(0.35, 0.35, 0.35), 0.25, function() {

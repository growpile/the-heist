...
const InteractionHintModule = require("SpectaclesInteractionKit.lspkg/InteractionHintController")
...
script.startSolo = function() {
    script.interactionHintController.playHintAnimation(HandMode.Right, HandAnimationsLibrary.Right.PalmTouchSurface, 1, 0.8);

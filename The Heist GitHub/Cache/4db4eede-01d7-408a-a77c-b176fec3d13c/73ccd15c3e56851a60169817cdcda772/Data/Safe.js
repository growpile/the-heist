...
script.init = function(safeType) {
    ...
    if(safeType != "tutorial") {
        ...
        frontSlotSpawnResult.moduleObject.getComponent("Component.ScriptComponent").tutorialInstaComplete();
        frontSlotSpawnResult.getComponent("Component.ScriptComponent").tutorialInstaComplete();
        this.completeModule(2);
    }
